...
public class Service extends Thread
{
	...
	private static final String[] SEEK_FOR_HEADERS = new String[]{"Cache-Control", "X-Cache", "X-Cache-Lookup",};
	...
	private Pair<ToolsService, String> getSession()
	{
		...
		final ToolsService clientService = soapHelper.createSoap(ToolsService.class, serviceEndpoint,
	...
	private void downloadItemUrls(ItemId key, String serverBase, String sessionid) throws IOException
	{
		...
		try( BufferedReader in = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(out.toByteArray()),
			"UTF-8")) )
		{
	...
	private String getDifferences(Pair<ToolsService, String> session, String lastUpdate, Collection<String> additions,
		Collection<String> removals) throws Exception
	{
	...
	/**
	 * This is a output stream that nobody cares about. It just throws away
