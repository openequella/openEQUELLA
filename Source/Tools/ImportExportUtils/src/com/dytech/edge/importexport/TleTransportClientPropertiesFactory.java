...
/**
 * Basically an exact copy of TransportClientPropertiesFactory but it doesnt cache the proxy values
 *
 * @author will
 */
  ...
  public static TransportClientProperties create(String protocol) {
    ...
    tcp =
        (TransportClientProperties)
            AxisProperties.newInstance(
                TransportClientProperties.class, (Class) defaults.get(protocol));
