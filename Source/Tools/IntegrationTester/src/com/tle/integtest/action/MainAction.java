...
public class MainAction extends DispatchAction
{
	...
	protected static final String[] ACTIONS = {"contribute", "searchResources", "selectOrAdd", "searchThin",
			"structured",};
	...
	public ActionForward submit(ActionMapping mapping, ActionForm formData, HttpServletRequest request,
		HttpServletResponse response) throws Exception
	{
		MainForm form = (MainForm) formData;
	...
	public ActionForward showReturn(ActionMapping mapping, ActionForm formData, HttpServletRequest request,
		HttpServletResponse response) throws Exception
	{
		MainForm form = (MainForm) formData;
