...
public class HttpExchangeUtils {
  ...
  public static void respondApplicationError(HttpExchange exchange, Throwable th)
      throws IOException {
    th.printStackTrace();
  ...
  public static void respondHtmlMessage(HttpExchange exchange, int code, String html)
      throws IOException {
    setNoCaching(exchange);
    respondWithContent(exchange, code, "text/html", html);
  }

  public static void respondJSONMessage(HttpExchange exchange, int code, Object json)
      throws IOException {
    setNoCaching(exchange);
    respondWithContent(exchange, code, "text/json", JSONService.toString(json));
  }

  public static void respondWithContent(
      HttpExchange exchange, int code, String mimeType, String content) throws IOException {
