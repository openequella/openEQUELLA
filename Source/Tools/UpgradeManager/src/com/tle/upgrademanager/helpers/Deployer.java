...
public class Deployer
{
	...
	public void deploy(String filename)
	{
		...
		try
		{
			...
			{
				throw new DeployException("Error while attempting to deploy JAR file: " + ex.getMessage(), ex);
			}
			...
			{
				throw new DeployException("Error while attempting to migrate the installation " + ex.getMessage(), ex);
			}
		...
		catch( DeployException de )
		{
			...
			ajax.addErrorRaw(ajaxId, "Unfortunately an error has"
