rem Java options
set JAVA_ARGS=-Djava.endorsed.dirs=../common/endorsed;-Dcatalina.base=../tomcat;-Dcatalina.home=../tomcat;-Djava.io.tmpdir=../tomcat/temp;-Xrs;-Xms96m;-Xmx512m;-XX:MaxPermSize=256m;-Djava.net.preferIPv4Stack=true;-Djava.net.preferIPv6Addresses=false;-Djava.awt.headless=true;-Demma.rt.control=false
rem Class path
