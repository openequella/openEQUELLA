...
public class UpgradeToTomcat7_0_37 extends AbstractTomcatUpgrader
{
	...
	private static final Pattern LISTENER_REGEX = Pattern
		.compile("<Listener.*org.apache.catalina.mbeans.ServerLifecycleListener.*/>");
	private static final Pattern PROTOCOL_REGEX = Pattern.compile("protocol=\"(HTTP/1\\.1)\"");
	private static final String NIO_PROTOCOL = "protocol=\"org.apache.coyote.http11.Http11NioProtocol\"";
