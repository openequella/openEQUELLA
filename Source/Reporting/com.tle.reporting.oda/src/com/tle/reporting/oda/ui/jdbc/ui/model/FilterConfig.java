...
public class FilterConfig
{
	...
	public FilterConfig(String schemaName, Type type, String namePattern, boolean isShowSystemTable,
		int maxSchemaCount, int maxTableCountPerSchema)
	{
	...
	public static String getTypeDisplayText(Type type)
	{
		...
		{
		case PROCEDURE:
			return TLEOdaPlugin.getResourceString2("tablepage.text.procedure");
		case TABLE:
			return TLEOdaPlugin.getResourceString2("tablepage.text.tabletype");
		case VIEW:
			return TLEOdaPlugin.getResourceString2("tablepage.text.viewtype");
		case ALL:
			return TLEOdaPlugin.getResourceString2("tablepage.text.All");
		default:
			// should never goes here
			assert false;
			return "";
