...
public class ConnectionMetaData implements Serializable
{
	...
	private synchronized void connect() throws SQLException
	{
		if( connection == null || connection.isClosed() )
		{
			if( getClassname() != null && getUrl() != null )
			{
				...
				connection = DriverLoader.getConnectionWithExceptionTip(classname, url, username, password);
			}
		}
	}
	...
	/**
	 * Returns <code>true</code> if this <code>ConnectionMetaData</code> is the
	 * same as the o argument.
	 * 
	 * @return <code>true</code> if this <code>ConnectionMetaData</code> is the
	 *         same as the o argument.
	 */
	@Override
	public boolean equals(Object o)
	{
		...
		return ((this.classname == null ? castedObj.classname == null : this.classname.equals(castedObj.classname))
			...
			&& (this.password == null ? castedObj.password == null : this.password.equals(castedObj.password)) && (this.properties == null
				? castedObj.properties == null : this.properties.equals(castedObj.properties)));
	}
