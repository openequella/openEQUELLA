...
public abstract class AbstractSelectionsMadeCallback implements SelectionsMadeCallback
{
	...
	private static final ExternallyDefinedFunction DO_SELECTION_FUNCTION = new ExternallyDefinedFunction(
		"DoSelection.selectionsMade", new IncludeFile(urlHelper.plugUrl("com.tle.web.htmleditor.tinymce",
			"scripts/tinymce/tiny_mce_popup.js")), new IncludeFile(urlHelper.url("scripts/doselection.js")));
	...
	public void executeSelectionsMade(SectionInfo info, SelectionSession session)
	{
		...
		final FunctionCallStatement selectionsMadeSetupCall = Js.call_s(
			new ExternallyDefinedFunction("DoSelection.sm"), Js.function(selectionsMadeCall));
