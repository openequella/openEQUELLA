...
libraryDependencies := Seq(
  "org.eclipse.birt" % "birt-osgi" % "3.7.2" artifacts Artifact("birt-osgi", Artifact.DefaultType, "zip"),
  "com.tle.reporting" % "reporting-common-6.3" % "0.20141006",
  "com.tle.reporting" % "reporting-oda-6.3" % "0.20141006",
  "com.tle.reporting" % "reporting-oda-connectors-6.3" % "0.20141006",
  ...
  "org.eclipse.birt" % "org.eclipse.birt.api" % "1",
