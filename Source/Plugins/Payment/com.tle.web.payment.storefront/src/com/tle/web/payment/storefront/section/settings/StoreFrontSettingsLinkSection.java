...
public class StoreFrontSettingsLinkSection extends AbstractParentSettingsSection<Object>
{
	...
	public Pair<HtmlLinkState, Label> getLink(RenderEventContext context)
	{
		...
		SectionInfo fwd = context.createForward("/access/storefrontsettings.do");
