...
CodeMirror.defineMode("javascript", function(config, parserConfig) {
  ...
  var keywords = function(){
    ...
    var commonJS = kw("commonJS"), commonJS = {type: "string-2", style: "string-2"};
    var equella = kw("equella"), equella = {type: "builtin", style: "builtin"};
    ...
    var jsKeywords = {
      ...
      "yield": C, "export": kw("export"), "import": kw("import"), "extends": C, "exports": commonJS, "require" : commonJS,
      
      "attachments": equella, "attributes" : equella, "catalogue" : equella, "ctrl" : equella, "currentItem" : equella, 
