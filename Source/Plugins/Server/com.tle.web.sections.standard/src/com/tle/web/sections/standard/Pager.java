...
/**
 * For paging of search results |< First < Prev | 1 2 <b>3</b> 4 5 6 7 8 9 |
 * Next > Last >|
 * 
 * @author aholland
 */
		...
		BookmarkEventListener
{
	...
	public List<Long> setupAndGetPage(SectionInfo info, LongSet bitSet, int perPage, int maxDisplayed)
	{
	...
	public <T> List<T> setupAndGetPage(SectionInfo info, Collection<T> allData, int perPage, int maxDisplayed)
	{
