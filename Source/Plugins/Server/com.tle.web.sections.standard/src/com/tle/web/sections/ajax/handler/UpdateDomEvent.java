...
public class UpdateDomEvent implements ParameterizedEvent
{
	...
	public SectionEvent<?> createEvent(SectionInfo info, String[] params)
	{
		...
		renderContext.setFormBookmarkEvent(new BookmarkEvent(modalId, true, modalId != null ? info : null));
		if( modalId != null )
		{
			renderContext.setModalId(modalId.getSectionId());
		}
		renderContext.setJSONResponseCallback(new JSONResponseCallback()
		{
			@Override
	...
	public static UpdateDomEvent register(SectionTree tree, SectionId modalId, ParameterizedEvent wrapped,
		String... ajaxIds)
	{
