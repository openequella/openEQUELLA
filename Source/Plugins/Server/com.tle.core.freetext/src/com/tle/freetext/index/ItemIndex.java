...
import com.tle.freetext.filters.DateFilter;
import com.tle.freetext.filters.InstitutionFilter;
import com.tle.freetext.filters.MustFilter;
import com.tle.freetext.filters.MustNotFilter;
import com.tle.freetext.filters.SecurityFilter;
...
public abstract class ItemIndex<T extends FreetextResult> extends AbstractIndexEngine
{
	...
	private static final Logger LOGGER = Logger.getLogger(ItemIndex.class);
	...
	private Sort getSorter(Search request)
	{
		...
		if( sortfields != null )
		{
			...
			for( com.tle.common.searching.SortField sortfield : sortfields )
			{
				...
				convFields[i++] = new SortField(sortfield.getField(), type, sortfield.isReverse());
			}
