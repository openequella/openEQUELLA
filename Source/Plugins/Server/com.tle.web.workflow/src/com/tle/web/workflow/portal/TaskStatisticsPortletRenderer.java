		...
		PortletContentRenderer<TaskStatisticsPortletRenderer.TaskStatisticsPortletRendererModel>
{
	...
	public void registered(final String id, SectionTree tree)
	{
		...
		workflowSelector.addChangeEventHandler(new OverrideHandler(ajax.getAjaxUpdateDomFunction(tree, this,
			events.getEventHandler("workflowChanged"), ajax.getEffectFunction(EffectType.REPLACE_WITH_LOADING), id
				+ "taskstatsresults")));
