		...
		WorkflowSelection
{
	...
	{
		return viewFactory.createResult("managequery.ftl", this); //$NON-NLS-1$
	}
	...
	public void treeFinished(String id, SectionTree tree)
	{
		...
		workflowList.addChangeEventHandler(new StatementHandler(searchResults.getResultsUpdater(tree, null,
			SearchResultsActionsSection.ACTIONS_AJAX_ID)));
	}
