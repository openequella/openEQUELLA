...
public class UserPreferenceServiceImpl implements UserPreferenceService, UserChangeListener
{
	...
	public static final String HIDE_LOGIN_NOTICE = "hide.login.notice";
	...
	public static final String RECENT_SELECTIONS = "recent.selections";
	public static final String SEARCH_WITHIN_ATTACHMENT = "search.within.attachment";
								...
								return CacheBuilder.newBuilder().expireAfterWrite(5, TimeUnit.MINUTES).softValues()
									.build(new CacheLoader<String, String>()
									{
										...
										public String load(String key)
										{
											...
											Criterion c2 = Restrictions.eq("key.institution",
