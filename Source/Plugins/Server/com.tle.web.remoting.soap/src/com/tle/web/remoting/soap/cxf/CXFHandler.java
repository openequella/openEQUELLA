...
public class CXFHandler extends CXFNonSpringServlet
{
	...
	{
		endpointTracker = new PluginTracker<Object>(pluginService, getClass(), "endpoint", "path").setBeanKey("bean");
		interceptorTracker = new PluginTracker<AbstractPhaseInterceptor<? extends Message>>(pluginService, getClass(),
			"interceptor", null);
		endpointIntTracker = new PluginTracker<Object>(pluginService, getClass(), "endpoint-interface", null)
			.setBeanKey("bean");
	}
