...
public abstract class AbstractSearchResultsSection<LE extends ListEntry, SE extends AbstractSearchEvent<SE>, RE extends AbstractSearchResultsEvent<RE>, M extends AbstractSearchResultsSection.SearchResultsModel>
	extends
		AbstractPrototypeSection<M> implements HtmlRenderer, SearchResultsListener<RE>
{
	...
	public void registered(String id, SectionTree tree)
	{
		...
		resultsEffect = new PrependedParameterFunction(new ExternallyDefinedFunction("showNewResults", new IncludeFile(
			URL_RESULTSJS), AjaxGenerator.AJAX_LIBRARY, JQueryScrollTo.INCLUDE), AjaxGenerator.URL_SPINNER);
