...
{
	private static IncludeFile JS = new IncludeFile(ResourcesService.getResourceHelper(CourseListSection.class).url(
		"scripts/courselist.js"), JQueryDraggable.PRERENDER, JQueryDroppable.PRERENDER, JQueryUIEffects.TRANSFER);
	...
	{
		final JSCallable reloadFolderFunction = CourseListFolderUpdateCallback.getReloadFunction(ajax
			.getAjaxFunction("reloadFolder"));
			...
			selectionService.addSelectedResource(
				...
				selectionService.createItemSelection(
					...
					itemResolver.getItem(new ItemId(resourceKey.getUuid(), resourceKey.getVersion()),
						resourceKey.getExtensionType()), folder, resourceKey.getExtensionType()), false);
		}
	}
	...
	@EventHandlerMethod
	public void selectAllAttachments(SectionInfo info, List<String> uuids, ItemId itemId, @Nullable String extensionType)
	{
		final String et = sanitiseExtensionType(extensionType);
