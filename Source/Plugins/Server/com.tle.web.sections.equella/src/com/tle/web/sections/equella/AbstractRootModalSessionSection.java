 ...
 */
@TreeIndexed
public abstract class AbstractRootModalSessionSection<M extends AbstractRootModalSessionSection.RootModalSessionModel>
	extends
		AbstractPrototypeSection<M> implements ForwardEventListener, HtmlRenderer, BeforeEventsListener
{
	@Inject
	...
	{
		@Bookmarked(ignoreForContext = {ViewItemUrl.VIEWONLY_CONTEXT}, contexts = {BookmarkEvent.CONTEXT_SESSION})
		private String stateId;
		@Bookmarked(name = "t", ignoreForContext = {ViewItemUrl.VIEWONLY_CONTEXT}, contexts = {"TEMP"})
