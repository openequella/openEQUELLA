...
{
	private static final PluginResourceHelper resources = ResourcesService.getResourceHelper(DialogTemplate.class);
	...
	public SectionRenderable getLayout(Label title, RenderContext info, TemplateResult result,
		AbstractDialog<?> dialog, JSHandler closeHandler, String contentBodyClass, ElementId footerId)
	{
		if( dialog.isModal() )
		{
			...
			result = new FallbackTemplateResult(result, new GenericTemplateResult().addNamedResult("head", renderer));
		}
