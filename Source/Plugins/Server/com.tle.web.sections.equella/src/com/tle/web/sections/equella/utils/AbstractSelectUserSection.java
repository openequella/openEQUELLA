		...
		AbstractPrototypeSection<M> implements HtmlRenderer
{
	...
	public void registered(String id, SectionTree tree)
	{
		...
		{
			userList = (MultiSelectionList<UserBean>) componentFactory.createSingleSelectionList(id, "ul", tree);
		}

		final UserSearchWithExclusionsListModel listModel = new UserSearchWithExclusionsListModel(query, userService,
	...
	protected abstract SelectedUser createSelectedUser(SectionInfo info, String uuid, String displayName);
