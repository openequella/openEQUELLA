...
public class GoogleDocViewer extends FileViewer implements ViewItemViewer
{
	...
	public Bookmark createStreamUrl(SectionInfo info, ViewableResource resource)
	{
		...
		// single string ...
		String fullEquellaURLWithTokenParam = canonical + (canonical.contains("?") ? "&" : "?") + "token="
			+ encodedToken;
		...
		String fullGoogleURL = docsGoogleRsrcURL + urlAllEncodedStringPlusToken.toString();

		return new SimpleBookmark(fullGoogleURL);
	}
