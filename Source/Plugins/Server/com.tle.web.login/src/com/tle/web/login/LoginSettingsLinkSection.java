...
public class LoginSettingsLinkSection extends AbstractParentSettingsSection<Object>
{
	@PlugKey("login.title")
	private static Label TITLE_LABEL;
	@PlugKey("login.description")
	...
	public Pair<HtmlLinkState, Label> getLink(RenderEventContext context)
	{
		...
		SectionInfo fwd = context.createForward("/access/loginsettings.do");
