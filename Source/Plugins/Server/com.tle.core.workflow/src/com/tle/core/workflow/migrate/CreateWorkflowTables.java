...
public class CreateWorkflowTables extends AbstractHibernateSchemaMigration
{
	...
	{
		List<String> creationSql = helper.getCreationSql(new TablesOnlyFilter("workflow_node",
			"workflow_node_auto_assigns", "workflow_node_groups", "workflow_node_roles", "workflow_node_users",
	...
	{
		return new Class<?>[]{Workflow.class, WorkflowNodeStatus.class, WorkflowItemStatus.class, Institution.class,
				LanguageBundle.class, LanguageString.class, WorkflowItem.class, DecisionNode.class, SerialNode.class,
				ParallelNode.class, OldWorkflowGroups.class, FakeItem.class, ModerationStatus.class,
				FakeItemDefinition.class, WorkflowNode.class};
	}
