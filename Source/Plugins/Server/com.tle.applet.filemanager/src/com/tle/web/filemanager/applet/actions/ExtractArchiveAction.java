...
public class ExtractArchiveAction extends TLEAction
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		GlassProgressWorker<?> worker = new GlassProgressWorker<Object>(CurrentLocale.get(
			"action.extract.progress", selected.getName()), -1, false) //$NON-NLS-1$
		{
			@Override
	...
	public void update()
	{
		...
		if( e )
		{
			...
			e = n.endsWith(".zip") || n.endsWith(".jar") || n.endsWith(".war") || n.endsWith(".tar.bz2")
				|| n.endsWith(".tar.gz");
		}
		setEnabled(e);
	}
