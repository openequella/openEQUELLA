...
public class MainPanel extends JPanel
{
	...
	private void setupActions(Parameters params)
	{
		...
		if( isPostJava5 )
		{
			...
			if( Desktop.isDesktopSupported() && Desktop.getDesktop().isSupported(java.awt.Desktop.Action.EDIT) )
			{
		...
		fileList.registerDropHandler(new InternalDragHandler(fileList, new CopyDragAction(backend), new MoveDragAction(
			backend)));
