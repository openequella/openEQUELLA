...
/**
 * Implementations must provide a constructor that take a single java.net.URL
 * parameter, representing the server end-point.
 */
public interface Backend
{
	...
	void downloadFile(FileInfo info, File destination, ProgressMonitorCallback callback) throws IOException;

	long uploadFile(File file, FileInfo cwd, ProgressMonitorCallback progressMonitorCallback) throws IOException;
