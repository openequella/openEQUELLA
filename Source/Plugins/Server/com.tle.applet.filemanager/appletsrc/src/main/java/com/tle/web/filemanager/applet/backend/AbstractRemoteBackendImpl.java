...
public abstract class AbstractRemoteBackendImpl implements Backend
{
	...
	@Override
	public final File cacheFileForEditing(FileInfo info, ProgressMonitorCallback callback) throws IOException
	{
		throw new UnsupportedOperationException();
	}
	...
	@Override
	public final void synchroniseFile(FileInfo info, ProgressMonitorCallback callback) throws IOException
	{
		throw new UnsupportedOperationException();
	}
