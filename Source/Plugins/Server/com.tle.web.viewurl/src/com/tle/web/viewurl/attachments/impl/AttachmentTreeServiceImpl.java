...
{
	@Inject
	private PluginTracker<AttachmentTreeExtension> attachmentTreeTracker;

	private Map<String, AttachmentTreeExtension> extensionMap;

	@Override
	public List<AttachmentNode> getTreeStructure(Iterable<? extends IAttachment> attachments, boolean flattenHidden)
	{
