...
public class OaiIdentifierSettingsLinkSection extends AbstractParentSettingsSection<Object>
{
	@PlugKey("oai.title")
	private static Label TITLE_LABEL;
	@PlugKey("oaiidentifier.description")
	...
	public Pair<HtmlLinkState, Label> getLink(RenderEventContext context)
	{
		...
		SectionInfo fwd = context.createForward("/access/oaiidentifiersettings.do");
