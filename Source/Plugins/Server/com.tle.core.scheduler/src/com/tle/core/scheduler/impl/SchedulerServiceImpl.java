...
public class SchedulerServiceImpl implements SchedulerService, SchemaListener
{
	...
	public Task createSupervisorTask()
	{
		return new AlwaysRunningTask<Void>()
		{
			...
			private final LoadingCache<Institution, TargetDates> targetDates = CacheBuilder.newBuilder().build(
	...
	{
		taskService.getGlobalTask(new BeanClusteredTask("Scheduler-Supervisor", true, SchedulerService.class,
