...
public interface ThumbnailRequestService
{
	...
	/**
	 * This is deliberately just the UUID. It will try to load the request
	 * again, which may already be gone.
	 * 
	 * @param requestUuid
	 */
	...
	/**
	 * @param itemId
	 * @param excludingHandle List files that <em>don't</em> belong to this
	 *            handle.
	 * @param filename
	 * @return
	 */
