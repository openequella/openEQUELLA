...
public class ThumbingCallable implements Callable<ThumbingCallableResult>
{
	...
	{
		final ThumbnailRequest thumbnailRequest = getThumbnailRequest();
	...
	protected ThumbnailRequest getThumbnailRequest()
	{
		final ThumbnailRequest thumbnailRequest = thumbnailRequestService.getByUuid(requestUuid);
		return initialiserService.initialise(thumbnailRequest);
	}
