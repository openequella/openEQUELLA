...
public class ThumbnailServiceImpl implements ThumbnailService, ItemDeletedListener
{
	...
	{
		// TODO: kill tasks? They should realise it's not there anymore
		// anyway...
	...
	private class SingleThumbnailTask extends SingleShotTask
	{
		...
		public void runTask()
		{
			...
			// Even though this task (and all tasks in general) wait for the
			// institution keeper task,
			// it can still attempt to run before the institution task is fully
			// prepared.
