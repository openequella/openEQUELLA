...
/* package protected */class ThumbnailRequestServiceImpl implements ThumbnailRequestService
{
		...
		boolean clearPending)
	{
		...
		// (TODO: this could be a large video... we'd want to avoid this copy if
		// it were possible. COWFS anyone?)
	...
	/**
	 * Cancels all requests for the item that don't belong to the supplied
	 * handle+filename
	 * 
	 * @param itemId
	 * @param handle
	...
	{
		// At this point, the request could already be deleted. Get it again so
		// we avoid an error.
	...
	/**
	 * You can directly use this method if you know that it definitely still
	 * exists. The Nullable is due to the string parameter version using this
	 * method.
	 * 
	 * @param tr
	 */
