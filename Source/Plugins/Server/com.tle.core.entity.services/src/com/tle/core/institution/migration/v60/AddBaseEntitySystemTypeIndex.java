...
{
	private static final String keyPrefix = PluginServiceImpl.getMyPluginId(AddBaseEntitySystemTypeIndex.class)
		+ ".migration.v60.systemindex.";

	private static final String BASE_ENTITY_SYSTEMTYPE_INDEX = "baseEntitySystemTypeIndex";

	private static String COLUMN_NAME = "system_type";
