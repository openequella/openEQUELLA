...
public class RemoveObsoleteJavascriptLibraries extends AbstractHibernateDataMigration
{
	...
	private static String prefix = PluginServiceImpl.getMyPluginId(RemoveObsoleteJavascriptLibraries.class) + ".";
	...
	{
		return new MigrationInfo(prefix + "migration.v60.removejscript.title");
	}
