...
{
	private static String prefix = PluginServiceImpl.getMyPluginId(AttachmentRestrictMigration.class) + ".";

	@Override
	public MigrationInfo createMigrationInfo()
	{
		return new MigrationInfo(prefix + "migration.v63.restrictattachments.title");
	}
