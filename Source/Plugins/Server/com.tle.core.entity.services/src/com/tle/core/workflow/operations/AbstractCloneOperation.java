...
public abstract class AbstractCloneOperation extends TaskOperation
	implements
		...
		MetadataTransformingOperation
{
	...
	public final boolean execute()
	{
		...
		ItemFile from = new ItemFile(getId(), getVersion());
	...
	protected void finalProcessing(Item origItem, Item item)
	{
		...
		{
			fileProcessor.processFiles(origItem.getItemId(), new ItemFile(origItem.getItemId()), item, getStaging());
		}
	}
