...
public class EntityDisabledFieldMigrationPart2 extends AbstractHibernateSchemaMigration
{
	...
	private static String prefix = PluginServiceImpl.getMyPluginId(EntityDisabledFieldMigrationPart2.class) + ".";
	...
	{
		return new MigrationInfo(prefix + "migration.v60.disabledentity2.title");
	}
