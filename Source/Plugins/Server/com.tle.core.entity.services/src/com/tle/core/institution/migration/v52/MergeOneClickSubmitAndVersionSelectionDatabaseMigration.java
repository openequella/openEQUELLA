...
{
	private static final String keyPrefix = PluginServiceImpl.getMyPluginId(MergeOneClickSubmitAndVersionSelectionDatabaseMigration.class) + ".";
	...
	{
		return new MigrationInfo(keyPrefix + "migration.mergeoneclickandversionselectprivs");
	}
	...
	protected int countDataMigrations(HibernateMigrationHelper helper, Session session)
	{
		int ct = count(session
			.createQuery("SELECT COUNT(*) From AccessEntry ae WHERE ae.targetObject in ('C:oneClickSubmit', 'C:versionSelection', 'C:loginnotice', 'C:freetext')"));
		return ct;
	}
