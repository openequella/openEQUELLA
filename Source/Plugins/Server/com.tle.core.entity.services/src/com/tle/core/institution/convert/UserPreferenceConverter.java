...
{
	private static final String USERPREFS_FILE = "userprefs/preferences.xml"; //$NON-NLS-1$
		...
		throws IOException
	{
		...
		final List<UserPreference> allProperties = (List<UserPreference>) xmlHelper
			.readXmlFile(staging, USERPREFS_FILE);
