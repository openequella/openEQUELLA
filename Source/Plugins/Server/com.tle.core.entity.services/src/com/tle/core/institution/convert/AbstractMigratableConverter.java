...
public abstract class AbstractMigratableConverter<T> implements Converter
{
	...
	@Override
	public void importIt(final TemporaryFileHandle staging, final Institution institution,
		final ConverterParams params, String cid) throws IOException
	{
		doInTransaction(new Runnable()
		{
	...
	public void deleteIt(final TemporaryFileHandle staging, final Institution institution,
		final ConverterParams params, String cid)
	{
		doInTransaction(new Runnable()
		{
			@Override
	...
	public void setPluginService(PluginService pluginService)
	{
		...
		if( converterId != null )
		{
			postReadMigs = new PluginTracker<PostReadMigrator<T>>(pluginService, ServiceConstants.SERVICE_PLUGIN_ID,
