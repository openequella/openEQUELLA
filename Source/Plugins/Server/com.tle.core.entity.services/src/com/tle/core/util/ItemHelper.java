...
import com.tle.common.item.AttachmentHelper;
import com.tle.common.item.BadUrlHelper;
import com.tle.common.item.CollaboratorsHelper;
import com.tle.common.item.CurriculaHelper;
import com.tle.common.item.DRMHelper;
import com.tle.common.item.HistoryEventHelper;
import com.tle.common.item.ItemDetailsHelper;
import com.tle.common.item.ModerationHelper;
...
public class ItemHelper
{
	...
	@Inject
	private CurriculaHelper curriculaHelper;
	@Inject
	...
	{
		pack.setAttribute(SaveOperation.KEY_PRESAVE, new ArrayList<WorkflowOperation>());
		pack.setAttribute(SaveOperation.KEY_POSTSAVE, new ArrayList<WorkflowOperation>());
		List<AbstractHelper> helpers2 = getHelpers(settings);
