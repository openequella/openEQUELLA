...
{
	private static final String keyPrefix = PluginServiceImpl.getMyPluginId(AddDynamicMetadataRules.class);

	@Override
	public MigrationInfo createMigrationInfo()
	{
		return new MigrationInfo(keyPrefix + ".migration.v61.dynamicmetarules.title");
	}
