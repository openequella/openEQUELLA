...
{
	private static final String keyPrefix = PluginServiceImpl.getMyPluginId(IncreaseThumbnailLength.class) + ".";

	@Override
	public MigrationInfo createMigrationInfo()
	{
		return new MigrationInfo(keyPrefix + "migration.v64.thumbnail.columnsize.title");
	}
