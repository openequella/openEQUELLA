...
{
	private static final String KEY_PREFIX = PluginServiceImpl.getMyPluginId(DisplayTempateTitleMigration.class) + ".";

	@Override
	public MigrationInfo createMigrationInfo()
	{
		return new MigrationInfo(KEY_PREFIX + "migration.v64.displaytemplatetitle.title");
	}
