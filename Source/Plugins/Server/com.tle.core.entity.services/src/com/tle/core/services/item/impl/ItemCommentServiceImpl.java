...
import com.tle.core.dao.ItemCommentDao;
...
public class ItemCommentServiceImpl implements ItemCommentService, UserChangeListener
{
	...
	@Override
	public ItemPack<Item> addComment(ItemKey itemId, final String commentText, final int rating, final boolean anonymous)
	{
