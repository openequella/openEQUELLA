...
public class EntityDisabledFieldMigration extends AbstractHibernateSchemaMigration
{
	...
	private static String prefix = PluginServiceImpl.getMyPluginId(EntityDisabledFieldMigration.class) + ".";

	@Override
	public MigrationInfo createMigrationInfo()
	{
		return new MigrationInfo(prefix + "migration.v60.disabledentity.title");
	}
