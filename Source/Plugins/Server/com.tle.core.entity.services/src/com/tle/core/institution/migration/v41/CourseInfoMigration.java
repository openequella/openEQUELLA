...
public class CourseInfoMigration extends AbstractHibernateSchemaMigration
{
	...
	private static final String TABLE_NAME = "course_info"; //$NON-NLS-1$
	private static final String NEW_SETTING_COLUMN = "version_selection"; //$NON-NLS-1$
	private static final String keyPrefix = PluginServiceImpl.getMyPluginId(CourseInfoMigration.class) + "."; //$NON-NLS-1$

	@SuppressWarnings("nls")
	@Override
	public MigrationInfo createMigrationInfo()
	{
		return new MigrationInfo(keyPrefix + "courseinfo.versel.title", keyPrefix + "courseinfo.versel.description");
	}
