...
public class LDAPServiceImpl implements LDAPService
{
	...
	{
		return new LDAP(settings).doAsAdmin(new InContext<List<? extends Attribute>>()
		{
			@Override
	...
	{
		return new LDAP(settings).doAsAdmin(new InContext<List<SearchResult>>()
		{
			@Override
	...
	{
		return new LDAP(settings).getBases();
	}

	@Override
	public List<String> getDNs(LDAPSettings settings)
	{
		LDAP ldap = new LDAP(settings);
		return ldap.getDNs();
	}
