...
public class ActivationServiceImpl implements ActivationService, ItemIdExtension, UserChangeListener
{
	...
	{
		implTracker = new PluginTracker<ActivationImplementation>(pluginService, ActivationService.class,
	...
	public boolean attachmentIsSelectableForCourse(String activationType, String attachmentUuid, String courseCode)
	{
		...
		List<ActivateRequest> requests = requestDao.getAllActiveAndPendingRequests(activationType, attachmentUuid);
		return requests.stream().findFirst().isPresent();
	}
}
