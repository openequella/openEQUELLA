...
public class Z3950QuerySection extends RemoteRepoQuerySection<Z3950SearchEvent> {
  private static final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(Z3950QuerySection.class);
  ...
  @Component private TextField term2;
  @Component private TextField term3;
  @Component private SingleSelectionList<NameValue> use1;
  @Component private SingleSelectionList<NameValue> use2;
  @Component private SingleSelectionList<NameValue> use3;
  @Component private SingleSelectionList<Pair<String, Operator>> op2;
  @Component private SingleSelectionList<Pair<String, Operator>> op3;
  ...
  public SectionResult renderHtml(RenderEventContext context) {
    ...
    if (settings.isAdvanced()) {
      ...
      if (!Check.isEmpty(settings.getAdvancedSearchFields())) {
        fields =
            z3950Service.convertAdvancedFieldsXml(settings.getAdvancedSearchFields(), bundleCache);
  ...
  public void registered(String id, SectionTree tree) {
    ...
    SimpleHtmlListModel<Pair<String, Operator>> opModel =
        new SimpleHtmlListModel<Pair<String, Operator>>(ops) {
          @Override
          protected Option<Pair<String, Operator>> convertToOption(Pair<String, Operator> obj) {
            return new NameValueOption<Pair<String, Operator>>(
                new BundleNameValue(obj.getFirst(), obj.getSecond().toString(), bundleCache), obj);
          }
        };
