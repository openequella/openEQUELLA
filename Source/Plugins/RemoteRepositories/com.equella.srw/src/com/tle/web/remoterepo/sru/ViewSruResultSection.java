...
public class ViewSruResultSection
    extends RemoteRepoViewResultSection<
        ViewSruResultSection.ViewSruResultModel, SruListEntry, GenericRecord>
    implements CourseListVetoSection {
  private static final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(ViewSruResultSection.class);

  @Inject private SruService sruService;

  @TreeLookup private SruQuerySection querySection;

  @Override
  @SuppressWarnings("nls")
  protected void getContents(
      SectionInfo info, ViewSruResultModel model, List<SectionRenderable> contents) {
  ...
  public Bookmark getViewHandler(SectionInfo info, SruListEntry listItem) {
    return new BookmarkAndModify(
        info,
        events.getNamedModifier("viewResult", listItem.getResult().getIndex())); // $NON-NLS-1$
  }
  ...
  public static class ViewSruResultModel
