...
public interface SrwService
{
	...
	/**
	 * first: long form URI, second: short form uri name. IN the case of the
	 * long form for MODS, the value here is an abbreviation, actual value will
	 * be such as info:srw/schema/1/mods-v3.0 (or 3.1, 3.2, 3.3), hence
	 * String.startsWith is required, not String.equals when comparing.
	 */
