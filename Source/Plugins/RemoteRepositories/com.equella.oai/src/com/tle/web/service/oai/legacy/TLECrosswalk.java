...
public class TLECrosswalk extends Crosswalks {
  ...
  @Inject private Crosswalk crosswalk;
  ...
  private class TLECross extends Crosswalk {
    ...
    public TLECross(
        String prefix, String schemaLocation, String contentType, String docType, String encoding) {
    ...
    public String createMetadata(Object nativeItem) throws CannotDisseminateFormatException {
      ...
      try {
        ...
        String s =
            schemaService.transformForExport(getSchema(item).getId(), getPrefix(), xml, true);
        if (s != null) {
          return s;
        }
      } catch (Exception e) {
  ...
  private void addCrossWalk(String metadataPrefix, String schema, String metadataNamespace) {
    ...
    Crosswalk crosswalk1 =
        new TLECross(metadataPrefix, metadataNamespace + ' ' + schema, null, null, null);
    crosswalksMap.put(
        metadataPrefix, new CrosswalkItem(metadataPrefix, schema, metadataNamespace, crosswalk1));
  }
  ...
  private Map<String, CrosswalkItem> getSchemaTypes() {
    ...
    addCrossWalk(
        "oai_dc",
        "http://www.openarchives.org/OAI/2.0/oai_dc.xsd", //$NON-NLS-1$ //$NON-NLS-2$
