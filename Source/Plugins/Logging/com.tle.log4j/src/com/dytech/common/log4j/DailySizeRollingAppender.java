...
public class DailySizeRollingAppender extends FileAppender {
    ...
    if (maxBackupIndex > 0) {
      ...
      for (int i = maxBackupIndex - 1; i >= 1; i--) {
        ...
        if (file.exists()) {
          ...
          if (!wasRenamed) {
            LogLog.warn(
                "Failed to rename " + file.getAbsolutePath() + " to " + target.getAbsolutePath());
          }
        }
      }
  ...
  public synchronized void setFile(
      String fileName, boolean append, boolean bufferedIO, int bufferSize) throws IOException {
  ...
  public static void main(String args[]) {
    Logger logger = LoggerFactory.getLogger(com.dytech.common.log4j.DailySizeRollingAppender.class);
    do {
