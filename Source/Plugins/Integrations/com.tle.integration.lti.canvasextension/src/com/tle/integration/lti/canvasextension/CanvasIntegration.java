...
public class CanvasIntegration extends AbstractIntegrationService<CanvasSessionData>
{
	...
	public void setupSingleSignOn(SectionInfo info, SingleSignonForm form)
	{
		...
		if( userState instanceof LtiUserState )
		{
			...
			if( ltiData != null )
			{
				...
				{
					// TODO is this always the course code ????
	...
	@Override
	public void select(SectionInfo info, CanvasSessionData data, SelectionSession session)
	{
		try
		{
			...
			else
			{
				...
				for( SelectedResource resource : selectedResources )
				{
					...
					connectorRepoService.addItemToCourse(connector, CurrentUser.getUsername(), courseId, moduleId,
						item, resource);
