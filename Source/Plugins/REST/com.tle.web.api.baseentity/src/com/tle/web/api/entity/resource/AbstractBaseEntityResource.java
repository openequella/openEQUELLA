		...
		BaseEntityResource<B, SB>
{
	...
	protected abstract Class<? extends BaseEntityResource<?, ?>> getResourceClass();
	...
	protected URI getSelfUri(Class<? extends BaseEntityResource<?, ?>> resourceClass, String uuid)
	{
		return urlLinkService.getMethodUriBuilder(resourceClass, "get").build(uuid);
	}

	protected URI getGetUri(String uuid)
	{
		return getSelfUri(getResourceClass(), uuid);
	}
