...
public interface ActivationResource
{
	...
	ActivationBean get(@ApiParam(value = "Activation request uuid") @PathParam("requestuuid") String requestUuid);
	...
	Response delete(@ApiParam(value = "Activation request uuid") @PathParam("requestuuid") String requestUuid);
}
