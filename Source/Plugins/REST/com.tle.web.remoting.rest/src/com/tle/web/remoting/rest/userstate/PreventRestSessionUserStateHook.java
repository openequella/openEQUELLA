package com.tle.web.remoting.rest.userstate;
 ...
 * If the requested URL is a REST endpoint, do NOT create a guest session when there is no existing user state.
 * 
 * @author Aaron
 *
 */
@Bind
@Singleton
public class PreventRestSessionUserStateHook implements UserStateHook
{
	@Inject
	...
	{
		if( userState == null && isRestEndpoint(request) )
		{
	...
	private boolean isRestEndpoint(HttpServletRequest request)
	{
