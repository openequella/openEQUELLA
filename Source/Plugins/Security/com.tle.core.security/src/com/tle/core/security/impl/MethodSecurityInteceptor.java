...
public class MethodSecurityInteceptor implements MethodInterceptor
{
	...
	private void throwAccessDenied(Set<String> privsList)
	{
		...
		throw new AccessDeniedException("You do not have the required privileges to access this object [" //$NON-NLS-1$
			+ privs.toString() + "]"); //$NON-NLS-1$
	}

	private Collection<Object> filterCollection(SecurityAttribute secAttr, Collection<Object> returnedObject)
	{
