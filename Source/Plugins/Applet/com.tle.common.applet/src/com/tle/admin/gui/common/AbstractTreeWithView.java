 ...
 */
public abstract class AbstractTreeWithView<NODE_TYPE extends DefaultMutableTreeNode, VIEW_TYPE extends TreeWithViewInterface<NODE_TYPE>>
	extends
		JPanel
{
	...
	private void loadCurrentSelection()
	{
		...
		{
			currentEditor.setup();
			currentEditor.addNameListener(new KeyAdapter()
			{
				@Override
	...
	private TLEAction upAction = new UpAction()
	{
		...
		public void update()
		{
			setEnabled(AbstractTreeWithView.this.isEnabled() && model.canMoveUp(getCurrentTreeSelection()));
		}
	};
	...
	private TLEAction downAction = new DownAction()
	{
		...
		public void update()
		{
			setEnabled(AbstractTreeWithView.this.isEnabled() && model.canMoveDown(getCurrentTreeSelection()));
		}
	};
