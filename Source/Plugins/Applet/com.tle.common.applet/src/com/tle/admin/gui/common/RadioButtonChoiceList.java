...
public abstract class RadioButtonChoiceList<STATE_TYPE, CHOICE_TYPE>
    extends AbstractChoiceList<STATE_TYPE, CHOICE_TYPE, AbstractButton> {
  ...
  protected void removeAndIgnoreOldComponents() {
    ...
    for (AbstractButton b :
        Lists.newArrayList(new Iter8<AbstractButton>(buttonGroup.getElements()).iterator())) {
  ...
  private final ItemListener buttonListener =
      new ItemListener() {
        @Override
