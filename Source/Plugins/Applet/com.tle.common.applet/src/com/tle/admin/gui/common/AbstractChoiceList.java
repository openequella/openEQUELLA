...
public abstract class AbstractChoiceList<STATE_TYPE, CHOICE_TYPE, CHOICE_COMPONENT_TYPE> extends JPanel
	implements
		Changeable
{
	protected final Map<CHOICE_COMPONENT_TYPE, DynamicChoicePanel<STATE_TYPE>> choices = new HashMap<CHOICE_COMPONENT_TYPE, DynamicChoicePanel<STATE_TYPE>>();
	...
	/**
	 * Remove any old components from the UI, and ignore them in the
	 * <code>changedetector</code> member.
	 */
