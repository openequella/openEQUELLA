...
public class DateSelector extends JPanel implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (src.equals(defaultClear)) {
      ...
      java.util.Date selection =
          CalendarDialog.showCalendarDialog(
              this,
              CurrentLocale.get("com.dytech.edge.admin.wizard.editor.calendareditor.selectdate"),
              savedDate == null ? null : savedDate.toDate());
      setDate(selection);
    }
  }

  /**
   * Attempt to load the calendar control with the saved date in the default field (if any - we
   * expect at least a default Jan 1st 1970). In practice this will display the year and month.
   * Highlighting the single day in the control is just too much of a fiddle with Mouse Events etc
