...
public class JChangeDetectorPanel extends JPanel implements Changeable {
  ...
  /**
   * TODO: This is really dangerous - recusively en/disabling all components inside every panel will
   * screw up things like JGroup, JShuffleList, JShuffleBox, and anything else that en/disables
   * stuff depending on other settings.
   */
