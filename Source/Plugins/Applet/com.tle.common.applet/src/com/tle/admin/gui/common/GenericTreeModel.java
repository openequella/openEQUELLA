...
public class GenericTreeModel<T extends DefaultMutableTreeNode> implements Serializable
{
	 ...
	 * @author Nicholas Read
	 */
	public interface UpDownPolicyImplementor<T extends DefaultMutableTreeNode> extends UpDownPolicy<T>, Serializable
	{
	...
	/**
	 * Implements a policy where children can only move up and down in their
	 * current siblings, restricted to the one parent.
	 * 
	 * @author Nicholas Read
	 */
	public static class UpDownWithInParentPolicy<T extends DefaultMutableTreeNode>
		implements
			UpDownPolicyImplementor<T>
	{
		private static final long serialVersionUID = 1L;
	...
	/**
	 * Implements a policy where children can move up and down through their
	 * siblings, and will become the previous sibling of their parent if moving
	 * up and is the first child, or the next sibling of their parent if moving
	 * down and is the last child.
	 * 
	 * @author Nicholas Read
	 */
	public static class UpDownDepthFirstPolicy<T extends DefaultMutableTreeNode> implements UpDownPolicyImplementor<T>
	{
		private static final long serialVersionUID = 1L;
	...
	/**
	 * Implements a policy where nothing can be moved up or down. Sounds
	 * useless, but it can be handy.
	 * 
	 * @author Nicholas Read
	 */
	public static class DisabledUpDownPolicy<T extends DefaultMutableTreeNode> implements UpDownPolicyImplementor<T>
	{
		private static final long serialVersionUID = 1L;
