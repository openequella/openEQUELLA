...
public class EntityCache
{
	...
	private Map<Long, NameId> transform(RemoteAbstractEntityService<?> service, boolean showArchived)
	{
		List<NameId> nis = BundleCache.getNameIds(showArchived ? service.listAll() : service.listEnabled());
