...
public class AppletLauncher extends AbstractAppletLauncher
{
	...
	{
		Parameters params = new Parameters(getEndpoint(), getBackendClass(), getWizardId(), isAutoMarkAsResource());
	...
	private Class<? extends AbstractRemoteBackendImpl> getBackendClass() throws ClassNotFoundException
	{
		return Class.forName(getParameter(BACKEND_PARAMETER)).asSubclass(AbstractRemoteBackendImpl.class);
	}
