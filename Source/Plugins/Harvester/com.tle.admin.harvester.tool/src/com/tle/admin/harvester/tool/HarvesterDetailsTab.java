...
{
	private static final String PREAMBLE = "com.tle.admin.harvester.tool.detailstab.";
	...
	public HarvesterDetailsTab()
	{
		...
		namePanel.addTextAndComponent(PREAMBLE + "namefield",
			nameField);
		namePanel.addTextAndComponent(PREAMBLE + "enabled", enabled);
		namePanel.addTextAndComponent(PREAMBLE + "collections",
			collections);
		namePanel.addTextAndComponent(PREAMBLE + "import", transforms);

		namePanel.addComponent(separate1);

		namePanel.addComponent(new JLabel(getLocaleString("updates")));
		namePanel.addTextAndComponent(PREAMBLE + "emptyfiller", new JLabel(getLocaleString("versioningdescriptor")));

		namePanel.addTextAndComponent(PREAMBLE + "emptyfiller", newVersionRadio);
		namePanel.addTextAndComponent(PREAMBLE + "emptyfiller", updateVersionRadio);
	...
	private String getLocaleString(String suffix)
	{
		return CurrentLocale.get(PREAMBLE + suffix);
