...
public abstract class FlatterDefaults {
  ...
  // Fonts:
  public static final FontUIResource SerifFont =
      new FontUIResource("Serif", java.awt.Font.PLAIN, 12); // $NON-NLS-1$
  public static final FontUIResource SansSerifFont =
      new FontUIResource(
          "SansSerif", // "Tahoma", //$NON-NLS-1$
          java.awt.Font.PLAIN,
          11);
  public static final FontUIResource MonospaceFont =
      new FontUIResource("Monospace", java.awt.Font.PLAIN, 12); // $NON-NLS-1$
  ...
  public static final BorderUIResource LineBorder =
      new BorderUIResource(BorderFactory.createLineBorder(DarkGray, 1));
  public static final BorderUIResource MidLineBorder =
      new BorderUIResource(BorderFactory.createLineBorder(MidGray, 1));
  public static final BorderUIResource LightLineBorder =
      new BorderUIResource(BorderFactory.createLineBorder(LightGray, 1));
  public static final BorderUIResource LighterLineBorder =
      new BorderUIResource(BorderFactory.createLineBorder(LighterGray, 1));
  public static final BorderUIResource EmptyBorder =
      new BorderUIResource(BorderFactory.createEmptyBorder(2, 2, 2, 2));

  public static final BorderUIResource CMidLineBorder =
      new BorderUIResource(
          BorderFactory.createCompoundBorder(
              BorderFactory.createLineBorder(MidGray, 1),
              BorderFactory.createEmptyBorder(2, 2, 2, 2)));
  public static final BorderUIResource CLightLineBorder =
      new BorderUIResource(
          BorderFactory.createCompoundBorder(
              BorderFactory.createLineBorder(LightGray, 1),
              BorderFactory.createEmptyBorder(2, 2, 2, 2)));
  public static final BorderUIResource CLighterLineBorder =
      new BorderUIResource(
          BorderFactory.createCompoundBorder(
              BorderFactory.createLineBorder(LighterGray, 1),
              BorderFactory.createEmptyBorder(2, 2, 2, 2)));
  ...
  // Icons:
  public static final IconUIResource CheckIcon =
      new IconUIResource(new FlatterIcons.BoxIcon(12, 12, DarkGray, DarkGray));
  ...
  public abstract static class CheckBox {
    ...
    public static final IconUIResource IconChecked =
        new IconUIResource(
            new FlatterIcons.BoxChecked(IconHeight, IconWidth, IconColorEC, IconColorDC));

    public static final IconUIResource IconUnchecked =
        new IconUIResource(
            new FlatterIcons.BoxUnchecked(IconHeight, IconWidth, IconColorEUC, IconColorDUC));
  }
  ...
  public abstract static class CheckBoxMenuItem {
    ...
    public static final ColorUIResource IconColorEC =
        FlatterDefaults.CheckBox.IconColorEC; // Enabled
    // and
    // Checked
    public static final ColorUIResource IconColorDC =
        FlatterDefaults.CheckBox.IconColorDC; // Disabled
    // and
    // Checked
    public static final ColorUIResource IconColorEUC =
        FlatterDefaults.CheckBox.IconColorEUC; // Enabled
    // and
    // Unchecked
    public static final ColorUIResource IconColorDUC =
        FlatterDefaults.CheckBox.IconColorDUC; // Disabled
    // and
    // Unchecked
  ...
  public abstract static class MenuBar {
    ...
    public static final ColorUIResource ForegroundSelected = FlatterDefaults.SelectedText;
    public static final ColorUIResource BackgroundSelected = FlatterDefaults.SelectedBackground;
    public static final BorderUIResource Border =
        new BorderUIResource(new com.dytech.gui.LineBorder(MidGray, 0, 0, 1, 0));
  ...
  public abstract static class RadioButton {
    public static final ColorUIResource BackgroundNormal =
        FlatterDefaults.CheckBox.BackgroundNormal;
    public static final ColorUIResource BackgroundPressed =
        FlatterDefaults.CheckBox.BackgroundPressed;
    public static final ColorUIResource BackgroundActive =
  ...
  public abstract static class PasswordField {
    ...
    public static final ColorUIResource BackgroundSelected =
