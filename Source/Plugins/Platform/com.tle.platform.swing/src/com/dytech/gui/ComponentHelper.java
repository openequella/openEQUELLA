...
public final class ComponentHelper
{
	 ...
	 * @deprecated Doesn't work in dual-monitor environments. Use
	 *             percentageOfScreen(Window, float, float)
	 */
	@Deprecated
	...
	/**
	 * Finds the deepest direct child window of the given window that matches
	 * the specified attributes.
	 * 
	 * @param baseWindow the parent window.
	 * @param isVisible the child window must be visible or not.
	 * @param isActive the child window must be active or not.
	 * @return the deepest child window matching the attributes. This may be the
	 *         given baseWindow.
	 */
	public static Window findDeepestChildWindow(Window baseWindow, boolean isVisible, boolean isActive)
	{
