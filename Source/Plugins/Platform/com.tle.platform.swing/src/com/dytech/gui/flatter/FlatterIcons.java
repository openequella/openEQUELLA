...
public abstract class FlatterIcons
{
	...
	/**
	 * Used to extend JButton which led to strange behaviour when clicking on it
	 * from JComboBox.
	 * 
	 * @dytech.jira see Jira Defect TLE-1078 :
	 *              http://apps.dytech.com.au/jira/browse/TLE-1078
	 */
