...
public class JSmartTextField extends JTextField
{
	...
	public static final int I_SYMBOLS = I_UNDERSCORE | I_HYPHEN | I_COLON | I_SEMICOLON | I_PERIOD | I_COMMA;
	public static final int I_MOST_STUFF = I_ALPHANUMERIC | I_WHITESPACE | I_SYMBOLS;
	public static final int I_ALRIGHT_IN_URLS = I_ALPHANUMERIC | I_UNDERSCORE | I_PERIOD | I_FORWARD_SLASH;
	...
	/**
	 * @param maxLength The maxLength to set. Any length less than zero
