/*
 * @(#)BasicSpinnerUI.java 1.15 03/01/23 Copyright 2003 Sun Microsystems, Inc.
...
/**
 * adame: Taken from BasicSpinnerUI because too many parts were private to
 * override effectively. The default Spinner UI delegate.
 * 
...
public class FlatterSpinnerUI extends SpinnerUI
{
	 ...
	 */
	private static class ArrowButtonHandler extends AbstractAction implements MouseListener, UIResource
	{
	 ...
	 * the BasicSpinnerUI javadoc for more information about exactly how the
