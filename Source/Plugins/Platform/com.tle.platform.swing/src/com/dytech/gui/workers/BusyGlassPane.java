 ...
 * system busy states.
 * <hr/>
 * This was merged in to Dytech's code library by Nicholas Read. It should be
 * used in conjunction with <code>GlassSwingWorker</code>. Code has been added
 * to stop the window closing down during it's busy state if the window is an
 * instance of <code>JFrame</code> or <code>JDialog</code>.
 * 
 * @author Yexin Chen
