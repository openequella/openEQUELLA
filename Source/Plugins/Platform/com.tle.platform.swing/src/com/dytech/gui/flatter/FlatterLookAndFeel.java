...
public class FlatterLookAndFeel extends MetalLookAndFeel {
  ...
  public static final String DESCRIPTION =
      "A complete revision of the original com.dytech.gui.Flat L&F";
  private Object[] defaults;
  public static final List<String> listData =
  ...
  protected void initComponentDefaults(UIDefaults table) {
    ...
    Object[] defaultSettings = {
      "Button.background",
      FlatterDefaults.Button.BackgroundNormal,
      "Button.backgroundPressed",
      FlatterDefaults.Button.BackgroundPressed,
      "Button.backgroundActive",
      FlatterDefaults.Button.BackgroundActive,
      "Button.textNormal",
      FlatterDefaults.Button.TextNormal,
      "Button.textPressed",
      FlatterDefaults.Button.TextPressed,
      "Button.textActive",
      FlatterDefaults.Button.TextActive,
      "Button.textDisabled",
      FlatterDefaults.Button.TextDisabled,
      "Button.font",
      FlatterDefaults.Button.Font,
      "Button.border",
      FlatterDefaults.Button.Border,
      "CheckBox.font",
      FlatterDefaults.CheckBox.Font,
      "CheckBox.background",
      FlatterDefaults.CheckBox.BackgroundNormal,
      "CheckBox.backgroundPressed",
      FlatterDefaults.CheckBox.BackgroundPressed,
      "CheckBox.backgroundActive",
      FlatterDefaults.CheckBox.BackgroundActive,
      "CheckBox.textNormal",
      FlatterDefaults.CheckBox.TextNormal,
      "CheckBox.textActive",
      FlatterDefaults.CheckBox.TextActive,
      "CheckBox.textPressed",
      FlatterDefaults.CheckBox.TextPressed,
      "CheckBox.textDisabled",
      FlatterDefaults.CheckBox.TextDisabled,
      "CheckBox.iconChecked",
      FlatterDefaults.CheckBox.IconChecked,
      "CheckBox.iconUnchecked",
      FlatterDefaults.CheckBox.IconUnchecked,
      "CheckBox.iconPressedChecked",
      FlatterDefaults.CheckBox.IconChecked,
      "CheckBox.iconPressedUnchecked",
      FlatterDefaults.CheckBox.IconUnchecked,
      "CheckBox.textIconGap",
      FlatterDefaults.CheckBox.TextIconGap,
      "CheckBoxMenuItem.font",
      FlatterDefaults.CheckBoxMenuItem.Font,
      "CheckBoxMenuItem.background",
      FlatterDefaults.CheckBoxMenuItem.Background,
      "CheckBoxMenuItem.foreground",
      FlatterDefaults.CheckBoxMenuItem.Foreground,
      "CheckBoxMenuItem.border",
      FlatterDefaults.CheckBoxMenuItem.Border,
      "CheckBoxMenuItem.selectionBackground",
      FlatterDefaults.CheckBoxMenuItem.SelectionBackground,
      "CheckBoxMenuItem.checkIcon",
      FlatterDefaults.CheckBoxMenuItem.CheckIcon,
      "ComboBox.font",
      FlatterDefaults.ComboBox.Font,
      "ComboBox.background",
      FlatterDefaults.ComboBox.Background,
      "ComboBox.foreground",
      FlatterDefaults.ComboBox.Foreground,
      "ComboBox.border",
      FlatterDefaults.ComboBox.Border,
      "ComboBox.disabledBackground",
      FlatterDefaults.ComboBox.Background,
      "ComboBox.disabledForeground",
      FlatterDefaults.ComboBox.ForegroundDisabled,
      "ComboBox.selectedBackground",
      FlatterDefaults.ComboBox.BackgroundSelected,
      "ComboBox.selectedForeground",
      FlatterDefaults.ComboBox.ForegroundSelected,
      ...
      "PopupMenu.border",
      FlatterDefaults.PopupMenu.Border,
      "Panel.font",
      FlatterDefaults.Panel.Font,
      "Panel.background",
      FlatterDefaults.Panel.Background,
      "Panel.foreground",
      FlatterDefaults.Panel.Foreground,
      "PasswordField.font",
      FlatterDefaults.TextField.Font,
      "PasswordField.background",
      FlatterDefaults.TextField.Background,
      "PasswordField.selectionBackground",
      FlatterDefaults.TextField.BackgroundSelected,
      "PasswordField.foreground",
      FlatterDefaults.TextField.TextNormal,
      "PasswordField.inactiveForeground",
      FlatterDefaults.TextField.TextDisabled,
      "PasswordField.selectionForeground",
      FlatterDefaults.TextField.TextSelected,
      "PasswordField.border",
      FlatterDefaults.TextField.Border,
      "RadioButton.font",
      FlatterDefaults.RadioButton.Font,
      "RadioButton.background",
      FlatterDefaults.RadioButton.BackgroundNormal,
      "RadioButton.backgroundPressed",
      FlatterDefaults.RadioButton.BackgroundPressed,
      "RadioButton.backgroundActive",
      FlatterDefaults.RadioButton.BackgroundActive,
      "RadioButton.textNormal",
      FlatterDefaults.RadioButton.TextNormal,
      "RadioButton.textActive",
      FlatterDefaults.RadioButton.TextActive,
      "RadioButton.textPressed",
      FlatterDefaults.RadioButton.TextPressed,
      "RadioButton.textDisabled",
      FlatterDefaults.RadioButton.TextDisabled,
      "RadioButton.iconChecked",
      FlatterDefaults.RadioButton.IconChecked,
      "RadioButton.iconUnchecked",
      FlatterDefaults.RadioButton.IconUnchecked,
      "RadioButton.iconPressedChecked",
      FlatterDefaults.RadioButton.IconChecked,
      "RadioButton.iconPressedUnchecked",
      FlatterDefaults.RadioButton.IconUnchecked,
      "RadioButton.textIconGap",
      FlatterDefaults.RadioButton.TextIconGap,
      "RadioButtonMenuItem.font",
      FlatterDefaults.RadioButtonMenuItem.Font,
      "RadioButtonMenuItem.background",
      FlatterDefaults.RadioButtonMenuItem.Background,
      "RadioButtonMenuItem.foreground",
      FlatterDefaults.RadioButtonMenuItem.Foreground,
      "RadioButtonMenuItem.selectionBackground",
      FlatterDefaults.RadioButtonMenuItem.SelectionBackground,
      "RadioButtonMenuItem.border",
      FlatterDefaults.RadioButtonMenuItem.Border,
      "RadioButtonMenuItem.checkIcon",
      FlatterDefaults.RadioButtonMenuItem.CheckIcon,
      "ScrollBar.track",
      FlatterDefaults.ScrollBar.Track,
      "ScrollBar.thumb",
      FlatterDefaults.ScrollBar.Thumb,
      "ScrollBar.arrow",
      FlatterDefaults.ScrollBar.Arrow,
      "ScrollBar.width",
      FlatterDefaults.ScrollBar.Width,
      "ScrollPane.background",
      FlatterDefaults.ScrollPane.Background,
      "ScrollPane.foreground",
      FlatterDefaults.ScrollPane.Foreground,
      "ScrollPane.border",
      FlatterDefaults.ScrollPane.Border,
      "Viewport.background",
      FlatterDefaults.ScrollPane.Background,
      "Separator.foreground",
      FlatterDefaults.Separator.Foreground,
      "Separator.background",
      FlatterDefaults.Separator.Background,
      "Spinner.border",
      FlatterDefaults.Spinner.Border,
      "TabbedPane.font",
      FlatterDefaults.TabbedPane.Font,
      "Table.font",
      FlatterDefaults.Table.Font,
      "Table.background",
      FlatterDefaults.Table.Background,
      "Table.foreground",
      FlatterDefaults.Table.Foreground,
      "Table.gridColor",
      FlatterDefaults.Table.Grid,
      "Table.scrollPaneBorder",
      FlatterDefaults.Table.Border,
      "Table.selectionBackground",
      FlatterDefaults.Table.BackgroundSelected,
      "Table.selectionForeground",
      FlatterDefaults.Table.ForegroundSelected,
      "Table.focusCellBackground",
      FlatterDefaults.Table.CellBackgroundSelected,
      "Table.focusCellForeground",
      FlatterDefaults.Table.CellForegroundSelected,
      "Table.focusCellHighlightBorder",
      FlatterDefaults.Table.Border,
      "TableHeader.background",
      FlatterDefaults.TableHeader.Background,
      "TableHeader.foreground",
      FlatterDefaults.TableHeader.Foreground,
      "TableHeader.font",
      FlatterDefaults.TableHeader.Font,
      "TableHeader.cellBorder",
      FlatterDefaults.TableHeader.Border,
      "TextField.font",
      FlatterDefaults.TextField.Font,
      ...
      FlatterDefaults.TextField.Border,
      "TitledBorder.font",
      FlatterDefaults.Font,
      "OptionPane.background",
      FlatterDefaults.Background,
      "ToolTip.border",
      FlatterDefaults.ToolTipBorder,
      "ToolTip.background",
      FlatterDefaults.ToolTipBackground,
      "ToolTip.foreground",
      FlatterDefaults.ToolTipForeground,
    };
      ...
      if (defaults == null) {
        defaults =
            new Object[] {
              ...
              buttonClass,
              buttonClass,
              Class.forName(buttonClass),
              "CheckBoxUI",
              checkBoxClass,
              checkBoxClass,
              Class.forName(checkBoxClass),
              "ComboBoxUI",
              comboBoxClass,
              comboBoxClass,
              Class.forName(comboBoxClass),
              "RadioButtonUI",
              radioButtonClass,
              radioButtonClass,
              Class.forName(radioButtonClass),
              "ScrollBarUI",
              scrollBarClass,
              scrollBarClass,
              Class.forName(scrollBarClass),
              "SeparatorUI",
              separatorClass,
              separatorClass,
              Class.forName(separatorClass),
              ...
              spinnerClass,
              spinnerClass,
              Class.forName(spinnerClass),
              tabbedPaneClass,
              Class.forName(tabbedPaneClass),
            };
      }
  ...
  public static void main(String[] args) throws Exception {
    ...
    JOptionPane.showMessageDialog(
        frame,
        "Information",
        spinner.getUI().getClass().getName(),
