...
public class ExceptionDialog extends JDialog implements ActionListener
{
	...
	public ExceptionDialog(Dialog dialog, String title, String message, String version, Throwable throwable)
	{
		super(dialog);
		setup(title, message, version, throwable);
	}

	public ExceptionDialog(Frame frame, String title, String message, String version, Throwable throwable)
	{
		super(frame);
		setup(title, message, version, throwable);
	}
