...
public final class PrivilegeTree
{
	...
	public enum Node
	{
		...
		SCHEMA(false, PRIORITY_SCHEMA), ALL_COLLECTIONS(true, PRIORITY_ALL_COLLECTIONS), COLLECTION(false,
			PRIORITY_COLLECTION), GLOBAL_ITEM_STATUS(true, PRIORITY_GLOBAL_ITEM_STATUS), ITEM_STATUS(true,
			PRIORITY_ITEM_STATUS), ITEM_METADATA(true, PRIORITY_ITEM_METADATA), DYNAMIC_ITEM_METADATA(false,
			PRIORITY_DYNAMIC_METADATA), ALL_WORKFLOWS(true, PRIORITY_ALL_WORKFLOWS),
		WORKFLOW(false, PRIORITY_WORKFLOW), WORKFLOW_TASK(false, PRIORITY_WORKFLOW_TASK), ALL_POWER_SEARCHES(true,
			PRIORITY_ALL_POWER_SEARCHES), POWER_SEARCH(false, PRIORITY_POWER_SEARCH), ALL_FEDERATED_SEARCHES(true,
			PRIORITY_ALL_FEDERATED_SEARCHES), FEDERATED_SEARCH(false, PRIORITY_FEDERATED_SEARCH), ALL_FILTER_GROUPS(
			true, PRIORITY_ALL_FILTER_GROUPS), FILTER_GROUP(false, PRIORITY_FILTER_GROUP), ITEM(false, PRIORITY_ITEM),
		ALL_REPORTS(true, PRIORITY_ALL_REPORTS), REPORT(false, PRIORITY_REPORT), ALL_SYSTEM_SETTINGS(true,
			PRIORITY_ALL_SYSTEM_SETTINGS), SYSTEM_SETTING(false, PRIORITY_SYSTEM_SETTING), HIERARCHY_TOPIC(false,
			PRIORITY_HIERARCHY_TOPIC), ALL_COURSE_INFO(true, PRIORITY_ALL_COURSE_INFO), COURSE_INFO(false,
			PRIORITY_COURSE_INFO), ALL_DYNA_COLLECTIONS(true, PRIORITY_ALL_DYNA_COLLECTIONS), DYNA_COLLECTION(false,
			PRIORITY_DYNA_COLLECTION),
		ALL_TAXONOMIES(true, PRIORITY_ALL_TAXONOMIES),
		TAXONOMY(false, PRIORITY_TAXONOMY),

		// Portlet HAX
		ALL_PORTLETS(true, PRIORITY_ALL_PORTLETS), PORTLET(false, PRIORITY_PORTLET), PORTLET_HTML(false,
			PRIORITY_PORTLET), PORTLET_RSS(false, PRIORITY_PORTLET), PORTLET_IFRAME(false, PRIORITY_PORTLET),
		PORTLET_FREEMARKER(false, PRIORITY_PORTLET), PORTLET_TASKS(false, PRIORITY_PORTLET), PORTLET_SEARCH(false,
			PRIORITY_PORTLET), PORTLET_MYRESOURCES(false, PRIORITY_PORTLET),
		PORTLET_FAVOURITES(false, PRIORITY_PORTLET), PORTLET_RECENT(false, PRIORITY_PORTLET), PORTLET_BROWSE(false,
			PRIORITY_PORTLET), PORTLET_TASKSTATISTICS(false, PRIORITY_PORTLET),
		...
		ALL_HTMLEDITOR_PLUGINS(true, PRIORITY_ALL_HTMLEDITOR_PLUGINS), HTMLEDITOR_PLUGIN(false,
			PRIORITY_HTMLEDITOR_PLUGIN),

		ALL_HARVESTER_PROFILES(true, PRIORITY_ALL_HARVESTER_PROFILES), HARVESTER_PROFILE(false,
			PRIORITY_HARVESTER_PROFILE), ALL_CUSTOM_LINKS(true, PRIORITY_ALL_CUSTOM_LINKS), CUSTOM_LINK(false,
			PRIORITY_CUSTOM_LINK), ALL_MANAGING(true, PRIORITY_ALL_MANAGING), MANAGING(false, PRIORITY_MANAGING);
