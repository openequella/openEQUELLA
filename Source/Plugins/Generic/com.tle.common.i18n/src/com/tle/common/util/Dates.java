...
public enum Dates
{
	...
	ISO_DATE_ONLY("yyyy-MM-dd"), ISO_WITH_TIMEZONE(GeneralConstants.ISO_DATE_FORMAT_STR + "Z"),
	ISO_WITH_GENERAL_TIMEZONE("yyyy-MM-dd'T'HH:mm:ssz"), ISO_MIDNIGHT("yyyy-MM-dd'T00:00:00'"), DATE_ONLY(
		DateFormat.LONG, -1), DATE_ONLY_FULL(DateFormat.FULL, -1), DATE_AND_TIME(DateFormat.LONG, DateFormat.SHORT),
	ACTIVE_CACHE_TIMESLOT("H:mm"), MERLOT("MMM dd, yyyy"), @Deprecated
