...
import com.tle.common.property.PropertyBeanFactory;

public class BeanPropertySerialiser extends PropertySerialiser
{
	@Override
	public void query(Object object, Field field, Collection<String> queries) throws IllegalAccessException,
	...
	@Override
	public void load(Object object, Field field, Map<String, String> properties) throws IllegalAccessException,
		InstantiationException
	{
		Class<?> type = field.getType();
		if( ConfigurationProperties.class.isAssignableFrom(type) )
