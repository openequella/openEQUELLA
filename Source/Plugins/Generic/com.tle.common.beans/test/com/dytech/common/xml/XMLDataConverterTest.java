...
import com.dytech.common.xml.mapping.CollectionMapping;
import com.dytech.common.xml.mapping.DataMapMapping;
import com.dytech.common.xml.mapping.DataMapping;
import com.dytech.common.xml.mapping.DateMapping;
import com.dytech.common.xml.mapping.ElementMapping;
import com.dytech.common.xml.mapping.ListMapping;
import com.dytech.common.xml.mapping.MapMapping;
import com.dytech.common.xml.mapping.NamespaceMapping;
import com.dytech.common.xml.mapping.NodeMapping;
import com.dytech.common.xml.mapping.NodeTypeMapping;
import com.dytech.common.xml.mapping.PropBagMapping;
import com.dytech.common.xml.mapping.URLMapping;
...
public class XMLDataConverterTest extends TestCase
{
	...
	protected void setUp() throws Exception
	{
		...
		stringXml = "<xml xml:base=\"attribute\" attribute=\"attribute\" another=\"another\">"
			...
			+ "		<node3><node2 a1=\"a1\" a2=\"a2\">sdfsdf</node2></node3>"
			+ "	</element>"
			+ "	<deep deep=\"attribute\"><deep>deep1</deep></deep>"
			+ "	<deep2><deeper><deep>deep2</deep></deeper></deep2>"
			+ "	<prefix:namespace>namespace</prefix:namespace>"
			+ "	<map>"
			+ "		<node key=\"a\" ><value>valuea</value></node>"
			+ "		<node key=\"b\" ><value>valueb</value></node>"
			+ "	</map>"
			+ "	<datamap>"
			+ "		<data>"
			+ "			<key><data>a</data></key>"
			+ "			<value><data>valuea</data></value>"
			+ "		</data>"
			+ "		<data>"
			+ "			<key><data>b</data></key>"
			+ "			<value><data>valueb</data></value>"
			+ "		</data>"
			+ "	</datamap>"
			+ "	<resolver type=\"override\"><string>resolved</string></resolver>"
	...
	public void testCollectionSuperDuperAdvanced()
	{
		...
		mappings.addNodeMapping(new CollectionMapping("collection", xpath, ArrayList.class, new DataMapping("", "",
			TestBean2.class)));
		getBean();
		assertEquals(2, bean.collection.size());
	...
	public void testDataMap()
	{
		...
		mappings.addNodeMapping(new DataMapMapping("map", "datamap", "data/key", "data/value", TestBean2.class,
			TestBean2.class));
