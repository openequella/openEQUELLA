...
public class EchoVodcastViewer extends AbstractEchoViewer
{
	@Override
	public boolean supports(SectionInfo info, ViewableResource resource)
	{
		...
		if( a != null )
		{
			...
			return ed == null ? supportsMime : supportsMime && !Check.isEmpty(ed.getEchoData().getVodcastUrl());
		}
