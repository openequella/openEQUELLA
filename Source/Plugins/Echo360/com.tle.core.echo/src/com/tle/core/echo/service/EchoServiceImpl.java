		...
		EchoService
{
	...
	public void editEchoServer(String uuid, EchoServer newServer) throws InvalidDataException
	{
		...
		// Other details
		oldServer.setApplicationUrl(newServer.getApplicationUrl().trim());
		oldServer.setContentUrl(newServer.getContentUrl().trim());
		oldServer.setConsumerKey(newServer.getConsumerKey().trim());
		oldServer.setConsumerSecret(newServer.getConsumerSecret().trim());
		oldServer.setEchoSystemID(newServer.getEchoSystemID().trim());
