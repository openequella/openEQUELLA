...
public interface ExtendedDialect {
  ...
  /**
   * This method is here because of a bug in hibernate. Types are cached before the dialect has a
   * say in it, thus buggering up some of our Lob types.
   *
   * @return
   */
  ...
  /**
   * THe first element in the indexes array is the index name, all elements beyond are the column
   * names to which the function applies
   *
   * @param tableName
   * @param indexes
   * @return
