...
public class EventServiceImpl implements EventService, ClusterMessageHandler {
  ...
  @Inject private PluginTracker<ApplicationListener> pluginListeners;
  @Inject private PluginTracker<EventExecutor> executorTracker;
  ...
  public class BeanListener implements ListenerFinder {
    ...
    public void addListeners(Set<ApplicationListener> listeners) {
      listeners.add(
          (ApplicationListener)
              pluginService.getBean(extension.getDeclaringPluginDescriptor(), bean));
    }
  }
  ...
  public class ScanForListeners implements ListenerFinder {
    ...
    @Override
    public void addListeners(Set<ApplicationListener> listeners) {
      PluginBeanLocator locator =
          pluginService.getBeanLocator(extension.getDeclaringPluginDescriptor().getId());
      try {
  ...
  public void publishApplicationEvent(
      Collection<Institution> institutions, final ApplicationEvent<?> event) {
