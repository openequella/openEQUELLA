...
public class SystemConfigDaoImpl extends AbstractSystemDaoImpl<SystemConfig, String>
            ...
            .execute(
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) {
                    return session
                        .createQuery("SELECT value FROM SystemConfig WHERE key = :key")
            ...
            .execute(
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) {
                    Query query =
                        session
                            .createQuery("FROM SystemConfig sc WHERE sc.key = :key")
                            .setParameter("key", key)
