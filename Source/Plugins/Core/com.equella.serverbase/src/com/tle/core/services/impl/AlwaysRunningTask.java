 ...
 * in which case one will be destroyed. Typically, these tasks wait for messages that they react to.
 */
...
public abstract class AlwaysRunningTask<T> extends Task {
  ...
  /**
   * Where work should be done and then returned (do not do while(true)!). The value of waitFor() is
   * passed in.
   */
