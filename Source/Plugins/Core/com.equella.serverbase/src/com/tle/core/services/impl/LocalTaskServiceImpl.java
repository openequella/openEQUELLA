...
public class LocalTaskServiceImpl extends AbstractTaskServiceImpl {
  ...
  private final Cache<String, TaskStatus> finishedStatuses =
  ...
  protected void processTaskUpdate(
      final String taskId, final Collection<TaskStatusChange<?>> changes) {
    synchronized (stateMutex) {
