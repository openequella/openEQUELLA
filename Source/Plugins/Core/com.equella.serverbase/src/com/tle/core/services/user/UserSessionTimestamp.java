...
public class UserSessionTimestamp implements Serializable {
  ...
  public UserSessionTimestamp(
      String sessionId, boolean isGuest, String username, String hostAddress) {
    this(sessionId, isGuest, username, hostAddress, new Date());
  }

  private UserSessionTimestamp(
      String sessionId, boolean isGuest, String username, String hostAddress, Date created) {
