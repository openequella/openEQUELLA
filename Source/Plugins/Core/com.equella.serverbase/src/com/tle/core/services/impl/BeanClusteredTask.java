...
public class BeanClusteredTask implements ClusteredTask {
  ...
  public BeanClusteredTask(
      String globalId, Class<?> service, String methodName, Serializable... args) {
  ...
  public Task createTask(PluginService pluginService, final Serializable[] args) {
    ...
    final Method method =
        MethodUtils.getMatchingAccessibleMethod(origBean.getClass(), methodName, argTypes);
    if (method == null) {
