...
/**
 * Takes a JSON string and turns into a Map of objects. Or a Map of a Map of objects, as the case
 * may be.
 *
 * @author Aaron
 */
public class MapDeserialiser extends StdDeserializer<Map<String, Object>> {
  ...
  private Object[] parseArray(JsonParser parser, DeserializationContext context)
      throws IOException, JsonProcessingException {
