(function () {
  ...
  var equellaKeywords = ("attachments attributes catalogue ctrl currentItem data drm images items lang logger mime " +
...
//      for (var name in obj) maybeAdd(name); don't want to add all the irrelevant keywords.
    }
