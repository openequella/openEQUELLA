...
<div class="selectcourse">
	...
	<div class="input text">
		<div class="control">
			...
			<@button section=s.search showAs="search">${p.gkey('com.tle.web.sections.equella', 'utils.selectuserdialog.searchbutton')}</@button>
		</div>
	</div>
	<@div id="results">
		<div class="resultlist">
			<#if m.invalidQuery>
				<h4>${p.gkey('com.tle.web.sections.equella', 'utils.selectuserdialog.validation.invalid')}</h4>
			<#else>
				<#if m.hasNoResults>
