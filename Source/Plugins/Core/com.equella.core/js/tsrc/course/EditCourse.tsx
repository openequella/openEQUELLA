...
import { Button, TextField, Grid, Select, InputLabel, Input, 
    ...
    AppBar, /*IconButton, Icon,*/ Tabs, Tab, /*Typography,*/ Theme, Paper } from 'material-ui';
...
const styles: StyleRulesCallback<'form' | 'formControl'> = (theme: Theme) => {
    ...
    const drawerWidth = 240, tabHeight = 48, footerHeight = 48;
    return {
        form: {
            display: 'flex',
            flexFlow: 'row wrap',
...
class EditCourse extends React.Component<Props, EditCourseState> {
    ...
    render() {
        ...
        const { AclEditor, router, routes } = this.props.bridge;
        ...
        return <div style={{ width: '100%', height: 'calc(100% - 48px)'}}>
                    
            <AppBar className={this.props.classes.tabBar}>
                        ...
                        <Grid>
                            <div className={this.props.classes.form}>
                                ...
                                <TextField id="name" 
                                    ...
                                    margin="normal"
                                    className={this.props.classes.formControl2}
                                    required
                                    />
                                ...
                                <FormGroup className={this.props.classes.formControl}>
                                    <FormControlLabel 
                                        label="Archived"
                                        control={<Switch
            ...
            <Paper component="footer" className={this.props.classes.footer}>
                <div className={this.props.classes.footerActions}>
