...
case class OwnerControl(default: Option[String], editable: Boolean)
    extends SearchControl
case class ModifiedWithinControl(default: Double, editable: Boolean)
    extends SearchControl
case class FacetControl(title: String, node: String) extends SearchControl
case class CollectionsControl(collections: Option[Iterable[UUID]],
                              editable: Boolean)
    extends SearchControl
