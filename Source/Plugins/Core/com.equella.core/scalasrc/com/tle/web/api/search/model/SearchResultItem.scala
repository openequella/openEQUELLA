...
/** This model class includes an item's information required in the new Search page.
  ...
  *   Item's unique ID.
  * @param name
  *   Item's name which can be null.
  * @param description
  *   Item's description which can be null.
  * @param status
  *   Item's status.
  * @param createdDate
  *   The date when an item is created.
  * @param modifiedDate
  *   The last date when an item is modified.
  * @param collectionId
  *   The ID of a collection which the item belongs to.
  * @param commentCount
  *   The count of an item's comments.
  * @param starRatings
  *   The star ratings of an Item.
  * @param attachmentCount
  *   The total number of attachments for this item.
  * @param attachments
  *   A list of Item's attachments.
  * @param thumbnail
  *   Item's thumbnail type.
  * @param thumbnailDetails
  *   Details for displaying a thumbnail for an item.
  * @param displayFields
  *   A list of Item's displayFields.
  * @param displayOptions
  *   Item's displayOptions which can be null.
  * @param keywordFoundInAttachment
  ...
  * @param drmStatus
  *   Status of Item's DRM, consisting if terms accepted and if authorised, absent if item not DRM
  *   controlled.
  */
...
/** This model class provides general information of an attachment.
  ...
  * @param brokenAttachment
  *   If true, this attachment is broken or inaccessible. For file attachments, this means that it
  *   is not accessible from the filestore. For resource selector attachments, this means that the
  *   linked attachment or item summary does not exist.
  * @param preview
  *   If an attachment can be previewed or not.
  * @param mimeType
  *   Mime Type of file based attachments
  * @param hasGeneratedThumb
  *   Indicates if file based attachments have a generated thumbnail store in filestore
  * @param links
  *   Attachment's links.
  * @param filePath
...
/** Model class providing DRM related status.
  *
  * @param termsAccepted
  *   Whether terms have been accepted or not.
  * @param isAuthorised
  *   Whether user is authorised to access Item or accept DRM.
  * @param isAllowSummary
  *   Whether user can view the Item summary page without accepting the terms.
  */
...
/** Provides details to assist with displaying a thumbnail for a search result, based on the
  ...
  *
  * @param attachmentType
  *   The broad indicator of attachment type which which drives the content of the other properties.
