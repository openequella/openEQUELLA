...
/**
  ...
  * @param stateDetails Details of the authentication request based on which the state was generated.
  */
...
class OidcAuthService @Inject()(
  ...
  /**
    ...
    *
    * - `scope` which must contain `openid`, but we also include `email` and `profile`
  ...
  /**
    ...
    * Ane because we always add 'state' in the initial request, the callback request MUST also contain the
    ...
    * @return Either an error of 'invalid_request' or a tuple of code, state and the authentication details based on which
  ...
  /**
    ...
    * @param stateDetails Details of the state where the code verified is stored
