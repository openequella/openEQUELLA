    ...
    it("retrieves a configuration through ConfigurationService") {
      ...
      val expected = GenericIdentityProviderDetails(
        commonDetails = CommonDetails(
          ...
          userIdAttribute = auth0.userIdAttribute,
