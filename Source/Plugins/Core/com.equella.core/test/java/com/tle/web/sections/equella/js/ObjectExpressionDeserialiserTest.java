...
public class ObjectExpressionDeserialiserTest extends TestCase {
  public void testDeserialiser() throws Exception {
    ...
    //
    // String expr =
    // "{val1:true,val2:false,val3:'text',val4:{val4_1:null,val4_2:[{}, true, 'single quote', [1, 2,
    // 3, false, null, 'double quote']]}}";
            ...
            new Module() {
              ...
              public void configure(Binder arg0) {
                ...
                ParameterizedType type =
                    Types.newParameterizedType(PluginTracker.class, SectionsConverter.class);
                TrackerProvider<SectionsConverter> trackerProvider =
                    new TrackerProvider<SectionsConverter>("", "", "") {
                      @Override
                ...
                TypeLiteral<PluginTracker<SectionsConverter>> typeLiteral =
                    (TypeLiteral<PluginTracker<SectionsConverter>>) TypeLiteral.get(type);
                LinkedBindingBuilder<PluginTracker<SectionsConverter>> bindingBuilder =
                    arg0.bind(typeLiteral);
