...
public class NavNodesHelperTest {
  ...
  private void assertNode(
      PropBagEx nodexml, String uuid, String name, String icon, String ident, String[][] tabs) {
  ...
  public void testAttachmentsSave() {
    PropBagEx nodexml =
        new PropBagEx(new UnicodeReader(getClass().getResourceAsStream("nodes.xml"), "UTF-8"));
    Item item = new Item();
    FileAttachment file1 = new FileAttachment();
    ...
    assertNodeSaved(
        treeNodes.get(1),
        "579fa85f-21fc-4d12-bcdf-6a6025a1b29c",
        "Node 2",
        "ims2.gif",
        "ident2",
        "2cbde4ac-9d2e-4e9f-acf6-4035b91eaa8e",
    ...
    assertNodeSaved(
        treeNodes.get(2),
        "d3572b6f-c38b-41b6-9dbe-a977375746a1",
        "Node 3",
        "ims3.gif",
        "ident3",
        "2cbde4ac-9d2e-4e9f-acf6-4035b91eaa8e",
