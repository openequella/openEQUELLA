...
public class IMSMetadataMapperTest extends AbstractMetadataMapperTester {
  ...
  public void testIMS() throws IOException {
    ...
    assertEquals(
        xml, "item/itembody/catalogentry/catalog/", "Australian Flexible Learning Toolboxes");
    ...
    assertEquals(
        xml,
        "item/itembody/classification/description/langstring",
        "ICTCC101A Communicate effectively in a Customer Contact Centre");

    assertEquals(
        xml,
        "item/itembody/classification/keyword/langstring",
