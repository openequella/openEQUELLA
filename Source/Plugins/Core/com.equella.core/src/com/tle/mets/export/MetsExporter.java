...
@Bind
public class MetsExporter extends AbstractPrototypeSection<MetsExporterModel>
  ...
  public void doExport(final SectionInfo info) throws Exception {
    ...
    contentStreamWriter.outputStream(
        info.getRequest(), info.getResponse(), new MetsContentStream(info, itemInfo));
  }
  ...
  protected Mets createMetsObject(SectionInfo info, ItemSectionInfo iinfo, boolean full)
      throws Exception {
    ...
    for (Attachment attachment : item.getAttachmentsUnmodifiable()) {
      final List<Pair<File, String>> attachmentMetsFiles =
          createMetsFiles(info, iinfo, attachment, full);
   ...
   */
  @SuppressWarnings("unchecked")
  private List<Pair<File, String>> createMetsFiles(
      SectionInfo info, ItemSectionInfo itemInfo, Attachment attachment, boolean full)
      throws Exception {
    final List<Pair<File, String>> files = new ArrayList<Pair<File, String>>();
    final List<MetsIDElementInfo<? extends MetsIDElement>> converted =
        (full
   ...
   * @throws Exception
   */
  protected List<MetsIDElementInfo<? extends MetsIDElement>> convertRecordOnlyAttachment(
      SectionInfo info, ItemSectionInfo itemInfo, Attachment attachment) throws Exception {
    final ViewableResource resource =
        attachmentResourceService.getViewableResource(info, itemInfo.getViewableItem(), attachment);
   ...
   * @throws Exception
   */
  protected List<MetsIDElementInfo<? extends MetsIDElement>> convertFullAttachment(
      SectionInfo info, ItemSectionInfo itemInfo, Attachment attachment) throws Exception {
