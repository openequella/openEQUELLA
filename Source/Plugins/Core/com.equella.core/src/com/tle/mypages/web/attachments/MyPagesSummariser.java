...
/**
 * Only used when looking at the item from advanced item management OR when you've used the MyPages
 * web control
 *
 * @author aholland
 */
...
public class MyPagesSummariser
    implements AttachmentResourceExtension<HtmlAttachment>,
  ...
  @Inject private ExtendedFreemarkerFactory viewFactory;
  @Inject private FileSystemService fileSystemService;

  @Override
  public ViewableResource process(
      SectionInfo info, ViewableResource resource, HtmlAttachment attachment) {
  ...
  public class MyPagesResource extends AbstractWrappedResource {
      ...
      stream =
          new MyPagesContentStream(
              fileSystemService.getContentStream(
                  resource.getViewableItem().getFileHandle(),
    ...
    protected MyPagesResource(
        SectionInfo info, HtmlAttachment page, String html, boolean noBaseHref) {
        ...
        if (contentBytes == null) {
          ...
          try {
            ...
            if (userCss != null) {
              ...
              styles.add(
                  noBaseHref
                      ? PathUtils.filePath("..", PathUtils.getFilenameFromFilepath(userCss))
