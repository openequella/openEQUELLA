...
public class MyPagesUrlFactoryImpl implements MyPagesUrlFactory {
  ...
  @Inject private ModalSessionService modalSessionService;

  @Override
  public MyPagesEditUrl createEditUrl(
      SectionInfo info, String wizid, HtmlAttachment page, JSCallAndReference finishedCallback) {
    return new MyPagesEditUrl(
        info,
        wizid,
        (page == null ? Constants.BLANK : page.getUuid()),
        new ParentFrameCallback(finishedCallback),
        modalSessionService);
  }
