...
public final class UserDirectoryUtils {
   ...
   * user during initState to speed up repeated logins.
   */
  ...
  public static Map<String, UserBean> getMultipleUserInfosFromSingleInfos(
      UserDirectory ud, Collection<String> userIds) {
  ...
  public static Map<String, GroupBean> getMultipleGroupInfosFromSingleInfos(
      UserDirectory ud, Collection<String> groupIds) {
