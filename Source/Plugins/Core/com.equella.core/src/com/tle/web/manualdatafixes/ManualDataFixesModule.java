...
public class ManualDataFixesModule extends SectionsModule {
  ...
  protected void configure() {
    bind(Object.class)
        .annotatedWith(Names.named("/access/manualdatafixes"))
        .toProvider(
            node(RootManualDataFixesSettingsSection.class)
                .placeHolder("FIXES")
                .children(
                    GenerateThumbnailOpSection.class,
                    AttachmentHashOpSection.class,
                    ReindexOpSection.class));
  }
}
