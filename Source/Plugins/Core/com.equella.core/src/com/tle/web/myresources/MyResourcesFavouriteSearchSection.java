...
public class MyResourcesFavouriteSearchSection extends AbstractFavouriteSearchSection {
  @TreeLookup private MyResourcesSearchTypeSection myResourcesSearchTypeSection;

  @Override
  protected String getWithin(SectionInfo info) {
    MyResourcesSubSearch subSearch =
        myResourcesSearchTypeSection.getSearchType().getSelectedValue(info);
