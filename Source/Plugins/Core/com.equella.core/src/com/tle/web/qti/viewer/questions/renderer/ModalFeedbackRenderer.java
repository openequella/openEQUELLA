...
public class ModalFeedbackRenderer extends QtiNodeRenderer {
  ...
  @AssistedInject
  protected ModalFeedbackRenderer(
      @Assisted ModalFeedback model, @Assisted QtiViewerContext context) {
    super(model, context);
    this.model = model;
  }
      ...
      while (childIterator.hasNext()) {
        ...
        children =
            CombinedRenderer.combineResults(
                children,
                modalFeedbackRenderer.qfac.chooseRenderer(
                    node, modalFeedbackRenderer.getContext()));
      }
