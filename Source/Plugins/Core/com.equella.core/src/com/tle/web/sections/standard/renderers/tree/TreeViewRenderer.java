...
public class TreeViewRenderer extends AbstractComponentRenderer implements JSDisableable, TreeRenderer
{
	...
	@SuppressWarnings("nls")
	private void renderNode(SectionWriter writer, HtmlTreeModel model, HtmlTreeNode node) throws IOException
	{
		writer.writeTag("li");
