...
public interface HtmlEditorInterface extends Section, HtmlRenderer {
   ...
   *
   * <p>The width and height of the editor are css style values and their property names are "width"
   * and "height" respectively. These two properties are mandatory, you can specify a value of
   * "auto" if you are not fussed about the size of your editor.
   *
   * <p>Additional properties are dependent on the HTML editor implementation. Check implementers of
   * this interface for additional properties.
   *
   * @param info
   * @param properties
   * @throws Exception
