...
/**
 * The ResponseHeaderInfo complexType is the container for the information to be placed in the
 * SOAP/POX header for the response message transmitted for the associated operation call.
 *
...
@XmlType(
    name = "imsx_ResponseHeaderInfo.Type",
    propOrder = {
      "imsxVersion",
...
public class ImsxResponseHeaderInfoType {
   ...
   *
   * @return possible object is {@link ImsxGWSVersionValueType }
   */
   ...
   *
   * @param value allowed object is {@link ImsxGWSVersionValueType }
   */
   ...
   *
   * @return possible object is {@link ImsxStatusInfoType }
   */
   ...
   *
   * @param value allowed object is {@link ImsxStatusInfoType }
   */
