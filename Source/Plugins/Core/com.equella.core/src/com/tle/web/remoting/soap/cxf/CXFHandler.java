...
// Likely going to completely remove this.
...
public class CXFHandler extends CXFNonSpringServlet {
  ...
  private void createService(Extension extension, String pathInfo) {
    ...
    if (beanParam != null) {
      ...
      Class<?> serviceInterface =
          endpointTracker.getClassForName(
              extension, extension.getParameter("serviceInterface").valueAsString());
      ...
      if (namespaceParam != null) {
        factoryBean.setServiceName(
            new QName(namespaceParam.valueAsString(), serviceInterface.getSimpleName()));
      }
      ...
      ExtendedReflection reflection =
          new ExtendedReflection(serviceNamespace, serviceName, matchingExtensions, methodMap);
  ...
  public void setPluginService(PluginService pluginService) {
    endpointTracker =
        new PluginTracker<Object>(pluginService, "com.tle.web.remoting.soap", "endpoint", "path")
            .setBeanKey("bean");
    interceptorTracker =
        new PluginTracker<AbstractPhaseInterceptor<? extends Message>>(
            pluginService, "com.tle.web.remoting.soap", "interceptor", null);
    endpointIntTracker =
        new PluginTracker<Object>(
                pluginService, "com.tle.web.remoting.soap", "endpoint-interface", null)
            .setBeanKey("bean");
  }
  ...
  public class ExtendedReflection extends ReflectionServiceFactoryBean {
    ...
    protected void initializeServiceModel() {
      ...
      for (Extension ext : extensions) {
        Class<?> clazz =
            endpointIntTracker.getClassForName(
                ext, ext.getParameter("serviceInterface").valueAsString());
      ...
      // MethodComparator in CXF is no longer a visable class.
