...
public class FileDropRenderer extends TagRenderer {
  private static final PluginResourceHelper urlHelper =
      ResourcesService.getResourceHelper(FileDropRenderer.class);
  ...
  private static final JSCallable SETUP =
      new ExternallyDefinedFunction("setupFileDrop", JS, JQueryProgression.PRERENDER);
