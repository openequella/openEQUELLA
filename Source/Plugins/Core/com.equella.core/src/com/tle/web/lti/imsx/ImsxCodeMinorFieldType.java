...
@XmlType(
    name = "imsx_CodeMinorField.Type",
    propOrder = {"imsxCodeMinorFieldName", "imsxCodeMinorFieldValue"})
public class ImsxCodeMinorFieldType {
   ...
   *
   * @return possible object is {@link ImsxCodeMinorValueType }
   */
   ...
   *
   * @param value allowed object is {@link ImsxCodeMinorValueType }
   */
