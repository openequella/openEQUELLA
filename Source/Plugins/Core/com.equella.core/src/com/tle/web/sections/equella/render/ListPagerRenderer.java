...
{
	private static final PluginResourceHelper RESOURCES = ResourcesService.getResourceHelper(ListPagerRenderer.class);
	...
	protected void processHandler(SectionWriter writer, Map<String, String> attrs, String event, JSHandler handler)
	{
		...
		else
		{
			...
			JSStatements body = StatementBlock.get(
				new AssignStatement(new ElementValueExpression(hiddenId), scriptPage),
				handler);
