...
public class CustomTemplateLoader implements TemplateLoader {
  ...
  private Map<String, String> renamed =
      new ImmutableMap.Builder()
          ...
          .put("com.tle.web.freemarker@", "com.equella.core@")
          ...
          .put("com.tle.web.viewitem.summary@", "com.equella.core@")
          .build();

  @Inject private PluginService pluginService;
  private final Map<String, PluginFreemarkerFactory> factories =
      new HashMap<String, PluginFreemarkerFactory>();
  ...
  public Object findTemplateSource(String template) throws IOException {
    ...
    String renamedFactory = renamed.get(factoryName);
    if (renamedFactory == null) {
      renamedFactory = factoryName;
    }
    PluginFreemarkerFactory factory = factories.get(renamedFactory);
    if (factory == null) {
