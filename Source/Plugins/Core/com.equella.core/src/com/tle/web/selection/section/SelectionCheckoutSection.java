...
public class SelectionCheckoutSection
    extends AbstractPrototypeSection<SelectionCheckoutSection.SelectionCheckoutModel>
  ...
  public SectionResult renderHtml(RenderEventContext context) {
    ...
    finishButton.setLabel(
        context, ss.isSelectMultiple() ? FINISH_MULTIPLE_LABEL : FINISH_SINGLE_LABEL);
  ...
  public static class SelectionCheckoutModel {
    @Bookmarked private String continueSelectionsBackTo;
