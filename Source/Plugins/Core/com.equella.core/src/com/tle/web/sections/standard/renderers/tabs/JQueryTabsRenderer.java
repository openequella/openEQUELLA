...
public class JQueryTabsRenderer extends AbstractComponentRenderer {
  ...
  public void preRender(PreRenderContext info) {
    ...
    JSStatements selectBody =
        new AssignStatement(
            new ElementValueExpression(this),
            ArrayIndexExpression.create(
    ...
    state.addReadyStatements(
        Js.statement(Jq.methodCall(getVisibleElementId(), Js.function("tabs"), tabsOptions)));
  }
}
