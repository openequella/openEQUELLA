...
public class WizardState implements WizardStateInterface {
  ...
  private /* final */ List<UnsavedEditOperation> unsavedEdits =
      new ArrayList<UnsavedEditOperation>();
  private /* final */ Map<String, DuringSaveOperation> saveOperations =
      new HashMap<String, DuringSaveOperation>();
  ...
  /**
   * @return A *copy* of the path overrides. If you want to change them, use pushPathOverride and
   *     popPathOverride
   */
