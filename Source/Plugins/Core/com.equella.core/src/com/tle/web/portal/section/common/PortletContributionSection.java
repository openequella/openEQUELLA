...
public class PortletContributionSection
  ...
  /**
   * Invoked by PortletWebService ONLY. Use PortletWebService.newPortlet instead
   *
   * @param info
   * @param type
   */
  ...
  /**
   * Invoked by PortletWebService ONLY. Use PortletWebService.editPortlet instead
   *
   * @param info
   * @param portletUuid
   * @param type
  ...
  /**
   * Invoked by PortletWebService ONLY. Use PortletWebService.returnFromEdit instead
   *
   * @param info
   */
