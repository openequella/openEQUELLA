...
public class ZipTreeExtension implements AttachmentTreeExtension {
  ...
  @Override
  public void addRootAttachmentNode(
      IAttachment attachment,
      List<IAttachment> otherAttachments,
      List<AttachmentNode> rootNodes,
      boolean flattenHidden) {
    ...
    while (iter.hasNext()) {
      ...
      String zipUuid =
          (String) processedNode.getAttachment().getData(ZipAttachment.KEY_ZIP_ATTACHMENT_UUID);
