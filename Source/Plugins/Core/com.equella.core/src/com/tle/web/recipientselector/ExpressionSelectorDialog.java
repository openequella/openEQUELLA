...
public class ExpressionSelectorDialog
    extends AbstractOkayableDialog<ExpressionSelectorDialog.ExpressionSelectorDialogModel> {
  ...
  @Inject private ExpressionSelectorSection section;
  ...
  /**
   * @param info
   * @return the recipient expression and an empty string if nothing is selected
   */
