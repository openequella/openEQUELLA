...
public class DRMViewerFilter implements ResourceViewerFilter {
  ...
  private static final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(DRMViewerFilter.class);
  ...
  public LinkTagRenderer filterLink(
    ...
    if (vitem.isDRMApplicable()
        && drmService.requiresAcceptanceCheck(vitem.getItemId(), false, false)
  ...
  public static class DRMLinkRenderer extends LinkRenderer {
    ...
    public DRMLinkRenderer(
        HtmlLinkState state, LinkTagRenderer previewRenderer, LinkTagRenderer viewerTag) {
      super(state);
    ...
    public void preRender(PreRenderContext info) {
      ...
      info.preRender(
          previewTag,
          viewerTag,
          new IncludeFile(resources.url("scripts/drmlicense.js")),
