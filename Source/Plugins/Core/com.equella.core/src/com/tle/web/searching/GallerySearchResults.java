...
public class GallerySearchResults extends AbstractPrototypeSection<SearchResultsModel>
  ...
  private static PluginResourceHelper helper =
      ResourcesService.getResourceHelper(GallerySearchResults.class);

  @Inject private GalleryItemList itemList;
  @Inject private MimeTypeService mimeTypeService;
  @Inject private ConfigurationService configService;

  private Cache<String, Collection<String>> mimeCache =
      CacheBuilder.newBuilder().expireAfterAccess(1, TimeUnit.HOURS).softValues().build();
  private static final String CACHE_KEY = "mime_types";
