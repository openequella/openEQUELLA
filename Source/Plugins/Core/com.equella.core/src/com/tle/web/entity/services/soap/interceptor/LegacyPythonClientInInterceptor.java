...
/**
 * Injects a LegacyPythonClientXMLStreamReader so that parameters get renamed to in0, in1 etc
 *
 * @author Aaron
 */
@Bind
    ...
    if (in != null) {
      ...
      if (contentType == null) {
        ...
        if (m != null) {
          ...
          List<String> contentTE =
              HttpHeaderHelper.getHeader(m, HttpHeaderHelper.CONTENT_TRANSFER_ENCODING);
      ...
      message.setContent(
          XMLStreamReader.class, new LegacyPythonClientXMLStreamReader(reader, mappedNamespace));
    }
  }
