...
@Bind
public class BulkExecuteScriptOperation extends BulkExecuteScriptSection
  ...
  public void addOptions(SectionInfo info, List<Option<OperationInfo>> options) {
    options.add(
        new KeyOption<OperationInfo>(
            LABEL_EXECUTE, BULK_EXEC_VAL, new OperationInfo(this, BULK_EXEC_VAL)));
  }

  @Override
  public BeanLocator<ExecuteScriptExecutor> getExecutor(SectionInfo info, String operationId) {
    return new FactoryMethodLocator<ExecuteScriptExecutor>(
        ExecuteSriptExecutorFactory.class, "create", getScript(info));
  }
  ...
  public static class ExecuteScriptExecutor implements BulkOperationExecutor {
    ...
    @Inject private ExecuteScriptFactory exScriptFactory;
    ...
    public WorkflowOperation[] getOperations() {
      return new WorkflowOperation[] {
        ...
        exScriptFactory.executeScript(script),
  ...
  public ItemPack runPreview(SectionInfo info, String operationId, long itemId) throws Exception {
    ...
    StandardScriptContextParams params =
        new StandardScriptContextParams(
            itemPack, itemFileService.getItemFile((Item) itemPack.getItem()), false, null);
