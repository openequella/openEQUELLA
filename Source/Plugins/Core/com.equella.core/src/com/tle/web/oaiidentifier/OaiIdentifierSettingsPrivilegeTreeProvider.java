...
@Bind
public class OaiIdentifierSettingsPrivilegeTreeProvider
  ...
  public OaiIdentifierSettingsPrivilegeTreeProvider() {
    super(
        Type.SYSTEM_SETTING,
        ResourcesService.getResourceHelper(OaiIdentifierSettingsPrivilegeTreeProvider.class)
            .key("securitytree.oaiidentifiersettings"),
        new SettingsTarget("oai"));
  }
}
