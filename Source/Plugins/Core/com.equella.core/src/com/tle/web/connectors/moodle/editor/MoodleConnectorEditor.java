...
public class MoodleConnectorEditor
    extends AbstractConnectorEditorSection<MoodleConnectorEditor.MoodleConnectorEditorModel> {
  ...
  @Inject private MoodleConnectorService moodleService;
  ...
  public void registered(String id, SectionTree tree) {
    ...
    testServiceButton.setClickHandler(
        ajax.getAjaxUpdateDomFunction(tree, this, events.getEventHandler("testMoodle"), "testdiv"));
  }
  ...
  public void testMoodle(SectionInfo info) {
    ...
    final String result =
        moodleService.testConnection(
            ...
            connector.getAttribute(FIELD_WEBSERVICE_TOKEN),
  ...
  protected void customLoad(SectionInfo info, ConnectorEditingBean connector) {
    ...
    final boolean testedWebservice =
        connector.getAttribute(MoodleConnectorConstants.FIELD_TESTED_WEBSERVICE, false);
    if (testedWebservice) {
  ...
  public class MoodleConnectorEditorModel
      extends AbstractConnectorEditorSection<MoodleConnectorEditorModel>
