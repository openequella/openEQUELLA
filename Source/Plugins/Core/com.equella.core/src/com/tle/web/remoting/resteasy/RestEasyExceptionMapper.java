...
public class RestEasyExceptionMapper implements ExceptionMapper<Throwable> {
  ...
  public Response toResponse(Throwable t) {
    ...
    if (response.getEntity() == null) {
      ...
      response =
          builder
              .entity(convertExceptionToJsonResponse(response.getStatus(), webAppException))
  ...
  public static WebApplicationException mapException(Throwable t) {
    ...
    if (t instanceof WebApplicationException) {
      ...
      webAppException = new WebApplicationException(t, Status.CONFLICT);
        ...
        || t instanceof com.tle.common.beans.exception.NotFoundException) {
  ...
  public static ErrorResponse convertExceptionToJsonResponse(
      int status, WebApplicationException webAppException) {
    ...
    // exception message
    String statusCodeErr =
        Status.fromStatusCode(status) != null
