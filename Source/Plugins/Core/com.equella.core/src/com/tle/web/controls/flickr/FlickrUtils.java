...
public final class FlickrUtils {
  ...
  /**
   * Lines beginning with "#", or entirely blank/whitespace lines, are ignored. Each line is assumed
   * to consist of a single token, (the flickr user ID of the institution, a single space, and then
   * the rest of the line as institution name.
   *
   * @param filename
   * @return
   */
  public static List<String[]> getKeyStringsAsPair(String filename, int elementsPerLine) {
    try {
      String rawKeyStrings =
          Resources.toString(FlickrUtils.class.getResource(filename), Charsets.UTF_8);
  ...
  public static List<NameValue> getNameValuesFromFile(
      String filename, int elementsPerLine, boolean valueBeforeName) {
