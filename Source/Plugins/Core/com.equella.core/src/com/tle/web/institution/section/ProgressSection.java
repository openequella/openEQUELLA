...
public class ProgressSection extends AbstractPrototypeSection<ProgressSection.ProgressModel>
  ...
  @TreeLookup private TabsSection tabsSection;

  @Component private Button returnButton;

  public static class ProgressModel {
    @Bookmarked private String progressId;
    ...
    new AuthenticatedThread() {
      ...
      public void doRun() {
        try {
          ...
          LOGGER.error(
              "Error running " + run.getTaskName() + " operation", e); // $NON-NLS-1$ //$NON-NLS-2$
