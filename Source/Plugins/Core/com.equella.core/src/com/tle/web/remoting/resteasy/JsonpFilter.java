...
public class JsonpFilter implements WebFilter {
  ...
  protected String[] jsonMimeTypes =
      new String[] {"application/json", "application/x-json", "text/json", "text/x-json"};
  ...
  @Override
  public FilterResult filterRequest(final HttpServletRequest req, HttpServletResponse resp)
      throws IOException, ServletException {
    if (isJsonp(req)) {

      final HttpServletResponseContentWrapper wrapper =
          new HttpServletResponseContentWrapper(resp) {
            @Override
  ...
  public static class HttpServletResponseContentWrapper extends HttpServletResponseWrapper {
    ...
    /**
     * The default behaviour of this method is to return getWriter() on the wrapped response object.
     */
    @Override
  ...
  public static class ByteArrayServletOutputStream extends ServletOutputStream {
    ...
    /** copy from: jdk1.6, java.util.Arrays.copyOf(byte[] original, int newLength) */
