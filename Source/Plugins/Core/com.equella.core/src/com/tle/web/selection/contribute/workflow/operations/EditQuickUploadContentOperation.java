...
public class EditQuickUploadContentOperation extends AbstractStandardWorkflowOperation {
  ...
  public EditQuickUploadContentOperation(
      ContentFields fields, String filename, InputStream inputStream) {
    this.fields = fields;
  ...
  private void generateThumbnail(
      FileAttachment fattach, FileHandle staging, String attachFilename) {
