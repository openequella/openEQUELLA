...
public abstract class AbstractFileUpload<S extends HtmlFileUploadState> extends AbstractDisablerComponent<S> {
    ...
    public void setAjaxAfterUpload(SectionInfo info, JSStatements after) {
        getState(info).setValidateFile(new AnonymousFunction(
