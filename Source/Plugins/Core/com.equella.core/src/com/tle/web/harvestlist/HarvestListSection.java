...
@Bind
public class HarvestListSection
    extends AbstractPrototypeSection<HarvestListSection.HarvestListModel> implements HtmlRenderer {
  ...
  public SectionResult renderHtml(RenderEventContext context) {
    context
        .getPreRenderContext()
        .addHeaderMarkup("<meta name=\"robots\" content=\"noindex, follow\">"); // $NON-NLS-1$
    ...
    final SearchResults<ItemIdKey> results =
        freeTextService.searchIds(search, model.getCurrentPage() * MAX_PER_PAGE, MAX_PER_PAGE);
  ...
  public static class HarvestListModel {
    @Bookmarked private int currentPage = 0;
