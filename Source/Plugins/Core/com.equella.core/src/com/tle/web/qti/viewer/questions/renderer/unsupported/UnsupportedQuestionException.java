...
public class UnsupportedQuestionException extends RuntimeException {
  ...
  /**
   * @param element True if it is a sub-part of the question that can't be rendered and not the
   *     interaction itself
   */
  ...
  public String getMessage() {
    return CurrentLocale.get(
        "com.tle.web.qti.notsupported." + (element ? "element" : "question"), nodeName);
  }
}
