...
public abstract class RemoteRepoViewResultSection<
        ...
        E extends RemoteRepoListEntry<?>,
        R extends GenericRecord>
    extends AbstractPrototypeSection<M>
    implements RemoteRepoListItemViewHandlerCreator<E>, HtmlRenderer {
  ...
  @Component private Button importButton;

  /**
   * You should add your record to the model so you can fetch it will for getTitle and getContents
   *
   * @param info
   * @return
   */
  ...
  protected void addField(
      List<SectionRenderable> contents, String key, SectionRenderable renderable) {
  ...
  protected SectionRenderable getStandardRow(
      Label label, SectionRenderable renderable, Object... values) {
