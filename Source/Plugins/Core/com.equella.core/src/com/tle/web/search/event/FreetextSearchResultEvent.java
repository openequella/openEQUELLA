...
public class FreetextSearchResultEvent
    extends AbstractSearchResultsEvent<FreetextSearchResultEvent> {
  ...
  public FreetextSearchResultEvent(
  ...
  public void fire(
      SectionId sectionId,
      SectionInfo info,
      SearchResultsListener<FreetextSearchResultEvent> listener)
      throws Exception {
