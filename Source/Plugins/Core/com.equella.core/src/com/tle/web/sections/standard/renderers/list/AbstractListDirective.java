...
public abstract class AbstractListDirective extends SectionsTemplateModel implements TemplateDirectiveModel
{
	@Override
	...
	protected abstract TagRenderer createTagRenderer(HtmlMutableListState state, Environment env, Map<?, ?> params,
