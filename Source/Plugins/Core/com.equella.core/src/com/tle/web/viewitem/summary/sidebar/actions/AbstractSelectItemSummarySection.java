...
public abstract class AbstractSelectItemSummarySection<I extends IItem<?>, M>
  ...
  public boolean canView(SectionInfo info) {
    ...
    return selectionService.canSelectItem(info, vitem)
        && !selectionService.isSelected(
            info, vitem.getItemId(), null, getItemExtensionType(), false);
  }

  @EventHandlerMethod
  public void select(SectionInfo info) {
    selectionService.addSelectedItem(
        info, getViewableItem(info).getItem(), null, getItemExtensionType());
  }
}
