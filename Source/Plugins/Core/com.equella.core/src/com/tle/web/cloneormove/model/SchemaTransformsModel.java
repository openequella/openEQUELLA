...
public class SchemaTransformsModel extends DynamicHtmlListModel<String> {
  ...
  public SchemaTransformsModel(
      SingleSelectionList<ItemDefinition> collections, SchemaService schemaService) {
  ...
  protected Option<String> getTopOption() {
    return new KeyOption<String>(
        KEY_PFX + "selectcollection.option.schematransform.none",
        "",
