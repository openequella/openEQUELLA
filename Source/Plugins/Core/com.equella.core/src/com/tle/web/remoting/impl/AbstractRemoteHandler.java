...
public abstract class AbstractRemoteHandler<T> extends HttpServlet {
  ...
  private Map<Extension, HttpRequestHandler> handlerMappings =
      Collections.synchronizedMap(new HashMap<Extension, HttpRequestHandler>());
  ...
  public void setPluginService(PluginService pluginService) {
    tracker =
        new PluginTracker<T>(pluginService, "com.tle.web.services", getExtensionPointName(), null)
            .setBeanKey("bean");
  }
