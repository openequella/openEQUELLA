...
public class SectionsBeansWrapper extends BeansWrapper {
  ...
  public void setPluginService(PluginService pluginService) {
    tracker =
        new PluginTracker<SectionsTemplateModelProvider>(
            pluginService, "com.tle.web.freemarker", "templateModelProvider", "modelClass");
  ...
  public TemplateModel wrap(Object object) throws TemplateModelException {
    if (object instanceof JSExpression
        || object instanceof JSStatements
        || object instanceof JSCallable) {
  ...
  public static class LabelTemplateModel extends SectionsTemplateModel
  ...
  public static class JSTemplateModel extends SectionsTemplateModel
      implements TemplateScalarModel, AdapterTemplateModel, TemplateMethodModelEx {
  ...
  public class TemplateResultModel extends SectionsTemplateModel
      ...
      try {
        return (SectionWriter)
            ((AdapterTemplateModel)
                    Environment.getCurrentEnvironment().getGlobalVariable("_info")) // $NON-NLS-1$
