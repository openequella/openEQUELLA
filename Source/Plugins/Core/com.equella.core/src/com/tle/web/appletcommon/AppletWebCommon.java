...
public final class AppletWebCommon {
  private static final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(AppletWebCommon.class);
  public static final IncludeFile INCLUDE =
      new IncludeFile(resources.url("scripts/writeapplet.js"));
   ...
   * @param id applet ID
   */
  public static final ExternallyDefinedFunction WRITE_APPLET =
      new ExternallyDefinedFunction("writeAppletTags", INCLUDE);
