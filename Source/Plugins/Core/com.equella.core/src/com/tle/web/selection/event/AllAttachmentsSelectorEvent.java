...
public class AllAttachmentsSelectorEvent
    extends AbstractSectionEvent<AllAttachmentsSelectorEventListener> {
  ...
  @Override
  public void fire(
      SectionId sectionId, SectionInfo info, AllAttachmentsSelectorEventListener listener) {
