...
public class JQueryStarRating implements JavascriptModule {
  ...
  public static final PreRenderable PRERENDER =
      new JQueryLibraryInclude("jquery.stars.js", "jquery.stars.css", JQueryUIWidget.PRERENDER)
          .hasMin();

  public static final JSCallable FUNC_STARRATING =
      new ExternallyDefinedFunction("stars", PRERENDER);
    ...
    JQueryCore.appendReady(
        ...
        new ScriptStatement(
            PropertyExpression.create(
                selector, new FunctionCallExpression(FUNC_STARRATING, params))));
  }
