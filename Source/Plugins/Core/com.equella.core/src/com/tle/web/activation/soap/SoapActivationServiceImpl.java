...
public class SoapActivationServiceImpl implements SoapActivationService {
   ...
   */
  @Override
  public void activateItemAttachments(
      String uuid, int version, String courseCode, String[] attachments) {
    ...
    if (course == null) {
      throw new NotFoundException(
          CurrentLocale.get(
              "com.tle.cal.web.soapservice.coursenotfound", courseCode)); // $NON-NLS-1$
    }
