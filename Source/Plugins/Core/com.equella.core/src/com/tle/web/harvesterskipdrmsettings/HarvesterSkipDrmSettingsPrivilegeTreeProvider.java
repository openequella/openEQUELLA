...
public class HarvesterSkipDrmSettingsPrivilegeTreeProvider
    extends AbstractSettingsPrivilegeTreeProvider {
  public HarvesterSkipDrmSettingsPrivilegeTreeProvider() {
    super(
        Type.SYSTEM_SETTING,
        ResourcesService.getResourceHelper(HarvesterSkipDrmSettingsPrivilegeTreeProvider.class)
            .key("securitytree.harvesterskipdrmsettings"),
