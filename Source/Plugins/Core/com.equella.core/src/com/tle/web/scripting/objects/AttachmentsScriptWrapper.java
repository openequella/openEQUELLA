...
public class AttachmentsScriptWrapper extends AbstractScriptWrapper implements AttachmentsScriptObject
{
	...
	@Inject
	protected AttachmentsScriptWrapper(@Assisted("attachments") ModifiableAttachments attachments, @Assisted("staging") FileHandle staging)
	{
	...
	public List<AttachmentScriptType> listForItem(ItemScriptType item)
	{
		...
		return Lists
			.newArrayList(Lists.transform(realItem.getAttachments(), o -> scriptTypeFactory.createAttachment(o, staging)));
	}
