...
public class DatabaseEditDialog extends AbstractOkayableDialog<DatabaseEditDialog.Model> {
  ...
  @Component private TextField password;
  @Component private TextField reportingUrl;
  @Component private TextField reportingUsername;
  @Component private TextField reportingPassword;
  @Component private Checkbox useSystem;
  ...
  public void registered(String id, SectionTree tree) {
    ...
    addOnline.setClickHandler(
        events
            .getSubmitValuesHandler("save", true)
            .addValidator(new Confirm(LABEL_ADDONLINE_CONFIRM)));
    ...
    useSystem.setClickHandler(
        new StatementHandler(
            disableFields.createDisableFunction(), useSystem.createGetExpression()));
  }
  ...
  public static class Model extends DialogModel {
    @Bookmarked private long schemaId;
