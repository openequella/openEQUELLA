		...
		AbstractPrototypeSection<HelpAndScreenOptionsSection.HelpAndScreenOptionsModel> implements HtmlRenderer
{
	...
	private static final ExternallyDefinedFunction BLIND = new ExternallyDefinedFunction("blindDomResults",
		JQueryUIEffects.BLIND, new IncludeFile(resources.url("scripts/helpandoptions.js")));
	...
	public SectionResult renderHtml(RenderEventContext context)
	{
		...
		return new GenericNamedResult("helpandoptions", new PreRenderable()
		{
			...
			public void preRender(PreRenderContext info)
			{
				...
				List<BlueBarRenderable> renderables = new ArrayList<BlueBarRenderable>(model.getTabMap().values());
				...
				Collections.sort(renderables, new Comparator<BlueBarRenderable>()
				{
					@Override
	...
	public void registered(String id, SectionTree tree)
	{
		...
		showFunc = ajax.getAjaxUpdateDomFunction(tree, null, events.getEventHandler("show"), BLIND, "helpAndOptions");

		hideFunc = ajax.getAjaxUpdateDomFunction(tree, null, events.getEventHandler("hideEverything"), BLIND,
			"helpAndOptions");
	}
