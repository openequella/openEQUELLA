...
public class InPlaceEditorWebServiceImpl implements InPlaceEditorWebService
{
	...
	private static final IncludeFile INPLACE_INCLUDE = new IncludeFile(resources.url("scripts/inplaceedit.js"),
		AppletWebCommon.INCLUDE);
	 ...
	 * @param id
	 */
	private static final JSCallable CREATE_FUNCTION = new ExternallyDefinedFunction("inPlaceCreateApplet",
		INPLACE_INCLUDE);
	private static final JSCallable OPEN_FUNCTION = new ExternallyDefinedFunction("inPlaceOpen", INPLACE_INCLUDE);
	/**
	 * @param appletId
	 ...
	 */
	private static final JSCallable CHECK_SYNCED_FUNCTION = new ExternallyDefinedFunction("inPlaceCheckSynced",
		INPLACE_INCLUDE);
	/**
	 * @param $editLinks
	 * @param $openWithLink
	 */
	private static final JSCallable INIT_INPLACE_FUNCTION = new ExternallyDefinedFunction("initInPlace",
		INPLACE_INCLUDE);
	...
	private final JSFunction beingUploadedMessageCallback = new RuntimeFunction()
	{
		@Override
	...
	private final JSFunction changesDetectedConfirmationMessageCallback = new RuntimeFunction()
	{
		@Override
		protected JSCallable createFunction(RenderContext info)
		{
	...
	@Override
	public JSStatements createHideLinksStatements(JQuerySelector divSelector, JQuerySelector openWithLinkSelector)
	{
		return Js.call_s(INIT_INPLACE_FUNCTION, divSelector, openWithLinkSelector);
	}

	@Override
	public JSCallable createAppletFunction(String appletId, ItemId itemId, String stagingId, String filename,
	...
	@Override
	public JSHandler createOpenHandler(String appletId, boolean openWith, JSFunction noAppletCallback)
	{
