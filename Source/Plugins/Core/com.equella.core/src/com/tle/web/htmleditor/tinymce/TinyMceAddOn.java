...
public interface TinyMceAddOn extends PreRenderable {
  /**
   * Return true if your addon can handle the supplied action name. This will exclude any other
   * addon from handling that action.
   *
   * @param action The name of the action associated with the addon. This will come from your
   *     editor_plugin_src.js file. Eg: init : function(ed, url) { ed.addCommand('mceMyAddon',
   *     function() { ed.windowManager.open({ file : baseActionUrl + 'myAddonActionName', ...
  ...
  /**
   * TinyMceActionSection will call this on your addon if you returned true in your applies method.
   *
   * @param info
   * @param action
   * @param sessionId
  ...
  /**
   * @param info
   * @param scriptContext The script context you may wish to use during preRender and
   *     getInitialisation. You can reliably store it in the info if your addOn is a singleton.
   */
  ...
  /**
   * Registers your addon into TinyMceActionSection's tree. You do not necessarily need to do
   ...
   *
   * @param context
   * @return An object containing the contents of the config.json file. Return null if no config
   *     needed
   */
  @Nullable
