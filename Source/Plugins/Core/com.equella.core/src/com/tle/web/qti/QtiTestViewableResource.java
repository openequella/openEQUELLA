...
public class QtiTestViewableResource extends AbstractWrappedResource {
  ...
  public List<AttachmentDetail> getCommonAttachmentDetails() {
    ...
    addNumberIfPresent(
        qtiAttachment, commonDetails, QUESTION_COUNT, QtiConstants.KEY_QUESTION_COUNT);
  ...
  private void addStringIfPresent(
      CustomAttachment attachment, List<AttachmentDetail> commonDetails, Label label, String key) {
  ...
  private void addNumberIfPresent(
      CustomAttachment attachment, List<AttachmentDetail> commonDetails, Label label, String key) {
