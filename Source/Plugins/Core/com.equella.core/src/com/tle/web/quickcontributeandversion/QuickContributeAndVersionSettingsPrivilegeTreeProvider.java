...
@Bind
public class QuickContributeAndVersionSettingsPrivilegeTreeProvider
   ...
   * of AbstractSettingsPrivilegeTreeProvider is a legacy. In this case, the schizoid names of
   * "quick contribute" and "one click submit" persist.
   */
  public QuickContributeAndVersionSettingsPrivilegeTreeProvider() {
    super(
        Type.SYSTEM_SETTING,
        ResourcesService.getResourceHelper(
                QuickContributeAndVersionSettingsPrivilegeTreeProvider.class)
            .key("securitytree.quickcontributeandversionsettings"),
        new SettingsTarget("selectionSessions"));
  }
}
