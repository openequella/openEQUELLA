...
public class SchemaEditorImpl extends AbstractBaseEntityEditor<Schema, SchemaBean>
  ...
  protected void copyCustomFields(SchemaBean bean) {
    ...
    if (editing
        && (!Objects.equal(schema.getItemNamePath(), bean.getNamePath())
      ...
      publishEventAfterCommit(
          new ItemOperationEvent(
              new FactoryMethodLocator<BaseFilter>(
                  FilterFactory.class, "refreshSchemaItems", entity.getId())));
      return;
    }
  ...
  public interface SchemaEditorFactory {
    SchemaEditorImpl createExistingEditor(
        @Assisted Schema schema,
        @Assisted("stagingUuid") @Nullable String stagingUuid,
        @Assisted("lockId") @Nullable String lockId,
        @Assisted("editing") boolean editing,
    ...
    SchemaEditorImpl createNewEditor(
        @Assisted Schema schema,
        @Assisted("stagingUuid") @Nullable String stagingUuid,
        @Assisted("importing") boolean importing);
  }
