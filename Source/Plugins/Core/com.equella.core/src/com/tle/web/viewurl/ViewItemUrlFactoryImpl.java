...
public class ViewItemUrlFactoryImpl implements ViewItemUrlFactory {
  ...
  public ViewItemUrl createFullItemUrl(ItemKey itemId) {
    return doCreateFromItemId(
        null, null, itemId, UrlEncodedString.BLANK, null, ViewItemUrl.FLAG_FULL_URL);
  }
  ...
  @Override
  public ViewItemUrl createItemUrl(
      SectionInfo info, ItemKey itemId, UrlEncodedString filePath, String queryString, int flags) {
    return doCreateFromItemId(info, null, itemId, filePath, queryString, flags);
  }

  private ViewItemUrl doCreateFromItemId(
      @Nullable SectionInfo existing,
    ...
    return new ViewItemUrl(
        createViewInfo(existing, itemdir),
        itemdir,
        filePath,
        queryString,
        institutionService,
  ...
  public ViewItemUrl createItemUrl(
    ...
    return new ViewItemUrl(
        createViewInfo(info, itemdir), itemdir, filePath, queryString, institutionService, flags);
  }
}
