 ...
 * http://INSTITUTION_URL/services/calcourses.service?wsdl (for compatibility reasons)
 */
public interface SoapCourseService {
  ...
  /**
   * Archives a course so that is not selectable in the web-ui (can still be edited in the
