...
/**
 * Yes, this is a component that needs to be autowired. The idea is that all settings can be
 * over-ridden in optional.properties HOWEVER, they should really be system settings.
 *
 * @author aholland
 */
@Bind
