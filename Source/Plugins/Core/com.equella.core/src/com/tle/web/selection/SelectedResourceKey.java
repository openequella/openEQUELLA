...
public class SelectedResourceKey implements Serializable {
  ...
  public SelectedResourceKey(
      ItemKey itemId, String attachmentUuid, TargetFolder folder, String extensionType) {
    this(itemId, 'a', attachmentUuid, folder, extensionType);
  }

  private SelectedResourceKey(
      ItemKey itemId, char type, String attachmentUuid, TargetFolder folder, String extensionType) {
    this.itemKey = itemId;
