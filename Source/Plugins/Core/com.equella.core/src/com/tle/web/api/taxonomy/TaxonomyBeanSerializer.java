...
@Bind
@Singleton
public class TaxonomyBeanSerializer
    extends AbstractEquellaBaseEntitySerializer<Taxonomy, TaxonomyBean, TaxonomyEditor> {
  @Inject private TaxonomyService taxonomyService;
  @Inject private TaxonomyEditorFactory editorFactory;
  ...
  @Override
  protected TaxonomyEditor createExistingEditor(
      Taxonomy entity, String stagingUuid, String lockId, boolean importing) {
