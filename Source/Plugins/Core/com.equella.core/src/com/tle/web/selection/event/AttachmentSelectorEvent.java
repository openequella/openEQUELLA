...
/**
 * Asks the current SectionTree set to see if there is something that handles attachment selection
 *
 * @author Aaron
 */
public class AttachmentSelectorEvent extends AbstractSectionEvent<AttachmentSelectorEventListener> {
  ...
  @Override
  public void fire(
      SectionId sectionId, SectionInfo info, AttachmentSelectorEventListener listener) {
   ...
   * uuid, ItemId itemId, String extensionType)
   *
   * @param function
   */
