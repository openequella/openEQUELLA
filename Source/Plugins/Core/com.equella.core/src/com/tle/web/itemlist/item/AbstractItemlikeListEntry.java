...
public abstract class AbstractItemlikeListEntry<I extends IItem<?>> extends AbstractListEntry
    implements ItemlikeListEntry<I> {
  ...
  /* @LazyNonNull */ @Nullable private List<ViewableResource> viewableResources;
  /* @LazyNonNull */ @Nullable private UnmodifiableAttachments attachments;
  /* @LazyNonNull */ @Nullable private ViewableItem<I> viewableItem;
  private I item;
  ...
  public Label getTitleLabel() {
    ...
    if (item != null) {
      return new HighlightableBundleLabel(
          item.getName(), item.getUuid(), bundleCache, listSettings.getHilightedWords(), false);
    }
  ...
  public Label getDescription() {
    ...
    if (item != null) {
      return new HighlightableBundleLabel(
          item.getDescription(), "", bundleCache, listSettings.getHilightedWords(), true);
    }
  ...
  public static <I extends IItem<?>> List<I> getItems(
      List<? extends ItemlikeListEntry<I>> entries) {
