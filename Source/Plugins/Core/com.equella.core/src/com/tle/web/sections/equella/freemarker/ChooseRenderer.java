...
public class ChooseRenderer extends SectionsTemplateModel implements TemplateMethodModelEx {
  ...
  public static SectionRenderable getSectionRenderable(
      RenderContext context, Object section, String type, RendererFactory factory) {
    ...
    throw new SectionsRuntimeException(
        "Bad type in section parameter:" + section.getClass()); // $NON-NLS-1$
  }
}
