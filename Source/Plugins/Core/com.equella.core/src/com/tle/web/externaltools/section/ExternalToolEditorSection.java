...
public class ExternalToolEditorSection
    extends AbstractEntityEditor<ExternalToolEditingBean, ExternalTool, ExternalToolEditorModel> {
  ...
  @Component private TextField baseUrl;
  ...
  protected void loadFromSession(
      SectionInfo info, EntityEditingSession<ExternalToolEditingBean, ExternalTool> session) {
  ...
  /**
   * In addition to validating the mandatory fields, we also ensure any URLs actually entered are
   * prima facie valid. Errors are duplicated in the model to facilitate rendering in the ftl
   */
  @Override
