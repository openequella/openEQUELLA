...
/**
 * Referenced by the 'request' variable in script (OnSubmit script only). Allows you to retrieve
 * request parameters of any inputs/selects you have rendered in your display template. All
 * input/select names must be prefixed with ${prefix}
 *
 * @author aholland
 */
