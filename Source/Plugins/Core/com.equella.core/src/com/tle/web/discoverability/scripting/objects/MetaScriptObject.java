...
public interface MetaScriptObject extends ScriptObject {
  ...
  /**
   * Add a new meta tag to the head element of the item summary page. So <code>
   * meta.add("citation_title", "Etiam aliquet massa et lorem")</code> will add the following meta
   * tag:
   *
   * <pre>{@code
