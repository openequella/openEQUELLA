...
/**
 * This handler specialised in order to attend to all variety of exceptions, so long as they're
 * wrapped in RootSelectionException instance.
 *
 * @author larry
 */
@Bind
...
public class RootSelectionExceptionHandler extends SelectionExceptionHandler {
   ...
   *     com.tle.web.sections.SectionInfo, com.tle.web.sections.SectionsController,
  ...
  public void handle(
    ...
    if (!response.isCommitted()) {
      ...
      try {
        String errMsg =
            "An error occurred on the server when invoking the request: " + exception.getMessage();
