 ...
 */
@NonNullByDefault
public class TinyMceActionSection
    extends AbstractPrototypeSection<TinyMceActionSection.TinyMceActionModel>
    implements HtmlRenderer {
  @Inject private TinyMceService tinyMceService;

  private final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(TinyMceActionSection.class);
    ...
    for (TinyMceAddOn addOn : tinyMceService.getAddOns()) {
      if (addOn.applies(action)) {
        ...
        return addOn.execute(
            ...
            model.isRestrictedCollections(),
            model.getCollectionUuids(),
            model.isRestrictedDynacolls(),
            model.getDynaCollectionUuids(),
            model.isRestrictedSearches(),
            model.getSearchUuids(),
            model.isRestrictedContributables(),
            model.getContributableUuids());
        // @formatter:on
      }
    }
  ...
  public static class TinyMceActionModel {
    @Bookmarked protected String action;
    @Bookmarked protected String sessionId;
    @Bookmarked protected String pageId;
    @Bookmarked protected boolean restrictedCollections;
    @Bookmarked protected Set<String> collectionUuids;
    @Bookmarked protected boolean restrictedDynacolls;
    @Bookmarked protected Set<String> dynaCollectionUuids;
    @Bookmarked protected boolean restrictedSearches;
    @Bookmarked protected Set<String> searchUuids;
    @Bookmarked protected boolean restrictedContributables;
    @Bookmarked protected Set<String> contributableUuids;
