...
@Bind
public class EchoServerEditorSection
    extends AbstractPrototypeSection<EchoServerEditorSection.EchoServerEditorModel>
    implements HtmlRenderer, ModalEchoServerSection {
  // Success - All good
  ...
  private static final CssInclude CSS =
      CssInclude.include(
              ResourcesService.getResourceHelper(EchoServerEditorSection.class)
                  .url("css/echoeditor.css"))
          .make();
  ...
  @Inject private URLCheckerService urlService;
  ...
  public void registered(String id, SectionTree tree) {
    ...
    testUrlButton.setClickHandler(
        ajax.getAjaxUpdateDomFunction(
            tree, this, events.getEventHandler("testUrl"), "connectionstatus", "controls"));
  ...
  private boolean testEchoUrls(SectionInfo info) {
    ...
    for (Entry<String, String> url : urls.entrySet()) {
      ReferencedURL urlStatus =
          urlService.getUrlStatus(url.getValue(), URLCheckMode.RECORDS_FIRST_NON_ITERACTIVE);
  ...
  public class EchoServerEditorModel {
    ...
    @Bookmarked private String editUuid;
