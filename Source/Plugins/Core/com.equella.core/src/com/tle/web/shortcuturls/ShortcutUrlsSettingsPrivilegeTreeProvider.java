...
@Bind
public class ShortcutUrlsSettingsPrivilegeTreeProvider
  ...
  public ShortcutUrlsSettingsPrivilegeTreeProvider() {
    super(
        Type.SYSTEM_SETTING,
        ResourcesService.getResourceHelper(ShortcutUrlsSettingsPrivilegeTreeProvider.class)
            .key("securitytree.shortcuturlssettings"),
        new SettingsTarget("shortcutUrls"));
  }
}
