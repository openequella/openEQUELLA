...
public abstract class AbstractShareWithOthersSection
    extends AbstractContentSection<AbstractShareWithOthersSection.ShareModel>
  ...
  @Inject protected SharePassService sharePassService;
  ...
  @Component protected TextField messageField;
  @Component protected TextField emailField;
      ...
      try {
        ...
        Future<EmailResult<String>> result =
            emailService.sendEmail(
                CurrentLocale.get(EMAIL_SUBJECT, new ItemNameLabel(iinfo.getItem(), bundleCache)),
                addresses,
                createEmail(info));
