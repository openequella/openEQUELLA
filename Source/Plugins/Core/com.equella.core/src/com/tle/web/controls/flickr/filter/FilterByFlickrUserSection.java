...
public class FilterByFlickrUserSection
    extends AbstractPrototypeSection<FilterByFlickrUserSection.FilterByFlickrUserModel>
  ...
  public void treeFinished(String id, SectionTree tree) {
    ...
    flickrIdField.setEventHandler(
        JSHandler.EVENT_CHANGE, searchResults.getRestartSearchHandler(tree));
  }
  ...
  /**
   * Before examining the contents of the Flickr-user text box, be sure there's no active selection
   * in the institution drop-down (institutions are glorified Flickr users - the institution
   * drop-down and the flickr-user text box are mutually exclusive). The operation of the drop down
   * is that the flickr-user box will be disabled but not necessarily cleared. The plain non-blank
   * text entered by the user is set as the value of the UserRawText in the FlickrSearchParameters.
   * The flickrService will further evaluate this field to determine if the raw string is to be
