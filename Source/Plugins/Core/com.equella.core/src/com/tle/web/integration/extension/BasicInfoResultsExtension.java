...
public class BasicInfoResultsExtension implements IntegrationSessionExtension {
  ...
  public void processResultForSingle(
    ...
    Bookmark bm =
        viewableItemResolver.createThumbnailAttachmentLink(
            item,
            resource.isLatest(),
            resource.getAttachmentUuid(),
  ...
  public void processSingle(
      SectionInfo info, ObjectNode link, String prefix, IItem<?> item, SelectedResource resource) {
    Bookmark bm =
        viewableItemResolver.createThumbnailAttachmentLink(
            item,
            resource.isLatest(),
