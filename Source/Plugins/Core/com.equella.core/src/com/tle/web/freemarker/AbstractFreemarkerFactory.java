...
public abstract class AbstractFreemarkerFactory {
  ...
  protected void addRootObjects(
      Map<String, Object> rootObjects, FreemarkerSectionResult result, Writer writer) {
  ...
  public FreemarkerSectionResult createResult(
      String name, Reader reader, Object model, PreRenderable preRenderer) {
    try {
