...
public class AjaxTagRenderer extends TagRenderer {
  ...
  public AjaxTagRenderer(
      String tag, TagState state, SectionRenderable nestedRenderable, boolean includeTag) {
  ...
  private SectionWriter startCapture(AjaxRenderContext context, SectionWriter writer) {
    ...
    return new SectionWriter(
        context.startCapture(writer, divId, getCaptureParams(writer), isCollection(writer)),
        writer);
  }
