...
public class TaskManagementQuerySection
    extends AbstractResetFiltersQuerySection<Object, FreetextSearchEvent>
    ...
    workflowList.addChangeEventHandler(
        new StatementHandler(
            searchResults.getResultsUpdater(
                tree, null, SearchResultsActionsSection.ACTIONS_AJAX_ID)));
  }
