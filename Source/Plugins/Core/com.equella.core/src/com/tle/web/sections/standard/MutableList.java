...
public class MutableList<T> extends AbstractValueComponent<HtmlMutableListState, JSMutableListComponent>
	implements
		...
		JSMutableListComponent
{
	...
	{
		addDocumentedParam(event, getParameterId(), List.class.getName() + " of " + String.class.getName());
	}
