...
@NonNullByDefault
public class RootItemFileSection
    extends AbstractPrototypeSection<RootItemFileSection.RootItemFileModel>
  ...
  private static PluginResourceHelper urlHelper =
      ResourcesService.getResourceHelper(RootItemFileSection.class);
  ...
  private final OrderedPathMapper<ViewItemFilter> pathMappedFilters =
      new OrderedPathMapper<ViewItemFilter>(NumberOrderComparator.HIGHEST_FIRST);
  ...
  private ViewItemResource getBaseViewItemResource(
      ViewableItem<Item> viewableItem, String filename, String mimeType, String viewer) {
  ...
  private void checkRestrictedResource(
      SectionInfo info, ViewItemResource resource, @Nullable ViewItemViewer viewer) {
  ...
  public static void ensureOnePrivilege(
      @Nullable Set<String> privs, @Nullable Collection<String> required) {
    ...
    throw new AccessDeniedException(
        urlHelper.getString("viewitem.missingprivileges", sbuf.toString())); // $NON-NLS-1$
  }
  ...
  public void processModel(SectionInfo info, ViewItemUrl viewItemUrl) {
    ...
    if (((flags & ViewItemUrl.FLAG_IS_RESOURCE) != 0
        && ((flags & ViewItemUrl.FLAG_PRESERVE_PARAMS) == 0))) {
  ...
  public void beforeEvents(SectionInfo info) {
    ...
    boolean viewitem =
        (filename == null || filename.equals("viewitem.jsp") || filename.equals("viewpopup.jsp"));
    ...
    if (vitem instanceof NewDefaultViewableItem) {
      ...
      if (ndvi.getIntegrationType() != null) {
        Integration<? extends IntegrationSessionData> iService =
            integrationService.getIntegrationServiceForId(ndvi.getIntegrationType());
  ...
  public class BaseViewItemResource implements ViewItemResource {
    ...
    public BaseViewItemResource(
        ViewableItem<?> viewableItem, String filepath, String mimeType, String viewerId) {
    ...
    public ContentStream getContentStream() {
      return fileSystemService.getContentStream(
          topLevel.getViewableItem().getFileHandle(),
          topLevel.getFilepath(),
          topLevel.getMimeType());
    }
