...
public class HtmlFiveMimeTypeAndPlayerMigration extends AbstractHibernateDataMigration {
  ...
  private static final String COUNT_OGG =
      "SELECT COUNT(*) FROM MimeEntry WHERE type = 'video/ogg' and institution = :institution";
  ...
  protected void executeDataMigration(
    ...
    for (FakeInstitution inst : institutions) {
      ...
      final List<FakeMimeEntry> entries =
          session.createQuery(FROM).setParameter("institution", inst).list();
