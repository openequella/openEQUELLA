...
@Bind
public class HtmlEditMceWebControl
    extends AbstractWebControl<HtmlEditMceWebControl.HtmlEditMceWebControlModel> {
  ...
  @Inject private ConvertHtmlService converter;

  @Component private Link editLink;
  ...
  public SectionResult renderHtml(RenderEventContext context) throws Exception {
    ...
    StagingConversion stagingConversion =
        new StagingConversion(true, itemId, wizId, repo.getStagingid());
    ...
    editor.setData(
        context,
        properties,
        tempDefinitionControl.isRestrictCollections(),
        tempDefinitionControl.isRestrictDynacolls(),
        tempDefinitionControl.isRestrictSearches(),
        tempDefinitionControl.isRestrictContributables(),
        searchableUuids,
        contributableUuids,
        getFormName(),
  ...
  public void doEdits(SectionInfo info) {
    ...
    if (!getDefinitionControl().isLazyLoad() || (model.isEditing() && !model.isDontSave())) {
      ...
      StagingConversion conversion =
          new StagingConversion(false, itemId, wizId, repo.getStagingid());
