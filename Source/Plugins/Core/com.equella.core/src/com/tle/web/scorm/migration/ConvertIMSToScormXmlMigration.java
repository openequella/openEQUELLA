...
public class ConvertIMSToScormXmlMigration extends AbstractItemXmlMigrator {
  ...
  public boolean migrate(
    ...
    String scormVersion =
        xml.getNode("attachments/com.tle.beans.item.attachments.ImsAttachment/value2");
    if (!Check.isEmpty(scormVersion)) {
      ...
      for (PropBagEx imsRes :
          attachments.iterateAll("com.tle.beans.item.attachments.IMSResourceAttachment")) {
      ...
      string =
          string.replaceAll(
              "com.tle.beans.item.attachments.IMSResourceAttachment",
