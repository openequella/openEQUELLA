...
public class LogonMigrateSection extends AbstractPrototypeSection<LogonMigrateSection.Model>
  ...
  @Inject private InstallSection installSection;
  ...
  public SectionResult renderHtml(RenderEventContext context) {
    ...
    if (!migrationService.isSystemSchemaUp()) {
      ...
      if (authenticatedSystem) {
        ...
        if (!runningMigrations && systemSchema.isHasErrors()) {
          MigrationErrorReport errors =
              migrationService.getErrorReport(DatabaseSchema.SYSTEM_SCHEMA.getId());
    ...
    return viewFactory.createResult("logon/serverlogon.ftl", this);
  }
  ...
  private SectionResult waitForSystem(
      RenderEventContext context, JSCallable waitCall, Label message) {
