...
public class InstitutionSection
    extends AbstractPrototypeSection<InstitutionSection.InstitutionModel>
    implements HtmlRenderer, ParametersEventListener {
  ...
  @Inject private ShowInstitutionsSection showInstitutionsSection;
  @Inject private LogonMigrateSection logonMigrateSection;
  @TreeLookup private AutoTestSetupSection autoTestSection;
  ...
  public static class InstitutionModel {
    @Bookmarked private boolean admin;
    @Bookmarked private boolean credits;
    @Bookmarked private boolean autotest;
  ...
  public String getBadgeUrl(SectionInfo info, long instId) {
    return new BookmarkAndModify(info, events.getNamedModifier("badge", Long.toString(instId)))
        .getHref();
  }
  ...
  public void badge(SectionInfo info, long instId) throws Exception {
    ...
    try (InputStream in = getBadgeStream(instId);
