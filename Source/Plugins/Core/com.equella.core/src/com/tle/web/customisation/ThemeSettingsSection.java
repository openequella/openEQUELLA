...
public class ThemeSettingsSection extends AbstractParentSettingsSection<Object>
{
	@PlugKey("customisation.settings.title")
	private static Label TITLE_LABEL;
	@PlugKey("customisation.settings.description")
	...
	public Pair<HtmlLinkState, Label> getLink(RenderEventContext context)
	{
		...
		SectionInfo fwd = context.createForward("/access/themesettings.do");
