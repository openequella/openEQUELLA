...
@NonNullByDefault
public class CloudDisplayNodesSection
    extends AbstractDisplayNodesSection<CloudItem, DisplayNodesModel> {
  ...
  protected List<AbstractDisplayNodesSection.Entry> getEntries(
      RenderEventContext context, ViewableItem<CloudItem> vitem) {
    ...
    if (subject != null) {
      final AbstractDisplayNodesSection.Entry entry =
          new AbstractDisplayNodesSection.Entry(
              LABEL_SUBJECT, new LabelRenderer(new TextLabel(subject)), -1);
    ...
    if (license != null) {
      ...
      final AbstractDisplayNodesSection.Entry entry =
          new AbstractDisplayNodesSection.Entry(LABEL_LICENSE, licRenderable, -1);
    ...
    if (rights != null) {
      final AbstractDisplayNodesSection.Entry entry =
          new AbstractDisplayNodesSection.Entry(
              LABEL_RIGHTS, new LabelRenderer(new TextLabel(rights)), -1);
      entry.setFullspan(false);
      entries.add(entry);
    }
    ...
    if (contributor != null) {
      final AbstractDisplayNodesSection.Entry entry =
          new AbstractDisplayNodesSection.Entry(
              LABEL_CONTRIBUTOR, new LabelRenderer(new TextLabel(contributor)), -1);
      entry.setFullspan(true);
      entries.add(entry);
    }
    ...
    if (publisher != null) {
      final AbstractDisplayNodesSection.Entry entry =
          new AbstractDisplayNodesSection.Entry(
              LABEL_PUBLISHER, new LabelRenderer(new TextLabel(publisher)), -1);
      entry.setFullspan(true);
      entries.add(entry);
    }
