...
@Bind
public class ShareWithOthersContentSection extends AbstractShareWithOthersSection
    implements CurrentUsersCallback {
  public static final String REQUIRED_PRIVILEGE = "SHARE_ITEM";

  @PlugKey("sharenotify.confirmremove")
  ...
  @Inject private SelectUserDialog userSelect;
  ...
  @Component private SingleSelectionList<VoidKeyOption> daysList;
  ...
  public void registered(String id, SectionTree tree) {
    ...
    daysList.setListModel(
        new SimpleHtmlListModel<VoidKeyOption>(
            new VoidKeyOption(t("1day"), "1"),
            new VoidKeyOption(t("2days"), "2"),
            new VoidKeyOption(t("3days"), "3"),
            new VoidKeyOption(t("4days"), "4"),
            new VoidKeyOption(t("5days"), "5"),
            new VoidKeyOption(t("6days"), "6"),
            new VoidKeyOption(t("1week"), "7"),
            new VoidKeyOption(t("2weeks"), "14"),
            new VoidKeyOption(t("3weeks"), "21"),
            new VoidKeyOption(t("4weeks"), "28"),
            new VoidKeyOption(t("2months"), "60"),
            new VoidKeyOption(t("3months"), "91"),
            new VoidKeyOption(t("4months"), "122"),
            new VoidKeyOption(t("5months"), "152"),
            new VoidKeyOption(t("6months"), "182")));
    ...
    removeUserFunction =
        ajax.getAjaxUpdateDomFunction(
            tree, this, events.getEventHandler("removeNotification"), inplace, "selectedusers");
  ...
  public List<SelectedUser> getCurrentSelectedUsers(SectionInfo info) {
    return Lists.newArrayList(
        Collections2.transform(
            ParentViewItemSectionUtils.getItemInfo(info).getItem().getNotifications(),
  ...
  public boolean canView(SectionInfo info) {
    ...
    return iinfo.hasPrivilege(REQUIRED_PRIVILEGE)
        && (sharePassService.isEnabled()
            || iinfo.getWorkflowStatus().getStatusName() != ItemStatus.LIVE);
  }
  ...
  private String buildEmail(SectionInfo info) {
    ...
    final String url =
        URLUtils.newURL(
                ...
                (iinfo.getItemdir() + "?token=" + SharePassWrapper.TOKEN_PREFIX + uuid))
            .toString();
    ...
    email.append(
        s("item.owner", getUser(userService.getInformationForUser(iinfo.getItem().getOwner()))));
    email.append("\n");
