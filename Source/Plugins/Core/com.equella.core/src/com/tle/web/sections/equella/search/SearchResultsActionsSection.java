...
public class SearchResultsActionsSection<RE extends AbstractSearchResultsEvent<RE>>
    extends AbstractPrototypeSection<SearchResultsActionsModel>
  ...
  public void registered(String id, SectionTree tree) {
    ...
    showFunc =
        ajax.getAjaxUpdateDomFunction(
            tree, null, events.getEventHandler("show"), BLIND, ACTIONS_AJAX_ID, BUTTON_AJAX_ID);
    hideFunc =
        ajax.getAjaxUpdateDomFunction(
            tree, null, events.getEventHandler("hide"), BLIND, ACTIONS_AJAX_ID, BUTTON_AJAX_ID);
