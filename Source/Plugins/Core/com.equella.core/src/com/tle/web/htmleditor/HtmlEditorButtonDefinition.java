...
public class HtmlEditorButtonDefinition implements SectionRenderable {
  ...
  public HtmlEditorButtonDefinition(
      String id,
      String pluginId,
  ...
  public HtmlEditorButtonDefinition(
      String id, String pluginId, SectionRenderable renderable, Label label) {
  ...
  /**
   * CURRENTLY UNUSED: reason is that the default button configuration is ordered AND contains
   * multiple separator buttons. <br>
   * A default row of -1 means the button does not show on the toolbar by default
   *
   * @return
   */
