...
public class DateFormatSettingsLinkSection extends AbstractParentSettingsSection<Object> 
{
	@PlugKey("dates.settings.title")
	private static Label TITLE_LABEL;
	@PlugKey("dates.settings.description")
	...
	public Pair<HtmlLinkState, Label> getLink(RenderEventContext context) 
	{
		...
		SectionInfo fwd = context.createForward("/access/dateformatsettings.do");
