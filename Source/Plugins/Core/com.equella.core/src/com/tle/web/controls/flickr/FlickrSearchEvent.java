...
public class FlickrSearchEvent extends AbstractSearchEvent<FlickrSearchEvent> {
  ...
  @Override
  public void fire(
      SectionId sectionId, SectionInfo info, SearchEventListener<FlickrSearchEvent> listener)
      throws Exception {
   ...
   *
   * @param dateRange an array of 2 dates, in order of the earlier and the later either of which may
   *     be null.
   */
