...
public class ItemAdminQuerySection
    extends AbstractResetFiltersQuerySection<
        ItemAdminQuerySection.ItemAdminQueryModel, FreetextSearchEvent>
    implements ItemDefinitionSelection {
  static {
  ...
  @TreeLookup private ItemAdminWhereSection whereSection;
  @Inject private AutoCompleteService autoCompleteService;

  @AjaxFactory private AjaxGenerator ajax;

  @TreeLookup private ItemAdminSearchResultsSection searchResults;
  ...
  public void setPluginService(PluginService pluginService) {
    tracker =
        new PluginTracker<WithinExtension>(
                pluginService, "com.tle.web.itemadmin", "withinExtension", "id")
            .setBeanKey("bean");
  }
  ...
  public SectionResult renderHtml(RenderEventContext context) throws Exception {
    ...
    return viewFactory.createResult("itemadmin-query.ftl", this);
  }
      ...
      collectionChangedHandler =
          new OverrideHandler(
              searchResults.getResultsUpdater(
                  tree,
                  events.getEventHandler("changedCollection"),
                  ajaxIds.toArray(new String[ajaxIds.size()])));
    }
  ...
  public class ItemAdminQueryModel
      extends AbstractResetFiltersQuerySection.AbstractQuerySectionModel {
  ...
  public class ItemAdminWhereModel extends DynamicHtmlListModel<WithinEntry> {
    public ItemAdminWhereModel() {
      setSort(true);
      setComparator(
          new NumberStringComparator<Option<WithinEntry>>(true) {
            ...
            public String convertToString(Option<WithinEntry> t) {
              ...
              return Strings.nullToEmpty(
                  withinEntry.getOrder() + " " + t.getGroupName() + " " + t.getName());
            }
          });
    }
    ...
    protected Option<WithinEntry> convertToOption(SectionInfo info, final WithinEntry obj) {
      ...
      Label label =
          obj.getOverrideLabel() == null
              ? new BundleLabel(bel.getBundleId(), bundleCache)
