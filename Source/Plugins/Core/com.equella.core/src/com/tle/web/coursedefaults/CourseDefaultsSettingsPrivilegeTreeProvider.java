...
@Bind
public class CourseDefaultsSettingsPrivilegeTreeProvider
  ...
  public CourseDefaultsSettingsPrivilegeTreeProvider() {
    super(
        Type.SYSTEM_SETTING,
        ResourcesService.getResourceHelper(CourseDefaultsSettingsPrivilegeTreeProvider.class)
            .key("securitytree.coursedefaultssettings"),
        new SettingsTarget("courseDefaults"));
  }
}
