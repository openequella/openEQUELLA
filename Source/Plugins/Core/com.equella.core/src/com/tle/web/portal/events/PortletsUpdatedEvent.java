...
public class PortletsUpdatedEvent extends ApplicationEvent<PortletsUpdatedEventListener> {
  ...
  public PortletsUpdatedEvent(
      String userId, String portletUuid, boolean institutional, PortletUpdateEventType type) {
  ...
  /**
   * @return The portlet that was moved or removed. May be null if the portlet that triggered the
