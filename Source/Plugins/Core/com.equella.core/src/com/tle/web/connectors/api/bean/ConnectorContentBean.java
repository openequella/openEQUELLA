...
/**
 * This class exists to provide item-usage information for the REST API implementation of
 * connector/uses query, and is a scaled down version of the ConnectorContent class.
 *
 * @author larry
 */
@XmlRootElement
