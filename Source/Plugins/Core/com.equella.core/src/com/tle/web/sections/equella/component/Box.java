...
public class Box extends AbstractRenderedComponent<BoxState> {
  ...
  private static final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(Box.class);

  private static final PreRenderable INCLUDE =
      new IncludeFile(
          resources.url("scripts/component/box.js"), AjaxGenerator.AJAX_LIBRARY); // $NON-NLS-1$
  public static final ExternallyDefinedFunction AJAX_CALLBACK =
      new ExternallyDefinedFunction("boxCallback", INCLUDE); // $NON-NLS-1$
    ...
    toggleFunction =
        new JSCallable() {
          ...
          public String getExpressionForCall(RenderContext info, JSExpression... params) {
            return toggleAjax.getExpressionForCall(
                info,
                new AnonymousAjaxCallback(
