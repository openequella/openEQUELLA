...
public interface UniversalControlState {
  ...
  /**
   * Get the control configuration which contains information about each handler type.
   *
  ...
  /**
   * Set an attribute for this dialog. Each dialog opening has a new set of attributes.
   *
   * @param info
   * @param key
   * @param value
  ...
  /**
   * Determine if the dialog was opened to replace an existing attachment (re-use it's uuid).
   *
   * @param info
  ...
  /**
   * Remove an {@link Attachment} from the item's global attachment list and ensure it is removed
  ...
  /**
   * Remove a collection of Attachments from the item's global attachment list and ensure they are
  ...
  /**
   * Remove an element from the item xml at the control's xpath matching the given uuid.
   *
   * @param info
   * @param uuid
   */
  ...
  /**
   * Perform a save. Does exactly the same thing as clicking the dialog's save button.
   *
   * @param info
   */
  ...
  /**
   * Gets all the {@link Attachment} objects pointed to by the uuids at the control's xpath.
   *
   * @return
   */
  ...
  /**
   * Get the the {@link Attachment} that will be replaced. Only valid if {@link
   * #isReplacing(SectionInfo)} returns true.
   *
   * @param info
   * @return
   */
