...
public class NotificationTopbarLink extends AbstractCachedTopbarLink {
  ...
  public int getCount() {
    return freeTextService
        .countsFromFilters(Collections.singletonList(new NotificationSearch()))[0];
  }
  ...
  public LinkRenderer getLink() {
    ...
    HtmlLinkState notificationLink =
        new HtmlLinkState(new SimpleBookmark("access/notifications.do"));
