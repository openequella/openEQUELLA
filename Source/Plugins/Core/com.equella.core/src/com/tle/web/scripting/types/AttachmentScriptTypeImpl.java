...
public class AttachmentScriptTypeImpl implements AttachmentScriptType
{
	...
	public Integer getViewCount()
	{
		...
		if (!aclService.filterNonGrantedPrivileges(wrapped.getItem(), SecurityConstants.VIEW_VIEWCOUNT).isEmpty())
		{
			viewCount = ViewCountJavaDao.getAttachmentViewCount(wrapped.getItem().getItemId(), wrapped.getUuid());
		}
