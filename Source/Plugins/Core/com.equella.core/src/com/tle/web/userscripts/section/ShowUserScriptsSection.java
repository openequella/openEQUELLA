...
public class ShowUserScriptsSection
    extends AbstractShowEntitiesSection<UserScript, ShowUserScriptsSection.ShowUserScriptsModel> {
  ...
  @Inject private UserScriptsService userScriptsService;
  ...
  protected List<Object> getColumnHeadings() {
    return Lists.newArrayList(
        (Object) getEntityColumnLabel(), (Object) COLUMN_MODULE_NAME, (Object) COLUMN_TYPE_LABEL);
  }

  @Override
  protected void addDynamicColumnData(
      SectionInfo info, UserScript script, SelectionsTableSelection row) {
