...
public class SearchFavouritesResultsSection
    extends AbstractSearchResultsSection<
        FavouriteSearchEntry,
        FreetextSearchEvent,
        SearchFavouritesSearchResultEvent,
        SearchResultsModel>
  ...
  @Inject private SearchFavouritesList searchFavouritesList;
  ...
  @Override
  protected SearchFavouritesSearchResultEvent createResultsEvent(
      SectionInfo info, FreetextSearchEvent searchEvent) {
    SearchFavouritesSearchResults results =
        favSearchService.search(
            searchEvent.getFinalSearch(), searchEvent.getOffset(), searchEvent.getCount());

    SearchFavouritesSearchResults unfiltered =
        favSearchService.search(
            searchEvent.getUnfilteredSearch(), searchEvent.getOffset(), searchEvent.getCount());

    return new SearchFavouritesSearchResultEvent(
        results, unfiltered.getAvailable() - results.getAvailable());
  }
