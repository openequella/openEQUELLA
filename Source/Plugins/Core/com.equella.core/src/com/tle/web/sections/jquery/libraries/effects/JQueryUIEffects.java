...
public class JQueryUIEffects implements JavascriptModule {
  ...
  private static final PreRenderable PRERENDER =
      new JQueryLibraryInclude("jquery.ui.effect.js", JQueryCore.PRERENDER).hasMin();
  private static final Map<String, PreRenderable> effectLibraries =
      new HashMap<String, PreRenderable>();
  ...
  public static JQueryUIEffectsLibrary addStdEffect(String effect) {
    JQueryUIEffectsLibrary lib =
        new JQueryUIEffectsLibrary(effect, "jquery.ui.effect-" + effect + ".js");
  ...
  public static class JQueryUIEffectsLibrary extends JQueryLibraryInclude {
    ...
    public FunctionCallExpression show() {
      return new FunctionCallExpression(
          new ExternallyDefinedFunction("show", this), getEffectName());
    }

    public FunctionCallExpression hide() {
      return new FunctionCallExpression(
          new ExternallyDefinedFunction("hide", this), getEffectName());
    }
  }
}
