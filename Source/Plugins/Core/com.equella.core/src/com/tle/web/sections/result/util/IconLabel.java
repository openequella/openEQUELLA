...
public class IconLabel implements ProcessedLabel {
  public enum Icon {
    ...
    NEXT("icon-arrow-right", false),
    ADD("icon-plus"),
    DELETE("icon-remove"),
    EDIT("icon-pencil"),
    SELECT("icon-thumbs-up"),
    UNSELECT("icon-ban-circle"),
    ...
    ROTATE_LEFT("icon-arrow-left"),
    ROTATE_RIGHT("icon-arrow-right", false),
    PRINT("icon-print"),
    REFRESH("icon-refresh"),
    JUMP_TO_FIRST("icon-fast-backward"),
    JUMP_TO_LAST("icon-fast-forward", false),
    CART("icon-shopping-cart"),
    BACK("icon-circle-arrow-left"),
    COG("icon-cog"),
    BELL("icon-bell"),
    TASKS("icon-tasks"),
    OFF("icon-off"),
    ...
    FAVOURITES_EMPTY("icon-star-empty"),
    HIERACHY("icon-th-list"),
