...
public class TargetFolder implements Serializable {
  ...
  private final Map<SelectedResourceKey, SelectedResource> selectedResources =
      new LinkedHashMap<SelectedResourceKey, SelectedResource>();
  ...
  /**
   * @return A deep search for selected resources, ie. resources in this folder and a deep search of
   *     every sub folder
   */
  ...
  /**
   * Performs a deep search for the selected resource and removes all instances of it in this folder
   * and subfolders
   *
   * @param resource
   * @return
  ...
  /**
   * @return Some folders may only be containers for sub folders. Blackboard's courses for example.
   */
