...
public class ViewItemSummaryModule extends SectionsModule {
  ...
  private NodeProvider mainContent() {
    NodeProvider node =
        node(MainItemContentSection.class)
            .placeHolder("com.tle.web.viewitem.summary.SUMMARY_MAINCONTENT");
  ...
  private NodeProvider summaryContent() {
    NodeProvider node =
        node(ItemSummaryContentSection.class)
            .placeHolder("com.tle.web.viewitem.summary.SUMMARY_CONTENT");
    ...
    node.child(
        node(ExportContentSection.class)
            .placeHolder("com.tle.web.viewitem.summary.section.EXPORTERS"));
  ...
  private NodeProvider summarySidebar() {
    NodeProvider node =
        node(ItemSummarySidebarSection.class)
            .placeHolder("com.tle.web.viewitem.summary.SUMMARY_SIDEBAR");
    node.child(majorActions());
    node.child(ViewItemSelectionSummarySection.class);
    NodeProvider lockedBy =
        node(LockedByGroupSection.class)
            .placeHolder("com.tle.web.viewitem.summary.sidebar.LOCKED_BY");
  ...
  private NodeProvider itemDetails() {
    NodeProvider node =
        node(ItemDetailsGroupSection.class)
            .placeHolder("com.tle.web.viewitem.summary.sidebar.DETAILS_GROUP");
  ...
  private NodeProvider majorActions() {
    NodeProvider node =
        node(MajorActionsGroupSection.class)
            .placeHolder("com.tle.web.viewitem.summary.sidebar.MAJOR_ACTIONS");
