...
@NonNullByDefault
@TreeIndexed
public class RootCloudViewItemSection
    extends AbstractPrototypeSection<RootCloudViewItemSection.RootCloudViewItemModel>
    implements HtmlRenderer, CloudItemSectionInfoFactory, ViewItemUrlProcessor {
  @PlugKey("viewitem.error.notfound.remoteserver")
  private static Label LABEL_ITEM_NOT_FOUND;

  @Inject private CloudViewItemAuditor auditor;
  @Inject private AttachmentResourceService attachmentResourceService;
  @Inject private ViewItemService viewItemService;

  @TreeLookup private CloudItemSummarySection summarySection;
  ...
  /**
   * Do not call this. Use CloudItemSectionInfo.getItemInfo instead, otherwise you will invoke
   * unncessary REST calls
   */
  @Override
  ...
  public class CloudAttachmentViewItemResource extends WrappedViewItemResource {
    ...
    public CloudAttachmentViewItemResource(
        ViewItemResource inner, ViewableResource viewableResource) {
      super(inner);
