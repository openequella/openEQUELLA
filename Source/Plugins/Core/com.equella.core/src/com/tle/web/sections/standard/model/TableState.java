...
public class TableState extends HtmlComponentState
{
	...
	public static abstract class BaseTableRow<C extends TableCell> extends TagState
	{
		private final List<C> cells;

		protected BaseTableRow(ElementId parent, C... cells)
		{
			super(new AppendedElementId(parent, new AppendedElementId(new SimpleElementId("tr"), new PageUniqueId())));
	...
	public static class TableHeaderCell extends TableCell
	{
		...
		{
			super(content);
			setElementId(new AppendedElementId(parent, new AppendedElementId(new SimpleElementId("th"),
				new PageUniqueId())));
		}
