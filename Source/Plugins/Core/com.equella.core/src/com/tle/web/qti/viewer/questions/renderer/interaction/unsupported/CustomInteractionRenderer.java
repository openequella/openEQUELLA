 ...
 * @author Aaron
 */
public class CustomInteractionRenderer extends QtiNodeRenderer
{
	@AssistedInject
	public CustomInteractionRenderer(@Assisted CustomInteraction<?> model, @Assisted QtiViewerContext context)
	{
		super(model, context);
	}
	...
	{
		throw new UnsupportedQuestionException("customInteraction");
	}
}
