...
@Bind
public class AddShortcutUrlDialog
    extends AbstractOkayableDialog<AddShortcutUrlDialog.AddShortculUrlDialogModel> {
  ...
  public void addShortcutUrl(SectionInfo info) {
    ...
    boolean emptyField =
        checkBlank(info, shortcutText, SHORTCUT_ERROR, ERROR_SHORTCUT_BLANK)
