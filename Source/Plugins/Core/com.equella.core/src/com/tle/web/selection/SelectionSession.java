...
public class SelectionSession extends ModalSession {
  ...
  private final Map<String, Map<String, String[]>> searchContexts =
  ...
  /**
   * The target course and it's folders in the LMS. Used by CourseListSection This also stores the
   * SelectedResources for normal selection sessions.
   *
   * @return
   */
