...
public interface Integration<T extends IntegrationSessionData> {
  ...
  @Nullable
  SelectionSession setupSelectionSession(
  ...
  <I extends IItem<?>> ViewableItem<I> createViewableItem(
      ItemId itemId, boolean latest, @Nullable String itemExtensionType);

  LmsLinkInfo getLinkForResource(
      SectionInfo info,
  ...
  public static class LmsLinkInfo {
    ...
    @Nullable private final IAttachment resourceAttachment;
    private final LmsLink lmsLink;

    protected LmsLinkInfo(
        IItem<?> resourceItem, @Nullable IAttachment resourceAttachment, LmsLink lmsLink) {
