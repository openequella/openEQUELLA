...
public class ButtonListDirective extends AbstractListDirective {
  ...
  protected TagRenderer createTagRenderer(
    ...
    if (params.containsKey("hideDisabledOptions")) {
      hideDisabledOptions =
          ((TemplateBooleanModel) params.get("hideDisabledOptions")).getAsBoolean();
    }

    return new ButtonListTagRenderer(
        tag, (HtmlListState) state, env, body, loopVars, hideDisabledOptions);
  }
