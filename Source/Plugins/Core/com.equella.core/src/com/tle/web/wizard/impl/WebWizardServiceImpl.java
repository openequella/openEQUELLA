...
public class WebWizardServiceImpl implements WebWizardService, ModerationView {
  ...
  @Override
  public void forwardToLoadItemWizard(
      SectionInfo info,
      String itemUuid,
      int itemVersion,
      boolean edit,
  ...
  @Override
  public SectionInfo getNewItemWizardForward(
      SectionInfo info,
  ...
  @Override
  public void forwardToNewItemWizard(
      SectionInfo info,
      String collectionUuid,
      PropBagEx initialXml,
      StagingFile staging,
      boolean cancellable) {
    info.forwardAsBookmark(
        getNewItemWizardForward(info, collectionUuid, initialXml, staging, cancellable));
  }

  @Override
  public void forwardToCloneItemWizard(
      SectionInfo info,
