...
public class BooleanListDirective extends AbstractListDirective {
  ...
  protected TagRenderer createTagRenderer(
    ...
    return new FreemarkerCheckListRenderer(
        new BooleanListRenderer((HtmlListState) state), env, body, loopVars);
  }

  public static class FreemarkerCheckListRenderer extends TagRenderer
      implements JSDisableable, JSListComponent {
    ...
    public FreemarkerCheckListRenderer(
        BooleanListRenderer renderer,
        Environment env,
        TemplateDirectiveBody body,
        TemplateModel[] loopVars) {
