...
public class BulkEditMetadataModel {
  ...
  @Bookmarked private boolean schemaSelection;
  @Bookmarked private boolean actionSelection;
  @Bookmarked private long selectedSchema;
  @Bookmarked private List<String> selectedNodes;
  @Bookmarked private String nodeDisplay;
  @Bookmarked private boolean actionReplace;
  @Bookmarked private boolean actionAdd;
  @Bookmarked private boolean actionSet;
  @Bookmarked private List<Modification> modifications = new ArrayList<Modification>();
  @Bookmarked private int editIndex;
  @Bookmarked private boolean edit;
