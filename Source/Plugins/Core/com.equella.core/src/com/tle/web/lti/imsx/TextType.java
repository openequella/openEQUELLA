...
/**
 * The text complexType is the container for a language specific string. The language is denoted
 * using the ISO 639 code set. See the corresponding VDEX file that contains the permitted
