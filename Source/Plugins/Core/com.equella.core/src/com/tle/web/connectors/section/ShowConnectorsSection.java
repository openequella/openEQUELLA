...
public class ShowConnectorsSection
    extends AbstractShowEntitiesSection<
        Connector, ShowConnectorsSection.ShowConnectorsSectionModel> {
  ...
  protected boolean canAdd(SectionInfo info) {
    return !aclService
        .filterNonGrantedPrivileges(ConnectorConstants.PRIV_CREATE_CONNECTOR)
        .isEmpty();
  }
  ...
  public class ShowConnectorsSectionModel
