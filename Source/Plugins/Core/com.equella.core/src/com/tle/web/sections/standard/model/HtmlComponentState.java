...
/**
 * The base "State" class for all Standard Component Library Renderers and Sections.
 *
 * <p>This class extends the {@link TagState} with properties specific to the Standard Component
 * Library, such as:
 *
 * <ul>
 *   <li>An optional label
 *   <li>Renderer type strings (default, override, markup selected)
 *   <li>A form name - not always the same as the element id
 *   <li>Flags for disabling and not displaying at all
 *   <li>Flags for keeping track of whether or not it was rendered
 * </ul>
 *
 * <p>This class itself is useful for {@code Section}s and Renderers which only need event
 * processing and don't store any other state, such as {@link Button}.
 *
 * @author jmaginnis
 */
public class HtmlComponentState extends TagState implements RendererSelectable {
  ...
  public static final Comparator<HtmlComponentState> LABEL_COMPARATOR =
      new NumberStringComparator<HtmlComponentState>() {
