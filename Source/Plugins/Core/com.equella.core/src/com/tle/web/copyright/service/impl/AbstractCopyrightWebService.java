...
public abstract class AbstractCopyrightWebService<H extends Holding>
  ...
  protected abstract CopyrightService<H, ? extends Portion, ? extends Section>
  ...
  private Map<String, Integer> getActivations(SectionInfo info, Item item) {
    ...
    if (activations == null) {
      List<ActivateRequest> activationRequests =
          copyrightService.getCurrentOrPendingActivations(getHolding(info, item));
