...
/**
 * Asks the current SectionTree set to see if there is something that handles Item selection. The
 * function you supply must conform to: public void selectItem(SectionInfo info, ItemId itemId)
 *
 * @author Aaron
 */
