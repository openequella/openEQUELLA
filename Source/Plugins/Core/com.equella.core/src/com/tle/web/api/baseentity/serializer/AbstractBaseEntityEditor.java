...
public abstract class AbstractBaseEntityEditor<BE extends BaseEntity, BEB extends BaseEntityBean>
  ...
  @Nullable protected final String stagingUuid;
  @Nullable protected final String lockId;
  protected boolean keepLocked;
  @Nullable private TargetList targetList;
  @Nullable private Map<Object, TargetList> otherTargetLists;

  protected abstract AbstractEntityService<?, BE> getEntityService();

  protected AbstractBaseEntityEditor(
      BE entity,
    ...
    if (!editing) {
      ...
      throw new InvalidDataException(
          new ValidationError(
              "uuid",
              CurrentLocale.get(
                  "com.tle.web.api.baseentity.serializer.validation.uuidcannotchange")));
    }

    entity.setName(getBundle(entity.getName(), source.getNameStrings(), source.getName()));
    entity.setDescription(
        getBundle(
            entity.getDescription(), source.getDescriptionStrings(), source.getDescription()));
    if (importing) {
  ...
  protected LanguageBundle getBundle(
      @Nullable LanguageBundle sourceBundle,
      @Nullable I18NStrings strings,
  ...
  @Nullable
  protected LanguageBundle getBundle(
      @Nullable LanguageBundle sourceBundle, @Nullable Map<String, String> strings) {
  ...
  protected Map<String, String> getStrings(
      @Nullable I18NStrings strings, @Nullable I18NString single) {
    if (strings != null) {
