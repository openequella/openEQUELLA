...
public class GenericIntegrationService
    extends AbstractIntegrationService<GenericIntegrationService.GenericIntegrationData> {
  ...
  public boolean select(
      SectionInfo info, final GenericIntegrationData data, SelectionSession session) {
    if (session.isSelectMultiple() || session.isForcePost()) {
      ...
      try {
        ...
        form.addReadyStatements(
            new JQueryStatement(JQuerySelector.Type.ID, "returnForm", "submit()"));
      ...
      LmsLink link =
          getLinkForResource(
              ...
              .getLmsLink();
      forwardToLms(
          info, session, data, item, getTypeForResource(data, resource, link), link, resource);
    }
  ...
  public void forwardToLms(
      SectionInfo info,
      SelectionSession session,
      GenericIntegrationData data,
      IItem<?> item,
      String type,
      LmsLink link,
  ...
  public static class GenericIntegrationData implements IntegrationSessionData {
    ...
    /**
     * This code was here before, but has been refactored out. I can't think of any real world case
     * where the URL would be everything except the http:// part but I'd better not remove it
     */
  ...
  protected String getTypeForResource(
      GenericIntegrationData data, SelectedResource resource, LmsLink link) {
