...
public class MyResourceACLMigrator implements PostReadMigrator<AclPostReadMigratorParams> {
  ...
  public void migrate(AclPostReadMigratorParams list) throws IOException {
    final AccessExpression owner =
        accessExpressionDao.retrieveOrCreate(SecurityConstants.getRecipient(Recipient.OWNER));
    ...
    final ItemDefinition collection =
        itemDefinitionService.getByUuid(MyContentConstants.MY_CONTENT_UUID);
