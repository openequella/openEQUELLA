...
public class MyResourceConverter extends AbstractItemXmlMigrator {
  ...
  private static final Set<String> ASSEM_COLLECTIONS =
      new HashSet<String>(
          Arrays.asList(
              "d243936d-67ba-0a6f-6f4c-4a2a6b676d54",
              "855f6055-5271-1e13-ceae-336e70cf5110",
              "16dda617-1829-8555-1510-4348c162c592",
              "5ac082d2-3015-aba1-a749-cd928a5c6e9c",
              "77279582-ce3f-97ee-84c3-66de5af5a4c5",
              "01d4757e-b10e-788d-a713-176427d4f90c",
              "e8f050dd-f6c0-4cec-559f-e54d7ef19836",
              "5eafc9ff-cad1-7290-2bd5-bd0cb7c193ee",
  ...
  public void beforeMigrate(
      ConverterParams params, TemporaryFileHandle staging, SubTemporaryFile file) throws Exception {
  ...
  public boolean migrate(
      ConverterParams params, PropBagEx xml, SubTemporaryFile handle, String filename)
      throws Exception {
  ...
  @SuppressWarnings("nls")
  private void addItemXml(ConvertInfo info, SubTemporaryFile handle, String filename, PropBagEx xml)
      throws Exception {
    ...
    final String attUrl =
        xml.getNode("attachments/com.tle.beans.item.attachments.FileAttachment/url");
  ...
  public void afterMigrate(ConverterParams params, SubTemporaryFile staging) throws Exception {
    ...
    for (ItemXml item : info.items) {
      ...
      final SubTemporaryFile originalDataFolder =
          new SubTemporaryFile(staging, item.getDataFolderPath());
      ...
      fileSystemService.write(
          newDataFolder, "/_ITEM/item.xml", new StringReader(item.getMetadata().toString()), false);
      fileSystemService.write(
          bucketFolder, newId + ".xml", new StringReader(item.getItem().toString()), false);
    }
  }
