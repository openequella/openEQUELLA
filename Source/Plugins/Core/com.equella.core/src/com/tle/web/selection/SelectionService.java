...
public interface SelectionService {
  ...
  /**
   * @param info
   * @return DOWNLOAD_ITEM if in an EQUELLA repo selection session, otherwise DISCOVER_ITEM
   */
  ...
  List<? extends BaseEntity> filterFullEntities(
      List<? extends BaseEntity> entities, Set<String> entityIds);

  SectionInfo getSelectionSessionForward(
  ...
  void addSelectedPath(
      SectionInfo info,
      ItemKey itemId,
      String resource,
      String title,
      String description,
      @Nullable TargetFolder folder,
  ...
  SelectedResource createItemSelection(
  ...
  SelectedResource createAttachmentSelection(
      SectionInfo info,
      ItemKey itemId,
  ...
  /** Much the same as the getSelectAttachmentFunction, only it's something invokable in Java */
  @Nullable
  SelectAttachmentHandler getSelectAttachmentHandler(
      SectionInfo info, ViewableItem<?> vitem, @Nullable String attachmentUuid);
  ...
  @Nullable
  JSCallable getSelectAttachmentFunction(
      SectionInfo info, ViewableItem<?> vitem, @Nullable String attachmentUuid);
}
