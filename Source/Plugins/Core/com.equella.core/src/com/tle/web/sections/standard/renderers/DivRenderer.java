...
public class DivRenderer extends TagRenderer {
  ...
  public DivRenderer(
      TagState tagState, @Nullable String styleClass, @Nullable Object innerContent) {
  ...
  public DivRenderer(
      TagState tagState, String tag, @Nullable String styleClass, @Nullable Object innerContent) {
    super(tag, tagState);
