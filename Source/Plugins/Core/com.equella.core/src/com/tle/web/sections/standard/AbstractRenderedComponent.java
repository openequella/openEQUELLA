...
@NonNullByDefault
public abstract class AbstractRenderedComponent<S extends HtmlComponentState>
    extends AbstractHtmlComponent<S>
    implements HtmlRenderer, RendererSelectable, ElementId, RendererCallback {
  @Inject protected RendererFactory renderFactory;

  private boolean used = true;
  private boolean disabled;
  private boolean displayed = true;
  @Nullable private HandlerMap handlerMap;
  @Nullable private List<PreRenderable> preRenderables;
  @Nullable private List<TagProcessor> processors;

  protected Label label;
  @Nullable protected String styleClass;
