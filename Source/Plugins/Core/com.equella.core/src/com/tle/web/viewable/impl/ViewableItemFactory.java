...
public class ViewableItemFactory {
  ...
  @Inject private Provider<NewDefaultViewableItem> viewableItemProvider;
  ...
  public NewDefaultViewableItem createIntegrationViewableItem(
      ItemKey itemKey, ViewableItemType vtype, boolean latest) {
    NewDefaultViewableItem nvi = viewableItemProvider.get();
    NewViewableItemState state = nvi.getState();
    state.setLatest(latest);
