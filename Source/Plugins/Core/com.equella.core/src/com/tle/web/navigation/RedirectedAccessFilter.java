...
/**
 * Originates with EQ-2212/EQ-2203. The "access" in URLs like ../access/hierarchy.do?... is removed
 * from the URL, hence where it is so present, we redirect to the truncated version (in a sense, as
 * if "access/" was stripped out from the path)
 *
 * @author larry
 */
@Bind
