...
public abstract class QtiNodeRenderer implements NestedRenderable {
  ...
  @Nullable private final QtiViewerContext context;
  private boolean preProcessed;

  @Nullable private SectionRenderable topRenderable;
  @Nullable private SectionRenderable nestedRenderable;
  @Nullable private SectionRenderable bottomRenderable;

  private List<SectionRenderable> childRenderables = Lists.newArrayList();

  @Inject protected QuestionRenderers qfac;
  @Inject protected QuestionFreemarkerFactory view;
