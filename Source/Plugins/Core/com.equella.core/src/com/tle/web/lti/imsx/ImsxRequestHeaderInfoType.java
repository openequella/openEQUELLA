...
/**
 * The RequestHeaderInfo complexType is the container for the information to be placed in the
 * SOAP/POX header for the request message transmitted for the associated operation call.
 *
...
@XmlType(
    name = "imsx_RequestHeaderInfo.Type",
    propOrder = {"imsxVersion", "imsxMessageIdentifier", "imsxSendingAgentIdentifier"})
