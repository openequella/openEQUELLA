...
public class FilterByItemStatusSection
    extends AbstractPrototypeSection<FilterByItemStatusSection.Model>
    implements SearchEventListener<FreetextSearchEvent>, HtmlRenderer, ResetFiltersListener {
  ...
  public void treeFinished(String id, SectionTree tree) {
    ...
    onlyInModeration.setClickHandler(
