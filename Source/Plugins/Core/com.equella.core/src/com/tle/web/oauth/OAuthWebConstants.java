...
public final class OAuthWebConstants {
  // OAuth 1 parameters
  public static final List<String> SINGLE_PARAMETERS =
      Arrays.asList(
  ...
  public static final Set<String> RESPONSE_TYPES_ALL =
      ImmutableSet.of(RESPONSE_TYPE_CODE, RESPONSE_TYPE_TOKEN);
