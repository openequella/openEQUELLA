...
public final class ValidationHelper {
  ...
  public static boolean checkBlankFields(
      Object entity, String[] blanks, List<ValidationError> errors) {
      ...
      if (value == null || value.toString().trim().length() == 0) {
        ...
        errors.add(
            new ValidationError(
                field,
                CurrentLocale.get(
                    "com.tle.core.services.entity.generic.validation.fillallmandatory")));
      }
    }
    return foundErrors;
  }
