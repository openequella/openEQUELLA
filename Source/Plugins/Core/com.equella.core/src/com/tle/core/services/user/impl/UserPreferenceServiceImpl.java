...
public class UserPreferenceServiceImpl implements UserPreferenceService, UserChangeListener {
  ...
  @Inject private UserPreferenceDao userPreferencesDao;
    ...
    cache =
        service.newInstitutionAwareCache(
            new CacheLoader<Institution, LoadingCache<String, LoadingCache<String, String>>>() {
              @Override
              public LoadingCache<String, LoadingCache<String, String>> load(
                                ...
                                .build(
                                    new CacheLoader<String, String>() {
                                      ...
                                      public String load(String key) {
                                        ...
                                        Criterion c2 =
                                            Restrictions.eq(
                                                "key.institution", institution.getDatabaseId());
                                        Criterion c3 = Restrictions.eq("key.preferenceID", key);
                                        UserPreference pref =
                                            userPreferencesDao.findByCriteria(c1, c2, c3);
  ...
  public Locale getPreferredLocale(HttpServletRequest request) {
    ...
    if (CurrentInstitution.get() != null
        && !CurrentUser.isGuest()
        && !CurrentUser.getUserState().isSystem()) {
