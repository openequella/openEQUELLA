...
public interface TaxonomyServiceScriptObject extends ScriptObject {
  ...
  /**
   * Find a taxonomy by the display name of the taxonomy (in the current user's language). If
   * multiple taxonomies with the same name are found then a RuntimeException is thrown.
   *
