...
public class AddOAuthTokenUniqueConstraintMigration extends AbstractHibernateMigration {
  private static final String KEY_PREFIX =
      PluginServiceImpl.getMyPluginId(AddOAuthTokenUniqueConstraintMigration.class)
    ...
    runInTransaction(
        ...
        new HibernateCall() {
          ...
          public void run(Session session) throws Exception {
            // Most likely unnecessary, but check for and delete any rows duplicated on user_id +
            // client_id
            // @formatter:off
            session
                .createSQLQuery(
