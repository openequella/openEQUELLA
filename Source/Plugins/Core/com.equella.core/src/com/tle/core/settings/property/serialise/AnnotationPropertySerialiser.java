...
public abstract class AnnotationPropertySerialiser<T extends Annotation>
    extends PropertySerialiser {
  @Override
  ...
  abstract void load(Object object, Field field, T details, Map<String, String> properties)
      throws Exception;

  abstract void save(Object object, Field field, T details, Map<String, String> properties)
      throws Exception;
}
