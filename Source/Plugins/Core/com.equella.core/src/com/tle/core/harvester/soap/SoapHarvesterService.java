...
public interface SoapHarvesterService {
   ...
   *
   * <p>Note that the response sent back by this method will include a new cookie. <b>Your client
   * MUST have cookies enabled</b>.
   *
   ...
   * @param since The date to search from in the format of "yyyy-MM-dd'T'HH:mm:ssZ"
  ...
  /**
   * Returns a list of all collections that the currently logged in user can search. <br>
   * <div class="block">
   *
   * <pre>
   * &lt;xml&gt;
  ...
  /**
   * Returns a list of all dynamic collections that the currently logged in user can search. <br>
   * <div class="block">
   *
   * <pre>
   * &lt;xml&gt;
   ...
   *     for the format of the returned Item XML.
   */
  String searchDynamicCollection(
      String dynaCollection, String virtualisationValue, String since, boolean liveOnly);

  /**
   * Gets the item xml for the supplied item.<br>
   * If the item has a DRM acceptance, the logged in use must have accepted it or the "Skip DRM for
   * harvesters" setting must be set.
   *
  ...
  /**
   * Zips up an item for downloading later by the returned URL. If the item has a DRM acceptance,
   * the logged in use must have accepted it or the "Skip DRM for harvesters" setting must be set.
   *
