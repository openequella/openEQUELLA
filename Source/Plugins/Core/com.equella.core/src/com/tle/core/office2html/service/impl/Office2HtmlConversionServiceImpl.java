...
/**
 * Provides file conversion services to the application. The conversion work is performed by calls
 * to conversion-service.jar via the command line.
 *
...
public class Office2HtmlConversionServiceImpl implements Office2HtmlConversionService {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(Office2HtmlConversionServiceImpl.class);

  private static final Collection<String> SUPPORTED_EXTENSIONS =
      Arrays.asList(
          "doc", "xls", "ppt", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
          "pps"); //$NON-NLS-1$
