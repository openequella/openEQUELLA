...
public final class PageCounter {
  private static final Pattern REGEX_ANUMBER =
      Pattern.compile("[0-9ivxlcdmIVXLCDM]+"); // $NON-NLS-1$
  private static final Pattern REGEX_SQUARE =
      Pattern.compile("(.*)\\[(.*?)([0-9ivxlcdmIVXLCDM]*)\\]"); // $NON-NLS-1$
