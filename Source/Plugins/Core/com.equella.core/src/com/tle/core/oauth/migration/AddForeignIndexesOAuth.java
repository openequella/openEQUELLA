...
public class AddForeignIndexesOAuth extends AbstractHibernateSchemaMigration {
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(AddForeignIndexesOAuth.class) + ".migration."; // $NON-NLS-1$
  ...
  protected List<String> getAddSql(HibernateMigrationHelper helper) {
    ...
    sql.addAll(
        helper.getAddIndexesRaw("oauth_client_permissions", "oac_permissions", "oauth_client_id"));
    sql.addAll(
        helper.getAddIndexesRaw("oauth_token_permissions", "oat_permissions", "oauth_token_id"));
    return sql;
  }
