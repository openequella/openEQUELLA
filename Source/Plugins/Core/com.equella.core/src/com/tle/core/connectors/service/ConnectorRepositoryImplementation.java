...
public interface ConnectorRepositoryImplementation {
   ...
   */
  @Nullable
  String getCourseCode(Connector connector, String username, String courseId)
      throws LmsUserNotFoundException;
   ...
   * @throws LmsUserNotFoundException
   */
  List<ConnectorCourse> getCourses(
      Connector connector,
      String username,
  ...
  boolean deleteContent(Connector connector, String username, String contentId)
      throws LmsUserNotFoundException;
