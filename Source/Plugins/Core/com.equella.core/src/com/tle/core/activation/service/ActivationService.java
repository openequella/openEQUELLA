...
public interface ActivationService {
  List<ActivateRequest> getAllRequestsForDateRange(
  ...
  List<ActivateRequest> activate(
      String activationType, Item key, List<ActivateRequest> requests, boolean skipPercentage);

  void activateAll(
      String activationType, Map<Long, List<ActivateRequest>> requestMap, boolean ignorePercentage);
  ...
  List<ActivateRequest> getAllCurrentAndPendingActivations(
      String activationType, String attachmentUuid);

  boolean attachmentIsSelectableForCourse(
