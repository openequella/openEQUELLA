...
public class RemoveFilters extends AbstractHibernateSchemaMigration {
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(RemoveFilters.class) + ".removefilters.";
  ...
  protected void executeDataMigration(
    ...
    if (!fgs.isEmpty()) {
      session
          .createQuery("DELETE FROM EntityLock WHERE entity IN (:filters)")
          .setParameterList("filters", fgs)
          .executeUpdate();
    }
  ...
  protected Class<?>[] getDomainClasses() {
    return new Class[] {
      FakeFilterGroup.class,
      FakeBaseEntity.class,
      FakeEntityLock.class,
      FakeItemFilter.class,
      FakeLanguageBundle.class,
      FakeLanguageString.class,
      FakeFilterControl.class,
      FakeItemdefControl.class,
      FakeItemDefinition.class,
      FakeBulkControl.class,
      FakeCourseControl.class,
      FakeDateControl.class,
      FakeFilterChangeControl.class,
      FakeFlagsControl.class,
      FakePerPageControl.class,
      FakeQueryControl.class,
      FakeRefineControl.class,
      FakeSortControl.class,
      FakeStatusControl.class,
      FakeSynonymControl.class,
      FakeUserControl.class,
      FakeWorkflowStepControl.class,
      FakeXPathControl.class,
  ...
  protected List<String> getDropModifySql(HibernateMigrationHelper helper) {
    List<String> sql =
        helper.getDropTableSql(
            "filter_group_filters",
            "item_filter_controls",
            "filter_group_default_controls",
            "filter_control",
            "filter_group",
            "item_filter");
    return sql;
