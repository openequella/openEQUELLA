...
public abstract class AbstractListPropertySerialiser<T extends Annotation, M, N>
    extends AnnotationPropertySerialiser<T> {
  protected abstract Class<? extends N> getType(T t);

  protected abstract void load(
      Map<String, M> list, Map<String, String> properties, String nkey, String num, String value);

  protected abstract N initialise(Class<? extends N> type, M val)
  ...
  public void load(
      Collection<N> col, String pkey, Class<? extends N> type, Map<String, String> properties)
      throws IllegalAccessException, InstantiationException {
