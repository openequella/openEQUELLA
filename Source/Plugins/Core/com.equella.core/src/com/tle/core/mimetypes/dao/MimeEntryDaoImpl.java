...
@Singleton
public class MimeEntryDaoImpl extends GenericInstitionalDaoImpl<MimeEntry, Long>
    implements MimeEntryDao {
  ...
  @Override
  public MimeTypesSearchResults searchAll(
      final String mimeType, final int offset, final int length) {
    return (MimeTypesSearchResults)
            ...
            .execute(
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) {
                    ...
                    return new MimeTypesSearchResults(
                        query.list(), offset, ((Long) count.uniqueResult()).intValue());
                  }
                });
  }
  ...
  @Override
  public MimeTypesSearchResults searchByMimeType(
      final String mimeType, final int offset, final int length) {
    return (MimeTypesSearchResults)
        getHibernateTemplate()
            .execute(
