...
public class IMSFileWrapper extends IMSChild {
   ...
   *
   * @param sbuf
   * @dytech.jira see Jira Defect TLE-924 : http://apps.dytech.com.au/jira/browse/TLE-924
   */
  ...
  /**
   * Compares the object with this file. If the object is an IMSFileWrapper and it has the same
   * entity encoded href, then true is returned, false otherwise.
   *
   * @return true if and only if obh is an IMSFileWrapper with the same entity encoded href.
   */
  @Override
