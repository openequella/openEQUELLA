...
public class IncreaseColumnForEncryptionMigration extends AbstractHibernateSchemaMigration {
  private static final String KEY_PREFIX =
      PluginServiceImpl.getMyPluginId(IncreaseColumnForEncryptionMigration.class) + ".";
  ...
  protected void executeDataMigration(
    ...
    session
        .createQuery("UPDATE LtiConsumer SET tempConsumerSecret = consumerSecret")
        .executeUpdate();
  }
  ...
  protected List<String> getDropModifySql(HibernateMigrationHelper helper) {
    ...
    modSQL.addAll(
        helper.getRenameColumnSQL(
            FakeOAuthClient.TABLE_NAME, "temp_client_secret", origOAuthColumn));
    modSQL.addAll(
        helper.getRenameColumnSQL(
            FakeLtiConsumer.TABLE_NAME, "temp_consumer_secret", origLTIColumn));
  ...
  public static class FakeOAuthClient extends FakeBaseEntity {
    ...
    @Lob String clientSecret;

    @Lob String tempClientSecret;
  }
  ...
  public static class FakeLtiConsumer extends FakeBaseEntity {
    ...
    @Lob String consumerSecret;

    @Lob String tempConsumerSecret;
  }
}
