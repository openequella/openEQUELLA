...
public final class OAuthConstants {
  ...
  /**
   * The request is missing a required parameter, includes an unsupported parameter value, repeats a
   * parameter, includes multiple credentials, utilizes more than one mechanism for authenticating
