...
public class OAuthClientDaoImpl extends AbstractEntityDaoImpl<OAuthClient>
  ...
  public OAuthClient getByClientIdAndRedirectUrl(String clientId, String redirectUrl) {
    return findByCriteria(
        ...
        Restrictions.eq("redirectUrl", redirectUrl),
        ...
        .execute(
            new TLEHibernateCallback() {
              ...
              public Object doInHibernate(Session session) throws HibernateException {
                final Query query =
                    session.createQuery(
                        "UPDATE OAuthClient SET userId = :toUserId"
