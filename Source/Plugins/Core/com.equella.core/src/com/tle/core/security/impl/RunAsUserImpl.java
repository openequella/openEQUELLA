...
public class RunAsUserImpl implements RunAsUser {
  ...
  public void execute(Institution institution, UserState userState, Runnable runnable) {
    UserState newUserState =
        new RunAsUserState(
            userState.getUserBean(), institution, aclManager, userService, userState.isSystem());
  ...
  @Override
  public void executeAsGuest(
      Institution institution, Runnable runnable, WebAuthenticationDetails details) {
