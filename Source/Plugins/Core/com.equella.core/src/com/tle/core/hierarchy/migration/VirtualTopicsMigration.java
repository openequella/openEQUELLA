...
public class VirtualTopicsMigration extends AbstractHibernateSchemaMigration {
  private static final String TITLE_KEY =
      PluginServiceImpl.getMyPluginId(VirtualTopicsMigration.class)
  ...
  protected Class<?>[] getDomainClasses() {
    return new Class[] {
      FakeTopic.class, FakeTopic.FakeAttribute.class,
    };
  }
  ...
  protected List<String> getAddSql(HibernateMigrationHelper helper) {
    ...
    rv.addAll(
        helper.getAddColumnsSQL("hierarchy_topic", "virtualisation_id", "virtualisation_path"));
    rv.addAll(
        helper.getAddIndexesRaw("hierarchy_topic_attributes", "hta_topic", "hierarchy_topic_id"));
    return rv;
  }
  ...
  public static class FakeTopic {
    ...
    @CollectionTable(
        name = "hierarchy_topic_attributes",
