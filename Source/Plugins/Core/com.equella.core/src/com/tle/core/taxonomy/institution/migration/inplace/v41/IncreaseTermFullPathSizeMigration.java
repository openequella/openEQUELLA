...
public class IncreaseTermFullPathSizeMigration extends AbstractHibernateSchemaMigration {
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(IncreaseTermFullPathSizeMigration.class) + "."; // $NON-NLS-1$
  ...
  protected List<String> getDropModifySql(HibernateMigrationHelper helper) {
    return helper.getModifyColumnSQL(
        "term", "full_value", false, true); // $NON-NLS-1$ //$NON-NLS-2$
  }
