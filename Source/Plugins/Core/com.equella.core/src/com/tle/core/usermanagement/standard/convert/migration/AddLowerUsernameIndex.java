...
public class AddLowerUsernameIndex extends AbstractHibernateSchemaMigration {
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(AddLowerUsernameIndex.class) + ".migration.addindex.";
  ...
  /**
   * @see
   *     com.tle.core.migration.AbstractHibernateDataMigration#executeDataMigration(com.tle.core.hibernate.impl.HibernateMigrationHelper,
   *     com.tle.core.migration.MigrationResult, org.hibernate.classic.Session)
   */
  @Override
   ...
   *
   * @see
   *     com.tle.core.migration.AbstractHibernateDataMigration#getDropModifySql(com.tle.core.hibernate.impl.HibernateMigrationHelper)
   */
  @Override
  ...
  /**
   * @see
   *     com.tle.core.migration.AbstractHibernateDataMigration#getAddSql(com.tle.core.hibernate.impl.HibernateMigrationHelper)
   */
  @Override
  protected List<String> getAddSql(HibernateMigrationHelper helper) {
    List<String> sql = new ArrayList<String>();
    sql.addAll(
        helper.getAddFunctionIndexes(
            TLEUSER_TABLE, FUNCTION_LOWER, new String[] {LOWERCASE_USERNAME_INDEX, COLUMN_NAME}));
    return sql;
  }
