...
public final class LanguageBundleMigration extends XmlMigrator implements ItemXmlMigrator {
  ...
  private List<Mapping> getXPathMappings() {
    ...
    Mapping.create(map, "filtergroup")
        .addPath("name", "description", "filters/*/name", "filters/*/description");

    Mapping.create(map, "hierarchy")
        .addPath(
            "*/name",
            "*/keyResourcesSectionName",
            "*/longDescription",
            "*/shortDescription",
            "*/subtopicsSectionName",
            "*/resultsSectionName");

    Mapping.create(map, "itemdefinition")
        .addPath("name", "description", "slow/*/displayNodes/*/title")
    ...
    Mapping.create(map, "powersearch")
        .addPath("name", "description")
        .customProcessor(POWERSEARCH_PROCESSOR);

    Mapping.create(map, "courseinfo").addPath("name", "description");

    Mapping.create(map, "schema").addPath("name", "description");

    Mapping.create(map, "workflow")
        .addPath("name", "description")
        .customProcessor(WORKFLOW_PROCESSOR);
  ...
  private final CustomProcessor CONTRIBUTE_PROCESSOR =
      new CustomProcessor() {
        @Override
  ...
  private final CustomProcessor POWERSEARCH_PROCESSOR =
      new CustomProcessor() {
        @Override
        public void process(PropBagEx xml, Locale locale) {
  ...
  private static final CustomProcessor WORKFLOW_PROCESSOR =
      new CustomProcessor() {
        @Override
        public void process(PropBagEx xml, Locale locale) {
