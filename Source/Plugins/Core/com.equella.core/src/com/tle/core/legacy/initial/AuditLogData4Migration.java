...
public class AuditLogData4Migration extends AbstractHibernateSchemaMigration {
  ...
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(AuditLogData4Migration.class) + ".";

  @Override
  public MigrationInfo createMigrationInfo() {
    return new MigrationInfo(
        keyPrefix + "auditlog.data4migration.title",
        keyPrefix + "auditlog.data4migration.description");
  }
  ...
  protected void executeDataMigration(
    ...
    session
        .createQuery("UPDATE AuditLogEntry SET data4 = data3 WHERE eventType = 'CONTENT_VIEWED'")
        .executeUpdate();
    result.incrementStatus();

    // Remove old data3 entries
    session
        .createQuery("UPDATE AuditLogEntry SET data3 = NULL WHERE eventType = 'CONTENT_VIEWED'")
        .executeUpdate();
    result.incrementStatus();
