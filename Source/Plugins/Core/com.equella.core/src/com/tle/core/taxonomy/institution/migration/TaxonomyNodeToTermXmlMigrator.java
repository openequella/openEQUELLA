...
public class TaxonomyNodeToTermXmlMigrator extends XmlMigrator implements TreeNodeCreator<TaxonomyNode>
{
	...
	private static PluginResourceHelper r = ResourcesService.getResourceHelper(TaxonomyNodeToTermXmlMigrator.class);
		...
		throws IOException
	{
		...
		DefaultMessageCallback message = new DefaultMessageCallback(
			r.key("converter.nodetoterm.progressmessage"));
