...
@Singleton
public class QtiAssessmentItemRefDaoImpl
    extends GenericInstitionalDaoImpl<QtiAssessmentItemRef, Long>
    implements QtiAssessmentItemRefDao {
  ...
  public QtiAssessmentItemRef getByUuid(final String uuid) {
    final QtiAssessmentItemRef question =
  ...
  public QtiAssessmentItemRef getByIdentifier(QtiAssessmentTest test, String identifier) {
    final QtiAssessmentItemRef question =
        findByCriteria(Restrictions.eq("test", test), Restrictions.eq("identifier", identifier));
    if (question == null) {
      throw new NotFoundException(
          "Cannot find assessment item with identifier "
              + identifier
              + " in test "
              + test.getUuid());
    }
