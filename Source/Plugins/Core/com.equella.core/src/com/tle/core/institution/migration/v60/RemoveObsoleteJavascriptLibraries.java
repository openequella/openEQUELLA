...
public class RemoveObsoleteJavascriptLibraries extends AbstractHibernateDataMigration {
  ...
  private static final String PRETTY_PHOTO_XPATH =
      "//attributes/entry/list/string[text() = 'jquery.prettyphoto']";
  private static final String PRETTY_GALLERY_XPATH =
      "//attributes/entry/list/string[text() = 'jquery.prettygallery']";
  private static final String J_CAROUSEL =
      "//attributes/entry/list/string[text() = 'jquery.carousel']";
  ...
  protected Class<?>[] getDomainClasses() {
    return new Class<?>[] {
      Institution.class, FakeItemDefinition.class, FakeBaseEntity.class, FakeItemdefBlobs.class
    };
  }
