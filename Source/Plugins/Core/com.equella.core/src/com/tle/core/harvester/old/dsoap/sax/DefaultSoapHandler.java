...
public abstract class DefaultSoapHandler extends DefaultHandler {
  ...
  public void startElement(
      String namespaceURL, String localName, String qname, Attributes attributes) {
  ...
  public void throwException(int soapResponseCode) throws SoapCallException {
    if (foundError) {
      if (!interpretExceptions) {
        ...
        try {
          Constructor<?> con =
              Class.forName(exceptionClass).getConstructor(new Class[] {String.class});
          SoapCallException sce =
              new SoapCallException(
                  (Exception) con.newInstance(new Object[] {message}), soapResponseCode);
          throw sce;
   ...
   * @param attributes
   */
  protected void hookStartElement(
      String namespaceURL, String localName, String qname, Attributes attributes) {
    // Nothing to do here
  }
