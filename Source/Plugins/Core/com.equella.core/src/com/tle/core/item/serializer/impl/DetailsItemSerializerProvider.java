  ...
  public void writeItemBeanResult(
    ...
    if (state.hasCategory(SerialisationCategory.DETAIL)) {
      ...
      equellaItemBean.setStatus(
          ((String) state.getData(itemId, ItemSerializerState.STATUS_ALIAS)).toLowerCase());
    ...
    if (state.isExport()) {
      ...
      List<HistoryEventBean> history =
          itemSerializerService.getHistory(equellaItemBean.getUuid(), equellaItemBean.getVersion());
