...
public class CustomLinkServiceImpl
    extends AbstractEntityServiceImpl<CustomLinkEditingBean, CustomLink, CustomLinkService>
  ...
  public static final Comparator<CustomLink> CUSTOM_LINK_COMPARATOR =
      new Comparator<CustomLink>() {
        @Override
  ...
  protected void doValidation(
      EntityEditingSession<CustomLinkEditingBean, CustomLink> session,
      CustomLink entity,
  ...
  public void insertLink(CustomLink newLink) {
    ...
    List<CustomLink> links =
        customLinkDao.findAllByCriteria(
            Restrictions.ge(ORDER, newOrder), getInstitutionCriterion());
  ...
  public void deleteLink(CustomLink link) {
    ...
    List<CustomLink> links =
        customLinkDao.findAllByCriteria(Restrictions.ge(ORDER, order), getInstitutionCriterion());
  ...
  @Override
  protected <SESSION extends EntityEditingSession<CustomLinkEditingBean, CustomLink>>
  ...
  protected void onStartNewSession(
      EntityEditingSession<CustomLinkEditingBean, CustomLink> session, EntityFile entFile) {
