...
public class BaseEntityXmlConverter implements Converter {
  ...
  public Object unmarshal(HierarchicalStreamReader reader, UnmarshallingContext context) {
    ...
    try {
      AbstractEntityService<?, ? extends BaseEntity> service =
          registry.getServiceForClass((Class<? extends BaseEntity>) Class.forName(classFromStream));
      if (service == null) {
        throw new RuntimeException(
            "Could not find service for class '" + classFromStream + "' in entity registry!");
      }
