            ...
            .execute(
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) {
                    Object res =
                        session
                            .getNamedQuery("getAverageRatingForItem")
                            .setParameter("uuid", itemId.getUuid())
                            .setParameter("version", itemId.getVersion())
        ...
        getHibernateTemplate()
            .execute(
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) {
                    return session
                        .getNamedQuery("getItemCommentByUuid")
                ...
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) {
                    ...
                    if (filter.contains(CommentFilter.ONLY_MOST_RECENT_PER_USER)) {
                      ...
                      sb.append(
                          " ) lc ON (c.owner = lc.owner AND c.date_created = lc.date_created)");
  ...
  public Multimap<Long, Comment> getCommentsForItems(Collection<Long> itemIds) {
    ...
    List<Object[]> attachments =
        (List<Object[]>)
            getHibernateTemplate()
                .findByNamedParam(
                    "select c, i.id from Item i join i.comments c where i.id in (:items)",
                    "items",
                    itemIds);
