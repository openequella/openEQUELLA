...
public interface ConnectorRepositoryService {
  ...
  String getAuthorisationUrl(
      Connector connector, @Nullable String forwardUrl, @Nullable String authData);
  ...
  List<ConnectorCourse> getModifiableCourses(
      Connector connector, String username, boolean archived, boolean management)
      throws LmsUserNotFoundException;

  ConnectorFolder addItemToCourse(
      Connector connector,
      String username,
      String courseId,
      String sectionId,
   ...
   * @throws LmsUserNotFoundException
   */
  SearchResults<ConnectorContent> findAllUsagesAllConnectors(
      String username,
      String query,
      String courseId,
      String folderId,
   ...
   * @throws LmsUserNotFoundException
   */
  int getUnfilteredAllUsagesCount(
  ...
  boolean deleteContent(Connector connector, String username, String id)
      throws LmsUserNotFoundException;
  ...
  // TODO: change all the supportsX calls to getCapabilities which returns an object with boolen
  // fields on it.
}
