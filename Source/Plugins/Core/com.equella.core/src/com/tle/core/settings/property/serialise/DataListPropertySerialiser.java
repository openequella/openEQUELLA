...
public class DataListPropertySerialiser
    extends AbstractListPropertySerialiser<
        PropertyDataList, Map<String, String>, ConfigurationProperties> {
  @Override
  ...
  @Override
  protected ConfigurationProperties initialise(
      Class<? extends ConfigurationProperties> type, Map<String, String> val)
