...
public class URLCheckerService {
  ...
  ListenableFuture<ReferencedURL> checkUrl(final ReferencedURL rurl) {
    ...
    final ListenableFuture<ReferencedURL> mapToRurl =
    ...
    return Futures.catchingAsync(
        mapToRurl,
        Throwable.class,
        new AsyncFunction<Throwable, ReferencedURL>() {
          @Override
  ...
  private ListenableFuture<Pair<ReferencedURL, Boolean>> checkUrl(
    ...
    AsyncHandler<Pair<ReferencedURL, Boolean>> handler =
        new AsyncHandler<Pair<ReferencedURL, Boolean>>() {
    ...
    try {
      ...
      return Futures.transformAsync(
          ...
          new AsyncFunction<Pair<ReferencedURL, Boolean>, Pair<ReferencedURL, Boolean>>() {
            @Override
            public ListenableFuture<Pair<ReferencedURL, Boolean>> apply(
                Pair<ReferencedURL, Boolean> result) throws Exception {
              if (result.getSecond()) {
  ...
  /**
   * Stupidity! AsyncHttpClient copied the Guava implementation so we now need adapters to delegate
   * between them, all because Java doesn't provide the ability to add listeners to Future or
