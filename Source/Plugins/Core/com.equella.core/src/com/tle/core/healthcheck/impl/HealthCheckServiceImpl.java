...
public class HealthCheckServiceImpl implements HealthCheckService, ServiceCheckResponseListener {
  ...
  private final Cache<String, List<ServiceStatus>> responseCache =
      CacheBuilder.newBuilder().expireAfterWrite(1, TimeUnit.MINUTES).softValues().build();
  ...
  @Override
  public void serviceCheckResponse(
      String requesterId, String responderId, ServiceStatus serviceStatus) {
