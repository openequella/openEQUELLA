...
public class SecurityMigration extends AbstractHibernateDataMigration {
  ...
  private static final String KEY_PREFIX =
      PluginServiceImpl.getMyPluginId(SecurityMigration.class) + ".";
  ...
  protected void executeDataMigration(
    ...
    query =
        session
            .createQuery("FROM ConfigurationProperty WHERE property = :smtp OR property = :ldap")
            .setParameter("smtp", SMTP_PWD_KEY)
            .setParameter("ldap", LDAP_PWD_KEY);
