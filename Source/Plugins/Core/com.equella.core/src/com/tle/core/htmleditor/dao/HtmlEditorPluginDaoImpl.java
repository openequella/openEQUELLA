...
public class HtmlEditorPluginDaoImpl extends AbstractEntityDaoImpl<HtmlEditorPlugin>
    implements HtmlEditorPluginDao {
  ...
  public HtmlEditorPlugin getByPluginId(String pluginId) {
    return findByCriteria(
        Restrictions.eq("pluginId", pluginId),
        ...
        .execute(
            new TLEHibernateCallback() {
              ...
              public Object doInHibernate(Session session) throws HibernateException {
                final Query query =
                    session.createQuery(
                        "UPDATE HtmlEditorPlugin SET userId = :toUserId"
