...
public interface HttpService {
  ...
  /**
   * The idea is that you can build up the URL with the request object and "toString" it via this.
   *
   * @param request
  ...
  /** Turns a list of NameValue into a query string. e.g param1=val1&param2=val2 */
  @Nullable
