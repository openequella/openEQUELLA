...
public class AddExtraRemoteRepoColumns extends AbstractHibernateSchemaMigration {
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(AddExtraRemoteRepoColumns.class) + ".setupremoterepo.";
  ...
  protected void executeDataMigration(
    ...
    Query setDenyQuery =
        session.createQuery("UPDATE ItemDefinition SET denyDirectContribution = :value");
