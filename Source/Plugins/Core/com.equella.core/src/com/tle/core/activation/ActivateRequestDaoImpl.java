...
public class ActivateRequestDaoImpl extends GenericDaoImpl<ActivateRequest, Long>
    implements ActivateRequestDao {
  ...
  @Override
  @Transactional
  public List<ActivateRequest> getAllActiveOrPendingRequestsForItems(
      String type, Collection<Item> items) {
    if (items.isEmpty()) {
      return Collections.emptyList();
    }
    ...
    return (Long)
        getHibernateTemplate()
            .findByNamedParam(
                ...
                new Object[] {
                  request.getItem(), request.getAttachment(), ActivateRequest.TYPE_ACTIVE
                })
            .get(0);
  }
  ...
  @Override
  @Transactional
  public ActivateRequest getLastActive(
      final String type, final Item item, final String attachment) {
