...
public class UserScriptsDaoImpl extends AbstractEntityDaoImpl<UserScript>
    implements UserScriptsDao {
                  ...
                  public Object doInHibernate(Session session) throws HibernateException {
                    ...
                    final Query q =
                        session
                            ...
                            .setParameter("inst", CurrentInstitution.get());
                    return q.list();
                  }
                });
  }
                ...
                new HibernateCallback() {
                  ...
                  public Object doInHibernate(Session session) throws HibernateException {
                    ...
                    final Query q =
                        session
                            .createQuery(query)
                            .setParameter("moduleName", moduleName.toString())
                            .setParameter("inst", CurrentInstitution.get())
                            .setParameter("type", "EXECUTABLE")
                            .setParameter("id", id);
