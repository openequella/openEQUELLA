...
public interface TermService extends RemoteTermService {
  ...
  /**
   * Adds a new term to the taxonomy bypassing the EDIT_TAXONOMY security checks. This is intended
   * to be used by the Auto-Complete edit box for folksonomies where users should be able to add
   * terms, but not edit the taxonomy as a whole. Assumes that checks have already been made as to
  ...
  void doExport(
      Taxonomy taxonomy,
      SubTemporaryFile dataSourceFolder,
