...
public class SoapHarvesterServiceImpl implements PrivateSoapHarvesterService, SoapHarvesterService {
  ...
  protected static final String KEY_PFX =
      AbstractPluginService.getMyPluginId(SoapHarvesterServiceImpl.class) + ".";
  ...
  @Inject private ConfigurationService config;
  ...
  public String getDynamicCollections() throws Exception {
    List<VirtualisableAndValue<DynaCollection>> dcs =
        dynaCollectionService.enumerateExpanded(HARVESTER_USAGE);
  ...
  public String searchItemsSince(String[] collectionUuids, boolean onlyLive, String since) {
    ...
    // UUID return results
    List<ItemDefinition> matchingSearchableUuid =
        collectionService.getMatchingSearchableUuid(Arrays.asList(collectionUuids));
  ...
  @Override
  public String searchDynamicCollection(
    ...
    FreeTextBooleanQuery searchClause =
        dynaCollectionService.getSearchClause(dc, virtualisationValue);
