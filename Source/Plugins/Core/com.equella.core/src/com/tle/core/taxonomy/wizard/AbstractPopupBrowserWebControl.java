...
public abstract class AbstractPopupBrowserWebControl
    extends BaseTermSelectorDisplayDelegate<BaseTermSelectorWebControlModel> {
  ...
  public void registered(String id, SectionTree tree) {
    ...
    popupBrowserDialog.setOkCallback(
        termWebControl.getReloadFunction(true, events.getEventHandler("addTerms")));
    ...
    popupBrowserDialog.setBrowseEnabled(
        definitionControl.getBooleanAttribute(POPUP_ALLOW_BROWSING, true));
    popupBrowserDialog.setSearchEnabled(
        definitionControl.getBooleanAttribute(POPUP_ALLOW_SEARCHING, true));
