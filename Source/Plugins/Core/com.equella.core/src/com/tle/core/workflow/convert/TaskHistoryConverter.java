...
public class TaskHistoryConverter implements ItemExtrasConverter {
  ...
  @Override
  public void importExtras(
      ItemConverterInfo info, XStream xstreamUnsed, SubTemporaryFile extrasFolder) {
    LoadingCache<String, Map<String, WorkflowNode>> workflowMaps =
        info.getState(TaskHistoryConverter.class);
  ...
  @Override
  public void exportExtras(
      ItemConverterInfo info, XStream xstreamUnused, SubTemporaryFile extrasFolder) {
