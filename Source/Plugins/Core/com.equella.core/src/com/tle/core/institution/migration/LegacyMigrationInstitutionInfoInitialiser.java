...
public class LegacyMigrationInstitutionInfoInitialiser implements InstitutionInfoInitialiser {
  ...
  private TreeMultimap<String, String> buildXmlMigrations() {
    TreeMultimap<String, String> xmlMigs =
        TreeMultimap.create(new NumberStringComparator<String>(), Ordering.natural());
  ...
  private TreeMultimap<String, String> buildItemXmlMigrations() {
    TreeMultimap<String, String> itemXmlMigs =
        TreeMultimap.create(new NumberStringComparator<String>(), Ordering.natural());
  ...
  private TreeMultimap<String, String> buildPostReadMigrations() {
    TreeMultimap<String, String> postReadMigs =
        TreeMultimap.create(new NumberStringComparator<String>(), Ordering.natural());
  ...
  private void add32PostReadMigrators(Multimap<String, String> postReadMigs) {
    ...
    postReadMigs.put(
        "3.2.22212", "com.tle.core.institution.migration.v32.RemoveEmailTemplatePrivMigrator");
  }
  ...
  private void add40PostReadMigrators(Multimap<String, String> postReadMigs) {
    ...
    postReadMigs.put(
        "4.0", "com.tle.core.institution.migration.v40.EditHierarchyPrivilegeMigrator");
  }
  ...
  private void add50ItemMigrators(Multimap<String, String> itemXmlMigs) {
    itemXmlMigs.put(
        "5.0", "com.tle.core.legacy.migration.v50.RemoveAssemblerAndActivityWizardItemsFix");
  ...
  private void add32Migrators(Multimap<String, String> xmlMigs) {
    ...
    xmlMigs.put(
        "3.2",
        "com.tle.core.institution.migration.v32.ConvertFedSearchAttributesToBaseEntityAttributes");
    xmlMigs.put("3.2", "com.tle.core.institution.migration.v32.RenameSchemaTransformations");
    xmlMigs.put(
        "3.2.21273", "com.tle.core.institution.migration.v32.ChangeBlackZ3950UsernameToGuest");
  }
  ...
  private void add41Migrators(Multimap<String, String> xmlMigs) {
    ...
    xmlMigs.put(
        "4.1.24503", "com.tle.core.wizard.institution.migration.v41.WizardLayoutXmlMigrator");
    xmlMigs.put("4.1.24520", "com.tle.core.taxonomy.institution.migration.TempTaxonomyXmlMigrator");
    xmlMigs.put(
        "4.1.24520", "com.tle.core.taxonomy.institution.migration.TaxonomyNodeToTermXmlMigrator");
    xmlMigs.put(
        "4.1.25700", "com.tle.core.institution.migration.v41.DisplayTemplateLocationXmlMigrator");
  }

  private void add50Migrators(Multimap<String, String> xmlMigs) {
    xmlMigs.put(
        "5.0", "com.tle.web.viewitem.migration.xml.v50.RemoveViewPackageContentXmlMigration");
    xmlMigs.put("5.0", "com.tle.core.legacy.migration.v50.RemoveNavigationGroupsAndLinksXml");
    xmlMigs.put(
        "5.0", "com.tle.core.legacy.migration.v50.RemoveAssemblerAndActivityWizardEntitiesFix");
    xmlMigs.put(
        "5.0", "com.tle.core.legacy.migration.v50.AddCommentsSectionToItemSummarySectionsXml");
    ...
    xmlMigs.put(
        "5.0.27421", "com.tle.core.legacy.migration.v50.RemoveObsoleteCollectionSettingsXml");
    xmlMigs.put(
        "5.0.27876",
    ...
    xmlMigs.put(
        "5.0.28276",
        "com.tle.core.legacy.migration.v50.RemovePopupFixViewerAndConvertPrettyViewerXml");

    xmlMigs.put(
        "5.0.29456",
        "com.tle.core.fedsearch.migrations.RemoveGoogleAndEdnaAndDSMFedSearchMigrationXml");
  }
