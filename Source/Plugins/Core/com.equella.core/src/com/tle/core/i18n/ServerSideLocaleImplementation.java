...
public class ServerSideLocaleImplementation extends AbstractCurrentLocale {
  ...
  private static final InheritableThreadLocal<CurrentData> local =
      new InheritableThreadLocal<CurrentData>();
  ...
  private static class CurrentData {
    ...
    public CurrentData(
        UserState userState, Locale locale, boolean rightToLeft, ResourceBundle resourceBundle) {
