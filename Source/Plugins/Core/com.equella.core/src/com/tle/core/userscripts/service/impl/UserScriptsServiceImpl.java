...
public class UserScriptsServiceImpl
    extends AbstractEntityServiceImpl<UserScriptEditingBean, UserScript, UserScriptsService>
    implements UserScriptsService {
  private static final PluginResourceHelper resources =
      ResourcesService.getResourceHelper(UserScriptsServiceImpl.class);

  private static final String KEY_VALIDATION_NOSCRIPT = "validation.script.empty";

  @Inject private UserScriptsDao scriptDao;
  ...
  @Override
  protected <SESSION extends EntityEditingSession<UserScriptEditingBean, UserScript>>
  ...
  protected void doValidationBean(UserScriptEditingBean bean, List<ValidationError> errors) {
    if (Check.isEmpty(bean.getScript())) {
      errors.add(
          new ValidationError("errors.noscript", resources.getString(KEY_VALIDATION_NOSCRIPT)));
    }
  }
