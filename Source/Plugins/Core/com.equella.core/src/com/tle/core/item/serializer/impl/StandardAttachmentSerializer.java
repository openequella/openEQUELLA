  ...
  public String deserialize(EquellaAttachmentBean attachBean, ItemEditor itemEditor) {
    ...
    switch (type) {
      case FILE:
        ...
        FileAttachmentEditor editor =
            itemEditor.getAttachmentEditor(attachUuid, FileAttachmentEditor.class);
        attachEditor = editor;
      ...
      case LINK:
        ...
        UrlAttachmentEditor ueditor =
            itemEditor.getAttachmentEditor(attachUuid, UrlAttachmentEditor.class);
      ...
      case IMSRES:
        ...
        PackageResourceAttachmentEditor preditor =
            itemEditor.getAttachmentEditor(attachUuid, PackageResourceAttachmentEditor.class);
      ...
      case IMS:
        ...
        PackageAttachmentEditor peditor =
            itemEditor.getAttachmentEditor(attachUuid, PackageAttachmentEditor.class);
      ...
      case ZIP:
        ...
        ZipAttachmentEditor zeditor =
            itemEditor.getAttachmentEditor(attachUuid, ZipAttachmentEditor.class);
      ...
      case CUSTOM:
        if (rawAttachmentType.equals("custom/scorm")) {
          ...
          ScormAttachmentEditor seditor =
              itemEditor.getAttachmentEditor(attachUuid, ScormAttachmentEditor.class);
          ...
          ScormResourceAttachmentEditor sreditor =
              itemEditor.getAttachmentEditor(attachUuid, ScormResourceAttachmentEditor.class);
