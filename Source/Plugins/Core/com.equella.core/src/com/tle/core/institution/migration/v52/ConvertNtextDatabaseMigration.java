...
/**
 * This migration only applies to SQL Server. The ntext data type has long been deprecated and
 * nvarchar(max) should be used.
 *
 * @author Aaron
 */
...
public class ConvertNtextDatabaseMigration extends AbstractHibernateSchemaMigration {
  private static final Logger LOGGER = LoggerFactory.getLogger(ConvertNtextDatabaseMigration.class);
