...
/**
 * Importer for new node format that has a single node XML per file. Files are sequentially
 * numbered, and it is important that they are read in that order for correct top-down insertion of
 * nodes.
 */
