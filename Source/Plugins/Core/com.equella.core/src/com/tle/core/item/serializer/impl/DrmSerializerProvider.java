      ...
      if (drm != null) {
        ...
        if (parties != null && !parties.isEmpty()) {
          ...
          for (Party party : parties) {
            partyBeans.add(
                new DrmPartyBean(
                    party.getUserID(), party.getName(), party.getEmail(), party.isOwner()));
          }
        ...
        final List<Triple<String, String, String>> restrictedToIpRanges =
            drm.getRestrictedToIpRanges();
        if (restrictedToIpRanges != null && !restrictedToIpRanges.isEmpty()) {
          ...
          for (Triple<String, String, String> triple : restrictedToIpRanges) {
            networkBeans.add(
                new DrmNetworkBean(triple.getFirst(), triple.getSecond(), triple.getThird()));
          }
