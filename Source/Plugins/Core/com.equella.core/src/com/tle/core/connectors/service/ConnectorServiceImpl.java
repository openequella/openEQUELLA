...
public class ConnectorServiceImpl
    extends AbstractEntityServiceImpl<ConnectorEditingBean, Connector, ConnectorService>
  ...
  @Inject private DefaultConnectorExtensionService defaultExtension;
  ...
  private synchronized Map<String, ConnectorTypeDescriptor> getTypeDescriptorMap() {
    if (typesTracker.needsUpdate() || typeDescriptorMap == null) {
      Map<String, ConnectorTypeDescriptor> tempTypeDescriptors =
          new HashMap<String, ConnectorTypeDescriptor>();
  ...
  @Override
  protected <SESSION extends EntityEditingSession<ConnectorEditingBean, Connector>>
  ...
  protected void populateEntity(ConnectorEditingBean conBean, Connector entity) {
    ...
    final ConnectorServiceExtension connectorExtension =
        getExtensionForConnector(conBean.getLmsType());
    connectorExtension.edit(entity, conBean);
  }

  @Override
  protected void saveTargetLists(
      EntityEditingSession<ConnectorEditingBean, Connector> session, EntityPack<Connector> pack) {
  ...
  public void setPluginService(PluginService pluginService) {
    typesTracker =
        new PluginTracker<ConnectorServiceExtension>(
            pluginService, "com.tle.core.connectors", "connectorType", "id");
