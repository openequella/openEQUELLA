...
/**
 * @author larry Note we are taking advantage of this class to also remove the obsolete loginnotice
 *     and freeetext privileges.
 */
@Bind
@Singleton
public class MergeOneClickSubmitAndVersionSelectionAclXmlMigrator
  ...
  public void migrate(AclPostReadMigratorParams list) {
    ...
    while (entries.hasNext()) {
      ...
      if (target.equals("C:loginnotice")
          || target.equals("C:oneClickSubmit")
          || target.equals("C:freetext")) {
        entries.remove();
