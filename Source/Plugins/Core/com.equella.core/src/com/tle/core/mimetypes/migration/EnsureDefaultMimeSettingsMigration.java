...
public class EnsureDefaultMimeSettingsMigration extends AbstractHibernateDataMigration {
  private static final String KEY_PREFIX =
      PluginServiceImpl.getMyPluginId(EnsureDefaultMimeSettingsMigration.class) + ".";
  ...
  protected void executeDataMigration(
    ...
    for (MimeEntry def : defaultTypes) {
      ...
      List<FakeMimeEntry> mimes =
          session
              .createQuery("FROM MimeEntry WHERE type = :type")
              .setParameter("type", def.getType())
              .list();

      Map<FakeInstitution, FakeMimeEntry> instMimeMap =
          new HashMap<FakeInstitution, FakeMimeEntry>();
