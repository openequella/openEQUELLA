...
public abstract class TaskOperation extends AbstractStandardWorkflowOperation {
  ...
  @Inject protected TaskStatisticsService taskStatsService;
  ...
  public void addModerationNotifications(
      ItemKey itemKey, Collection<String> users, String reason, boolean batched) {
    String collectionUuid = getItem().getItemDefinition().getUuid();

    Multimap<String, String> collectionOptOut =
        notificationPrefs.getOptedOutCollectionsForUsers(users);
