...
public class CheckInstitutionStorageQuotas implements ScheduledTask {
  ...
  public void execute() {
    ...
    if (!instsOverLimit.isEmpty()) {
      String subject =
          CurrentLocale.get(
              "com.tle.core.entity.services.institutions.warninglimitexceeded.subject");
  ...
  private String buildEmailMessage(List<Institution> insts) {
    ...
    if (insts.size() > 1) {
      emailMessage.append(
          CurrentLocale.get("com.tle.core.entity.services.institutions.warninglimitexceeded.text"));

    } else {
      emailMessage.append(
          CurrentLocale.get(
              "com.tle.core.entity.services.institutions.warninglimitexceeded.text.1"));
    }
    emailMessage.append("\n\n");
    for (Institution inst : insts) {
      ...
      emailMessage.append(
          CurrentLocale.get(
                  "com.tle.core.entity.services.institutions.warninglimitexceeded.currentusage")
              + " ");
      emailMessage.append(
