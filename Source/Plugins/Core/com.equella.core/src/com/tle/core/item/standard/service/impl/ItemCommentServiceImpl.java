...
public class ItemCommentServiceImpl implements ItemCommentService, UserChangeListener {
  ...
  @Inject private ItemCommentDao dao;
  ...
  @Override
  public ItemPack<Item> addComment(
      ItemKey itemId, final String commentText, final int rating, final boolean anonymous) {
  ...
  public ItemPack<Item> addComment(
    ...
    return itemService.operation(
        itemId,
        commentOpFactory.comment(rating, anonymous, commentText, userId),
        commentOpFactory.average(),
  ...
  public void deleteComment(ItemKey itemId, final String commentUuid) {
    itemService.operation(
        itemId,
        commentOpFactory.delete(commentUuid),
        commentOpFactory.average(),
        workflowFactory.reindexOnly(false));
  }
...
class UpdateAverageRatingOperation extends AbstractWorkflowOperation {
  ...
  public boolean execute() {
    ...
    final Map<String, Pair<Date, Integer>> userRatings =
        Maps.newHashMapWithExpectedSize(ratings.size());
