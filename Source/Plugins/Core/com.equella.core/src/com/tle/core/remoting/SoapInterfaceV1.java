...
public interface SoapInterfaceV1 {
   ...
   * </code></pre>
   *
   * If you leave a tag out, it will be assumed to be the default (usually null, 0 or false)<br>
   * <br>
   * select: Must be *<br>
   * If any other value is specified, only the system item metadata will be returned.<br>
   * <br>
