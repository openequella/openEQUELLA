...
public class PowerSearchServiceImpl
    extends AbstractEntityServiceImpl<EntityEditingBean, PowerSearch, PowerSearchService>
    implements PowerSearchService,
        SchemaReferences,
  ...
  public void removeReferences(ItemDefinition itemDefinition) {
    for (PowerSearch psearch :
        powerSearchDao.getPowerSearchesReferencingItemDefinition(itemDefinition)) {
  ...
  protected void doValidation(
      EntityEditingSession<EntityEditingBean, PowerSearch> session,
      PowerSearch entity,
