...
public interface WorkflowService
  ...
  /**
   * Returns a list of moderators for a given workflow item. This is useful in the case of unanimous
   * acceptance, where all users that must moderate this item. For this to succeed all the
   * moderators must be defined as a specific user or a group. There is currently no means to
   * determine all moderators if a role is specified, and <code>null</code> will be returned.
   */
