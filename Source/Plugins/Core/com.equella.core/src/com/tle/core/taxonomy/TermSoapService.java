...
public interface TermSoapService {
  /**
   * Before terms can be edited, this method must be invoked to aquire an editing lock on the
   * taxonomy. An error will be raised if the lock cannot be acquired, most likely because it has
   * already been locked by a different user.
   *
  ...
  /**
   * Unlock a taxonomy that you previously acquired a lock on. You can also choose to forcefully
   * unlock the taxonomy, which will remove any existing lock, even if it has been made by another
   * user. It is recommended that the force option is used with care.
   *
   * @param taxonomyUuid The UUID of the taxonomy that you have finished editing.
   * @param force true if the taxonomy should be unlocked, even if your session is not the lock
   *     owner. It is recommended that you should you used false in nearly all case.
   */
   ...
   * @return An array of immediate child terms, eg, [Tiger, Lion, Jaguar, Leopard]
   */
   ...
   *
   * <p>This method requires an editing lock to have been acquired for the taxonomy.
   *
   * @param taxonomyUuid The UUID of the taxonomy.
   * @param parentFullPath The full path of the parent term the new term will be added to, eg,
   ...
   *
   * @param taxonomyUuid The UUID of the taxonomy.
   * @param termFullPath The full path of the term to delete, eg, Mammalia\Felidae\Panthera\Tiger.
   */
   ...
   *
   * @param taxonomyUuid The UUID of the taxonomy.
   * @param termFullPath The full path of the term to retrieve the data for, eg,
