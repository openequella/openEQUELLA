...
public class IMSNavigationHelperImpl implements IMSNavigationHelper {
  ...
  @Override
  public Collection<Attachment> createTree(
  ...
  private void lineariseOrgs(
      IMSOrganisation org,
      ItemNavigationNode parent,
      Map<String, IMSResource> resources,
  ...
  private boolean lineariseItems(
      IMSItem imsitem,
      ItemNavigationNode parent,
      Map<String, IMSResource> resources,
      TreeCreationInfo treeInfo) {
    ...
    if (url != null) {
      ...
      for (IMSAttachmentExporter attachmentImporter : attachmentImporters.getBeanList()) {
        fattach =
            attachmentImporter.importAttachment(
                treeInfo.getItem(), res, treeInfo.getRootFolder(), treeInfo.getPackageFolder());
        if (fattach != null) {
          break;
        }
      }
  ...
  public static class TreeCreationInfo {
    ...
    protected TreeCreationInfo(
        Item item, String packageFolder, FileHandle root, boolean scorm, boolean expand) {
