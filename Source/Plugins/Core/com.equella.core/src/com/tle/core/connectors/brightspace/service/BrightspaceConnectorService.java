...
public interface BrightspaceConnectorService extends ConnectorRepositoryImplementation {
   ...
   * @return
   */
  BrightspaceQuicklink addQuicklink(
      Connector connector,
      String courseId,
  ...
  List<ConnectorFolder> getFoldersForCourse(
      Connector connector, @Nullable String username, String courseId, boolean management)
   ...
   * encrypt the one returned from Brightspace.
   *
   * @param token
   * @return
   */
