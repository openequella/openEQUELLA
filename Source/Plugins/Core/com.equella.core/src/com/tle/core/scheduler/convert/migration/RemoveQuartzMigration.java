...
public class RemoveQuartzMigration extends AbstractHibernateSchemaMigration {
  private static final String keyPrefix =
      PluginServiceImpl.getMyPluginId(RemoveQuartzMigration.class) + ".removequartz.";
  ...
  protected Class<?>[] getDomainClasses() {
    return new Class[] {
      FakeQrtzBlobTriggers.class,
      FakeQrtzCalendars.class,
      FakeQrtzCronTriggers.class,
      FakeQrtzFiredTriggers.class,
      FakeQrtzJobDetails.class,
      FakeQrtzJobListeners.class,
      FakeQrtzLocks.class,
      FakeQrtzPausedTriggerGrps.class,
      FakeQrtzSchedulerState.class,
      FakeQrtzSimpleTriggers.class,
      FakeQrtzTriggerListeners.class,
      FakeQrtzTriggers.class,
  ...
  protected void executeDataMigration(
    ...
    session
        .createSQLQuery("DELETE FROM configuration_property WHERE property LIKE 'scheduler.jobs.%'")
        .executeUpdate();
