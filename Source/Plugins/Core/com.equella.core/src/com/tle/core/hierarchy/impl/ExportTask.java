...
public class ExportTask extends SingleShotTask {
  ...
  @Inject
  public ExportTask(
      @Assisted UserState userState, @Assisted long exportId, @Assisted boolean withSecurity) {
  ...
  void doExport() throws IOException {
    ...
    fileSystemService.write(
        staging, "topic.xml", new StringReader(hierarchyService.getXStream().toXML(nodes)), false);
    ...
    addLogEntry(
        URLUtils.newURL(
            instituionService.getInstitutionUrl(),
