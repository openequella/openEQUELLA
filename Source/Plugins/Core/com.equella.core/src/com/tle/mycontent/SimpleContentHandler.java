...
public abstract class SimpleContentHandler<S extends ContentHandlerSection>
  ...
  protected abstract void doAddCrumbs(
      S section, SectionInfo info, Decorations decorations, Breadcrumbs crumbs);
  ...
  public HtmlLinkState decorate(SectionInfo info, StandardItemListEntry itemEntry) {
    ...
    if (!item.getAttachments().isEmpty()) {
      ...
      return processLink(
          info, new HtmlLinkState(itemEntry.getTitleLabel(), viewable.createCanonicalUrl()));
    }
    return null;
  }
