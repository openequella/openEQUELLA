...
public class ScrapbookSoapServiceImpl implements ScrapbookSoapService {
  ...
  public String create(
    ...
    if (resourceType == null
        || !(resourceType.equals("myresource") || resourceType.equals("mypages"))) {
  ...
  public String update(
      String itemUuid, String title, String keywords, String filename, String base64Data) {
