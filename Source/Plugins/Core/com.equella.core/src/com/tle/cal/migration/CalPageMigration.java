...
public class CalPageMigration extends XmlMigrator {
  ...
  public void execute(
    ...
    for (String entry : entries) {
      ...
      PropBagEx page =
          xml.getSubtree("slow/wizard/pages/com.dytech.edge.wizard.beans.CALPage"); // $NON-NLS-1$
      if (page != null) {
        ...
        addAttribute(
            attrs,
            "com.tle.cal-ActivationError", //$NON-NLS-1$
            getLanguageBundleXmlAsLangString(page.getSubtree("error"))); // $NON-NLS-1$
        addAttribute(
            attrs,
            "com.tle.cal-InactiveError", //$NON-NLS-1$
        ...
        addAttribute(
            attrs,
            "com.tle.cal-AgreementFile",
            page.getNode("agreement")); // $NON-NLS-1$ //$NON-NLS-2$
