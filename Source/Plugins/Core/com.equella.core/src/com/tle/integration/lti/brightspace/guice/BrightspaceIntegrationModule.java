...
public class BrightspaceIntegrationModule extends SectionsModule {
  ...
  protected void configure() {
    bind(Object.class)
        .annotatedWith(Names.named("/brightspacenavbar"))
        .toProvider(new BrightspaceSignonNodeProvider(BrightspaceSignon.SESSION_TYPE_NAVBAR));
    bind(Object.class)
        .annotatedWith(Names.named("/brightspacequicklink"))
        .toProvider(new BrightspaceSignonNodeProvider(BrightspaceSignon.SESSION_TYPE_QUICKLINK));
    bind(Object.class)
        .annotatedWith(Names.named("/brightspacecoursebuilder"))
        .toProvider(
            new BrightspaceSignonNodeProvider(BrightspaceSignon.SESSION_TYPE_COURSEBUILDER));
    bind(Object.class)
        .annotatedWith(Names.named("/brightspaceinsertstuff"))
