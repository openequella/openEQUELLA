...
public class BlackboardLtiSessionData implements IntegrationSessionData
{
	...
	public BlackboardLtiSessionData(HttpServletRequest request)
	{
		...
		bbData = request.getParameter("data");
	}
	...
	public String toString() {
		return "selectionDirective=" + selectionDirective +
			", action=" + action +
			", extContentIntendedUse=" + extContentIntendedUse +
			", extContentReturnUrl=" + extContentReturnUrl +
			", launchPresentationLocale=" + launchPresentationLocale +
