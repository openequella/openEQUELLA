...
public class BlackboardLtiIntegration extends AbstractIntegrationService<BlackboardLtiSessionData>
{
	...
	@Inject
	private BlackboardConnectorService bbService;
	@Inject
...
//				courseCodes.add(ltiData.getContextLabel());
	...
	@Nullable
	@Override
	public SelectionSession setupSelectionSession(SectionInfo info, BlackboardLtiSessionData data, SelectionSession session,
...
//					TODO impl
//					bbService.addItemToCourse(connector, CurrentUser.getUsername(), courseId, moduleId, item,
//						resource);
