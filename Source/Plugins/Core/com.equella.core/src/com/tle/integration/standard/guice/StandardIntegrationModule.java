...
public class StandardIntegrationModule extends AbstractModule {
  ...
  protected void configure() {
    bind(Object.class)
        .annotatedWith(Names.named("com.tle.integration.standard.IntegrationPackDownload"))
        .to(IntegrationPackDownload.class);
    bind(Object.class)
        .annotatedWith(Names.named("com.tle.integration.standard.ActiveCacheToolDownload"))
        .to(ActiveCacheToolDownload.class);
    bind(Object.class)
        .annotatedWith(Names.named("com.tle.integration.standard.HTMLPluginsDownload"))
        .to(HTMLPluginsDownload.class);
  }
