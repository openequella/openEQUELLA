...
public final class LuceneConstants {
  /**
   * As most Lucene methods now require a version to be passed in and Version.LUCENE_CURRENT is now
   * deprecated this allows us to change the version in one simple location
   */
