...
public class IndexedItem {
  ...
  public List<Fieldable> queryACLEntries(Object domainObject, String privilege, String prefix) {
    ...
    for (ACLEntryMapping entry : allEntriesForObject) {
      ...
      boolean all =
          entry.getExpression().equals(SecurityConstants.getRecipient(Recipient.EVERYONE));
      ...
      fields.add(
          AbstractIndexingExtension.keyword(
              prefix + entry.getId(), String.format("%03d%c", i, grant))); // $NON-NLS-1$
