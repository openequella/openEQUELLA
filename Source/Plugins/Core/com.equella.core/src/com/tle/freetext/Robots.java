 ...
 * accessed on a server. Eg. http://www.google.com/robots.txt <code>
 * User-agent:
 * Disallow: /search
 * Disallow: /groups
 * Disallow: /images
 ...
 * ...
 * </code> This indicates that any paths beginning with the above paths are NOT allowed to be
 * searched by robots (such as our FreeText indexer). As that is required by this class is to call
 * the @see #isAllowed(String) method which will return true or false for a given path residing on
 * the server is allowed to be indexed.
 *
 * @author cofarrell
 */
public class Robots {
  ...
  /**
   * Determines from the Disallow and Allow properties of a robots file whether a given path is
   * allowed to be searched by a robot.
   *
   * @param path
