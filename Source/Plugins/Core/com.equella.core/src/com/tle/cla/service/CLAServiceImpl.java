...
@Singleton
public class CLAServiceImpl extends AbstractCopyrightService<CLAHolding, CLAPortion, CLASection>
    implements CLAService {
  ...
  public void validateHolding(CLAHolding holding) {
    ...
    if (!valid) {
      LanguageBundle calError =
          LangUtils.getBundleFromXmlString(
              holding
                  .getItem()
                  .getItemDefinition()
                  .getAttributes()
                  .get(CLAConstants.ACTIVATIONERROR));
