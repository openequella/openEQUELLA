...
public class RestStringsModule extends SimpleModule {
  ...
  public static class StringDeserializer extends JsonDeserializer<SimpleI18NString> {
    @Override
    public SimpleI18NString deserialize(JsonParser jp, DeserializationContext ctxt)
  ...
  public static class StringsDeserializer extends JsonDeserializer<I18NStrings> {
    @Override
    public I18NStrings deserialize(JsonParser jp, DeserializationContext ctxt)
        throws IOException, JsonProcessingException {
      ...
      while (jp.nextToken() == JsonToken.FIELD_NAME) {
        ...
        LanguageString tempLangString =
            LangUtils.createLanguageString(tempBundle, CurrentLocale.getLocale(), textValue);
  ...
  public static class StringSerializer extends JsonSerializer<I18NString> {
    @Override
    public void serialize(I18NString value, JsonGenerator jgen, SerializerProvider provider)
        throws IOException, JsonProcessingException {
  ...
  public static class StringsSerializer extends JsonSerializer<I18NStrings> {
    ...
    @Override
    public void serialize(I18NStrings value, JsonGenerator jgen, SerializerProvider provider)
        throws IOException, JsonProcessingException {
