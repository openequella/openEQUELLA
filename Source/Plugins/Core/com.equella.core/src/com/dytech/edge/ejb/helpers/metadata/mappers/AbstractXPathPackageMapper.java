...
public abstract class AbstractXPathPackageMapper implements PackageMapper {
  ...
  public void mapMetadata(
      ItemDefinition itemdef, PropBagEx item, FileHandle handle, String packageName) {
  ...
  protected abstract InputStream getXmlStream(FileHandle handle, String packageName)
      throws IOException;
}
