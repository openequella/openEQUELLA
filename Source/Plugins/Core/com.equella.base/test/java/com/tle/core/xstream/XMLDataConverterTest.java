...
public class XMLDataConverterTest extends TestCase {
  ...
  public void testCollectionAdvanced() throws MalformedURLException {
    ...
    mappings.addNodeMapping(
        new CollectionMapping("collection", xpath, ArrayList.class, new URLMapping("", "")));
    getBean();
    assertEquals(2, bean.collection.size());
  ...
  public void testCollectionBlank() {
    ...
    mappings.addNodeMapping(
        new CollectionMapping("collection", xpath, ArrayList.class, new NodeMapping("", "")));
    getBean();
    assertEquals(2, bean.collection.size());
  ...
  public void testCollectionSuperDuperAdvanced() {
    ...
    mappings.addNodeMapping(
        new CollectionMapping(
            "collection", xpath, ArrayList.class, new DataMapping("", "", TestBean2.class)));
    getBean();
    assertEquals(2, bean.collection.size());
  ...
  public void testBasicDataMap() {
    ...
    mappings.addNodeMapping(
        new DataMapMapping("map", "datamap", "data/key/data", "data/value", TestBean2.class));
  ...
  public void testDataMap() {
    ...
    mappings.addNodeMapping(
        new DataMapMapping(
            "map", "datamap", "data/key", "data/value", TestBean2.class, TestBean2.class));
  ...
  public void testTypeMap() {
    ...
    mappings.addNodeMapping(
        new ListMapping(
            ...
            "types/type",
            ArrayList.class,
            new NodeTypeMapping("", "", map, new Integer(4))));
    getBean();
