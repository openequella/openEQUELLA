...
case class BasicDetails(sectionTitle: String,
                        title: String,
...
case class MetaDisplay(title: String,
                       value: String,
                       fullWidth: Boolean,
                       `type`: String)

case class DisplayNodesSummarySection(sectionTitle: String,
                                      meta: Iterable[MetaDisplay])
    extends ItemSummarySection {
...
case class BookSummary(totalPages: Int, chapters: Iterable[BookChapter])
