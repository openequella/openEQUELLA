...
public class NodeInQuery extends NodeIsBlankQuery {
  ...
  public NodeInQuery(
      Collection<String> values, boolean not, Collection<String> fields, String displayName) {
    super(not, fields);
    this.values = values;
  ...
  public String getCriteriaText() {
    final String orWithSpace =
        " " + CurrentLocale.get("com.tle.core.entity.services.query.or") + " ";
    ...
    return CurrentLocale.get(
        "com.tle.core.entity.services.query.contains",
        fieldName,
