...
public class PluginServiceImpl extends AbstractPluginService implements PrivatePluginService {
  ...
  private final Map<String, PrivatePluginBeanLocator> lookups =
      new HashMap<String, PrivatePluginBeanLocator>();
        ...
        new TimerTask() {
          ...
          public void run() {
            try {
              ...
              final Set<TLEPluginLocation> plugins =
                  new HashSet<TLEPluginLocation>(scanPluginFolders(pluginFolders));
  ...
  private Collection<TLEPluginLocation> scanPluginFolders(Collection<String> pluginFolders)
      throws Exception {
  ...
  private void scanPluginFolder(File folder, Map<String, TLEPluginLocation> plugins)
      throws Exception {
      ...
      if (file.isDirectory()) {
        ...
        if ((hasJpf != null && hasJpf) || IoUtil.isResourceExists(manFile)) {
          ...
          TLEPluginLocation location =
              new TLEPluginLocation(info, filename, version, context, manFile);
  ...
  public void ensureBeanLocators(Collection<? extends PrivatePluginBeanLocator> beanLocators) {
    ...
    while (true) {
      ...
      List<AbstractBeanLocatorCallable<?>> callableList =
          new ArrayList<AbstractBeanLocatorCallable<?>>();
