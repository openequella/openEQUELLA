...
public class FreeTextDateQuery extends FreeTextQuery {
  ...
  public FreeTextDateQuery(
      String field, TleDate start, TleDate end, boolean includeStart, boolean includeEnd) {
  ...
  public boolean equals(Object obj) {
    if (obj == null || !(obj instanceof FreeTextDateQuery)) {
      ...
      return includeStart == rhs.includeStart
          && includeEnd == rhs.includeEnd
          && Objects.equals(field, rhs.field)
