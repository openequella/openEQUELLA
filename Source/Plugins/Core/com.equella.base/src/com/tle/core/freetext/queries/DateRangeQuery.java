...
public class DateRangeQuery extends BaseQuery {
  ...
  @Nullable private final TleDate start;
  @Nullable private final TleDate end;
  ...
  public String getCriteriaText() {
    ...
    if (start == null && end == null) {
      ...
      return CurrentLocale.get(
          "com.tle.core.entity.services.query.date.before", fieldName, format(end));
    } else if (end == null) {
      return CurrentLocale.get(
          "com.tle.core.entity.services.query.date.after", fieldName, format(start));
    }
    return CurrentLocale.get(
        "com.tle.core.entity.services.query.date.between", fieldName, format(start), format(end));
  }
