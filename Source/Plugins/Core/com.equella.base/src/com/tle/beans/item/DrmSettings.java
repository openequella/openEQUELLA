...
public class DrmSettings extends EntityCloneable implements Serializable {
  ...
  /**
   * This value serves as an alternative to null or empty values in cases where no DRM Page exists,
   * but DRM settings have been applied via a manual custom script.
   */
  public static final String CUSTOM_SCRIPTED_DRMSETTINGS_PAGE_PLACEHOLDER =
      "CustomScriptedDrmSettings";
  ...
  /**
   * These are the standard elements for ODRL. Simply toString().toLowerCase() for the xml element
   * name.
   */
  public enum Usage {
    DISPLAY,
  ...
  /**
   * A security rule-style expression indicating whom has to accept this DRM license. Null indicates
   * everyone.
   */
  @Lob
  @Column(name = "raf")
