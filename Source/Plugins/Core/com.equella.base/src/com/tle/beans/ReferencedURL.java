...
public class ReferencedURL implements Serializable {
  ...
  public static final Predicate<ReferencedURL> BAD_URLS =
      new Predicate<ReferencedURL>() {
        @Override
  ...
  @NotNull private int tries = 0;

  @NotNull private Date lastChecked;
  @NotNull private Date lastIndexed;
