...
public class ZipAttachment extends Attachment {
  ...
  /**
   * For zip attachments, make use of value2 to hold boolean flag as to whether the zip file itself
   * is attached to an item (as distinct from or as well as attaching the zip's contents). Require
   * the user to particularly specify that they want an actual true or false
   */
