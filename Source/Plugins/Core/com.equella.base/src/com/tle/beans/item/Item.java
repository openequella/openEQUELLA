...
public class Item implements Serializable, IdCloneable, FieldEquality<Item>, IItem<Attachment> {
  ...
  @Transient @XStreamOmitField private boolean newItem;

  @Deprecated @Lob private String curricula;
  ...
  @Embedded private NavigationSettings navigationSettings = new NavigationSettings();
