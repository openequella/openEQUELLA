...
public class Institution implements Serializable {
  ...
  /**
   * This is the ID used in the database. It is **NOT** necessarily unique for institutions across
   * different schemas.
   */
  @Id @GeneratedValue private long id;

  /**
   * This ID is guaranteed to be unique across schemas and is safe for use in maps, sets, etc... It
   * may be changed when an institution is taken online/offline.
   */
  ...
  /**
   * Can't remove this because it is XStreamed in the root of institution exports ->
   * institutionData.xml
   */
  @Transient
  @Deprecated
