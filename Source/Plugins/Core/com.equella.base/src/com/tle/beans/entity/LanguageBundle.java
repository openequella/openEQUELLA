...
public class LanguageBundle implements Serializable, IdCloneable {
  ...
  public static LanguageBundle edit(
      LanguageBundle orig, LanguageBundle newBundle, DeleteHandler deleteHandler) {
    if (orig == null) {
      if (newBundle != null) {
        newBundle.setId(0);
      }
  ...
  // TODO: maybe refactor...
  public static LanguageBundle edit(
      LanguageBundle orig, LanguageBundleBean newBundle, DeleteHandler deleteHandler) {
    if (orig == null) {
      if (newBundle != null) {
        newBundle.setId(0);
      }
