...
public interface NotificationResource {
  ...
  public Response notificationsSearch(
      ...
      @ApiParam(
              value = "The filter to apply to the notifications list",
              required = false,
              allowableValues = "all,wentlive,rejected,badurl,watchedwentlive,overdue",
              defaultValue = "all")
          @QueryParam("type")
          String searchFilter,
  ...
  public Response delete(
      ...
      @ApiParam(
              value = "Whether or not to wait for the item to be indexed before returning",
              defaultValue = "false")
          @QueryParam("waitforindex")
