...
/**
 * You will only need to use it if displaying a localised date to the user, and only when not using
 * Freemarker, as FreemarkerSectionResult ensures the localising transformation.
 *
 * @author aholland
 */
@NonNullByDefault
public class LocalDate extends UtcDate {
  ...
  /**
   * @param localString
   * @param dateFormat Note that if dateFormat contains a timezone, that will be used to parse the
   *     date into utc, not the zone you supply.
   * @param zone The zone to transform the localString with into utc, also used when formatting this
   *     date
