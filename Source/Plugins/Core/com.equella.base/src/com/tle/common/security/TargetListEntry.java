...
public class TargetListEntry implements Serializable, FieldEquality<TargetListEntry> {
  ...
  public TargetListEntry(
      boolean granted, boolean override, String privilege, String who, String postfix) {
  ...
  public boolean checkFields(TargetListEntry rhs) {
    return granted == rhs.granted
        && override == rhs.override
        && Objects.equals(privilege, rhs.privilege)
        && Objects.equals(who, rhs.who)
        && Objects.equals(postfix, rhs.postfix);
  }
