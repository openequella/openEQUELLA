...
public final class SecurityConstants {
  ...
  public static final String EDIT_TAXONOMY = "EDIT_TAXONOMY";
  ...
  public static final String DELETE_VIRTUAL_BASE =
      "DELETE_" + SecurityConstants.VIRTUAL_BASE_ENTITY;
  ...
  @Deprecated public static final String TARGET_BASEENTITY = "B";
  @Deprecated public static final String TARGET_SYSTEM_SETTING = "C";
  @Deprecated public static final String TARGET_ITEM_STATUS = "S";
  @Deprecated public static final String TARGET_ITEM_METADATA = "M";
  @Deprecated public static final String TARGET_DYNAMIC_ITEM_METADATA = "X";
  @Deprecated public static final String TARGET_ITEM = "I";
  @Deprecated public static final String TARGET_WORKFLOW_TASK = "T";
  @Deprecated public static final String TARGET_HIERARCHY_TOPIC = "H";
  @Deprecated public static final String TARGET_WORKFLOW_DYNAMIC_TASK = "D";
  ...
  public static String getRecipient(Recipient r) {
    if (!r.isStandalone()) {
      throw new IllegalArgumentException(
          "Only recipients that are 'standalone' may use this method");
    }
    return r.getPrefix();
  }
