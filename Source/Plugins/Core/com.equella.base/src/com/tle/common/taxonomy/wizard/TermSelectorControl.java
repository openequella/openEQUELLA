...
public class TermSelectorControl extends CustomControl {
  ...
  private static final String KEY_SELECTION_RESTRICTION =
      "KEY_SELECTION_RESTRICTION"; //$NON-NLS-1$
  ...
  public SelectionRestriction getSelectionRestriction() {
    return get(
        KEY_SELECTION_RESTRICTION, SelectionRestriction.class, SelectionRestriction.UNRESTRICTED);
  }
