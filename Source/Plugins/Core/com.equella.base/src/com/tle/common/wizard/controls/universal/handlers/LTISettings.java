...
public class LTISettings extends UniversalSettings {
  ...
  public List<LTICustomised> getLTIs() {
    List<Pair<String, Map<String, String>>> persistedObj =
        (List<Pair<String, Map<String, String>>>) wrapped.getAttributes().get(KEY_EXTTOOLS);
  ...
  public void setLTIs(List<LTICustomised> ltiCustomised) {
    if (Check.isEmpty(ltiCustomised)) {
      ...
      List<Pair<String, Map<String, String>>> persistObj =
          new ArrayList<Pair<String, Map<String, String>>>();
      for (LTICustomised ltiCust : ltiCustomised) {
        persistObj.add(
            new Pair<String, Map<String, String>>(ltiCust.getUuid(), ltiCust.getCustomParams()));
      }
  ...
  /**
   * On adding an LTI to an itemDefinition, we allow the collection designer to add custom
   * parameters to the LTI, being of the form Name/Value
   *
   * @author larry
   */
  public static final class LTICustomised implements Serializable {
    ...
    public boolean equals(Object obj) {
      ...
      return (this.uuid.equals(rhs.getUuid())
          && this.getCustomParams().equals(rhs.getCustomParams()));
    }
