...
public interface SystemScriptObject {
  ...
  /**
   * Executes a program without waiting for it finish. There is no indication of when the program
   * completes or if it was successful.
   *
   * @param programPath The full path to an executable program or script.
   * @param parameters An array of command line parameters to send to the executable program at
   *     programPath. The parameters can contain String, AttachmentScriptType and
   *     FileHandleScriptType objects.
   */
  void executeInBackground(String programPath, Object[] parameters);

  /**
   * Executes a program and retrieves the console output as well as any error codes returned by the
   * program.
   *
   * @param programPath The full path to an executable program or script.
   * @param parameters An array of command line parameters to send to the executable program at
   *     programPath. The parameters can contain String, AttachmentScriptType and
   *     FileHandleScriptType objects.
   * @return An ExecutionResult object with the output of the standard and error streams
   */
