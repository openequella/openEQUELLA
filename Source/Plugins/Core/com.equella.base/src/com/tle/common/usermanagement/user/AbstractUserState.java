...
/**
 * This class also effectively implements ModifiableUserState, but we don't want to mention this so
 * that user states such as the AnonymousUserState can use this, but not be modifiable.
 *
