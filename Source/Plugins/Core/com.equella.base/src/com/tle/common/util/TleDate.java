...
public interface TleDate extends Serializable, Comparable<TleDate> {
  ...
  /**
   * I'd argue strongly that there is no such thing. 'Conceptual' means that this date is just
   * storing a day/month/year value and shouldn't be used as an actionable date (who's date is it??)
   *
   * @return
   */
