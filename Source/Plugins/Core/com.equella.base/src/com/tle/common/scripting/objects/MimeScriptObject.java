...
public interface MimeScriptObject extends ScriptObject {
  ...
  /**
   * Get at MimeTypeScriptType for the given filename (will read the extension on the filename to
   * determine the MIME type)
   *
   * @param filename The name of the file
   * @return A MimeTypeScriptType object, or null if the mime type could not be determined.
   */
