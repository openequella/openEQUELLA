...
public final class DateHelper {
  ...
  public static List<NameValue> getTimeZoneNameValues(
      @Nullable NameValue defaultEntry, boolean includeUTCAtTop) {
    final List<NameValue> zones =
        Lists.newArrayList(
            Lists.transform(
                getTimeZoneIds(),
                  ...
                  public NameValue apply(String zone) {
                    ...
                    String gmtTZ =
                        String.format(
                            "(UTC%s%02d:%02d) ",
                            rawOff < 0 ? "-" : "+",
                            Math.abs(rawOff) / 3600000,
                            Math.abs(rawOff) / 60000 % 60);
