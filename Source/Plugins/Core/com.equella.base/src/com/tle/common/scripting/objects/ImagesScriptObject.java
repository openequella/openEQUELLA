...
public interface ImagesScriptObject extends ScriptObject {
   ...
   * @throws IOException If there were problems getting the dimensions of the image, e.g. there is
   *     no file at path or the image was in an unrecognised format.
   */
   ...
   * @throws IOException If there were problems resizing the image, e.g. there is no file at path or
   *     the image was in an unrecognised format.
   */
