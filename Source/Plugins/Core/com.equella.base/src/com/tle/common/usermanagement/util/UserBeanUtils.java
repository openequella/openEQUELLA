...
public final class UserBeanUtils {
  ...
  public static NameValue getUser(RemoteUserService userService, String uuid) {
    ...
    if (user == null) {
      user =
          new NameValue(
              CurrentLocale.get("com.dytech.edge.admin.helper.utils.unknownuser", uuid), uuid);
    }
  ...
  public static NameValue getGroup(RemoteUserService userService, String uuid) {
    ...
    if (group == null) {
      group =
          new NameValue(
              CurrentLocale.get("com.dytech.edge.admin.helper.utils.unknowngroup", uuid), uuid);
    }
  ...
  public static NameValue getRole(RemoteUserService userService, String uuid) {
    ...
    if (role == null) {
      role =
          new NameValue(
              CurrentLocale.get("com.dytech.edge.admin.helper.utils.unknownrole", uuid), uuid);
    }
