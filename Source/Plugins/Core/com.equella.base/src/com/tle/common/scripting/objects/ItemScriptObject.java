...
public interface ItemScriptObject extends ScriptObject {
  ...
  /**
   * Gets an item with the supplied uuid and version, or returns null if no item with the supplied
   * uuid and version can be found.
   *
  ...
  /**
   * Gets the latest version of the item (not necessarily the Live version) with the supplied uuid,
   * or null if no item with supplied uuid can be found.
   *
   * @param uuid The UUID of the item to get
   * @return The item object or null if not found.
   */
  ...
  /**
   * Gets the Live version of the item with the supplied uuid, or null if no item with supplied uuid
   * can be found.
   *
