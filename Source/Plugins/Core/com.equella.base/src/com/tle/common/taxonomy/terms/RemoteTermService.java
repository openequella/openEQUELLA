...
public interface RemoteTermService
{
	 ...
	 * @return The list the immediate child terms, eg, [Tiger, Lion, Jaguar,
	 *         Leopard]
	 */
	 ...
	 * <p>
	 * This method requires an editing lock to have been aquired for the
	 * taxonomy.
	 * 
	 * @param taxonomy The taxonomy the terms are being edited for.
	 * @param parentFullPath The full path of the parent term the new term will
	 ...
	 * @return The full path of the new term (may have been slightly
	 *         adjusted/fixed)
	 */
	...
	void updateTerm(Taxonomy taxonomy, String termUuid, String moveToParent, int index, String newValue);
	 ...
	 * 
	 * @param taxonomy The taxonomy the terms are being edited for.
	 * @param fullTermPath The full path of the term to delete, eg,
	 ...
	 * 
	 * @param taxonomy The taxonomy the terms are being edited for.
	 * @param fullTermPath The full path of the term to retrieve the data for,
	...
	/**
	 * Set an arbitrary data for a key against a term This method requires an
	 * editing lock to have been aquired for the taxonomy.
	 * 
	 * @param taxonomy
	 * @param termUuid
	 * @param dataKey
