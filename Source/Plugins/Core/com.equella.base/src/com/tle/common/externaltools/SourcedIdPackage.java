...
public class SourcedIdPackage {
  ...
  public static class SrcdIdPkgSerializer implements JsonSerializer<SourcedIdPackage> {
    ...
    public JsonElement serialize(
        SourcedIdPackage src, Type typeOfSrc, JsonSerializationContext context) {
    ...
    public SourcedIdPackage deserialize(JsonElement j) {
      ...
      String lmsSourcedId =
          jsonObject.get(LMS_SOURCED_ID) != null
              ? jsonObject.get(LMS_SOURCED_ID).getAsString()
              : null;
      String lmsOutcomeServiceUrl =
          jsonObject.get(LMS_OUTCOME_SERVICE_URL) != null
              ? jsonObject.get(LMS_OUTCOME_SERVICE_URL).getAsString()
              : null;
      String lmsOauthConsumerKey =
          jsonObject.get(LMS_OAUTH_CONSUMER_KEY) != null
              ? jsonObject.get(LMS_OAUTH_CONSUMER_KEY).getAsString()
              : null;
