...
public final class ExternalToolConstants {
  // ACLs
  public static final String PRIV_EDIT_TOOL = "EDIT_EXTERNAL_TOOL";
  public static final String PRIV_DELETE_TOOL = "DELETE_EXTERNAL_TOOL";
  public static final String PRIV_CREATE_TOOL = "CREATE_EXTERNAL_TOOL";
  ...
  /**
   * The value for "roles" parameter, recommended to be a comma-separated list of URN values for
   * roles, in this case a single URN.
   */
  ...
  public static final Set<String> INSTRUCTOR_ROLES_SET =
      Sets.newHashSet(INSTRUCTOR_CONTEXT_ROLE_URN, INSTRUCTOR_ROLE, INSTRUCTOR_ROLE_URN);
  ...
  /** not required by LTI, but moodle likes to send some, so we may as well pass them on */
  ...
  public static final String TOOL_CONSUMER_INSTANCE_CONSUMER_CONTACT_EMAIL =
  ...
  public static final String LTI_MESSAGE_TYPE_VALUES =
      BASIC_LTI_LAUNCH_REQUEST
          + ","
          + TOOL_PROXY_REGISTRATION_REQUEST
          + ","
          + TOOL_PROXY_REREGISTRATION_REQUEST;
