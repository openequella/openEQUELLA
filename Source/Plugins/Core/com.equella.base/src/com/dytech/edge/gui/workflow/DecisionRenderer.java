...
public class DecisionRenderer extends SerialRenderer {
  ...
  public void draw(Graphics g, Rectangle bounds) {
    ...
    drawLeadingOutArrow(
        g, centreX, bounds.y + bounds.height - HALF_ARROW_HEIGHT, HALF_ARROW_HEIGHT);
    ...
    int[] pointsY = {
      diamondTop, diamondTop + halfDiamondY, diamondTop + DIAMOND_SIZE, diamondTop + halfDiamondY
    };
