...
/**
 * Visit every node of a PropBagEx (including attributes if desired) and invoke a callback on the
 * node.
 *
 * @author aholland
 */
public class PropBagWalker {
  ...
  private void doNode(
      final Node node, final boolean visitAttributes, final NodeVisitorCallback callback) {
