...
import com.tle.admin.taxonomy.tool.internal.InternalDataSourceTab;
...
public class SqlConnectionAndQueryPanel extends JPanel implements Changeable {
  ...
  public SqlConnectionAndQueryPanel(ClientService clientService) {
    ...
    queryLWV =
        new ListWithView<QueryState, ListWithViewInterface<QueryState>>(false, false) {
          @Override
  ...
  private final TLEAction testConnection =
      new TLEAction(s("testconnection")) {
        @Override
          ...
          GlassSwingWorker<?> worker =
              new GlassSwingWorker<Object>() {
                ...
                public Object construct() throws Exception {
                  clientService
                      .getService(RemoteRemoteSqlQueryingService.class)
                      .testConnection(getDriverClass(), getJdbcUrl(), getUsername(), getPassword());
                  return null;
                }
                ...
                public void finished() {
                  JOptionPane.showMessageDialog(
                      getComponent(),
                      s("testconnection.success.message"),
                      s("testconnection.success.title"),
