  ...
  private static class UserGroupPanel extends JPanel implements ActionListener {
    ...
    private void createGui() {
      ...
      final String searchText =
          CurrentLocale.get("com.dytech.edge.admin.helper.usergroupdialog.search");
      ...
      tabs.addTab(
          CurrentLocale.get("com.dytech.edge.admin.helper.usergroupdialog.selectuser"),
          createTab("user", userQuery, userSearch, userList));
      tabs.addTab(
          CurrentLocale.get("com.dytech.edge.admin.helper.usergroupdialog.selectgroup"),
