...
public class IMSMapping
    extends AbstractTableMapping<com.tle.beans.entity.itemdef.mapping.IMSMapping> {
  private static final long serialVersionUID = 1L;
  private static final String TOP_NODE_NAME = "imspackage"; // $NON-NLS-1$
  private static final String[] COLUMN_NODE_NAMES =
      new String[] {
        "ims",
        "itemdef",
        "@type", //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
        "@replace"
      }; //$NON-NLS-1$
  ...
  public String toString() {
    return CurrentLocale.get(
        "com.tle.admin.itemdefinition.mapping.imsmapping.title"); //$NON-NLS-1$
  }
  ...
  public void add() {
    model.addRow(
        new Object[] {
          ...
          "", //$NON-NLS-1$ //$NON-NLS-2$
          CurrentLocale.get(
              "com.tle.admin.itemdefinition.mapping.imsmapping.simple"), //$NON-NLS-1$
          Boolean.FALSE
        });
  }
  ...
  protected String[] getColumnNames() {
    return new String[] {
      CurrentLocale.get("com.tle.admin.itemdefinition.mapping.imsmapping.package"), // $NON-NLS-1$
      ...
      CurrentLocale.get("com.tle.admin.itemdefinition.mapping.imsmapping.replace")
    }; //$NON-NLS-1$
  }
  ...
  protected TableCellEditor getCellEditor(int column) {
    ...
    if (column == 0) {
      ...
      cell = scell;
      scell.addCellEditedListener(
          new SchemaCellEditor.CellEditedListener() {
            @Override
              ...
              new JComboBox(
                  new String[] {
                    CurrentLocale.get(
                        "com.tle.admin.itemdefinition.mapping.imsmapping.simple"), //$NON-NLS-1$
                    CurrentLocale.get(
                        "com.tle.admin.itemdefinition.mapping.imsmapping.repeating"), //$NON-NLS-1$
                    CurrentLocale.get("com.tle.admin.itemdefinition.mapping.imsmapping.compound")
                  })); //$NON-NLS-1$
    } else if (column == 3) {
  ...
  @Override
  protected Collection<com.tle.beans.entity.itemdef.mapping.IMSMapping> getMappings(
  ...
  protected Object getNode(Object data, int column) {
    com.tle.beans.entity.itemdef.mapping.IMSMapping mapping =
        (com.tle.beans.entity.itemdef.mapping.IMSMapping) data;
    Object val = null;
    if (column == 0) {
      val = mapping.getIms();
    } else if (column == 1) {
