...
public class LDAPDirectoryTree extends JTree implements TreeExpansionListener
{
	...
	public void reload()
	{
		...
		{
			Driver.displayError(this, getKey("ldap.general.error"),
				getKey("ldap.general.check"), e);
		}
	...
	public void treeExpanded(TreeExpansionEvent event)
	{
		...
		if( !t.isUpdated() )
		{
			GlassSwingWorker<?> worker = new GlassSwingWorker<Object>()
			{
				...
				{
					Driver.displayError(getComponent(), getKey("ldap.general.error"),
						getKey("ldap.general.check"), getException());
				}
			};
