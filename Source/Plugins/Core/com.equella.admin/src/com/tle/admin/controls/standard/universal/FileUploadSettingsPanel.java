...
public class FileUploadSettingsPanel extends UniversalControlSettingPanel {
  ...
  public FileUploadSettingsPanel() {
    ...
    restrictMime.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            updateGui();
    ...
    restrictFileSize.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            updateGui();
  ...
  private static List<NameValue> getMimeTypeNames() {
    ...
    RemoteMimetypeService mimeService =
        Driver.instance().getClientService().getService(RemoteMimetypeService.class);
