...
public class CitationsTab extends BaseEntityTab<Schema>
  ...
  private void setupGUI() {
    ...
    final int[] rows = {
      height1, height1, TableLayout.FILL,
    };
    final int[] cols = {
  ...
  public class TransformCellEditor extends AbstractCellEditor
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == button) {
        ...
        final DialogResult result =
            DialogUtils.openDialog(getComponent(), null, FileFilterAdapter.XSLT(), null);
    ...
    public Component getTableCellEditorComponent(
        JTable table1, Object value, boolean isSelected, int row, int column) {
  ...
  private void onDelete() {
    final int result =
        JOptionPane.showConfirmDialog(
            panel, "Are you sure you wish to delete the selected citation?");
    ...
    private String[] getNames() {
      if (names == null) {
        names =
            new String[] {
              CurrentLocale.get(
                  "com.tle.admin.schema.manager.citationtab.column.citation"), //$NON-NLS-1$
              CurrentLocale.get(
                  "com.tle.admin.schema.manager.citationtab.column.transformation") //$NON-NLS-1$
            };
      }
      return names;
    }
