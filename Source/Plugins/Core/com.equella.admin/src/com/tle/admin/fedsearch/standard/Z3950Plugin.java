...
public class Z3950Plugin extends SearchPlugin<Z3950Settings> {
  ...
  public void initGUI() {
    ...
    defaultOpener.addActionListener(
        new ActionListener() {
          @Override
          public void actionPerformed(ActionEvent e) {
            if (e.getSource() == defaultOpener) {
              ...
              JOptionPane.showMessageDialog(
                  panel, dialog, s("dialog.title"), JOptionPane.QUESTION_MESSAGE);
  ...
  private void setAttributeField(Z3950AttributesEditor editor, String attributes) {
    if (!Check.isEmpty(attributes)) {
      ...
      editor.setAttributes(
          Integer.parseInt(atts[0]),
          Integer.parseInt(atts[1]),
  ...
  private class Z3950AttributesEditor extends JPanel implements KeyListener {
    ...
    public void setAttributes(
        int use, int relation, int position, int structure, int truncation, int completeness) {
