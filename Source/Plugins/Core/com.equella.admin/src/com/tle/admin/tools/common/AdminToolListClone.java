...
public abstract class AdminToolListClone extends AdminToolList {
   ...
   *
   * @param selected The selected Object in the list. If the returned object is null then no Object
   *     is added.
   */
  protected abstract void onClone();

  /**
   * Called when the import button is pressed. If the returned object is null then no Object is
   * added.
   */
  ...
  protected TLEAction cloneAction =
      new CloneAction() {
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          final int confirm =
              JOptionPane.showConfirmDialog(
                  parentFrame,
                  CurrentLocale.get(
                      "com.dytech.edge.admin.guiadmintoollistclone.confirm",
                      selections
                          .get(0) // $NON-NLS-1$
                          .toString()),
                  CurrentLocale.get(
                      "com.dytech.edge.admin.guiadmintoollistclone.clone"), //$NON-NLS-1$
  ...
  protected TLEAction importAction =
      new ImportAction() {
        private static final long serialVersionUID = 1L;
  ...
  protected TLEAction exportAction =
      new ExportAction() {
        private static final long serialVersionUID = 1L;
  ...
  protected TLEAction archiveAction =
      new ArchiveAction() {
        private static final long serialVersionUID = 1L;
        ...
        public void actionPerformed(ActionEvent e) {
          final int result =
              JOptionPane.showConfirmDialog(
                  parentFrame,
                  CurrentLocale.get(
                      "com.tle.admin.gui.common.actions.archiveaction.confirmarchive"), //$NON-NLS-1$
                  CurrentLocale.get(
                      "com.tle.admin.gui.common.actions.archiveaction.name"), //$NON-NLS-1$
                  JOptionPane.YES_NO_OPTION,
                  JOptionPane.QUESTION_MESSAGE);
  ...
  protected TLEAction unarchiveAction =
      new UnarchiveAction() {
        private static final long serialVersionUID = 1L;
        ...
        public void actionPerformed(ActionEvent e) {
          final int result =
              JOptionPane.showConfirmDialog(
                  parentFrame,
                  CurrentLocale.get(
                      "com.tle.admin.gui.common.actions.unarchiveaction.confirmunarchive"), //$NON-NLS-1$
                  CurrentLocale.get(
                      "com.tle.admin.gui.common.actions.unarchiveaction.name"), //$NON-NLS-1$
                  JOptionPane.YES_NO_OPTION,
                  JOptionPane.QUESTION_MESSAGE);
