...
/**
 * The user can specify that any selection of EQUELLA resources (made via the EQUELLA selection
 * session button in the html Editor) be restricted to such collections & searches as this control
 * allows to be chosen. Once the radio button is selected to bring the shuffle-boxes into view, by
 * default nothing is chosen. An attempt to both 'activate restriction to ...' and then to chose
 * nothing is invalid and cannot be saved. Once restriction is chosen, all remote repositories are
 * invisible..
 *
 * @author larry
 */
