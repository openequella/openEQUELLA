...
public abstract class PluginDialog<T, S extends PluginSetting> extends JDialog
  ...
  private void createGUI() {
    ...
    JButton help =
        new JButton(CurrentLocale.get("com.tle.admin.plugin.plugindialog.help")); // $NON-NLS-1$
    if (plugin.getHelp() != null) {
      help.addActionListener(
          new HelpListener(
              this.getParentWindow(),
              CurrentLocale.get("com.tle.admin.plugin.plugindialog.general"),
              plugin.getHelp())); // $NON-NLS-1$
    }
