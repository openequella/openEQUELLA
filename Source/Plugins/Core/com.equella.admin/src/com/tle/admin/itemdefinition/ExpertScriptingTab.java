...
public class ExpertScriptingTab extends AbstractItemdefTab implements FocusListener, CaretListener {
  ...
  public String getTitle() {
    return CurrentLocale.get(
        "com.tle.admin.itemdefinition.expertscriptingtab.title"); //$NON-NLS-1$
  }
  ...
  protected void setupGUI() {
    JLabel redraftLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.itemdefinition.expertscriptingtab.new")); //$NON-NLS-1$
    JLabel saveLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.itemdefinition.expertscriptingtab.save")); //$NON-NLS-1$
    ...
    final int[] rows = {
      height, TableLayout.FILL, height, TableLayout.FILL,
    };
    final int[] columns = {
      TableLayout.FILL,
    };
