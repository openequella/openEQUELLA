...
public class PowerSearchList extends JPanel implements Changeable {
  ...
  private TLEAction removeAction =
      new RemoveAction() {
        private static final long serialVersionUID = 1L;
          ...
          if (c != null) {
            int confirm =
                JOptionPane.showConfirmDialog(
                    PowerSearchList.this,
                    CurrentLocale.get("com.dytech.edge.admin.wizard.powersearchlist.confirm"),
  ...
  private TLEAction downAction =
      new DownAction() {
        ...
        public void update() {
          setEnabled(
              table.getSelectedRowCount() > 0 && table.getSelectedRow() != model.getRowCount() - 1);
        }
      };
