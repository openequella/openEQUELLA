...
public class WorkflowTree extends JTree {
      ...
      if (nodeClass != null) {
        try {
          WorkflowNode newNode =
              nodeClass.getConstructor(LanguageBundle.class).newInstance(new Object[] {null});
      ...
      final String message =
          CurrentLocale.get(
              ...
              CurrentLocale.get(
                  parent.getName(),
                  CurrentLocale.get(
                      "com.tle.admin.workflow.tree.workflowcellrenderer.unnamed"))); //$NON-NLS-1$
  ...
  private class WorkflowTreeMouseAdapter extends MouseAdapter implements ActionListener {
    ...
    public void mousePressed(final MouseEvent e) {
      ...
      visible =
          (node == null && model.getRootNode() == null) || (node != null && node.canAddChildren());
