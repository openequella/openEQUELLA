...
public class WizardTab extends AbstractItemdefTab
  ...
  public WizardTab(WizardTree tree, EditorInterface entityEditor) {
    ...
    panel =
        new JChangeDetectorPanel() {
          private static final long serialVersionUID = 1L;

          @Override
          public boolean hasDetectedChanges() {
            return super.hasDetectedChanges()
                || (currentEditor != null && currentEditor.hasDetectedChanges());
          }
  ...
  public void validation() throws EditorException {
    ...
    if (walker.errorDetected()) {
      ...
      throw new EditorException(
          CurrentLocale.get("com.tle.admin.itemdefinition.wizardtab.error")); // $NON-NLS-1$
    } else {
      if (currentEditor != null) {
  ...
  private void setupTab() {
    ...
    JLabel message =
        new JLabel(
            CurrentLocale.get("com.tle.admin.itemdefinition.wizardtab.noeditor")); // $NON-NLS-1$
        ...
        new GlassSwingWorker<Object>() {
          ...
          public void exception() {
            Driver.displayInformation(
                panel,
                CurrentLocale.get(
                    "com.tle.admin.itemdefinition.wizardtab.editorerror")); //$NON-NLS-1$
  ...
  private void onAddControl(final Control parent) {
    final GlassSwingWorker<ControlDialog> worker =
        new GlassSwingWorker<ControlDialog>() {
          @Override
  ...
  /** The size of the tree is now somewhat dynamic. It was getting lost in the new big windows :) */
  @Override
