...
public class ItemMetadataAccessControlTab extends AbstractItemdefTab {
  private static final String UNTITLED =
      CurrentLocale.get(
          "com.tle.admin.itemdefinition.itemmetadataaccesscontroltab.untitled"); //$NON-NLS-1$
  ...
  public void init(Component parent) {
    listWithView =
        new ListWithView<ItemMetadataRule, Editor>(true) {
    ...
    listWithView.setListCellRenderer(
  ...
  public String getTitle() {
    return CurrentLocale.get(
        "com.tle.admin.itemdefinition.itemmetadataaccesscontroltab.title"); //$NON-NLS-1$
  }
  ...
  private class Editor extends JPanel implements ListWithViewInterface<ItemMetadataRule> {
    ...
    public void setup() {
      ...
      JLabel nameLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.tle.admin.itemdefinition.itemmetadataaccesscontroltab.name")); //$NON-NLS-1$

      name = new JTextField();

      ScriptOptions myOptions =
          new ScriptOptionsWrapper(options) {
            @Override
      ...
      scriptView =
          new ScriptPanel(
              new BasicModel(schema, myOptions, null) {
                private static final long serialVersionUID = 1L;
      ...
      tabs.addTab(
          CurrentLocale.get(
              "com.tle.admin.itemdefinition.itemmetadataaccesscontroltab.matches"), //$NON-NLS-1$
          scriptBorder);
      tabs.addTab(
          CurrentLocale.get("com.tle.admin.itemdefinition.itemmetadataaccesscontroltab.apply"),
          aclEditor); //$NON-NLS-1$
