...
public class PowerSearchTab extends AbstractPowerSearchTab
  ...
  private static final String TITLE =
      CurrentLocale.get("com.tle.admin.powersearch.powersearchtab.title"); // $NON-NLS-1$
  ...
  public void validation() throws EditorException {
    ...
    if (walker.errorDetected()) {
      ...
      throw new EditorException(
          CurrentLocale.get("com.tle.admin.powersearch.powersearchtab.notvalid")); // $NON-NLS-1$
    } else {
      if (currentEditor != null) {
  ...
  public void load() {
    ...
    page.setTitle(
        LangUtils.createTempLangugageBundle(
            "com.tle.admin.powersearch.powersearcheditor.name")); //$NON-NLS-1$
  ...
  protected void setupTab() {
    ...
    JLabel message =
        new JLabel(
            CurrentLocale.get("com.tle.admin.powersearch.powersearchtab.noeditor")); // $NON-NLS-1$
            ...
            if (control != null) {
              ...
              currentEditor =
                  editorFactory.getEditor(
                      control, WizardHelper.WIZARD_TYPE_POWERSEARCH, schema, pluginService);
