...
public class UsersTab extends JChangeDetectorPanel implements ListSelectionListener {
  ...
  private void setupGui() {
    ...
    filterList =
        new FilterList<TLEUser>(
            new FilterModel<TLEUser>() {
    ...
    filterList.setListCellRenderer(
    ...
    filterList.setSortingComparator(
        new NumberStringComparator<TLEUser>() {
          private static final long serialVersionUID = 1L;
    ...
    final int[] cols = {
      width1, width1, width1, TableLayout.FILL,
    };
    ...
    public void actionPerformed(ActionEvent e) {
      int result =
          JOptionPane.showConfirmDialog(
              UsersTab.this,
              CurrentLocale.get(
                  "com.tle.admin.usermanagement.internal.userstab.sure")); //$NON-NLS-1$
