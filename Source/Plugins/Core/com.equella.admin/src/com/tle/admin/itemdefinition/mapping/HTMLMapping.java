...
public class HTMLMapping
    extends AbstractTableMapping<com.tle.beans.entity.itemdef.mapping.HTMLMapping> {
  private static final long serialVersionUID = 1L;

  @SuppressWarnings("nls")
  private static final String[] DEFAULT_META_NAMES =
      new String[] {
        "description",
        "keywords",
        "dc.title",
  ...
  public String toString() {
    return CurrentLocale.get(
        "com.tle.admin.itemdefinition.mapping.htmlmapping.title"); //$NON-NLS-1$
  }

  @Override
  protected String[] getColumnNames() {
    return new String[] {
      CurrentLocale.get("com.tle.admin.itemdefinition.mapping.htmlmapping.tagname"), // $NON-NLS-1$
      CurrentLocale.get("com.tle.admin.itemdefinition.mapping.htmlmapping.schema")
    }; //$NON-NLS-1$
  }

  @Override
  protected Collection<com.tle.beans.entity.itemdef.mapping.HTMLMapping> getMappings(
  ...
  protected Object getNode(Object data, int column) {
    com.tle.beans.entity.itemdef.mapping.HTMLMapping mapping =
        (com.tle.beans.entity.itemdef.mapping.HTMLMapping) data;
    Object val = null;
    if (column == 0) {
      val = mapping.getHtml();
    } else {
