...
public abstract class AbstractSchemaEditor extends JPanel implements Changeable {
  ...
  private void setup() {
    treeWithView =
        new AbstractTreeWithView<SchemaNode, TreeWithViewInterface<SchemaNode>>(model) {
          ...
          protected Component getNoSelectionComponent() {
            JLabel label =
                new JLabel(CurrentLocale.get("com.tle.admin.schema.abstractschemaeditor.select"));
          ...
          private final TLEAction addAttributeAction =
  ...
  private final UpDownPolicyImplementor<SchemaNode> upDownPolicy =
      new UpDownDepthFirstPolicy<SchemaNode>() {
        private static final long serialVersionUID = 1L;
        ...
        protected boolean shouldDescendInto(
            GenericTreeModel<SchemaNode> model, SchemaNode node, SchemaNode possibleParent) {
