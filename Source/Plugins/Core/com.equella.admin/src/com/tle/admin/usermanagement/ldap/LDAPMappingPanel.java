...
public class LDAPMappingPanel extends AbstractLDAPPanel implements ActionListener, ItemListener {
  ...
  protected static final List<String> ATTRIBUTES_NAMES =
  ...
  private JComponent createMiddle() {
    ...
    directory.addMouseMotionListener(
    ...
    final int[] rows = {
      height1, TableLayout.FILL, height2, height2, TableLayout.FILL,
    };
    final int[] cols = {
      TableLayout.FILL, width1, TableLayout.FILL,
    };
