...
/**
 * "Where" Statement BNF: STATEMENT ::= TERM (OPERATOR TERM)* TERM ::= BRACKETS | COMPARISON
 * BRACKETS ::= "(" STATEMENT ")" COMPARISON ::= XPATH EQUALITY VALUE XPATH ::= (ALPHA | NUMBER |
 * "/" | "." | "_" | "@")+ EQUALITY ::= "=" | "<>" | "LIKE" VALUE ::= "'" STRING "'" OPERATOR ::=
