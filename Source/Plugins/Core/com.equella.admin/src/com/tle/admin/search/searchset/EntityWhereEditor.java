...
public abstract class EntityWhereEditor<T extends BaseEntity, U extends EntityScript<T>>
  ...
  protected abstract EntityDialog getEntityDialog(
      Collection<NameId> allValues, Set<NameId> currentEntities);
  ...
  private final TLEAction addAction =
      new AddAction() {
        ...
        public void actionPerformed(ActionEvent e) {
          GlassSwingWorker<EntityDialog> worker =
              new GlassSwingWorker<EntityDialog>() {
                @Override
                ...
                public void exception() {
                  Driver.displayError(
                      getComponent(), "itemEditor/enumerating", getException()); // $NON-NLS-1$
  ...
  private class MyTableModel<T extends BaseEntity, U extends EntityScript<T>>
    ...
    /**
     * @param u
     * @return A placeholder NameId if the entity is not found (e.g. it's been deleted)
     */
      ...
      switch (column) {
        ...
        case 1:
          return CurrentLocale.get(
              "com.tle.admin.gui.common.entitywhereeditor.scripting"); //$NON-NLS-1$
        default:
          throw new IllegalStateException();
      }
    }
  ...
  public static class ItemDefinitionWhereEditor
    ...
    public ItemDefinitionWhereEditor(EntityCache cache, ClientService clientService) {
      super(
          ...
          CurrentLocale.get(
              "com.tle.admin.gui.common.entitywhereeditor.collection")); //$NON-NLS-1$
    }
  ...
  public static class SchemaWhereEditor extends EntityWhereEditor<Schema, SchemaScript> {
    ...
    public SchemaWhereEditor(EntityCache cache, ClientService clientService) {
      super(
          ...
          Schema.class,
          SchemaScript.class,
          CurrentLocale.get("com.tle.admin.gui.common.entitywhereeditor.schema")); // $NON-NLS-1$
    }
