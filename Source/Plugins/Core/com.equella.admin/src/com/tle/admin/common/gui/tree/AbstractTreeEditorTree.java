...
public abstract class AbstractTreeEditorTree<NodeType extends LazyTreeNode> extends JPanel
  ...
  /** Performed initial setup and initialisation. This method should only ever be invoked once. */
  ...
  protected abstract boolean preAddNewNode(
      NodeType parent, NodeType newNode, Map<Object, Object> params);

  protected abstract void doAddNewNode(
      NodeType parent, NodeType newNode, Map<Object, Object> params);
  ...
  private final TLEAction moveUpAction =
      new UpAction() {
  ...
  private final TLEAction moveDownAction =
      new DownAction() {
        @Override
        public void actionPerformed(ActionEvent arg0) {
          doMoveGui(getSelectedNode(), 1);
        ...
        public void actionPerformed(ActionEvent e) {
          ...
          final int result =
              JOptionPane.showConfirmDialog(
                  AbstractTreeEditorTree.this,
                  CurrentLocale.get(
                      "com.tle.admin.gui.common.tree.editor.confirmremove", node.getName()),
  ...
  private final TLEAction addChildAction =
      new AddChildAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
  ...
  private final TLEAction addSiblingAction =
      new AddSiblingAction() {
        ...
        public void update() {
          setEnabled(
              tree.getSelectionCount() == 1 && canEdit((NodeType) getSelectedNode().getParent()));
        }
      };
    ...
    do {
      name =
          JOptionPane.showInputDialog(
              this, CurrentLocale.get("com.tle.admin.gui.common.tree.editor.entername"));
      if (name == null) {
        return null;
      }
  ...
  public final void loadChildren(final NodeType parent) {
    switch (parent.getChildrenState()) {
      ...
      case UNLOADED:
        ...
        GlassSwingWorker<?> worker =
            new GlassSwingWorker<List<NodeType>>() {
              @Override
