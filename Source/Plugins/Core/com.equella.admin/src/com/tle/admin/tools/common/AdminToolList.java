...
public abstract class AdminToolList extends AdminTool {
  ...
  private static final NameValue DOWNLOADING_LIST_ELEMENT =
      new NameValue(
          CurrentLocale.get("com.dytech.edge.admin.guiadmintoollist.downloading"),
          null); //$NON-NLS-1$
  ...
  public void setup(Set<String> grantedPrivileges, String name) {
    ...
    final int[] rows = {
      5, height1, 5, TableLayout.FILL, 5, height2,
    };
  ...
  public void toolSelected() {
    ...
    if (!listFilled) {
      ...
      GlassSwingWorker<?> worker =
          new GlassSwingWorker<Collection<NameValue>>() {
            @Override
            ...
            public void exception() {
              ...
              Driver.displayError(
                  parentFrame,
                  CurrentLocale.get("com.dytech.edge.admin.guiadmintoollist.error"),
  ...
  protected TLEAction editAction =
      new EditAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
          onEdit();
  ...
  protected TLEAction removeAction =
      new RemoveAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
          ...
          if (selections.size() == 1) {
            message =
                CurrentLocale.get(
                    "com.dytech.edge.admin.guiadmintoollist.deleteitem", //$NON-NLS-1$
                    selections.get(0).toString());
          } else {
            message =
                CurrentLocale.get(
                    "com.dytech.edge.admin.guiadmintoollist.deleteitems", //$NON-NLS-1$
                    selections.size());
          }
          ...
          final int result =
              JOptionPane.showConfirmDialog(
                  parentFrame,
                  message,
                  CurrentLocale.get("com.dytech.edge.admin.guiadmintoollist.confirm"),
  ...
  private final TLEAction refreshAction =
      new RefreshAction() {
        @Override
        public void actionPerformed(ActionEvent e) {
          refreshAndSelect();
