...
public class ItemSearcher extends JPanel implements ActionListener, ListSelectionListener {
  ...
  private void updateEditor() {
    ...
    if (currentSelection != null && tabManager.hasDetectedChanges()) {
      ...
      Object[] buttons = {
        CurrentLocale.get("prompts.save"),
  ...
  private void setupGui() {
    ...
    final int[] rows = {
      height, TableLayout.FILL, height,
    };
    final int[] cols = {
      width1, TableLayout.FILL, width2, width2,
    };
        ...
        new GlassSwingWorker<SearchResults<Item>>() {
          ...
          public SearchResults<Item> construct() throws Exception {
            ...
            SearchResults<Item> results =
                adminService.searchReducedItems(search, start, RESULTS_PER_PAGE);
          ...
          public void doInAnyCase() {
            ...
            countLabel.setText(
                CurrentLocale.get(
                    "com.tle.admin.security.tree.itemsearcher.results",
                    new Object[] {startDisplay, (start + model.getRowCount()), total}));
