...
public abstract class AdminToolSelect extends AdminTool implements ActionListener, MouseListener {
  ...
  private JComponent createWrapperList() {
    ...
    JPanel panel =
        new JPanel(
            new TableLayout(
                new int[] {TableLayout.FILL, TableLayout.PREFERRED}, new int[] {TableLayout.FILL}));
  ...
  protected JPanel createSelectButtons() {
    ...
    selectButton =
        new JHoverButton(
            CurrentLocale.get("com.tle.admin.gui.admintoolselect.configure"), configureIcon);
  ...
  /**
   * Called when the add button is pressed. If the returned object is null then no Object is added.
   */
    ...
    if (e.getSource() == selectWrapperButton) {
      if (wrapperList.getSelectedRow() < 0) {
        Driver.displayInformation(
            parentFrame, CurrentLocale.get("com.tle.admin.gui.admintoolselect.mustselect"));
      } else {
        configureWrapper();
      }
    }
  ...
  protected static final List<String> COLUMNS =
        ...
        if (b) {
          if (JOptionPane.showConfirmDialog(
                  ...
                  "You have chosen to enable this plug-in, but this may not have\nbeen"
                      + " your intention.  Do you want to enable this plug-in?",
                  "Enable Plug-in?",
          ...
          String[] locButtons = {
            "Disable plug-in", "Configure plug-in settings", "Cancel",
          };
  ...
  public void editingStopped() {
    ...
    new AdvancedSwingWorker<Object>() {
      ...
      public void exception() {
        Driver.displayInformation(
            parentFrame,
            CurrentLocale.get("com.tle.admin.gui.admintoolselect.error")); // $NON-NLS-1$
      }
    }.start();
  }
