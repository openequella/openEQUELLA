...
public class UserDetailsPanel extends JChangeDetectorPanel {
  ...
  private void setupGui() {
    JLabel identifierLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.identifier")); //$NON-NLS-1$
    JLabel usernameLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.username")); //$NON-NLS-1$
    JLabel firstNameLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.first")); //$NON-NLS-1$
    JLabel lastNameLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.last")); //$NON-NLS-1$
    JLabel emailAddressLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.email")); //$NON-NLS-1$
    JLabel newPasswordLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.newpswd")); //$NON-NLS-1$
    JLabel passwordConfirmLabel =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.confirmpswd")); //$NON-NLS-1$
    ...
    final int[] cols = {
      width1, TableLayout.FILL, width2,
    };
          ...
          new MyGlassSwingWorker() {
            ...
            public void doStuff() {
              ...
              JOptionPane.showMessageDialog(
                  getComponent(),
                  CurrentLocale.get(
                      "com.tle.admin.usermanagement.internal.userdetailspanel.saved")); //$NON-NLS-1$
            }
  ...
  public void loadUser(final TLEUser user) {
    if (!changeDetector.hasDetectedChanges()) {
      ...
      Object[] buttons =
          new Object[] {
            CurrentLocale.get(
                "com.tle.admin.usermanagement.internal.userdetailspanel.save"), //$NON-NLS-1$
            CurrentLocale.get("com.tle.admin.usermanagement.internal.userdetailspanel.dontsave")
          }; //$NON-NLS-1$
      int results =
          JOptionPane.showOptionDialog(
              this,
              CurrentLocale.get(
                  "com.tle.admin.usermanagement.internal.userdetailspanel.confirm"), //$NON-NLS-1$
              CurrentLocale.get(
                  "com.tle.admin.usermanagement.internal.userdetailspanel.saveuser"), //$NON-NLS-1$
  ...
  private abstract class MyGlassSwingWorker extends GlassSwingWorker<Object> {
    ...
    public void exception() {
      ...
      if (ex instanceof InvalidDataException) {
        JOptionPane.showMessageDialog(
            getComponent(), error((InvalidDataException) ex).getMessage());
      } else {
