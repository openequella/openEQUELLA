...
public class ReplicatedPlugin extends GeneralPlugin<ReplicatedConfiguration>
  ...
  private static final String HELP_SEARCH_GROUPS_IN_GROUP_RECURSIVE =
      HELP_TEXT + "search.groups.in.group.recursive";
  private static final String HELP_USERS_IN_GROUP_RECURSIVE =
      HELP_TEXT + "users.in.group.recursive";
  private static final String HELP_USERS_IN_GROUP = HELP_TEXT + "users.in.group";
  private static final String HELP_SEARCH_USERS_IN_GROUP_RECURSIVE =
      HELP_TEXT + "search.users.in.group.recursive";
  ...
  private void setup() {
    ...
    p.addNameAndComponent(
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.driver"), drivers);
    p.addNameAndComponent(
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.jdbcurl"), url);
    p.addNameAndComponent(
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.username"), username);
    p.addNameAndComponent(
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.password"), password);

    p.getComponent().setBorder(new EmptyBorder(5, 5, 5, 5));
    tabs.addTab(
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.details"),
    ...
    JLabel presetLabel =
        new JLabel(CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.presets"));
    ...
    add(
        digests,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.digest"),
        HELP_DIGEST);
    add(
        authenticate,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.authenticate"),
        HELP_AUTHENTICATE);
    add(
        userInfo,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.userinfo"),
        HELP_USERINFO);
    add(
        userRole,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.userrole"),
        HELP_USERROLE);
    add(
        roleInfo,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.roleinfo"),
        HELP_ROLES_INFO);
    add(
        searchRoles,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.searchroles"),
        HELP_SEARCH_ROLES);
    add(
        groupInfo,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.groupinfo"),
        HELP_GROUPINFO);
    add(
        searchUsers,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.searchusers"),
        HELP_SEARCHUSERS);
    add(
        searchGroups,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.searchgroups"),
        HELP_SEARCHGROUPS);
    add(
        searchGroupsInGroup,
    ...
    add(
        searchGroupsInGroupRecursive,
        CurrentLocale.get(
            "com.tle.admin.usermanagement.replicatedplugin.searchgroupsingroup.recursive"),
        HELP_SEARCH_GROUPS_IN_GROUP_RECURSIVE);
    add(
        usersInGroupRecursive,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.usersinr"),
        HELP_USERS_IN_GROUP_RECURSIVE);
    add(
        usersInGroup,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.usersin"),
        HELP_USERS_IN_GROUP);
    add(
        searchUsersInGroupRecursive,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.searchusersinr"),
        HELP_SEARCH_USERS_IN_GROUP_RECURSIVE);
    add(
        searchUsersInGroup,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.searchusersin"),
        HELP_SEARCH_USERS_IN_GROUP);

    add(
        groupsContainingUser,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.groupcontaining"),
        HELP_GROUPS_CONTAINING_USER);
    add(
        parentGroup,
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.parentgroup"),
        HELP_PARENT_GROUP);

    cols[0] = width;
    all.setBorder(new EmptyBorder(5, 5, 5, 5));
    tabs.addTab(
        CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.sql"),
        new JScrollPane(all));
  ...
  private void add(JComponent comp, String text, String help) {
    ...
    label.addMouseListener(
        new HelpListener(this.getComponent(), text, help) {
          @Override
    ...
    if (e.getSource() == presets) {
      ...
      if (!Check.isEmpty(url.getText())
          && JOptionPane.showConfirmDialog(
                  getComponent(),
                  CurrentLocale.get(
                      "com.tle.admin.usermanagement.replicatedplugin.confirmjdbcurlreset"))
  ...
  private static NameValue[] getTypes() {
    return new NameValue[] {
      new NameValue("", ""),
      new NameValue(
          CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.standard"),
          SQL_PRESET_STANDARD),
      new NameValue(
          CurrentLocale.get("com.tle.admin.usermanagement.replicatedplugin.custom"),
          SQL_PRESET_CUSTOM)
    };
  }
}
