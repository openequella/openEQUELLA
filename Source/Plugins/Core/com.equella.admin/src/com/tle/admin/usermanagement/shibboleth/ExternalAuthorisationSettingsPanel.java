...
import com.tle.admin.usermanagement.ldap.ManageDNsDialog;
...
public class ExternalAuthorisationSettingsPanel extends JPanel implements Changeable {
  ...
  protected void setupGui() {
    ...
    final TableLayout innerLayout =
        new TableLayout(
            new int[] {height1, height1},
            new int[] {
              Math.max(
                  environmentVarNameLabel.getPreferredSize().width,
                  httpHeaderNameLabel.getPreferredSize().width),
              TableLayout.FILL
            },
            5,
            5);
    ...
    final int[] rows = {
      preamble.getPreferredSize().height * 2,
      height1,
      height1,
      height1,
      height1,
