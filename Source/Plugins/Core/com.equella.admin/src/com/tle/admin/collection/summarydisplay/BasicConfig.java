...
public class BasicConfig extends AbstractOnlyTitleConfig implements ActionListener
{
	...
	public void setup()
	{
		...
		limitDesc = new JCheckBox(
			getString("summarysections.basic.limitdesclabel")); //$NON-NLS-1$
		maxLengthDesc = new JAdminSpinner(355, 10, 10000, 5);

		limitTitle = new JCheckBox(
			getString("summarysections.basic.limittitlelabel")); //$NON-NLS-1$
		...
		add(new JLabel(getString("summarysections.basic.maxlabel")), //$NON-NLS-1$
			"split 2"); //$NON-NLS-1$
