...
public class DetailsTab extends BaseEntityTab<Report>
  ...
  private void setupGUI() {
    ...
    final int[] rows = {
      height1, height1, height1 * 3, height1, height1, height1, TableLayout.FILL,
    };
    final int[] cols = {
  ...
  public boolean uploadFile() {
    ...
    final DialogResult result =
        DialogUtils.openDialogStrictFilter(
            panel,
  ...
  public void download() {
    ...
    final DialogResult result =
        DialogUtils.saveDialogStrictFilter(
            panel,
    ...
    GlassSwingWorker<Object> worker =
          ...
          public Object construct() throws Exception {
            ...
            String stagingId =
                service.prepareDownload(
                    state.getEntity(), state.getEntityPack().getStagingID(), filename);
