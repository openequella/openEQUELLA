...
import com.tle.admin.usermanagement.shibboleth.ExternalAuthorisationSettingsPanel;
...
public class CanvasSettingsPanel extends JPanel implements Changeable, MouseListener
{
	...
	private static String KEY_PFX = AbstractPluginService.getMyPluginId(CanvasSettingsPanel.class) + ".";
