...
public class LDAPGeneralSettings extends AbstractLDAPPanel {
  ...
  private void createGUI() {
    ...
    searchLimitModel =
        new SpinnerNumberModel(SEARCH_LIMIT_START, SEARCH_LIMIT_START, SEARCH_LIMIT_END, 1);
  ...
  public void save(LDAPSettings saveSettings) {
    ...
    saveSettings.setAdminPassword(
        encryptionService.encrypt(new String(passwordField.getPassword())));
