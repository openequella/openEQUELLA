...
public class TransformationsTab extends BaseEntityTab<Schema> {
  ...
  public String getTitle() {
    return CurrentLocale.get(
        "com.tle.admin.schema.manager.transformationstab.title"); //$NON-NLS-1$
  }
  ...
  private void setupGUI() {
    JLabel il =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.schema.manager.transformationstab.importTitle")); //$NON-NLS-1$
    JLabel el =
        new JLabel(
            CurrentLocale.get(
                "com.tle.admin.schema.manager.transformationstab.exportTitle")); //$NON-NLS-1$
    ...
    final int[] rows = {
      height1, TableLayout.FILL, 10, height1, TableLayout.FILL,
    };
    final int[] cols = {
      TableLayout.FILL,
    };
