...
public class EQUELLAPlugin extends HarvesterPlugin<EQUELLAHarvesterSettings>
  ...
  public void load(EQUELLAHarvesterSettings settings) {
    ...
    String collectionName =
        settings.getCollectionName() == null ? selectedCollection : settings.getCollectionName();
  ...
  public void validation() throws EditorException {
    if (serverField.getText().isEmpty()) {
      throw new EditorException(s("serverfield"));
    }
    ...
    try {
      ...
      throw new EditorException(s("serverfieldinvalid"));
    }
  }
  ...
  private void updateCollections(final boolean clearChanges) {
    ...
    try {
      ...
      JOptionPane.showMessageDialog(panel.getComponent(), s("serverfieldinvalid"));
      return;
    }
    ...
    GlassSwingWorker<?> worker =
        new GlassSwingWorker<List<NameValue>>() {
          ...
          public List<NameValue> construct() throws Exception {
            ...
            RemoteEQUELLAHarvesterService equellaHarvesterService =
                clientService.getService(RemoteEQUELLAHarvesterService.class);

            List<NameValue> listCollections = null;
            try {
              listCollections =
                  equellaHarvesterService.listCollections(
                      serverUrl,
                      userField.getText(),
              ...
              Driver.displayInformation(
                  panel.getComponent(), s("collectionserror", ex.getMessage()));
            }
  ...
  public void validateSchema(JComboBox<NameValue> collections) throws EditorException {
    ...
    if (collection == null || collection.isEmpty()) {
      throw new EditorException(s("collection"));
    }
  }
