...
public class HelpListener extends MouseAdapter implements ActionListener {
  ...
  private void showHelp() {
    ...
    dialog.setTitle(
        CurrentLocale.get("com.tle.admin.plugin.helplistener.title", title)); // $NON-NLS-1$
  ...
  protected static class HelpPanel extends JPanel implements ActionListener {
    ...
    private void setup() {
      ...
      close =
          new JButton(CurrentLocale.get("com.tle.admin.plugin.helplistener.close")); // $NON-NLS-1$
