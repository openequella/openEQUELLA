...
public class BrowseFinder extends JPanel implements UserGroupRoleFinder {
  ...
  private class UserPanel extends BrowsePanelFinder
    ...
    public UserPanel() {
      ...
      panel.add(
          new JLabel(CurrentLocale.get("com.tle.admin.recipients.browserfinder.users")),
          BorderLayout.WEST);
    ...
    public void actionPerformed(ActionEvent e) {
      GlassSwingWorker<List<UserBean>> w =
          new GlassSwingWorker<List<UserBean>>() {
            @Override
    ...
    public void setSingleSelectionOnly(boolean b) {
      int mode =
          b ? ListSelectionModel.SINGLE_SELECTION : ListSelectionModel.MULTIPLE_INTERVAL_SELECTION;
  ...
  @SuppressWarnings("nls")
  private class TreePanel extends BrowsePanelFinder
    ...
    public TreePanel() {
      ...
      panel.setLayout(new BorderLayout(5, 5));
      panel.add(
          new JLabel(CurrentLocale.get("com.tle.admin.recipients.browserfinder.groups")),
          BorderLayout.WEST);
      panel.add(query, BorderLayout.CENTER);
      panel.add(search, BorderLayout.EAST);
