...
public class IpAddressFinder extends JPanel implements UserGroupRoleFinder, ActionListener {
  ...
  private void setupGUI() {
    ipAddressRadio =
        new JRadioButton(CurrentLocale.get("com.tle.admin.recipients.ipaddressfinder.addip"), true);
    referrerRadio =
        new JRadioButton(CurrentLocale.get("com.tle.admin.recipients.ipaddressfinder.addreferrer"));
    ...
    referrerExact =
        new JRadioButton(
            CurrentLocale.get("com.tle.admin.recipients.ipaddressfinder.onlymatch"), true);
    referrerPartial =
        new JRadioButton(CurrentLocale.get("com.tle.admin.recipients.ipaddressfinder.match"));
    ...
    final int[] rows = {
      height1, height2, height1, height3, height3, height3, TableLayout.FILL,
    };
    final int[] cols = {
      25, TableLayout.FILL,
    };
  ...
  private class IpAddressEditor extends JPanel implements KeyListener {
    ...
    public IpAddressEditor() {
      JLabel addressLabel =
          new JLabel(CurrentLocale.get("com.tle.admin.recipients.ipaddressfinder.ipaddress"));
      JLabel maskLabel =
          new JLabel(CurrentLocale.get("com.tle.admin.recipients.ipaddressfinder.subnet"));
      ...
      final int[] cols = {
        width1, width2, width1, width2, width1, width2, width1, width2, width1,
      };
