...
public class DRMAccessControlTab extends JPanel {
  ...
  public void save(DRMPage page) {
    ...
    if (network.isSelected()) {
      Set<com.dytech.edge.wizard.beans.DRMPage.Network> networks =
          new HashSet<com.dytech.edge.wizard.beans.DRMPage.Network>();
      final int count = network.getNetworkCount();
      for (int i = 0; i < count; i++) {
        Network nw = network.getNetworkAt(i);
        com.dytech.edge.wizard.beans.DRMPage.Network newnw =
            new com.dytech.edge.wizard.beans.DRMPage.Network();
  ...
  private static final class UserGroupPanel extends JGroup {
    ...
    public UserGroupPanel(RemoteUserService userService) {
      ...
      userLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.users")); //$NON-NLS-1$
      groupLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.groups")); //$NON-NLS-1$
      ...
      selectable =
          new JCheckBox(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.selectable")); //$NON-NLS-1$
  ...
  private static final class NetworkPanel extends JGroup {
    ...
    public NetworkPanel() {
      super(
          CurrentLocale.get(
              "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.restrictip"), //$NON-NLS-1$
          false);

      titleLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.ipbased")); //$NON-NLS-1$
      selectable =
          new JCheckBox(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.selectable")); //$NON-NLS-1$
  ...
  private static final class AccessCountPanel extends JGroup {
    ...
    public AccessCountPanel() {
      super(
          CurrentLocale.get(
              "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.restrictaccesses"), //$NON-NLS-1$
          false);

      JLabel accessesLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.number")); //$NON-NLS-1$

      selectable =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.numberspecified"), //$NON-NLS-1$
              true);
      fixed =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.specifyfixed")); //$NON-NLS-1$
      initial =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.specifydefault")); //$NON-NLS-1$
  ...
  private final class DatePanel extends JGroup {
    ...
    public DatePanel() {
      super(
          CurrentLocale.get(
              "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.restrictdate"), //$NON-NLS-1$
          false);

      JLabel startLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.start")); //$NON-NLS-1$
      JLabel endLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.end")); //$NON-NLS-1$
      ...
      fixed =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.specifyvalid"), //$NON-NLS-1$
              true);
      selectable =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.daterange")); //$NON-NLS-1$
      ...
      startSelect =
          new JButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.select")); //$NON-NLS-1$
      endSelect =
          new JButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.select")); //$NON-NLS-1$
      ...
      if (e.getSource() == selectable || e.getSource() == fixed) {
        ...
        Date d =
            CalendarDialog.showCalendarDialog(
                DRMAccessControlTab.this,
                CurrentLocale.get(
                    "com.dytech.edge.admin.wizard.editor.drm.drmacccesscontroltab.selectdate"), //$NON-NLS-1$
                startDate);
        if (d != null) {
