...
public class ScriptEditor extends JPanel implements StatusBarContainer {
  ...
  public void showEditor(Component parent) {
    ...
    dialog.setTitle(
        CurrentLocale.get("com.dytech.edge.admin.script.scripteditor.title")); // $NON-NLS-1$
            ...
            new CloseAction() {
              ...
              public void actionPerformed(ActionEvent e) {
                if (scriptPanel.hasDetectedChanges()) {
                  String message =
                      CurrentLocale.get(
                          "com.dytech.edge.admin.script.scripteditor.message"); //$NON-NLS-1$
                  String[] buttons = {
                  ...
                  final int choice =
                      JOptionPane.showOptionDialog(
                          ...
                          message,
                          CurrentLocale.get(
                              "com.dytech.edge.admin.script.scripteditor.confirm"), //$NON-NLS-1$
