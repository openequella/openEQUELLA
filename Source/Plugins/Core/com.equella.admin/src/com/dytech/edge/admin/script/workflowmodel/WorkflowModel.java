...
public class WorkflowModel extends BasicModel {
  ...
  protected void setup() {
    ...
    editor.setBorder(
        BorderFactory.createCompoundBorder(
            BorderFactory.createEtchedBorder(), BorderFactory.createEmptyBorder(2, 5, 2, 5)));
  ...
  private JPanel createTop() {
    JLabel label =
        new JLabel(
            CurrentLocale.get(
                "com.dytech.edge.admin.script.workflowmodel.workflowmodel.select")); //$NON-NLS-1$
    ...
    final int[] columns = {
      TableLayout.FILL, width, width * 4, TableLayout.FILL,
    };
  ...
  private JPanel createCentre() {
    ...
    final int[] rows = {
      TableLayout.FILL, height, TableLayout.FILL,
    };
    final int[] cols = {
      width1, TableLayout.FILL, width2, TableLayout.FILL,
    };
  ...
  private static String getMessage() {
    return CurrentLocale.get(
        "com.dytech.edge.admin.script.workflowmodel.workflowmodel.message"); //$NON-NLS-1$
  }

  private static String getTitle() {
    return CurrentLocale.get(
        "com.dytech.edge.admin.script.workflowmodel.workflowmodel.title"); //$NON-NLS-1$
  }
}
