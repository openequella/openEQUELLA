...
/**
 * This controls the data model of an "If" statement. This should be used along with the <code>
 * ScriptView</code> class in order to display and edit a statement. Given a Statement data
 * structure, the model will display on Block and OpTerm elements in the ScriptView. Each Block and
 * OpTerm will display their first Term in the same row as themselves. <b>Warning:</b> The code is
 * ugly, and I'm not proud of it!! It needs some serious refactoring, and some bits need a scraping.
...
public abstract class IfModel extends DefaultListModel implements ScriptModel {
  ...
  protected static final List<String> BASIC_OPERATORS =
      Collections.unmodifiableList(Arrays.asList("=", "!="));

  protected static final String[] EXTENDED_OPERATORS =
      new String[] {"=", "!=", "<", ">", "<=", ">="};
