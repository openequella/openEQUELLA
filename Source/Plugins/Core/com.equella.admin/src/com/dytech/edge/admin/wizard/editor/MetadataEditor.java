...
public class MetadataEditor extends Editor implements ActionListener {
  ...
  private void setupGUI() {
    ...
    JLabel nameLabel =
        new JLabel(
            CurrentLocale.get(
                "com.dytech.edge.admin.wizard.editor.metadateeditor.metatarget")); //$NON-NLS-1$
    JLabel metadataLabel =
        new JLabel(
            CurrentLocale.get(
                "com.dytech.edge.admin.wizard.editor.metadateeditor.metavalue")); //$NON-NLS-1$
    ...
    addButton =
        new JButton(
            CurrentLocale.get(
                "com.dytech.edge.admin.wizard.editor.metadateeditor.add")); //$NON-NLS-1$
    removeButton =
        new JButton(
            CurrentLocale.get(
                "com.dytech.edge.admin.wizard.editor.metadateeditor.remove")); //$NON-NLS-1$
    ...
    final int[] rows = {
      height2, height3, 10, height4, height4, 150, TableLayout.FILL,
    };
    final int[] cols = {
    ...
    public String getColumnName(int column) {
      if (column == 0) {
        return CurrentLocale.get(
            "com.dytech.edge.admin.wizard.editor.metadateeditor.item"); //$NON-NLS-1$
      } else {
        return CurrentLocale.get(
            "com.dytech.edge.admin.wizard.editor.metadateeditor.value"); //$NON-NLS-1$
      }
    }
