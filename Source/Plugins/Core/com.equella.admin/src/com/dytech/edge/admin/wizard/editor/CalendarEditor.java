...
public class CalendarEditor extends AbstractPowerSearchControlEditor<Calendar> {
  ...
  private JComponent generateDefaultDate() {
    ...
    defaultGroup =
        new JGroup(
            CurrentLocale.get("com.dytech.edge.admin.wizard.editor.calendareditor.defaultdate"));
  ...
  public static String[] getDayNames() {
    return new String[] {
      CurrentLocale.get("com.dytech.edge.admin.wizard.editor.calendareditor.today"),
