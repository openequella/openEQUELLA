...
public class ShuffleBoxEditor extends AbstractPowerSearchControlEditor<ShuffleBox>
{
	...
	protected void setupGUI()
	{
		...
		choices = new DualShuffleList(
			CurrentLocale.get("com.dytech.edge.admin.wizard.editor.shuffleboxeditor.name"), CurrentLocale //$NON-NLS-1$
		...
		addSection(WizardHelper.createItems(choices,
			CurrentLocale.get("com.dytech.edge.admin.wizard.editor.shuffleboxeditor.add"))); //$NON-NLS-1$
