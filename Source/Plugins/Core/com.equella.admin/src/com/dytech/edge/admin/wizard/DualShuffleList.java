...
public class DualShuffleList extends JComponent implements ActionListener {
  ...
  protected void setupGUI(String t1, String t2) {
    ...
    add =
        new JButton(
            CurrentLocale.get("com.dytech.edge.admin.wizard.dualshufflelist.add")); // $NON-NLS-1$
    remove =
        new JButton(
            CurrentLocale.get(
                "com.dytech.edge.admin.wizard.dualshufflelist.remove")); //$NON-NLS-1$
  ...
  public static class MyTableModel extends AbstractTableModel implements TablePasteModel {
    ...
    private static final String[] COLUMN_NAMES =
        new String[] {
          ...
          CurrentLocale.get("com.dytech.edge.admin.wizard.dualshufflelist.value")
        }; //$NON-NLS-1$
