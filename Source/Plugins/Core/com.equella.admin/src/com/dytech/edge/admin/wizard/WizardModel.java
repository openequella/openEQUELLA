...
public class WizardModel implements TreeModel {
  ...
  /**
   * Raises a nodes position up by one. If the control is the first control on a page, then it will
   * move to the last element of the previous page, if the previous page exists.
   *
  ...
  /**
   * Lowers a nodes position up by one. If the control is the last control on a page, then it will
   * move to the first element of the following page, if the following page exists.
   *
  ...
  /**
   * Builds the parents of node up to and including the root node, where the original node is the
   * last element in the returned collection. The length of the returned collection gives the node's
   * depth in the tree.
   *
   * @param control the Control to get the path for
   */
