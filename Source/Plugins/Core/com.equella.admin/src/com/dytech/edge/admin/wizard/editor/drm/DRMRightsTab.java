...
public class DRMRightsTab extends JPanel {
  ...
  private static final class SectorPanel extends JGroup {
    ...
    public SectorPanel() {
      super(
          CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.restrictwarning"),
          false); //$NON-NLS-1$

      restrict =
          new JRadioButton(
              CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.restrictedu"),
              true); //$NON-NLS-1$
      selectable =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmrightstab.contributor")); //$NON-NLS-1$
  ...
  private static final class AttributionPanel extends JGroup {
    ...
    public AttributionPanel() {
      super(
          CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.attribution"),
          false); //$NON-NLS-1$

      required =
          new JRadioButton(
              CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.require"),
              true); //$NON-NLS-1$
      selectable =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmrightstab.selects")); //$NON-NLS-1$
      enforce =
          new JCheckBox(
              CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.enforce"),
              true); //$NON-NLS-1$
  ...
  private static final class AcceptancePanel extends JGroup {
    ...
    public AcceptancePanel() {
      super(
          CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.acceptance"),
          false); //$NON-NLS-1$

      JLabel termsLabel =
          new JLabel(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmrightstab.terms")); //$NON-NLS-1$

      required =
          new JRadioButton(
              CurrentLocale.get("com.dytech.edge.admin.wizard.editor.drm.drmrightstab.requireall"),
              true); //$NON-NLS-1$
      selectable =
          new JRadioButton(
              CurrentLocale.get(
                  "com.dytech.edge.admin.wizard.editor.drm.drmrightstab.allow")); //$NON-NLS-1$
