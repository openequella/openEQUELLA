...
public class LearningEdgeOdaDelegateImpl implements LearningEdgeOdaDelegate {
  ...
  public void setPluginService(PluginService pluginService) {
    delegates =
        new PluginTracker<QueryDelegate>(
            pluginService, "com.tle.core.reporting", "queryDelegate", "id");
  ...
  @Override
  public IResultSetExt executeQuery(
      String queryType, String query, List<Object> params, int maxRows) throws OdaException {
