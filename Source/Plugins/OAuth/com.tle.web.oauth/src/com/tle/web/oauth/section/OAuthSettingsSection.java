...
@Bind
public class OAuthSettingsSection extends AbstractParentSettingsSection<Object>
{
	@PlugKey("oauth.page.title")
	private static Label TITLE_LABEL;
	@PlugKey("oauth.setting.description")
	...
	{
		return !aclService.filterNonGrantedPrivileges(OAuthConstants.PRIV_CREATE_OAUTH_CLIENT,
	...
	{
		return new Pair<HtmlLinkState, Label>(getShowOAuthLink(context), DESCRIPTION_LABEL);
	}

	@SuppressWarnings("nls")
	public static HtmlLinkState getShowOAuthLink(SectionInfo info)
	{
		final HtmlLinkState state = new HtmlLinkState();
		final SectionInfo fwd = info.createForward("/access/oauthadmin.do");
