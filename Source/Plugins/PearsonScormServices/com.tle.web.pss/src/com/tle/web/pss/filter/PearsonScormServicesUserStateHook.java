...
public class PearsonScormServicesUserStateHook extends AbstractOAuthV1UserStateHook
{
	...
	protected String getSecretFromKey(String key)
	{
		...
		if( key.equals(pssSettings.getConsumerKey()) )
		{
			...
			String errmsg = "Pearson SCORM Services is not enabled in this institution: " + CurrentInstitution.get();
	...
	{
		return new UserStateResult(new SystemUserState(null), Result.LOGIN_NO_SESSION_CREATION);
	}
}
