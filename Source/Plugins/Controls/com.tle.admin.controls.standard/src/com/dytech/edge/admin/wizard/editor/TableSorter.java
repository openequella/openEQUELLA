...
public class TableSorter extends AbstractTableModel
{
	...
	protected class TableModelHandler implements TableModelListener, Serializable
	{
		@Override
		...
		//AH: wtf is this about?
		// sonar strongly recommended that (x.compareTo(y)==0)==(x.equals(y))
		@Override
