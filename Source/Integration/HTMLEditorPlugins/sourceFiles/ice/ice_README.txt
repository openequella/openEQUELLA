...
Upload the ice.zip file into EQUELLA: Settings -> HTML editor -> Plugins



** 2. Edit the editor toolbar **

Add the buttons (There are 6 of them, they will appear towards the end of the 'available buttons' list) to the HTML editor toolbar: Settings -> HTML editor -> Toolbar
