 ...
 * @dytech.jira see Jira Issue TLE-797 : http://apps.dytech.com.au/jira/browse/TLE-797
 */
      ...
      if (result == JFileChooser.APPROVE_OPTION) {
        ...
        try {
          ...
          JOptionPane.showMessageDialog(
              this, "The select XSLT is not valid XML.", "Invalid XSLT", JOptionPane.ERROR_MESSAGE);
        }
      }
    }
  }
