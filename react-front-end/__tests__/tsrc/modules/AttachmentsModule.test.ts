...
describe("updateAttachmentForCustomInfo", () => {
  ...
  it("updates Kaltura attachments", () => {
    ...
    expect(updated.links.view).toBe(
      "http://localhost:8080/ian/items/91406c5e-e2fe-4528-beac-ab22266e0f50/1/?attachment.uuid=5673f889-6f72-432d-ad50-29b505a28739&externalId=4211234%2F48123443%23V7%2F1_d1h8f1dx",
    );
  });
