...
import { buildBookmarkOwnerMusts } from "../../../tsrc/favourites/FavouritesPageHelper";

describe("buildBookmarkOwnerMusts", () => {
  ...
  it("returns undefined when user is undefined", () => {
    const result = buildBookmarkOwnerMusts(undefined);
