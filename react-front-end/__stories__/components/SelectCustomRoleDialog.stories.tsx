...
EmptySelection.args = defaultProps;

export const WithSomeSelections: StoryFn<SelectCustomRoleDialogProps> = (
  args,
) => <SelectCustomRoleDialog {...args} />;
...
export const WithCustomSelector: StoryFn<SelectCustomRoleDialogProps> = (
  args,
) => <SelectCustomRoleDialog {...args} />;
