...
public class OAuthRedirectorServlet extends HttpServlet {
  ...
  private final ConcurrentMap<String, TestInfo> session =
      new MapMaker().expireAfterAccess(30, TimeUnit.MINUTES).makeMap();
    ...
    if (error != null) {
      Map<String, String> vals =
          ImmutableMap.of(
              ...
              request.getParameter(PARAM_ERROR_DESCRIPTION));
  ...
  private void writeMapResponse(HttpServletResponse response, Map<String, String> vals)
      throws IOException {
