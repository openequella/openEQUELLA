...
public interface CollectionResource
    extends BaseEntityResource<CollectionBean, AllCollectionsSecurityBean> {
  @Override
  @GET
  @Path("/")
  ...
  @ApiOperation(
      ...
      notes = "Create new or list existing collections")
  @ApiResponses({@ApiResponse(code = 201, message = "Location: {newcollection uri}")})
  public Response create(
      @Context UriInfo uriInfo,
      @ApiParam(value = "Collection") CollectionBean bean,
  ...
  public Response edit(
      ...
      @ApiParam(required = false, value = "The lock UUID if locked") @QueryParam("lock")
          String lockId,
      @ApiParam(value = "Unlock collection after edit") @QueryParam("keeplocked")
          boolean keepLocked);
  ...
  @Path("/{uuid}/lock")
  @ApiOperation(
      value = "Lock a collection",
      notes = "A collection lock will prevent others from editing it while locked",
