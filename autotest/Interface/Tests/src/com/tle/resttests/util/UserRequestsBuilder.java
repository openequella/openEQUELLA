...
public class UserRequestsBuilder
{
	...
	{
		return new UserRequests(baseURI, MAPPER, test.getContext(), test, test.getTestConfig(), "tle010");
	}
	...
	{
		return new GroupRequests(baseURI, MAPPER, test.getContext(), test, test.getTestConfig(), "tle010");
	}
	...
	{
		return new RoleRequests(baseURI, MAPPER, test.getContext(), test, test.getTestConfig(), "tle010");
	}
