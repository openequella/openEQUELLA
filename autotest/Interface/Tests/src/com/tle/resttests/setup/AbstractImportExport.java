...
public abstract class AbstractImportExport implements CleanupController {
  ...
  public AbstractImportExport(
      TestConfig testConfig, String fullName, String shortName, String password, File baseDir) {
    this(
        testConfig,
        fullName,
        shortName,
        ...
        password,
        baseDir,
        testConfig.getInstitutionUrlFromShortName(shortName));
  }
  ...
  public AbstractImportExport(
    ...
    // @formatter:off
    entityTypesBuilder.putAll(
        ImmutableMap.of(
            "schema", new SchemaRequests(baseURI, token, MAPPER, pageContext, this, testConfig),
            "collection",
                new CollectionRequests(baseURI, token, MAPPER, pageContext, this, testConfig),
            "oauth", new OAuthRequests(baseURI, token, MAPPER, pageContext, this, testConfig),
            "workflow",
                new WorkflowRequests(baseURI, token, MAPPER, pageContext, this, testConfig)));
    // @formatter:on
    ...
    instRequests =
        new InstitutionRequests(adminUri, MAPPER, pageContext, this, testConfig, adminPassword);
