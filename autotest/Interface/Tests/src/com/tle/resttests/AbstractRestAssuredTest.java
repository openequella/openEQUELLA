...
public class AbstractRestAssuredTest extends AbstractSessionTest implements TokenProvider, CleanupController
{
	...
	public OAuthTokenCache getTokens()
	{
		if( tokens == null )
		{
			tokens = new OAuthTokenCache(URI.create(context.getBaseUrl()), MAPPER, context, this, testConfig);
		}
		return tokens;
	}
