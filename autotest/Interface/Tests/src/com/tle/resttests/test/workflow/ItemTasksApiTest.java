...
public class ItemTasksApiTest extends AbstractRestAssuredTest
{
	...
	{
		return items.createId(RestTestConstants.COLLECTION_NOTIFICATIONS, true, "item/name", context.getFullName(name));
	}
	...
	public void commentItem() throws Exception
	{
		...
		ItemStatusAssertions.assertComment(findStatus(moderation, TASK1_UUID), 0, "This is a comment",
			getDefaultUser(), "comment");
	}
}
