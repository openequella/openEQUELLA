...
public class CollectionAndSchemaApiLockTest extends AbstractEntityApiLockTest
{
	...
	private void createEntities() throws Exception
	{
		...
		HttpResponse response = postEntity(schema.toString(), context.getBaseUrl() + "api/schema", token, true);
		...
		response = postEntity(collection.toString(), context.getBaseUrl() + "api/collection", token, true);
