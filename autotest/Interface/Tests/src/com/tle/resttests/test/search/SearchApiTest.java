...
public class SearchApiTest extends AbstractRestApiTest {
  ...
  public Object[][] getSortData() {
    ...
    return new Object[][] {
      {"name", new Integer[] {0, 1, 2, 3, 4}}, {"modified", new Integer[] {3, 4, 2, 1, 0}},
  ...
  public Object[][] getWhereData() {
    ...
    Object[] basicClause =
        new Object[] {
          "/xml/item/name = 'SearchApiTest - Other collection'",
          Lists.newArrayList("SearchApiTest - Other collection"),
          "SearchApiTest"
        };
    Object[] notClause =
        new Object[] {
          "/xml/item/name is not 'SearchApiTest - Other collection'",
          Lists.newArrayList("SearchApiTest - Other collection draft"),
          "\"SearchApiTest - Other collection\""
        };
    Object[] existsClause =
        new Object[] {
          "/xml/item/controls/checkboxes exists",
          Lists.newArrayList(
              "MyResourcesApiTest - Moderating", "TaskApiTest - Unassigned, must moderate"),
    ...
    Object[] orClause =
        new Object[] {
          ...
          Lists.newArrayList(
              "SearchApiTest - Other collection", "SearchApiTest - Other collection draft"),
          "SearchApiTest"
        };
    Object[] dateGTClause =
        new Object[] {
          ...
          Lists.newArrayList(
              "TaskApiTest - High priority, long due date",
              "TaskApiTest - Low priority, long due date"),
          "TaskApiTest"
        };
    Object[] dateGTEClause =
        new Object[] {
    ...
    if (isEquella()) {
      ...
      dateLTClause =
          new Object[] {
            ...
            Lists.newArrayList(
                "TaskApiTest - High priority, short due date",
                "TaskApiTest - Low priority, short due date",
                "TaskApiTest - Task assigned to me",
                "TaskApiTest - Task assigned to someone else"),
            "TaskApiTest"
          };
    } else {
      dateLTClause =
    ...
    Object[] fromWhereParserTest =
        new Object[] {
          "(/xml/item/@id = 'blah' AND /xml/item/something = 'blah2')"
              ...
              + " OR (/xml/item/notnull IS NOT NULL AND /xml/item/@id = 'tsf')",
          Lists.newArrayList(),
          ""
        };
  ...
  public void testShowall() throws Exception {
    ...
    asserter.assertBasic(
        (ObjectNode) itemsNode.get(1), "SearchApiTest - Other collection draft", null);
  }
  ...
  public void testWhereClause(String where, List<String> names, String query) throws Exception {
    ...
    JsonNode resultsNode =
        doSearch(
            "basic",
            query,
            ImmutableMap.of("order", "name", "showall", "true", "where", where),
            token);
