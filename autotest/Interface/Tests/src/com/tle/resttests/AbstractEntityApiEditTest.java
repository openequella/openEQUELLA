...
public abstract class AbstractEntityApiEditTest extends AbstractEntityCreatorTest
{
	...
	protected void customisePageContext()
	{
		...
		editPrivRequests = createRequestsWithBuilder(builder().user(RestTestConstants.USERID_RESTNOPRIV));
	}
	...
	public void testBasicPrivs()
	{
		...
		addRule(json, rule(getEditPrivilege(), true, false, userWho(RestTestConstants.USERID_RESTNOPRIV)));
