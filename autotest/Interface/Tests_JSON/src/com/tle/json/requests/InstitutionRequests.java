...
public class InstitutionRequests extends AbstractCleanupRequests<String> {
  ...
  public InstitutionRequests(
    ...
    this(
        baseUri,
        new SystemTokenProvider(password),
        mapper,
        pageContext,
        cleanupController,
        testConfig,
  ...
  public ObjectNode jsonAppendBaseUrl(
      String name, String password, String filestoreId, String url, boolean enabled) {
