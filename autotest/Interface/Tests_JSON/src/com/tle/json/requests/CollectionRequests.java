...
public class CollectionRequests extends BaseEntityRequests
{
	public CollectionRequests(URI baseUri, TokenProvider tokens, ObjectMapper mapper, PageContext pageContext,
