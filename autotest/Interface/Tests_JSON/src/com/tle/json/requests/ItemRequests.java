...
public class ItemRequests extends AbstractCleanupRequests<ItemId>
{
	...
	public ItemRequests(URI baseUri, TokenProvider tokens, ObjectMapper mapper, PageContext pageContext,
	...
	public ItemId createId(String collection, boolean waitForIndex, String firstParam, Object value, Object... others)
	{
	...
	public ObjectNode create(ObjectNode object, boolean waitForIndex, String firstParam, Object value, Object... others)
	{
	...
	public RequestSpecification createRequest(ObjectNode object, Object waitForIndex, String param, Object paramValue,
		Object... others)
	{
	...
	protected RequestSpecification deleteRequest(boolean requireSuccess, boolean purge, boolean waitForIndex)
	{
	...
	{
		return object(successfulRequest().get(getResolvedEntityUri() + "/moderation", getIdParams(itemId)));
	}
	...
	{
		return requestWaiter(successfulRequest()).until(new Function<RequestSpecification, T>()
		{
			@Override
	...
	public String copyFilesForEdit(ItemId itemId)
	{
		return createRequest().post(
			getResolvedPath() + "/copy?uuid=" + itemId.getUuid() + "&version=" + itemId.getVersion()).getHeader(
			"location");
	}
	...
	{
		request.post(getResolvedEntityUri() + "/action/{action}", itemId.getUuid(), itemId.getVersion(), action);
		return get(itemId);
	}
	...
	{
		return object(successfulRequest().get(getResolvedEntityUri() + "/file", itemId.getUuid(), itemId.getVersion()));
	}

	public Response file(RequestSpecification request, ItemId itemId, String filePath)
	{
		return request.get(getResolvedEntityUri() + "/file/" + filePath, itemId.getUuid(), itemId.getVersion());
	}

	public Response headFile(ItemId itemId, String filePath)
	{
		return successfulRequest().head(getResolvedEntityUri() + "/file/" + filePath, itemId.getUuid(),
			itemId.getVersion());
	}
