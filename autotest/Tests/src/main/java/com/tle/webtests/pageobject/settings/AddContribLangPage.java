...
{
	public static final String ADD_CONTRIBLANG_HEADER = "Select Language and/or Country"; // original property is addlanguage.dialog.title.title
	...
	public void selectLanguage(String languageVal)
	{
		...
		EquellaSelect languageList = new EquellaSelect(context, driver.findElement(By.id(LANG_DROPDOWN_ID)));
		languageList.selectByValue(languageVal);
	}

	public void selectCountry(String countryVal)
	{
		EquellaSelect countryList = new EquellaSelect(context, driver.findElement(By.id(CNTR_DROPDOWN_ID)));
