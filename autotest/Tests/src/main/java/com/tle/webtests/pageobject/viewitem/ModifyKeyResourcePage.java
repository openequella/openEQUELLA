...
public class ModifyKeyResourcePage extends AbstractPage<ModifyKeyResourcePage>
{
	...
	{
		expandAll();
		WebElement selectedTopic = driver.findElement(By.xpath("//span[text()=" + quoteXPath(topic) + "]/../input"));
	...
	{
		List<WebElement> elements = driver.findElements(By.xpath("//li[contains(@class,'expandable')]/div"));
