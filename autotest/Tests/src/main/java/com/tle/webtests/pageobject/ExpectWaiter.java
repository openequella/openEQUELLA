...
public class ExpectWaiter<T extends PageObject> implements WaitingPageObject<T>
{
	...
	protected ExpectWaiter(ExpectedCondition<?> condition, WebDriverWait waiter, WaitingPageObject<? extends T> other)
	{
	...
	public static <T extends PageObject> ExpectWaiter<T> waiter(ExpectedCondition<?> condition,
		WaitingPageObject<? extends T> other)
	{
