...
public class GroupControl extends AbstractWizardControl<GroupControl>
{
	...
	public GroupControl(PageContext context, AbstractWizardControlPage<?> page, int ctrlNum, int treeOffset)
	{
	...
	{
		return driver.findElement(By.xpath("//input[@name=" + quoteXPath(page.subComponentId(ctrlnum, "selected"))
			+ " and @value=" + quoteXPath(groupValue) + "]"));
	}
