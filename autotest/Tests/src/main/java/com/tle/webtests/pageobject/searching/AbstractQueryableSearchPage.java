...
public abstract class AbstractQueryableSearchPage<T extends AbstractQueryableSearchPage<T, RL, SR>, RL extends AbstractResultList<RL, SR>, SR extends SearchResult<SR>>
	extends
		AbstractSearchPage<T, RL, SR>
{
