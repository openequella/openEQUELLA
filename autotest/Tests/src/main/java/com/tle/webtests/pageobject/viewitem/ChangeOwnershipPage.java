...
public class ChangeOwnershipPage extends ItemPage<ChangeOwnershipPage> {
  ...
  public String getSelectedOwner() {
    return driver
        .findElement(By.xpath("id('owner')//td[@class='name']/span"))
        .getAttribute("title");
  }
  ...
  public void removeCollaborator(String collab) {
    ...
    collabSelectedStuff.clickActionWithConfirm(
        collab, "Remove", Boolean.TRUE, collabSelectedStuff.removalWaiter(collab));
  }
  ...
  public boolean isOwnershipChanged(String owner) {
    String trackerStatus =
        driver.findElement(By.xpath("//div[@id='adjacentuls']/ul[1]/li[1]")).getText();
    return trackerStatus.equals(owner);
  }

  public boolean isCollaboratorChanged(String collaborator) {
    String trackerStatus =
        driver.findElement(By.xpath("//div[@id='adjacentuls']/ul[1]/li[2]")).getText();
