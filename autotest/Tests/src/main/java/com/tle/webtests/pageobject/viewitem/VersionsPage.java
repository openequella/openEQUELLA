...
public class VersionsPage extends AbstractPage<VersionsPage>
{
	...
	{
		driver.findElement(
			By.xpath("//table[contains(@class, 'zebra')]//td[normalize-space(text())=" + quoteXPath(version)
	...
	{
		WebElement versionRow = driver.findElement(By.xpath("//table[@id='vc_v']/tbody/tr[./td[text()='" + version
			+ "']]/td[3]"));
