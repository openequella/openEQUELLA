...
public class SelectGroupControl extends AbstractWizardControl<SelectGroupControl> {
  ...
  public void removeGroup(String groupname) {
    ...
    getRootElem()
        .findElement(
            By.xpath(
                xpathForGroupname(groupname) + "/../td[@class='actions']/a[@class='unselect']"))
        .click();
    acceptConfirmation();
    waiter.get();
  }
  ...
  public WaitingPageObject<SelectGroupControl> selectedWaiter(String newlySelected) {
    return ExpectWaiter.waiter(
        ExpectedConditions2.visibilityOfElementLocated(
            getRootElem(), By.xpath(xpathForGroupname(newlySelected))),
        this);
  }
  ...
  public WaitingPageObject<SelectGroupControl> removedWaiter(String removed) {
    return ExpectWaiter.waiter(
        ExpectedConditions2.invisibilityOfElementLocated(
            getRootElem(), By.xpath(xpathForGroupname(removed))),
        this);
  }
}
