...
public interface TermSoapService {
   ...
   * taxonomy. An error will be raised if the lock cannot be aquired, most likely because it has
  ...
  /**
   * Unlock a taxonomy that you previously aquired a lock on. You can also choose to forcefully
