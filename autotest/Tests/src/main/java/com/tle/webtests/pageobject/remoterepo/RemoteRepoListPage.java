...
public class RemoteRepoListPage extends AbstractResultList<RemoteRepoListPage, RemoteRepoSearchResult>
{
	...
	protected void isError()
	{
		...
		if( isPresent(By
			.xpath("//div[@class='searchError']/p[contains(text(),'The host did not accept the connection')]")) )
		{
			throw new SkipException("Remote repo timed out...");
		}
		super.isError();
