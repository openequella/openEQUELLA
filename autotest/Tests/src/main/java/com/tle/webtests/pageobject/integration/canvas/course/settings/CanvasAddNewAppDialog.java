...
public class CanvasAddNewAppDialog extends AbstractPage<CanvasAddNewAppDialog>
{
	...
	public WaitingPageObject<CanvasAppsTab> addByPasting(String name, String consumerKey, String consumerSecret,
		String configXML, WaitingPageObject<CanvasAppsTab> returnTo)
	{
