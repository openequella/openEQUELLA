...
public interface SoapService41
{
	...
	// names as well then
	// be my guest :)
	String login(@WebParam(name = "in0") String username, @WebParam(name = "in1") String password) throws Exception;
	 ...
	 */
	void uploadFile(String stagingId, String filename, String base64Data, boolean overwrite) throws Exception;
	 ...
	 *            "Index for Power Searches" selected.
	...
	String searchItems(String freetext, String[] collectionUuids, String whereClause, boolean onlyLive, int orderType,
		boolean reverseOrder, int offset, int length) throws Exception;
	...
	String searchItemsFast(String freetext, String[] collectionUuids, String whereClause, boolean onlyLive,
		int orderType, boolean reverseOrder, int offset, int length, String[] resultCategories) throws Exception;
	 ...
	 *            will retrieve the latest live version, 
	 *            a version of -1 will retrieve the latest version (which may not be live) 
	 ...
	 * @throws Exception
	 */
	String acceptTask(String itemUuid, int itemVersion, String taskId, boolean unlock) throws Exception;
