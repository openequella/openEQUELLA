...
public class RemoteRepoAdvancedZ3950SearchPage
	extends
		AbstractRemoteRepoSearchPage<RemoteRepoAdvancedZ3950SearchPage, RemoteRepoListPage, RemoteRepoSearchResult>
{
	...
	public RemoteRepoListPage exactQuery(String s1, String q1, String o1, String s2, String q2, String o2, String s3,
		String q3)
	{
