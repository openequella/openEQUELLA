...
public class BlackboardToolAvailabilityPage extends AbstractBlackboardCoursePage<BlackboardToolAvailabilityPage>
{
	...
	public void availible()
	{
		...
		WebElement check = driver.findElement(By
			.xpath("//label[text()='Available in Content Area - EQUELLA Object']/following-sibling::input"));
		if( !check.isSelected() )
		{
			check.click();
		}
