...
public class ItemAdminPage
    extends AbstractBulkResultsPage<ItemAdminPage, ItemListPage, ItemSearchResult> {
  @FindBy(id = "status")
  ...
  protected void setWithin(String name) {
    ...
    driver
        .findElement(richdropdown)
        .findElement(By.xpath("ul/li/a[text()=" + quoteXPath(name) + "]"))
        .click();
  }
