 ...
 *
 */
public class WhereQueryPage<T extends PageObject> extends AbstractWizardControlPage<WhereQueryPage<T>>
{
	...
	/**
	 * "WHERE" is probably the only clause available on initial construction of
	 * the query. "AND" or "OR" can be expected to appear after a "WHERE" exists.
	 * @param predicate
	 */
