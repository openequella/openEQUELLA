...
public class FreemarkerPortalEditPage extends AbstractPortalEditPage<FreemarkerPortalEditPage> {
  ...
  public void loadFreemarkerScript(PrefixedName scriptName) {
    ...
    driver
        .findElement(
            By.xpath("//div[@id = 'fm-editor']/div/button[contains(@class,'dropdown-toggle')]"))
        .click();
    freeMarkerAjax
        .findElement(
            By.xpath(
                "//ul[@class = 'dropdown-menu']/li/a[text() ="
                    + quoteXPath(scriptName.toString())
                    + "]"))
        .click();
    ajaxUpdate.get();
  }
  ...
  public void loadClientSideScript(PrefixedName scriptName) {
    ...
    driver
        .findElement(
            By.xpath("//div[@id = 'client-editor']/div/button[contains(@class,'dropdown-toggle')]"))
        .click();
    driver
        .findElement(
            By.xpath(
                "//div[@id='client-editor']/div/ul[@class = 'dropdown-menu']/li/a[text() ="
                    + quoteXPath(scriptName.toString())
                    + "]"))
        .click();
    ajaxUpdate.get();
