...
public interface SoapService51 extends SoapService50 {
   ...
   * @return An XML user object representing the user's details. <em>See the section on XML Formats
   *     in {@link com.tle.web.remoting.soap SOAP Services} for the format of the User XML</em>
   * @throws Exception Will throw a NotFoundException if the user cannot be found.
   */
  String getUser(String userId) throws Exception;

  /**
   * Creates an internal EQUELLA user on the server. This does not assign the user to any groups,
  ...
  /**
   * Update the user on the server with the modifications made to the user. You may optionally
   * specifiy a new password for the user.
   *
   * @param userId The unique ID of the user to edit.
   * @param username The user's new username.
   * @param password The user's new password in plain text. May be null, in which case the password
   *     is not changed.
  ...
  /**
   * Adds the user (external or internal) with the id of userId to the internal EQUELLA group with
   * the id of groupId.
   *
  ...
  /**
   * Remove the user (external or internal) with the id of userId from the internal EQUELLA group
   * with the id of groupId.
   *
  ...
  /**
   * Is the user (external or internal) with id of userId <b>directly in</b> (that is, not in a
   * subgroup of) the internal EQUELLA group with the id of groupId.
   *
  ...
  /**
   * Removes all the users (internal and external) from the internal EQUELLA group with id of
   * groupId. Use with caution.
   *
  ...
  /**
   * Finds all the internal EQUELLA users that match the searchString. If a groupUuid is provided
   * the search is restricted to that group. If no groupUuid is provided the search will encompass
   * all groups
   *
  ...
  /**
   * Finds all the internal EQUELLA groups that the user is a member of. This includes nested groups
   *
   * @param userUuid
   * @return XML of format: <div class="block">
   *     <pre>
  ...
  /**
   * Changes the name of an existing internal EQUELLA group to the name provided
   *
  ...
  /**
   * Changes the parent of an existing internal EQUELLA group to the parent group specified
   *
