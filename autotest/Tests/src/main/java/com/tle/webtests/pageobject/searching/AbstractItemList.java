...
public abstract class AbstractItemList<T extends AbstractItemList<T, SR>, SR extends AbstractItemSearchResult<SR>>
	extends
		AbstractResultList<T, SR>
{
	...
	/**
	 * convenient static method to dig out the numeric value (23345) from a
	 * string such as "Showing 21 to 30 of 23,345 results" We assume the 'real'
	 * number is the last sequence of digits from the end
	 * 
	 * @param summaryString
	 * @return
	 */
	public static int parseAllAvailableFromSummaryString(String summaryString)
	{
		...
		for( char ch = summaryString.charAt(charIndex); ch == ',' || Character.isDigit(ch); ch = summaryString
			.charAt(--charIndex) )
		{
