...
public class ShuffleGroupControl extends AbstractWizardControl<ShuffleGroupControl> {
  ...
  public ShuffleGroupControl(
      PageContext context, int ctrlnum, AbstractWizardControlPage<?> page, int treenum) {
  ...
  public void remove(String value) {
    getDiv()
        .findElement(
            By.xpath(
                "//tr/td[@class='shuffle-text' and text()="
                    + quoteXPath(value)
                    + "]/../td[@class='actions']/a[@class='shuffle-remove']"))
        .click();
  }
    ...
    getDiv()
        .findElement(
            By.xpath(
                "//tr/td[@class='shuffle-text' and text()="
                    + quoteXPath(value)
                    + "]/../td[@class='actions']/a[@class='shuffle-edit']"))
        .click();
  }
