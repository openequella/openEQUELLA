...
* Sessions:
* Soap Sessions are now maintained by using HTTP Cookies, so your client must
* support them in order to work with SoapInterfaceV2. <br>
* The session id you pass to each method will NOT be used to link to an existing session, it
* will be used purely for diagnostic purposes.  That is, if the session id does not match the session
* retrieved by the server based on the cookie the client sent (if indeed it did), then an exception will be thrown.
*/
public interface SoapInterfaceV2
{
	 ...
	 * This method will throw an exception if Authentication fails.
	 *
	 ...
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV1 sessions})
	 */
	 ...
	 *
	 * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	...
	/**
	 * Get the names of all task filters.
	 *
	 * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	 * @return An array of task filter names.
	 */
	String[] getTaskFilterNames(String ssid);

	/**
	 * Do a task filter search and return the matching items.
	 *
	 * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	 * @param filterName The name of the filter to search with.
	 * @param start The number of the first result (starts from 0).
	 * @param numResults The maximum number of results to return.
	 * @return An array of {@link ItemTaskSimple}
	 */
	ItemTaskSimple[] getTaskList(String ssid, String filterName, int start, int numResults);
	...
	/**
	 * Check to see if the local EQUELLA user exists with the given uuid
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	...
	/**
	 * Check to see if the local EQUELLA user exists with the given loginName
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	...
	/**
	 * Check to see if the local EQUELLA group exists with the given uuid
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	...
	/**
	 * Find the local EQUELLA group Uuid with the given groupName
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	...
	/**
	 * Add a group with the given groupId and groupName to local EQUELLA users group
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	...
	/**
	 * Remove a group with the given groupId from local EQUELLA users group
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	 * @param groupId The Uuid of the group.
	 */
	...
	/**
	 * Remove all the users of  group with the given groupId from local EQUELLA users group
	 * * @param ssid The current session id
	 * (<strong>Important</strong>: please see documentation on {@link com.tle.core.remoting.SoapInterfaceV2 sessions})
	 * @param groupId The Uuid of the group.
	 */
	 ...
	 */
	public static class ItemTaskSimple
	{
