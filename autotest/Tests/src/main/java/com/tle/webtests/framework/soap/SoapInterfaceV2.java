 ...
 * your client must support them in order to work with SoapInterfaceV2. <br>
...
public interface SoapInterfaceV2 {
   ...
   * @throws Exception
   */
  String acceptTask(String ssid, String itemUuid, int itemVersion, String taskId, boolean unlock)
      throws Exception;
  ...
  /**
   * Check to see if the local EQUELLA user exists with the given uuid * @param ssid The current
   * session id (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
  ...
  /**
   * Check to see if the local EQUELLA user exists with the given loginName * @param ssid The
   * current session id (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
  ...
  /**
   * Check to see if the local EQUELLA group exists with the given uuid * @param ssid The current
   * session id (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
  ...
  /**
   * Find the local EQUELLA group Uuid with the given groupName * @param ssid The current session id
   * (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
  ...
  /**
   * Add a group with the given groupId and groupName to local EQUELLA users group * @param ssid The
   * current session id (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
  ...
  /**
   * Remove a group with the given groupId from local EQUELLA users group * @param ssid The current
   * session id (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
   * @param groupId The Uuid of the group.
  ...
  /**
   * Remove all the users of group with the given groupId from local EQUELLA users group * @param
   * ssid The current session id (<strong>Important</strong>: please see documentation on {@link
   * com.tle.core.remoting.SoapInterfaceV2 sessions})
   *
   * @param groupId The Uuid of the group.
   */
