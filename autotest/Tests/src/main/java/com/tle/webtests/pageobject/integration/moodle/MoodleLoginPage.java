...
public class MoodleLoginPage extends MoodleBasePage<MoodleLoginPage> {
  ...
  public MoodleLoginPage(PageContext context) {
    super(
        context,
        By.xpath(
            "//h2[contains(text(), 'Log in') or contains(text(), 'Returning to this web site')]"));
  }
  ...
  public UndeterminedPage<PageObject> logonToUndetermined(
      String username, String password, AbstractPage<?> page1, AbstractPage<?> page2) {
