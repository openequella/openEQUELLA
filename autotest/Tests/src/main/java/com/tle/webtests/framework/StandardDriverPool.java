...
public class StandardDriverPool {
  private final Map<WebDriverCheckout, WebDriverCheckout> checkoutDrivers =
      Maps.newIdentityHashMap();
  private final Map<WebDriverCheckout, WebDriverCheckout> returnedDrivers =
      Maps.newIdentityHashMap();
  ...
  public synchronized WebDriverCheckout getDriver(WebDriverCheckout preferredDriver, Class<?> clazz)
      throws Exception {
