...
public class ReceiptPage {
  ...
  public static <T extends PageObject> WaitingPageObject<T> waiter(
      String text, WaitingPageObject<T> pageObject) {
    return ExpectWaiter.waiter(condition(text), pageObject);
  }

  public static <T extends PageObject> WaitingPageObject<T> waiterContains(
      String text, WaitingPageObject<T> pageObject) {
