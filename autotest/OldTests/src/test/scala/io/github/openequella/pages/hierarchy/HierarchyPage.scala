...
class HierarchyPage(
  ...
  /** When the pin icon is highlighted click to remove this item from key resource.
    *
    * @param itemName
    *   The name of the item to add as a key resource.
    */
  ...
  /** When the pin icon is highlighted click to remove this item from key resource.
    *
    * @param itemName
    *   The name of the item to remove from key resource.
    */
  ...
  /** Click the pin icon button in KeyResourcePanel to remove the key resource.
    *
    * @param itemName
    *   The name of the item to remove from the key resource panel.
    */
  ...
  /** Click the breadcrumb to navigate to the hierarchy.
    *
    * @param hierarchyName
    *   The name of the hierarchy to click.
    * @param returnTo
    *   The page object to return to after clicking.
    */
