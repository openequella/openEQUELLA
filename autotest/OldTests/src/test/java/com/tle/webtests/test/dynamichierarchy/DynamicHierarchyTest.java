...
public class DynamicHierarchyTest extends AbstractCleanupTest
{
	...
	public void modifyKeyResourceLinkOnItemSummary()
	{
		...
		assertTrue(results.doesKeyResourceExist(TESTING_ITEM, 1), TESTING_ITEM + " doesn't exist in " + TOPIC_1);
	}
	...
	public void testKeyResourceReferenceRemove()
	{
		...
		WizardPageTab wiz = new MenuSection(context).clickMenu("Contribute", new WizardPageTab(context, 0));
