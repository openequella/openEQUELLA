...
public class PortalsTest extends AbstractCleanupTest
{
	...
	public void testFavPortal()
	{
		...
		FavouriteSearchesPage favSearches = new MenuSection(context).clickMenu("Favourites",
			new FavouritesPage(context)).searches();
	...
	public void testMyResourcesPortal()
	{
		...
		MyResourcesPortalSection myResources = new MyResourcesPortalSection(context, myResourceName).get();
	...
	public void testRecentPortal()
	{
		...
		WizardPageTab wizard1 = new ContributePage(context).load().openWizard(GENERIC_TESTING_COLLECTION);
		wizard1.editbox(1, liveItemName);
		wizard1.save().publish();

		String draftItemName = context.getFullName("draft item");
		WizardPageTab wizard2 = new ContributePage(context).load().openWizard("Simple Controls Collection");
		...
		WizardPageTab wizard3 = new ContributePage(context).load().openWizard(GENERIC_TESTING_COLLECTION);
