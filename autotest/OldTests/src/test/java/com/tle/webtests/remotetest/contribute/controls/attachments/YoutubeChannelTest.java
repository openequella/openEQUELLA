...
public class YoutubeChannelTest extends AbstractCleanupTest {
  ...
  public void youTubeChannels() {
    ...
    control
        .editResource(new YouTubeUniversalControlType(control), MATHS_VIDEO)
        .setDisplayName("A Video")
        .save();
    ...
    item.adminTab().edit();
    control = wizard.universalControl(2);
    YouTubeUniversalControlType addingResorce =
        control.addDefaultResource(new YouTubeUniversalControlType(control));
    ...
    control = wizard.universalControl(2);
    control
        .replaceSingleResource(new YouTubeUniversalControlType(control), "Cat Video")
        .search("Equella", "All Youtube")
        .selectVideo(2, "FIXME");
  ...
  public void youTubeNoChannels() {
    ...
    control = wizard.universalControl(2);
    control
        .editResource(new YouTubeUniversalControlType(control), "EQUELLA Video")
        .setDisplayName("A Video")
        .save();
    item = wizard.saveNoConfirm();
    assertTrue(item.attachments().attachmentExists("A Video"));
    ...
    GoogleBooksUniversalControlType book =
        control.replaceResource(new GoogleBooksUniversalControlType(control), "EQUELLA Video");
