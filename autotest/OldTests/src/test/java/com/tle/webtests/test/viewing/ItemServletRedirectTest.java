...
public class ItemServletRedirectTest extends AbstractCleanupAutoTest
{
	...
	private static final String BADITEM_URL3 = "items/268fbf77-ffdd-4731-a474-77c63c6aea62/0/?attachment.uuid=broken";
	...
	public void testRedirects()
	{
		...
		assertEquals(context.getDriver().getCurrentUrl(), context.getBaseUrl()
			+ "items/268fbf77-ffdd-4731-a474-77c63c6aea62/1/?frogs=frogs");
	}
	...
	public void testErrors()
	{
		...
		assertEquals(new ErrorPage(context).get().getMainErrorMessage(), "An error occurred");
		context.getDriver().get(context.getBaseUrl() + BADITEM_URL2);
		assertEquals(new ErrorPage(context).get().getMainErrorMessage(), "Resource not found");
