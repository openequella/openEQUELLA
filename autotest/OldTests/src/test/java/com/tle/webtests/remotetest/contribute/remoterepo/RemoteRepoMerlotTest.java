...
public class RemoteRepoMerlotTest extends AbstractCleanupAutoTest {
  ...
  public Object[][] sortOptions() {
    return new Object[][] {
      {"overallRating"}, {"title"}, {"author"}, {"materialtype"}, {"dateCreated"}
    };
  }
  ...
  public void testMerlotSearchAndContribute() {
    ...
    RemoteRepoMerlotSearchPage rrMerlot =
        rrp.clickRemoteRepository(remoteRepo, new RemoteRepoMerlotSearchPage(context));
    ...
    RemoteRepoViewMerlotResultPage merlotViewResult =
        sr.viewResult(new RemoteRepoViewMerlotResultPage(context));
  ...
  public void testMerlotPaging() {
    ...
    RemoteRepoMerlotSearchPage rrMerlot =
        contribPage.openRemoteRepo(MERLOT, new RemoteRepoMerlotSearchPage(context));
  ...
  public void testMerlotSortOptions(String sortOption) {
    ...
    RemoteRepoMerlotSearchPage rrMerlot =
        rrp.clickRemoteRepository(MERLOT, new RemoteRepoMerlotSearchPage(context));
