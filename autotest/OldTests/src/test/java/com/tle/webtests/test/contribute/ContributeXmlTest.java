...
public class ContributeXmlTest extends AbstractCleanupTest
{
	...
	/**
	 * Preserved in the exported contributions - tests/contribute/institution.tar.gz
	 * being the uuid for the "Basic Items" collection.
	 */
	private static String COLLECTIONS_ID_FROM_TEST_INSTITUTION = "b28f1ffe-2008-4f5e-d559-83c8acd79316";
	...
	public void contributeWithXml()
	{
		...
		itp.setItemXml("<xml><item><name>" + valueOfItemName + "</name><description>" + valueOfItemDescription
			+ "</description></item></xml>");

		// 3rd parameter for courseId not required here.
		String returnedUrl = itp.getSignonUrl(ACTION, USERNAME, "", "contributionCollectionIds="
			+ COLLECTIONS_ID_FROM_TEST_INSTITUTION);
