...
public class CanvasContributeTest extends AbstractCanvasTest
{
	...
	public void testAddExternalTool()
	{
		...
		addNewApp.addByPasting(EXTERNAL_TOOL_NAME, OAUTH_CLIENT_ID, OAUTH_CLIENT_SECRET, autoConfigXML, apps);
	...
	public void testExternalToolModules()
	{
		...
		SelectionCheckoutPage checkout = searchPage.getResult(1).clickAction("Select summary page",
	...
	public void testExternalToolPages()
	{
		...
		SelectionCheckoutPage checkout = searchPage.getResult(1).viewSummary().attachments()
			.selectSingleAttachment(IMAGE);
