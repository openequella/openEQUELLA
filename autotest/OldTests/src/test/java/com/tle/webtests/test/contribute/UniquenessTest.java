...
public class UniquenessTest extends AbstractWizardControlsTest
{
	...
	public void contributeSecond()
	{
		...
		Assert.assertEquals(wizardPage.getErrorMessage(3), "The value in this field must be unique across items");
		Assert.assertEquals(wizardPage.getErrorMessage(6), "The value in this field must be unique across items");
