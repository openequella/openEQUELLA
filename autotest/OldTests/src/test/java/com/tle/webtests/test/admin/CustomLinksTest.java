...
public class CustomLinksTest extends AbstractSessionTest
{
	...
	public Object[][] links()
	{
		return new Object[][]{{"Google", "http://www.google.com/", true},
				{"Yahoo", "http://www.yahoo.com/", false}};
	}
	...
	@Test(dependsOnMethods = {"testAddLink"}, dataProvider = "links")
	...
	@Test(dependsOnMethods = {"testUploadIcon"}, dataProvider = "links")
