...
public class ModerationProgressTest extends AbstractCleanupTest {
  ...
  public void ModerationProgress() throws ParseException {
    ...
    WizardPageTab wizard =
        new ContributePage(context).load().openWizard("Parallel Workflow Collection");
    ...
    assertTrue(
        fiveMinutesFuture > waitTime,
        "fiveMinutesFuture: " + fiveMinutesFuture + " + waitTime: " + waitTime);
  }
  ...
  public void ModerationCommentsFromProgress() {
    ...
    assertTrue(
        modTab.getCommentClass("Acceptance Message").equalsIgnoreCase("modcomment approval"));
