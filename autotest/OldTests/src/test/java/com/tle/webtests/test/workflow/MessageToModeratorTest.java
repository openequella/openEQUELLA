...
public class MessageToModeratorTest extends AbstractCleanupTest
{
	...
	public void messageToModeratorShortCommentTest()
	{
		...
		assertTrue(messageToModeratorBasicTest(fairlyShortComment1, fairlyShortComment2, fairlyShortComment3));
	}

	@Test
	public void messageToModeratorLongCommentTest()
	{
		String enormousComment1 = "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
		...
		String enormousComment2 = "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
			+ " Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit "
			+ "in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit "
			+ "anim id est laborum. Number 2.";

		String enormousComment3 = "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua."
			+ " Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit "
			+ "in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit "
			+ "anim id est laborum. Number 3.";
	...
	public boolean messageToModeratorBasicTest(String moderationComment, String approvalComment, String rejectionComment)
	{
