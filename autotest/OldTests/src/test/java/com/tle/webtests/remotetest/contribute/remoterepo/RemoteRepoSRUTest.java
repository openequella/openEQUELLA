...
public class RemoteRepoSRUTest extends AbstractCleanupAutoTest {
  ...
  public void testSRUSearchAndContribute() {
    ...
    RemoteRepoSRUSearchPage rrSRU =
        rrp.clickRemoteRepository(SRU, new RemoteRepoSRUSearchPage(context));
    rrSRU.blankQuery();
    ...
    RemoteRepoViewSRUResultPage srwViewResult =
        sr.viewResult(new RemoteRepoViewSRUResultPage(context));
  ...
  public void testSRUPaging() {
    ...
    RemoteRepoSRUSearchPage rrSRU =
        contribPage.openRemoteRepo(SRU, new RemoteRepoSRUSearchPage(context));
