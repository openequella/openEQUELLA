...
public class OAuthClientEditorTest extends AbstractCleanupTest
{
	...
	private final static String ACG_NAME = "OAuthClientEditorTest - Authorisation code grant";
	private final static String ACG_CID = "OAuthClientEditorTest - Authorisation code grant, Client ID";
	// Before you try, no it doesn't really exist :)
	private final static String ACG_URL = "http://www.somebogusredirecturl.com";
	private final static String IG_NAME = "OAuthClientEditorTest - Implicit grant";
	private final static String IG_CID = "OAuthClientEditorTest - Implicit grant, Client ID";
	private final static String CCG_NAME = "OAuthClientEditorTest - Client credentials grant";
	...
	public void setupClients()
	{
		...
		assertNotEquals(secret, editPage.getSecret(),
