...
public class CALPrivilegeTest extends AbstractCALTest
{
	...
	public void testDeactivatePrivilege()
	{
		...
		assertTrue(activations.bulk().executeCommandFailure(DEACTIVATE_BULKOP)
	...
	public void testBulkDelete() throws Exception
	{
		...
		assertTrue(bulkResults.errorsContain("You do not have the required privileges [DELETE_ACTIVATION_ITEM]"),
