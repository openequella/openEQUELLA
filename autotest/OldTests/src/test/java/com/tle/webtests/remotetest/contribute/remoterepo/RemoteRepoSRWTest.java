...
public class RemoteRepoSRWTest extends AbstractCleanupAutoTest
{
	...
	public void testSRWSearchAndContribute()
	{
		...
		RemoteRepoSRWSearchPage rrSRW = rrp.clickRemoteRepository(SRW, new RemoteRepoSRWSearchPage(context));
		...
		RemoteRepoViewSRWResultPage srwViewResult = sr.viewResult(new RemoteRepoViewSRWResultPage(context));
	...
	public void testSRWPaging()
	{
		...
		RemoteRepoSRWSearchPage rrSRW = contribPage.openRemoteRepo(SRW,
			new RemoteRepoSRWSearchPage(context));
	...
	public void testSRWBreadcrumbs()
	{
		...
		RemoteRepoSRWSearchPage rrSRW = contribPage.openRemoteRepo(SRW, new RemoteRepoSRWSearchPage(context));
