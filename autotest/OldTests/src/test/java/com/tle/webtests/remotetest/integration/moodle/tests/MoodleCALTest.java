...
public class MoodleCALTest extends AbstractMoodleSectionTest {
  ...
  private final Map<Integer, String> UUID_MAP =
      ImmutableMap.<Integer, String>builder()
          .put(25, "6b303fe3-9885-47b0-9e0c-0b679a200b20")
          .put(26, "72643609-78e0-4a61-8d78-d5251ed82ff1")
          .put(27, "82d9a918-200a-4b67-91f0-404c41d23161")
          .build();
  ...
  public void activateThenDelete() {
    ...
    Assert.assertEquals(
        ...
        ", 'Testable CAL Book - Chapter 1 moodle" + getMoodleVersion() + "' in");
    ...
    logon("teacher", "``````");
    ActivationsSummaryPage activations =
        DynamicUrlPage.load(
                context.getBaseUrl() + "integ/gen/" + itemUuid + "/1/", new SummaryPage(context))
            .cal()
            .activationsTab();
