...
public class DisplayTextReportParametersPage
    extends AbstractReportWindow<DisplayTextReportPage, DisplayTextReportParametersPage> {
  @FindBy(id = "c1")
  ...
  public String getCollectionId(String name) {
    return leftSelect
        .findElement(By.xpath(".//option[text()=" + quoteXPath(name) + "]"))
        .getAttribute("value");
  }
