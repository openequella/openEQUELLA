...
public class DecisionPointScriptingByItemStatusTest extends AbstractCleanupTest {
  ...
  public void scriptingByItemStatus() {
    ...
    WizardPageTab wizard =
        new ContributePage(context).load().openWizard("Decision Point Scripting by Item Status");
    ...
    assertEquals(
        modResults.getStepName(itemFullName), "This item is in moderation, please moderate it.");
