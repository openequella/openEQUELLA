...
public class CascadingParametersReportParametersPage extends
	AbstractReportWindow<CascadingParametersReportPage, CascadingParametersReportParametersPage>
{	
	@FindBy(id = "c1")
