...
public class ConnectorHelper
{
	...
	protected ManageExternalResourcePage selectConnector(ManageExternalResourcePage external, PrefixedName name)
	{
	...
	public SummaryPage createTestItem(String fullName)
	{
		...
		control.addResource(new FileUniversalControlType(control)).uploadPackageOption(Attachments.get("package.zip"))
			.showStructure().save();
