...
public class ItemApiContributeTest extends AbstractItemApiTest {
  ...
  private HttpResponse createItemResponse(String uuid, int version, boolean draft)
      throws Exception {
  ...
  public void createAndSubmit() throws Exception {
    assertResponse(
        createItemResponse(null, 2, false),
        400,
        "Shouldn't be able to create v2 of non-existant item");
