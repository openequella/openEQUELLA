...
public class PearsonSCORMPlayerTest extends AbstractCleanupTest
{
	...
	private static final String CONSUMER_KEY = "9a88edadc6d676293319c3b75810e01a"; // 8ca8f524fc76dda75a1d27da11e88e3f
	...
	{
		WizardPageTab wizard = new ContributePage(context).load()
			.openWizard("Attachments Restricted to SCORM packages");
