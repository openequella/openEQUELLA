...
public interface SoapCourseService
{
	...
	/**
	 * Add a course.   
	 * @param courseXml The XStreamed XML of the {@code CourseInfo}.  For an example
	 * of the XML format, use getCourse
	 */
	 ...
	 * reference anywhere else in the system.  
	 * (E.g. by copyright activations or hierarchy topics)
	 * 
