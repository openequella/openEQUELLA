...
public class BasicSearchingTest extends AbstractCleanupTest {
  ...
  private static final String[] ALL_SEARCHING_ITEMS =
      new String[] {"Searching item 1", "Searching item 2", "Searching item 3", "Searching item 4"};
  private static final String[] ALL_HORSE_ITEMS =
      new String[] {"Horse 1", "Horse 2", "Horse 3", "Horse 4"};
  ...
  public Object[][] queries() {
    ...
    return new Object[][] {
      ...
      {
        "hor?e",
        new String[] {"Horse 3", "Horge 4", "Horse 1", "Search Item Horse 1"},
        new String[] {"Horsey 3"}
      },
      ...
      {"search -horse", new String[] {"Search 2"}, ALL_HORSE_ITEMS},
      {
        ...
        new String[] {"Search Item Horse 1", "Search horse 4"},
        null
      },
  ...
  public void search(String query, String[] items, String[] notItems) {
    ItemListPage results =
        new SearchPage(context).load().search("+" + context.getNamePrefix() + " " + query);
    for (String item : items) {
      String itemName = context.getFullName(item);
      assertTrue(
          results.doesResultExist(itemName, 1), "Expecting '" + itemName + "' for query:" + query);
    }
    if (notItems != null) {
      for (String item : notItems) {
        ...
        assertFalse(
            ...
            "Not expecting '" + itemName + "' for query:" + query);
      }
    }
  }
}
