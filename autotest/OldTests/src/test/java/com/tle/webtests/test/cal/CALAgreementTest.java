...
public class CALAgreementTest extends AbstractCALTest {
  ...
  /** This is being ignored because it doesn't actually test a non-uploaded agreement. */
  @Test
  ...
  public void testViewNonActive() {
    ...
    context
        .getDriver()
        .get(context.getBaseUrl() + "items/2af490d1-bd43-2240-c717-17356cde5e1e/1/Issues_List.doc");
