...
public class BrowseHierarchy2ApiTest extends AbstractRestApiTest {
  Logger log = LoggerFactory.getLogger(BrowseHierarchy2ApiTest.class);
  ...
  public void browseHierarchy() throws IOException {
    ...
    JsonNode subTopics =
        getTopic(hierarchies, "886aa61d-f8df-4e82-8984-c487849f80ff:A James")
            .get("subHierarchyTopics");
    int keyResources =
        getTopic(
                subTopics,
