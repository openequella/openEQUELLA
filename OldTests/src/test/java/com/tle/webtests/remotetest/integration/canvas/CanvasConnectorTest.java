...
public class CanvasConnectorTest extends AbstractCanvasTest
{
	...
	private static final String ACCESS_TOKEN = "OjJlNipUH4ZeSvJn3M0dRTehJ9Fmq9QvwT9fYz8b6yGCsqS4vmnLxys0i93xeu9J";
	...
	public void setupCanvas()
	{
		...
		EditCanvasConnectorPage editPage = page.editConnector(new EditCanvasConnectorPage(page), CONNECTOR);
