...
public class AllControlsTest extends AbstractWizardControlsTest
{
	...
	public void validateItem() throws Exception
	{
		...
		String todayStr = String.format("%4d-%02d-%02d", today.get(Calendar.YEAR), today.get(Calendar.MONTH) + 1,
		...
		assertEquals(cXml, "userselector/allusers",
			Arrays.asList("6285301a-4e6e-e925-aa17-7d6435678f46", "0dc35aad-cc0f-f470-ceac-810b36f3fd56"));
		assertEquals(cXml, "userselector/group", Arrays.asList("6285301a-4e6e-e925-aa17-7d6435678f46"));

		assertEquals(cXml, "emailselector/multiple", Arrays.asList("jolse.maginnis@equella.com", "select1@test.com"));
