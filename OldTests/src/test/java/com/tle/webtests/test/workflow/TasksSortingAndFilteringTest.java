...
public class TasksSortingAndFilteringTest extends AbstractCleanupTest
{
	...
	public void workflowSortingAndFilteringTest()
	{
		...
		assertTrue(checkOrder(titles, expectedTitles, filterListPage.results().getResults()), "Sorted order was wrong");
	...
	private boolean checkForItems(String[] arr, boolean[] expected, AbstractItemList<?, ?> list,
