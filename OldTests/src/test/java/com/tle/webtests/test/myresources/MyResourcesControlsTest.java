...
public class MyResourcesControlsTest extends AbstractCleanupTest
{
	...
	public void testTabsAndControlsScrapbook()
	{
		...
		examineControlFeatures(GENERIC_TESTING_COLLECTION, ALL_RESOURCES, SCRAPBOOK, "Flickr*", 4, 1, -1,
	...
	public void testTabsAndControlsModerationQueue()
	{
		...
		examineControlFeatures(GENERIC_TESTING_COLLECTION, ALL_RESOURCES, MODQUEUE, "artful*", 0, 0, 0,
			true);
	}
	...
	public void testTabsAndControlsArchive()
	{
		...
		examineControlFeatures(GENERIC_TESTING_COLLECTION, ALL_RESOURCES, ARCHIVED, "artful*", 0, 0, 0,
			true);
	...
	public void testTabsAndControlsAllResource()
	{
		...
		examineControlFeatures(GENERIC_TESTING_COLLECTION, ALL_RESOURCES, ALL, "A*", 10, 1, 1, true);
