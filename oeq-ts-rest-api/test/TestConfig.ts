...
export const USERNAME = 'AutoTest';
export const PASSWORD = 'automated';
export const USERNAME_SUPER = 'TLE_ADMINISTRATOR';
export const PASSWORD_SUPER = 'autotestpassword';
