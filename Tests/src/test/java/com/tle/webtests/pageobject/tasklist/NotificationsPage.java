...
public class NotificationsPage
	extends
		AbstractQueryableSearchPage<NotificationsPage, NotificationSearchResults, ModerationSearchResult>
{
	...
	public NotificationsPage selectNotification(int index)
	{
		...
		WebElement selectButton = driver.findElement(By.xpath("//div[contains(@class, 'itemresult-wrapper')][" + index
	...
	{
		List<WebElement> selected = driver.findElements(By
			.xpath("//div[contains(@class, 'itemresult-wrapper')]/div[contains(@class, 'selected')]/.."));
	...
	public void unselectAll()
	{
		WebElement firstResult = driver
			.findElement(By.xpath("//div[contains(@class, 'itemresult-wrapper')][1]/div[1]"));
	...
	public class SelectedDialog extends AbstractPage<SelectedDialog>
	{
		...
		{
			WebElement unselectRowButton = driver.findElement(By
				.xpath("//tr[@id='bss_bulkDialog_selectionsTabletrbss_bulkDialog_i" + index + "']/td[2]/a"));
		...
		{
			ExpectedCondition<Boolean> removalContition = ExpectedConditions2.stalenessOrNonPresenceOf(closeButton);
			closeButton.click();
