...
public class ModerationTab extends AbstractPage<ModerationTab>
{
	...
	{
		return isPresent(By
			.xpath("//h3[text()='Tasks awaiting moderation']/following-sibling::table[1]/tbody/tr/td[text()="
				+ quoteXPath(task) + "]"));
	}
	...
	public boolean moderatorCorrect(int row, String moderator)
	{
		...
		return isPresent(By.xpath("//table[@id='cmc_m']/tbody/tr[" + quoteXPath(row)
			+ "]/td[2]/ul[@class='moderators']/li/span[text()=" + quoteXPath(moderator) + "]"));
	}
	...
	{
		WebElement moderationComments = driver.findElement(By.xpath("//table[@id='cmc_m']/tbody/tr[" + quoteXPath(row)
			+ "]/td[2]/a"));
	...
	{
		driver.findElement(By.xpath("//table[@id='cmc_m']/tbody/tr[" + quoteXPath(row) + "]/td[2]/a")).click();
