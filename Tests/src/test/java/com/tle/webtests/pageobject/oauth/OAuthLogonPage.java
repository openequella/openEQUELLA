...
public class OAuthLogonPage extends AbstractPage<OAuthLogonPage>
{
	...
	public <T extends AbstractPage<T>> T logon(String username, String password, AbstractPage<T> redirTo)
	{
	...
	public static OAuthLogonPage authorise(PageContext context, String clientId, String redirectUri,
		String responseType, String... otherParams)
	{
		...
		context.getDriver().get(context.getBaseUrl() + "oauth/authorise?" + URLEncodedUtils.format(params, "UTF-8"));
