...
public class BlackboardMyInstitutionPage extends AbstractPage<BlackboardMyInstitutionPage>
{
	...
	{
		super(context, By.xpath("id('paneTabs')/li[contains(@class, 'active')]/a[contains(text(), 'My Institution')]"));
	}
	...
	public static class MyCoursesPage extends AbstractPage<MyCoursesPage>
	{
		...
		public List<String> getCourseNames()
		{
			...
			List<WebElement> eles = driver.findElements(By.xpath("//ul[contains(@class,'courseListing')]/li/a"));
