...
public class GuidedSearchingTest extends AbstractCleanupTest
{
	...
	private static final String ITEM3_NAME = "Searching item 3 - this one is from the move live during moderation";
	...
	{
		return new Object[][]{{COLLECTION1, ITEM1_NAME, false}, {COLLECTION2, ITEM2_NAME, false},
	...
	public void searchingForGuides()
	{
		...
		// Save here instead, saved searches used to not save the status of the "include non live" checkbox
	...
	private void assertItemVisibility(ItemListPage results, String name, boolean b) 
	{
		...
		assertEquals(results.doesResultExist(fullName), b, "Expected "+fullName+" to be " + (b ? "found" : "missing"));
	}
