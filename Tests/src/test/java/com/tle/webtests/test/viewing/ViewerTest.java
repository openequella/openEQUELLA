...
public class ViewerTest extends AbstractCleanupAutoTest
{
	...
	public void downloadFileTest()
	{
		...
		DownloadFilePage fileDownload = new DownloadFilePage(context, "google(4).png",
			"169e859db7f28a01e1b51e1c9e2d6b2b");
	...
	public void galleryTest()
	{
		String type = "Gallery";
		SummaryPage summary = SearchPage.searchAndView(context, "BasicViewerImage");
		String displayedTitle = summary.attachments().viewAttachment(type, new ImageGalleryPage(context)).getDisplayedTitle();
	...
	public void livTest()
	{
		...
		SummaryPage summary = SearchPage.searchAndView(context, "BasicViewerImage");
		LargeImageViewerPage liv = summary.attachments().viewAttachment(type, new LargeImageViewerPage(context));
	...
	public void fileViewerTest()
	{
		...
		assertTrue(image.imageSource().contains("file/136f2956-21f9-4a80-8af1-8dbb18ca34e9/1/google.png"));
	}
	...
	public void testHtml5Player()
	{
		...
		assertTrue(vid.videoSource().contains("oceans-clip.mp4") || vid.videoSource().equals("flash"),
	...
	public void testLTIViewer()
	{
		...
		LTIViewerPage lti = summary.attachments().viewAttachment("youtube tool", new LTIViewerPage(context));
