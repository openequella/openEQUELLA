...
public class SelectionSessionTest extends AbstractCleanupTest
{
	...
	public void searchResourcesActionTest()
	{
		...
		assertEquals(resultList.get(0).getTitle(), "CancelWizardTest an item",
	...
	public void contributeActionTest()
	{
		...
		assertTrue(contrib.hasCollection("Basic Attachments"), "'Basic Attachments' not found on contribute page");
	...
	public void quickUploadTest()
	{
		...
		IntegrationTesterReturnPage returnPage = session.quickContribute(Attachments.get(ATTACHMENT),
	...
	public void selectionPortletTest()
	{
		...
		session.homeExactSearch(fullName).getResultForTitle(fullName, 1).viewSummary()
	...
	public void saveSearchAndShareSearchTest()
	{
		...
		assertEquals(searchPage.getShareSearchUrl(), context.getBaseUrl()
