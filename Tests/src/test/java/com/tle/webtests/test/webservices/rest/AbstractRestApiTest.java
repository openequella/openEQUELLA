...
public abstract class AbstractRestApiTest extends AbstractSessionTest
{
	...
	@BeforeClass
	public void setup() throws NoSuchAlgorithmException, KeyManagementException, UnrecoverableKeyException,
		KeyStoreException
	{
	...
	protected JsonNode getEntity(String uri, String token, Object... params) throws IOException
	{
		...
		Assert.assertEquals(response.getStatusLine().getStatusCode(), 200, "Error getting a resource at " + uri);
		...
		throws ClientProtocolException, IOException
	{
		...
		{
			throw new RuntimeException("SSL exception attempting to talk connect to " + request.getURI(), ex);
		}
	}
	...
	/**
	 * A bit crude, but should do the trick: 'available' and 'results' are fixed
	 * features of the SearchBean class
	 */
