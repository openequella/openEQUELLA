...
public class FavouritesPage extends AbstractPage<FavouritesPage>
{
	...
	{
		return By.xpath("//div[@id='searchresults-select']/strong[text()=" + quoteXPath(searchType) + "]");
	}
	...
	void clickType(String searchType)
	{
		...
		{
			driver.findElement(By.xpath("//div[@id='searchresults-select']/a[text()=" + quoteXPath(searchType) + "]"))
				.click();
		}
	}
	...
	{
		driver.findElement(By.xpath("//h3[contains(@class,'itemresult-title')]/a[text()='" + savedSearchName + "']"))
			.click();
	}
}
