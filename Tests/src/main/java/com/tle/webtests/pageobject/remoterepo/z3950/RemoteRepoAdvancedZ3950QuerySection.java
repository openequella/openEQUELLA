...
public class RemoteRepoAdvancedZ3950QuerySection extends AbstractQuerySection<RemoteRepoAdvancedZ3950QuerySection>
{
	@FindBy(id = "zq_use1")
	...
	public void setAvancedQuery(String s1, String q1, String o1, String s2, String q2, String o2, String s3, String q3)
	{
		queryField.clear();
		queryField2.clear();
		queryField3.clear();
