...
public class LoginSettingsPage extends AbstractPage<LoginSettingsPage>
{
	...
	public List<String> getErrors()
	{
		...
		return Lists.transform(errorElements, new Function<WebElement, String>()
		{
	...
	{
		return isPresent(By.xpath("//div[contains(@class, 'ctrlinvalid')]/p[text()=" + quoteXPath(text) + "]"));
	}

	/**
	 * Returns the rows containing 'name' elements, so should exclude the table
	 * header (if any) "
	 * 
