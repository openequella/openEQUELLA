...
public abstract class AbstractShowEntitiesPage<THIS extends AbstractShowEntitiesPage<THIS>> extends AbstractPage<THIS>
{
	...
	protected <S extends AbstractShowEntitiesPage<S>, T extends AbstractEditEntityPage<T, S>> T editEntity(T editor,
	...
	protected <S extends AbstractShowEntitiesPage<S>, T extends AbstractEditEntityPage<T, S>> T cloneEntity(T editor,
		PrefixedName entityName)
	{
	...
	{
		return By.xpath(".//tr[td[@class='name' and normalize-space(text())=" + quoteXPath(name) + "]]");
	}
