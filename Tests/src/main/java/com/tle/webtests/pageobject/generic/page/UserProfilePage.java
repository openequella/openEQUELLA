...
public class UserProfilePage extends AbstractPage<UserProfilePage>
{
	...
	{
		return ExpectWaiter.waiter(ExpectedConditions.presenceOfElementLocated(By
			.xpath("//p[normalize-space(@class)='ctrlinvalidmessage' and text()=" + quoteXPath(msg) + "]")), this);
	}
