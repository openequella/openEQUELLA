...
public class ContentRestrictionsPage extends AbstractPage<ContentRestrictionsPage>
{
	...
	public ContentRestrictionsPage deleteBannedExt(String name)
	{
		...
		WebElement wibble = ext.findElement(By.xpath("following-sibling::td[@class='actions']/a[@class='unselect']"));
		wibble.click();
		acceptConfirmation();
		return waiter.get();
	}
	...
	private ExpectWaiter<ContentRestrictionsPage> newWaiter(String named)
	{
		return ExpectWaiter.waiter(
			ExpectedConditions2.visibilityOfElementLocated(bannedExtTable, getBannedExtBy(named)), this);
	}
	...
	public boolean deleteUserQuotasByIndex(int index)
	{
		...
		if( trs != null && trs.size() > index )
		{
			...
			WebElement wibble = tr
				.findElement(By.xpath("following-sibling::td[@class='actions']/a[@class='unselect']"));
	...
	public String getUserQuotasInfoByExpression(String expression)
	{
		return driver.findElement(
			By.xpath("//div[@id='userQuotas']/table/tbody/tr/td[text()=" + quoteXPath(expression)
	...
	public void deleteUserQuotasByExpression(String expression)
	{
		driver.findElement(
			By.xpath("//div[@id='userQuotas']/table/tbody/tr/td[text()=" + quoteXPath(expression)
				+ "]/../td[@class='actions']/a[2]")).click();
		acceptConfirmation();
	}

	public <T extends PageObject> T editUserQuotasByExpression(String expression, WaitingPageObject<T> targetPage)
	{
		driver.findElement(
			By.xpath("//div[@id='userQuotas']/table/tbody/tr/td[text()=" + quoteXPath(expression)
				+ "]/../td[@class='actions']/a[1]")).click();
