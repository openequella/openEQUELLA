...
public class AddBannedExtensionPage extends AbstractPage<AddBannedExtensionPage>
{
	...
	{
		super(context, By.xpath("//h3[text()='Enter banned extension']")); // original properties file key: addbannedext.dialog.title
	}
	...
	{
		return isPresent(By.xpath("//div[contains(@class, 'ctrlinvalid')]/input[@id='" + BANNED_EXT_TEXT_BOX_ID
