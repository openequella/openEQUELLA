...
{
	public static final String ACTIVE_CACHING_TITLE = "Active caching"; // original property key: remotecaching.title
	public static final String EVERYONE_NODENAME = "Everyone"; // original property key: remotecaching.default.rootnode.name
	public static final String SETTINGS_SAVED_RECEIPT = "Active Caching settings saved successfully"; // original property: settings.save.receipt
	...
	/**
	 * The remote caching service and the tree control reload can be slow.
	 * In Run mode (as opposed to debug) we have to wait for a couple seconds
	 * before checking the receipt message.
	 */
