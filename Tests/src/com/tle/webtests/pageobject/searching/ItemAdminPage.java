...
import com.tle.webtests.pageobject.payment.storefront.FilterBySubscriptionEndDatePage;
...
public class ItemAdminPage extends AbstractBulkResultsPage<ItemAdminPage, ItemListPage, ItemSearchResult>
{
	...
	public ItemListPage setSubscriptionDateFilter(String option, Calendar[] dates)
	{
		openFilters();
		return new FilterBySubscriptionEndDatePage(context, resultsPageObject).get().setDateFilter(option, dates);
	}
