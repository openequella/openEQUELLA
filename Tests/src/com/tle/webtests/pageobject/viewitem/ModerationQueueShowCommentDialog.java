...
public class ModerationQueueShowCommentDialog extends AbstractPage<ModerationQueueShowCommentDialog> {
	...
	{
		return driver.findElement(By.className("modal-content-inner")).findElement(By.tagName("div")).getText();
	}
