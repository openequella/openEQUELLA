...
public class MoodleExternalToolPage extends AbstractPage<MoodleExternalToolPage>
{
	...
	public MoodleExternalToolPage(PageContext context)
	{
		super(
			context,
			By.xpath("//h2[contains(text(), 'Manage external tool types') or contains(text(), 'External Tool') or contains(text(), 'LTI')]"));
	}
	...
	public MoodleExternalToolPage addExternalTool(String name, String url, String key, String secret, boolean show)
	{
		...
		if( isPresent(By.xpath("//div[@id='lti_configured_tools_container']/table")) )
		{
			getWaiter().until(
				ExpectedConditions.presenceOfElementLocated(By
					.xpath("//div[@id='lti_configured_tools_container']/table/tbody[@class='yui-dt-data'][1]")));
		}
		else if( isPresent(By.xpath("//div[@id='lti_configured_container']/table")) )
		{
			getWaiter().until(
				ExpectedConditions.presenceOfElementLocated(By
					.xpath("//div[@id='lti_configured_container']/table/tbody[@class='yui-dt-data'][1]")));
		}
	}
