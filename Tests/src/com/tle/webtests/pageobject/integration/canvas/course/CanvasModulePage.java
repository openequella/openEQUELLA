...
public class CanvasModulePage extends AbstractCanvasCoursePage<CanvasModulePage>
{
	...
	public CanvasAddModuleItemDialog addModuleItem(String moduleName)
	{
		...
		WebElement addContentButton = moduleDiv.findElement(By
			.xpath(".//button[contains(@class,'add_module_item_link')]"));
	...
	public void deleteModuleItemsNamed(String moduleName, String itemName)
	{
		...
		{
			WebElement adminOpener = moduleDiv.findElement(By.xpath(".//span[text() = " + quoteXPath(itemName)
				+ "]/../../..//div[@class='ig-admin']/div/a[contains(@class, 'al-trigger')]"));
			dumbCanvasClickHack(adminOpener);
			WebElement activeRemoveButton = moduleDiv.findElement(By
				.xpath(".//ul[@aria-expanded='true']/li/a[contains(@class,'delete_item_link')]"));
	...
	public void deleteModule(String moduleName)
	{
		...
		{
			WebElement moduleDiv = driver.findElement(getModuleBy(moduleName));
			WebElement adminOpener = moduleDiv
				.findElement(By
				.xpath(".//div[@class='ig-header-admin']/button[@aria-label='Manage module']"));
			dumbCanvasClickHack(adminOpener);
			WebElement activeDeleteButton = moduleDiv.findElement(By
				.xpath(".//ul[@aria-expanded='true']/li/a[contains(@class,'delete_module_link')]"));
	...
	public void addModule(String moduleName)
	{
		...
		dumbCanvasClickHack(driver.findElement(By
			.xpath("//div[@class='ui-dialog-buttonset']/button[contains(@class,'button_type_submit')]")));
		waitForElement(getModuleBy(moduleName));
	}
