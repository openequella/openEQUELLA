...
public class SettingsPage extends AbstractPage<SettingsPage>
{
	...
	{
		return clickSetting(ShortcutURLsSettingsPage.SHORTCUT_URLS_TITLE, new ShortcutURLsSettingsPage(context));
	}
	...
	public ShowTiersPage pricingTierSettings()
	{
		return clickSetting("Pricing tiers", new ShowTiersPage(context));
	}

	public ShowGatewaysPage gatewaysPage()
	{
		return clickSetting("Payment gateways", new ShowGatewaysPage(context));
	}

	public ShowStoreFrontRegistrationsPage storeFrontRegisterPage()
	{
		return clickSetting("Store front registrations", new ShowStoreFrontRegistrationsPage(context));
	}

	public StoreRegistrationPage storeRegistrationsPage()
	{
		return clickSetting("Store registrations", new StoreRegistrationPage(context));
	}

	public StoreSetupPage storeSetupPage()
	{
		return clickSetting("Store setup", new StoreSetupPage(context));
	}
	...
	public ShowCataloguesPage showCataloguesPage()
	{
		return clickSetting("Catalogues", new ShowCataloguesPage(context));
	}

	public ShowRegionsPage showRegionPage()
	{
		return clickSetting("Regions", new ShowRegionsPage(context));
	}

	public ApprovalsPage approvalsPage()
	{
		return clickSetting("Approvals and payments", new ApprovalsPage(context));
	}
