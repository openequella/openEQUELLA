...
public class ShuffleBox extends AbstractPage<ShuffleBox> implements ListRenderer
{
	...
	public void checkLoaded() throws Error
	{
		...
		boxDiv = driver.findElement(By.xpath("//div[@class='shuffle-box' and .//select[@id=" + quoteXPath(id) + "]]"));
	}
	...
	{
		return Lists.transform(rightDropDown.getOptions(), new Function<WebElement, String>()
		{
			@Override
