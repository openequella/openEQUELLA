...
public class HarvestPage extends AbstractPage<HarvestPage>
{
	...
	public HarvestPage clickPage(final int i)
	{
		...
		waiter.until(new ExpectedCondition<Boolean>()
		{
			...
			{
				return String.format("Current page to be to be \"%d\". Current page: \"%d\"", i, currentPage);
			}
		});
		return get();
	}
	...
	{
		return Integer.valueOf(driver.findElement(By.xpath("//ul[@class='pages']/li[not(a)]")).getText().trim());
	}
