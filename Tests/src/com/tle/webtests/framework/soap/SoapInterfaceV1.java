...
public interface SoapInterfaceV1
{
	 ...
	 */
	String startEdit(String ssid, String uuid, int version, String itemdefid, boolean bModifyAttach) throws Exception;
	 ...
	 * @param prepare Whether or not to prepare all the item's XML for the
	 *            assembler (reduce manifests, setup thumbnail url etc)
	 ...
	 */
	String getItem(String ssid, String item_uuid, int version, String itemdef, String select) throws Exception;
