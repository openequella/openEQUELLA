...
public class CALBookActivationTest extends AbstractActivationsTest
{
	...
	public void testDateValidation()
	{
		...
		String endDateStr = untilDate.createFormatter().format(endDate);
		assertEquals(untilDate.getTextValue(), endDateStr);
		activatePage.cancel();
	...
	public void testCitationDisplayTemplate()
	{
		...
		createBook(citBook, "100", "CAL Guide Books Collection - citation displayed", "EYE ESS BEE ENN");
