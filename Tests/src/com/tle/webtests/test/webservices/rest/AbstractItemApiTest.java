...
public abstract class AbstractItemApiTest extends AbstractRestApiTest
{
	...
	protected void uploadFile(String stagingDirUrl, String filename, URL resource) throws IOException
	{
	...
	protected ObjectNode editItem(ObjectNode item, String token, Object... paramNameValues) throws IOException
	{
		...
		try
		{
			assertResponse(putItem, 200, "Should have been able to edit. " + superSerialResponse(putItem));
		}
		finally
		{
	...
	protected HttpResponse putItem(String itemUri, String json, String token, boolean consume,
		Object... paramNameValues) throws IOException
	{
