...
public class ApiAssertions
{
	...
	public void assertAttachmentBasics(JsonNode attachment, ItemId itemId, String type, String uuid, String description)
	{
		...
		assertLink(linksNode, "view", context.getBaseUrl() + "items/" + itemId + "/?attachment.uuid=" + actualUuid);
	}
	...
	public void assertDate(JsonNode dateNode, Object time)
	{
		...
		{
			assertEquals(dateNode.getTextValue(),
				ISO8601Utils.format(new Date((Long) time), true, TimeZone.getTimeZone("America/Chicago")));
		}
	}
