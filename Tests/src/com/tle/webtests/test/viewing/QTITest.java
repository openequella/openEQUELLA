...
{
	final static String OAUTH_ID = "LTI_QUIZ";

	@Test
	public void QTIPackageTest()
	{
		String q1 = "Question 1 - Welcome\n"
		...
		String q15 = "Question 15 - Matching\n"
		...
		String q16 = "Question 16 - Many Answers\n"
		...
		PackageAttachmentEditPage pkgEditor = control.addResource(new FileUniversalControlType(control))
	...
	public void QTIQuizTest()
	{
		...
		control.addResource(new FileUniversalControlType(control))
			.uploadQTITestOption(Attachments.get("repaired bbq.zip")).save();

		// open attachment
		SummaryPage item = wizard.save().publish();
		QTIQuizPage quiz = item.attachments().viewAttachment("BBQs test package", new QTIQuizPage(context));
