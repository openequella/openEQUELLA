...
public class LTISettingsTest extends AbstractSessionTest
{
	...
	private static final String LAUNCHABLE_WIKIPEDIA_LTI = "https://www.edu-apps.org/tool_redirect?id=wikipedia";
	...
	/**
	 * Presupposes that the LTI titled {@value LTISettingsTest#LTI_TITLE}
	 * exists, and is hereby tidied up while testing deletions.
	 */
