...
public class OAISettingsTest extends AbstractSessionTest
{
	...
	public void testOaiInputs()
	{
		...
		assertTrue("nufn".equals(oaip.getOAIScheme()), "Expected 'nufn', got " + oaip.getOAIScheme() + '.');
		assertTrue(Check.isEmpty(oaip.getNamespace()), "Expected null, got " + oaip.getNamespace() + '.');
		assertTrue("This is not an email".equals(oaip.getEmail()),
