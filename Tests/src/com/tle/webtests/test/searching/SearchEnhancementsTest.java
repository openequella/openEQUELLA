...
public class SearchEnhancementsTest extends AbstractCleanupAutoTest
{
	...
	{
		// Basic Hyphen tests
		List<String> expected = Lists.newArrayList("SearchSettings - Image 1 - JPEG/JPG",
			"SearchSettings - Image 2 - PNG", "SearchSettings - Image 3 - BMP", "SearchSettings - Image 4 - GIF");
		...
		expected = Lists.newArrayList("Summary DRM - Link to DRM Allowing Composition - Package",
			"Summary DRM - Link to DRM Show On Summary and Allowing Composition - Package");
		notExpected = Lists.newArrayList("Summary DRM - Link to DRM Require Composition Acceptance - Package",
	...
	public void testExclamation()
	{
		...
		List<String> expected = Lists.newArrayList("ExclamationTest ! Cat!", "ExclamationTest ! Dog!",
			"ExclamationTest ! Rat!");
