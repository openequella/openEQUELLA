...
public class Launch {
  public static void main(String[] args) throws Exception {
    if (System.getProperty("java.version").compareTo("1.6") < 0) {
      try {
        JOptionPane.showMessageDialog(
            null, "Equella requires Java 6u1 or greater in order to perform the installation.");
    ...
    if (args.length == 2 && "--unsupported".equals(args[0])) {
      mainClass
          .getMethod("setExistingResults", new Class[] {String.class})
          .invoke(mainObj, new Object[] {args[1]});
    }
