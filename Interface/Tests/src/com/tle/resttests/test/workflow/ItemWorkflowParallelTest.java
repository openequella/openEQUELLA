...
public class ItemWorkflowParallelTest extends AbstractEntityCreatorTest
{
	...
	public void create()
	{
		...
		collectionUuid = collections.createId(CollectionJson.json("Parallel collection", RestTestConstants.SCHEMA_BASIC,
			workflowUuid));
	...
	{
		ItemId itemId = items.createId(collectionUuid, true, "item/name", context.getFullName("Parallel Item"));
