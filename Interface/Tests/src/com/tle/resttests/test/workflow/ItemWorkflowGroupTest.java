...
public class ItemWorkflowGroupTest extends AbstractEntityCreatorTest
{
	...
	public void create()
	{
		...
		collectionUuid = collections.createId(CollectionJson.json("Workflow Task collection",
	...
	{
		ItemId itemId = items.createId(collectionUuid, true, "item/name", context.getFullName("Groups and roles"));
	...
	{
		ItemId itemId = items.createId(collectionUuid, true, "item/name",
			context.getFullName("Groups and roles indexing"));
