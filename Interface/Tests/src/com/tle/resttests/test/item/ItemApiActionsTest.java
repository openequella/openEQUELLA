...
public class ItemApiActionsTest extends AbstractRestAssuredTest
{
	...
	{
		ObjectNode item = Items.json(RestTestConstants.COLLECTION_MODERATE, "item/controls/checkboxes", true);
		...
		ItemStatusAssertions.assertComment(findStatus(moderation), 0, submitMessage, getDefaultUser(), "submit");
	}
}
