...
{
	public NotificationRequests(URI baseUri, TokenProvider tokenProvider, ObjectMapper mapper, PageContext pageContext,
	...
	public ObjectNode waitForNotification(final ItemId expectedId, final String query, final String reason)
	{
	...
	{
		Waiter<RequestSpecification> indexWaiter = new Waiter<RequestSpecification>(request).withTimeout(60,
			TimeUnit.SECONDS);
	...
	public static Function<ObjectNode, ObjectNode> resultAvailable(final ItemId expectedId, final String reason)
	{
