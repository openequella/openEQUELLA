...
{
	public static ObjectNode json(String username, String firstName, String lastName, String emailAddress,
		String password)
	{
		return json(null, username, firstName, lastName, emailAddress, password);
	}

	public static ObjectNode json(String uuid, String username, String firstName, String lastName, String emailAddress,
		String password)
	{
		if( uuid == null )
		{
