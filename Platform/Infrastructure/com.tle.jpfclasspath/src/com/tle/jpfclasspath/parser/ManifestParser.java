 ...
 */
final public class ManifestParser
{
	...
	private static String loadPluginDtd(final String version)
	{
		try
		{
			Reader in = new InputStreamReader(ManifestParser.class.getResourceAsStream("plugin_" //$NON-NLS-1$
	...
	public ModelPluginManifest parseManifest(InputStream strm) throws ParserConfigurationException,
