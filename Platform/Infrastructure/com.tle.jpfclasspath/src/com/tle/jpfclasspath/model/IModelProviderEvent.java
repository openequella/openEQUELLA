...
public interface IModelProviderEvent {
  ...
  /**
   * Returns the combination of flags indicating type of event. In case of multiple changes, flags
   * are ORed together. (a combination of MODEL_CHANGED, MODEL_ADDED, MODEL_REMOVED)
   *
