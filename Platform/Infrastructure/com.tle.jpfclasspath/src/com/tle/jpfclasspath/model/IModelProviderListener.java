...
/**
 * Classes should implement this interface in order to be able to register as model provider
 * listeners. They will be notified about events such as models being added or removed. These
 * changes are typically caused by the changes in the workspace when models are built on top of
 * workspace resources.
 *
