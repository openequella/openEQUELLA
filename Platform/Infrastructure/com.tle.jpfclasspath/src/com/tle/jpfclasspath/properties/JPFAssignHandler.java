	...
	public Object execute(ExecutionEvent event) throws ExecutionException
	{
		...
		if( sel instanceof IStructuredSelection )
		{
			...
			for( Object selObj : selections )
			{
				...
				String registry = JPFProject.getPreferences(project.getProject()).get(
					JPFClasspathPlugin.PREF_REGISTRY_NAME, "");
			...
			JPFProjectSelectionDialog dialog = new JPFProjectSelectionDialog(window.getShell(), defaultSelection);
				...
				protected IStatus run(IProgressMonitor monitor)
				{
					...
					for( Object selection : selections )
					{
						...
						IEclipsePreferences prefs = new ProjectScope(project.getProject())
							.getNode(JPFClasspathPlugin.PLUGIN_ID);
