...
public class CssInclude implements PreRenderable, Comparable<CssInclude> {
  ...
  public enum Priority {
    /**
     * Something like styles.css would use this since it is the base styles to be overridden where
     * appropriate
     */
    LOWEST,
    ...
    /** Something like customer.css would use this since it needs to override other styles */
    HIGHEST
  }
