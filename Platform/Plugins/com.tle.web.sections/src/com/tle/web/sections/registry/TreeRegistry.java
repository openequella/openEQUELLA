 ...
 *
 * <p>It also doubles up as the {@link RegistrationController}, so contains the logic for calling
 * {@link RegistrationHandler}s.
 *
 * <p>This implementation has a list of default {@code RegistrationHandler}s, and uses JPF to get
 * any additional handlers. <br>
 * The default handler list contains:
 *
 * <ul>
 *   <li>{@link com.tle.web.sections.registry.handler.StandardInterfaces}
 *   <li>{@link com.tle.web.sections.registry.handler.BookmarkRegistrationHandler}
 *   <li>{@link com.tle.web.sections.registry.handler.EventFactoryHandler}
 *   <li>{@link com.tle.web.sections.registry.handler.TreeLookupRegistrationHandler}
 * </ul>
 *
 * @author jmaginnis
 */
...
public class TreeRegistry implements RegistrationController {
  ...
  private final LoadingCache<String, SectionTreeData> treeMap =
      CacheBuilder.newBuilder().build(CacheLoader.from(new TreeMaker()));
  private List<RegistrationHandler> handlers;

  @Inject private StandardInterfaces standardHandler;
  @Inject private BookmarkRegistrationHandler bookmarkHandler;
  @Inject private EventFactoryHandler eventHandler;
  @Inject private TreeLookupRegistrationHandler treeLookupHandler;

  @PostConstruct
  public void setupHandlers() {
    this.handlers =
        ImmutableList.of(standardHandler, bookmarkHandler, eventHandler, treeLookupHandler);
  }
          ...
          for (Parameter classParam : extension.getParameters("class")) {
            final Object section =
                pluginService.getBean(
                    extension.getDeclaringPluginDescriptor(), classParam.valueAsString());
  ...
  public void setPluginService(PluginService pluginService) {
    ...
    sectionTreePlugin =
        new PluginTracker<Object>(pluginService, "com.tle.web.sections", "sectionTree", "path");
    sectionPlugin =
    ...
    registrationPlugins =
        new PluginTracker<RegistrationHandler>(
            pluginService,
            "com.tle.web.sections",
            "registrationHandler",
            null,
