...
public class Conversion {
  ...
  @Inject private PluginTracker<SectionsConverter> tracker;
  ...
  public synchronized void ensureConverters() {
    if (tracker.needsUpdate() || morphToParams == null) {
      ...
      converterList.add(new FromJSONConverter());
      morphFromJSString =
          new Transmorph(converterList.toArray(new IConverter[converterList.size()]));
      ...
      converterList.add(new ConstructorToStringConverter());
      converterList.add(new ToJSONConverter());
      MultiConverter toJSString =
          new MultiConverter(false, converterList.toArray(new IConverter[converterList.size()]));

      morphToJSExpression =
          new Transmorph(
              new StandardExpressions(toJSString), new CollectionToArray(), new ArrayToArray());
    }
  }
