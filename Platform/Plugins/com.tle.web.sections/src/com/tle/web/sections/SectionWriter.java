...
/**
 * A thin wrapper around a {@code java.io.PrintWriter} which extends it with convenience methods for
 * writing out HTML tags.
 *
 * <p>An example:
 *
 * <pre>
 ...
 * Will write:
 *
 * <p><code>&lt;div class="info">&amp;lt;Hello&amp;gt;&lt;/div></code>
 *
 * @author jmaginnis
 */
public class SectionWriter extends PrintWriter implements PreRenderContext {
   ...
   * @throws IOException
   */
  public void writeTag(String tag, Map<String, String> attributes, boolean empty)
      throws IOException {
    out.write('<');
    out.write(tag);
