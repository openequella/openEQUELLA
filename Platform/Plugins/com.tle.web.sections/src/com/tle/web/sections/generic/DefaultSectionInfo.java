...
public class DefaultSectionInfo implements MutableSectionInfo {
  ...
  protected final Queue<SectionEvent<EventListener>> eventQueue =
      new PriorityQueue<SectionEvent<EventListener>>();
  ...
  @Nullable protected HttpServletResponse response;
  @Nullable protected HttpServletRequest request;
  @Nullable private List<SectionEventFilter> eventFilters;
  @Nullable private RenderContext renderContext;
  @Nullable private Bookmark publicBookmark;
  ...
  private <T extends EventListener> List<Object> getListeners(
      @Nullable String target, Class<T> clazz) {
  ...
  public SectionInfo createForward(String path, @Nullable Map<Object, Object> attributes) {
    ...
    return controller.createInfo(
        SectionUtils.relativePath(thisPath, path), request, response, this, null, attributes);
  }
