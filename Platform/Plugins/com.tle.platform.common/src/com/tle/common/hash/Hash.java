...
public class Hash {
  ...
  public static boolean isHashed(String value) {
    if (!Check.isEmpty(value)) {
      return value.startsWith(PREFERRED.toString() + ':')
          || value.startsWith(FALLBACK.toString() + ':');
    }
    return false;
  }
  ...
  private static class SHA1Digester implements HashDigester {
    ...
    private static final String SHA256_SALT =
        customSalt == null ? "TimeIsAnIllusion.LunchtimeDoublySo." : customSalt;
