...
public class URLUtils
{
	...
	/**
	 * Extracts into 2 parts, the base URL and the query string.  The returned query string won't be null (ie it is blank if empty)
	 * @param url
	 * @return
	 */
	public static String[] decompose(String url)
	{
		...
		if( questionIndex >= 0 )
		{
			...
			bits[1] = Utils.safeSubstring(url, questionIndex);
		}
		else
		{
			bits[0] = url;
