...
public class Utils {
  ...
  /**
   * Parse a boolean from a string, but have a default value if the string is not exactly either
   * true or false. Boolean.parseBoolean(String) is very similar, but will always default to false
   * if the string is not exactly "true".
   */
  ...
  /**
   * Capitalises the first letter of every word Eg "barry ballshank" becomes "Barry Ballshank" Note
   * that it only uses spaces to tokenise the words...not any whitespace
   *
   * @param text
   ...
   */
  @Nullable
  public static Date parseDate(@Nullable String dateAsString, SimpleDateFormat dateFormat)
