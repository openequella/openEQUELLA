...
/**
 * Can only strip out invalid unicode chars as we see them... this means that escaped invalid chars
 * will slip through the cracks. Eg &amp;#x0B; Not as big a deal as it seems, when WE read the chars
 * back in, they will be removed. If anyone else reads them in... unrucky.
 *
 * @author aholland
 */
