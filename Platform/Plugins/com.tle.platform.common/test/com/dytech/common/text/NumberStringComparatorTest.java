...
public class NumberStringComparatorTest extends TestCase
{
	...
	public void testCompare()
	{
		...
		result = comparator.compare("this8is8not8same", "this8is8really8not8the8same"); //$NON-NLS-1$ //$NON-NLS-2$
		assertFirstComesFirst(result);
		...
		result = comparator.compare("OnCe UpOn A tImE, jUsT 15 yEaRs AgO", //$NON-NLS-1$
		...
		result = new NumberStringComparator<String>()
		{
