...
public class BadCharacterFilterReaderTest extends TestCase
{
	...
	private static final String PLAIN_BIG = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789GHGHGHGHGJGHHH"
		+ "GGHGHGGHGHGHJGHDSFDGFASAAGSHGAHGSAGSSGHASGSGHAGS" + "GHSGASGHAGSASGSGASGSAGSGASASGHASASASG9999990";
	...
	{
		exec("\u0011\u0009ABCDEFG\u0009\u0011HIJKLMNOPQRSTUVWX\u0011YZ0123456789",
			"\u0009ABCDEFG\u0009HIJKLMNOPQRSTUVWXYZ0123456789", true);
	}
	...
	public void testReadKnownProblemFileViaPropBag() throws Exception
	{
		...
		try
		{
			is = new InputStreamReader(BadCharacterFilterReaderTest.class.getResourceAsStream("real2.xml"), "UTF-8");
	...
	private void doReal(String realFilename) throws Exception
	{
		...
		try
		{
			...
			is = new InputStreamReader(BadCharacterFilterReaderTest.class.getResourceAsStream(realFilename), "UTF-8");
			...
			rdr = new BadCharacterFilterReader(new InputStreamReader(
	...
	private void exec(final String original, final String expected, final boolean expectDiscard) throws Exception
	{
		...
		assertTrue((expectDiscard ? "No discard!" : "Discarded when shouldn't!"), rdr.didDiscard() == expectDiscard);
	}

	private void exec(final String original, final String expected, final boolean expectDiscard, final int bufferSize)
		throws Exception
	{
		final StringReader str = new StringReader(original);
